...
def set_value(context, target, value):
    context.browser.element(locator(target)).highlight().set_value(value)
...
def file_upload_absolute(context, file_path, target):
    ...
    set_value(context, target, file_path)
...
def file_multi_upload_absolute(context, file_list, target):
    ...
    set_value(context, target, file_path_list_string)
...
def file_upload_relative(context, relative_file_path, target):
    ...
    set_value(context, target, absolute_file_path)
...
def file_multi_upload_relative(context, relative_path_list, target):
    ...
    set_value(context, target, file_list_string)
...
def downloaded_file_upload(context, target):
    ...
    if downloaded_file_path is None:
        ...
        set_value(context, target, downloaded_file_path)
