...
class CallableBuiltinJudge:
    ...
    def __call__(
        ...
        *,
        ...
        # TODO(ML-52850): Remove this once we deprecate the usage of `mlflow.evaluation.Assessment``
        warnings.filterwarnings(
            "ignore",
            message="``mlflow.evaluation.assessment.Assessment`` is deprecated since 3.0.0",
            ...
            for guidelines_name, grouped_guidelines in (
                ...
                assessments.append(
                    mlflow_utils.assessment_result_to_mlflow_assessments(
                        ...
                        assessment_source=mlflow_eval.AssessmentSource(
                            mlflow_eval.AssessmentSourceType.LLM_JUDGE,
                            entities.AssessmentSource.builtin().source_id,
                        ),
                    )
                )
