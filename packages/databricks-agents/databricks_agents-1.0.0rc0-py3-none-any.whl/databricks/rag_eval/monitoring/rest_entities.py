...
class MonitorSettings:
    ...
    trace_processing_concurrency: Optional[int] = None
    harness_evaluation_batch_size: Optional[int] = None
    ...
    def to_entity(self) -> entities.MonitorSettings:
        ...
        required_fields = [
            ...
            "trace_processing_concurrency",
            "harness_evaluation_batch_size",
        ...
        return entities.MonitorSettings(
