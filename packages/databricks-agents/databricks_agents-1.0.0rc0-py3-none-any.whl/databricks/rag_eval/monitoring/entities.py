...
class MonitorSettings:
    ...
    initial_lookback_period_hours: int
    max_traces_to_process_in_job: int
    trace_processing_concurrency: int
    harness_evaluation_batch_size: int
    rag_eval_max_workers: int
    rag_eval_rate_limit_quota: int
