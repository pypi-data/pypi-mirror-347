...
# logger.info("BRAVE_API_KEY: %s", os.getenv("BRAVE_API_KEY") or "Not found")
...
#         logger.info("Testing brave_web_search...")
#         result = await brave_web_search("python tutorials", count=5)
#         logger.info("Web search result:\n%s", result)
#         logger.info("Testing brave_local_search...")
#         result = await brave_local_search("coffee shops in Seattle", count=3)
#         logger.info("Local search result:\n%s", result)
#         await cleanup()
