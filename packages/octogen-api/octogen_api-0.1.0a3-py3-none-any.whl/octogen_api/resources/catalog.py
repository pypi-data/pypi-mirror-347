...
class CatalogResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> CatalogResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/octogen-systems/octogen-py-sdk#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> CatalogResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/octogen-systems/octogen-py-sdk#with_streaming_response
        """
