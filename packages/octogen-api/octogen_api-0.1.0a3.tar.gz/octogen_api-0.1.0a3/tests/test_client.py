...
from octogen_api import OctogenSDK, AsyncOctogenSDK, APIResponseValidationError
...
from octogen_api._exceptions import APIStatusError, APITimeoutError, OctogenSDKError, APIResponseValidationError
...
def _get_open_connections(client: OctogenSDK | AsyncOctogenSDK) -> int:
...
class TestOctogenSDK:
    client = OctogenSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(OctogenSDKError):
            with update_env(**{"OCTOGEN_SDK_API_KEY": Omit()}):
                client2 = OctogenSDK(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: OctogenSDK) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = OctogenSDK(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(OCTOGEN_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = OctogenSDK(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: OctogenSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: OctogenSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: OctogenSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = OctogenSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = OctogenSDK(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(
        self, client: OctogenSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncOctogenSDK:
    client = AsyncOctogenSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(OctogenSDKError):
            with update_env(**{"OCTOGEN_SDK_API_KEY": Omit()}):
                client2 = AsyncOctogenSDK(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncOctogenSDK) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(OCTOGEN_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncOctogenSDK(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncOctogenSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncOctogenSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncOctogenSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncOctogenSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncOctogenSDK(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncOctogenSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
