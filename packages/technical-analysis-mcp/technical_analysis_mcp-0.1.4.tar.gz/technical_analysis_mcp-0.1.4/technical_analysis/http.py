...
async def analyze_etf_technical(etf_code: str = '510300', with_market_style: bool = True):
    """
    获取ETF技术指标数据
    - **etf_code**: ETF代码 (例如510300)
...
async def analyze_stock_hist_technical(stock_code: str = '000001', with_market_style: bool = True):
    """
    获取股票技术指标数据
