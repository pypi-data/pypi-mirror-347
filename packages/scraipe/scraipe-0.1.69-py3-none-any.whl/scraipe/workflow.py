...
class Workflow:
    ...
    def scrape__compile_links(self, links:Iterable[str]=None, overwrite=False) -> List[str]:
    ...
    def scrape(self, links:Iterable[str] = None, overwrite:bool=False) -> Sequence[ScrapeResult]:
        ...
        links_to_scrape = self.scrape__compile_links(links, overwrite)
    ...
    def analyze__compile_links(self, links:Iterable[str]=None, overwrite:bool=False) -> List[str]:
        ...
        # Remove duplicates
        links_to_analyze = list(set(links))
