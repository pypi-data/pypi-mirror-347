...
# -*- coding: utf-8 -*-
#
# structure_step documentation build configuration file,
...
project = u'SEAMM Structure Plug-in'
...
version = structure_step.__version__
# The full version, including alpha/beta/rc tags.
release = structure_step.__version__
...
htmlhelp_basename = 'structure_stepdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'structure_step.tex',
     u'Structure Step Documentation',
     u'Paul Saxe', 'manual'),
]
