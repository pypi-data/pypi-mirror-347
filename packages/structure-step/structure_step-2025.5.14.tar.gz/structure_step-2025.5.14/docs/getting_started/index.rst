...
Installation
============
The Structure step is probably already installed in your SEAMM
...
check for `structure-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update structure-step
