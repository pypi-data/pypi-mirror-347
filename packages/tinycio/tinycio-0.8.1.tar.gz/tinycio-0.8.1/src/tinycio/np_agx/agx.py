# tinycio note:
#
#   This works just fine, so I'm holding off trying a PyTorch re-implementation.
#
#   Authored by:    https://github.com/MrLixm/AgXc
#   Originally:     https://github.com/sobotka/AgX-S2O3
#
#   Per original author re. license query:
#   https://github.com/sobotka/AgX-S2O3/issues/1
#
#       "
#       Fill your boots.
#       Placing licenses into things crosses ethical lines that are problematic. 
#       It’s a design concept for a given set of design constraints.
#       Pixar implemented Filmic into Renderman without an explicitly declared license.
#       "
# ------------------------------------------------------------------------------------------
