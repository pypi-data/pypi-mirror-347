...
from ..models.api_category import BaseResource, ApiClient
...
class BaseAPIService(BaseResource):
    ...
    def _extract_response_data(self, response: Dict[str, Any], key: Optional[str] = None) -> Any:
        """
    ...
    def _make_request_with_params(self, method: str, endpoint: str, 
        ...
        if params is not None and params:
            return self._client.make_request(method, endpoint, params=params, **kwargs)
        else:
            return self._client.make_request(method, endpoint, **kwargs)
    ...
    def get_all(self, page: Optional[int] = None, per_page: Optional[int] = None, 
        ...
        return self.list(params=all_params, **kwargs)
    ...
    def get_by_id(self, resource_id: str, params: Optional[Dict[str, Any]] = None, 
        ...
        return self._extract_response_data(response, response_key)
