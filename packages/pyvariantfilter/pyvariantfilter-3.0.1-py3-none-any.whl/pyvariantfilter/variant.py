...
class Variant:
	...
	def matches_mitochondrial(self):
		"""
		Is the variant on the mitochondrial chromosome?

		Input: self

		Returns:

			True - If variant is on mitochondrial chromosome.
			False - If variant is not on mitochondrial chromosome.
	...
	def matches_inheritance_model(self,
		...
		if 'mitochondrial' in models:

			if self.matches_mitochondrial():
	...
	def get_matching_inheritance_models(self, compound_het_dict, lenient=False, low_penetrance_genes={}, min_parental_gq_dn=30, min_parental_depth_dn=10, max_parental_alt_ref_ratio_dn=0.04, min_parental_gq_upi=30, min_parental_depth_upi=10):
		...
		if self.matches_mitochondrial():
			...
			matching_models.append('mitochondrial')
