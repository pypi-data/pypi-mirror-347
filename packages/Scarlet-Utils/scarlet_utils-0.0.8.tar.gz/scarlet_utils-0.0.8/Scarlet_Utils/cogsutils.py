...
class CogsUtils:
    ...
    # def __init__(
    #     self, cog: typing.Optional[commands.Cog] = None, bot: typing.Optional[StarBot] = None
    # ) -> None:
    #     if cog is not None:
    #         if isinstance(cog, str):
    #             cog = bot.get_cog(cog)
    #         self.cog: commands.Cog = cog
    #         self.bot: StarBot = self.cog.bot if hasattr(self.cog, "bot") else bot
    ...
    #     else:
    #         self.cog: typing.Optional[commands.Cog] = None
    #         self.bot: typing.Optional[StarBot] = None
    ...
    # async def add_cog(
    #     self, bot: typing.Optional[StarBot] = None, cog: typing.Optional[commands.Cog] = None, **kwargs
    # ) -> commands.Cog:
    #     """
    ...
    async def get_cog_version(
        cls, bot: StarBot, cog: typing.Union[commands.Cog, str]
    ...
    @classmethod
    async def add_hybrid_commands(cls, bot: StarBot, cog: commands.Cog) -> None:
    ...
    @classmethod
    async def get_hook(cls, bot: StarBot, channel: discord.TextChannel) -> discord.Webhook:
        """
    ...
    @classmethod
    def get_all_repo_cogs_objects(cls, bot: StarBot) -> typing.Dict[str, commands.Cog]:
        """
    ...
    @classmethod
    def at_least_one_cog_loaded(cls, bot: StarBot) -> bool:
        """
