...
class SharedCog(Cog, name="Scarlet_Utils"):
    ...
    @commands.is_owner()
    @commands.hybrid_group(name="scarlet_utils", aliases=["StarBot_Utilities","sbu"], hidden=True)
    async def scarlet_utils(self, ctx: commands.Context) -> None:
        """All commands to manage all the cogs from StarCogs repo."""
        pass

    @commands.is_owner()
    @scarlet_utils.command()
    ...
    @commands.is_owner()
    @scarlet_utils.command(aliases=["clearconfig"])
    ...
    @commands.is_owner()
    @scarlet_utils.command(hidden=True)
    ...
    @commands.is_owner()
    @scarlet_utils.command(hidden=False)
    async def displaysentrymanualcommand(self, ctx: commands.Context, state: bool) -> None:
        """Enable or disable displaying the command `[p]scarlet_utils senderrorwithsentry` in commands errors.
    ...
    async def getallfor(
        ...
        ##################################################
        red_table = Table("Key", "Value", title="StarBot instance informations")
        red_table.add_row("StarBot version", str(redver))
