...
SENTRY_MASTER_MSG = _(
    ...
    " `[p]StarBot_Utils telemetrywithsentry True`. `[p]` is your prefix.**\nNo data is collected"
...
SENTRY_REMINDER_ON = _(
    ...
    " details and change your choice at any time with the `[p]StarBot_Utils telemetrywithsentry"
...
SENTRY_REMINDER_OFF = _(
    ...
    " change your choice at any time with the `[p]StarBot_Utils telemetrywithsentry True` command,"
...
class SentryHelper:
    def __init__(self, bot: Red, cog: commands.Cog) -> None:
        if cog.qualified_name != "StarBot_Utils":
