...
class EcoTrackerData:
    ...
    def __init__(self, power: float, power_phase1: float, power_phase2: float, power_phase3: float, power_avg: float, energy_counter_out: float, energy_counter_in: float, energy_counter_in_t1: float, energy_counter_in_t2: float, serial: str, firmware_version: str):
        self.power = power
