...
from enkeep_trade.event import EventEngine, Event
from enkeep_trade.trader.constant import (
    Direction,
    Offset,
    Exchange,
    OrderType,
...
from enkeep_trade.trader.gateway import BaseGateway
from enkeep_trade.trader.object import (
    TickData,
    OrderData,
    TradeData,
    PositionData,
...
from enkeep_trade.trader.utility import get_folder_path, ZoneInfo
from enkeep_trade.trader.event import EVENT_TIMER
...
class CtpMdApi(MdApi):
    ...
    def onRspUserLogin(self, data: dict, error: dict, reqid: int, last: bool) -> None:
        ...
        if not error["ErrorID"]:
            ...
            print("md onRspUserLogin err", error)
...
class CtpTdApi(TdApi):
    ...
    def onRspAuthenticate(
        ...
        if not error["ErrorID"]:
            ...
            print("td onRspAuthenticate Error",error)
    ...
    def onRspUserLogin(self, data: dict, error: dict, reqid: int, last: bool) -> None:
        ...
        if not error["ErrorID"]:
            ...
            print("td onRspUserLogin err", error)
    ...
    def onRspQryInstrument(
        ...
        """合约查询回报"""
        """
        {'gateway_name': 'ctp_1299_8600600', 'symbol': 'nr2604', 'exchange': <Exchange.INE: 'INE'>, 'name': 'nr2604', 
        'product': <Product.FUTURES: '期货'>, 'size': 10, 'pricetick': 5.0, 'productID': None, 'max_volume': 500, 'min_volume': 1, 
        'stop_supported': False, 'net_position': False, 'history_data': False, 'option_strike': 0, 'option_underlying': '', 
        'option_type': None, 'option_listed': None, 'option_expiry': None, 'option_portfolio': '', 'option_index': '', 'vt_symbol': 'nr2604.INE'}
        ------------------------------------------------------------
        {'reserve1': '', 'ExchangeID': 'INE', 'InstrumentName': 'nr2604', 'reserve2': '', 'reserve3': '', 'ProductClass': '1', 
        'DeliveryYear': 2026, 'DeliveryMonth': 4, 'MaxMarketOrderVolume': 30, 'MinMarketOrderVolume': 1, 'MaxLimitOrderVolume': 500, 
        'MinLimitOrderVolume': 1, 'VolumeMultiple': 10, 'PriceTick': 5.0, 'CreateDate': '20250314', 'OpenDate': '20250416', 
        'ExpireDate': '20260415', 'StartDelivDate': '20260416', 'EndDelivDate': '20260422', 'InstLifePhase': '1', 'IsTrading': 1, 
        'PositionType': '2', 'PositionDateType': '1', 'LongMarginRatio': 0.1, 'ShortMarginRatio': 0.1, 'MaxMarginSideAlgorithm': '1',
        'reserve4': '', 'StrikePrice': 0.0, 'OptionsType': '\x00', 'UnderlyingMultiple': 1.0, 'CombinationType': '0', 
        'InstrumentID': 'nr2604', 'ExchangeInstID': 'nr2604', 'ProductID': 'nr', 'UnderlyingInstrID': 'nr'}
        """
        ...
        if last:
            ...
            self.gateway.on_contract_finish()
