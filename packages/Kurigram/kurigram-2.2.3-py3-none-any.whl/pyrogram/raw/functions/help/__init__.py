...
__all__ = ["GetConfig", "GetNearestDc", "GetAppUpdate", "GetInviteText", "GetSupport", "SetBotUpdatesStatus", "GetCdnConfig", "GetRecentMeUrls", "GetTermsOfServiceUpdate", "AcceptTermsOfService", "GetDeepLinkInfo", "GetAppConfig", "SaveAppLog", "GetPassportConfig", "GetSupportName", "GetUserInfo", "EditUserInfo", "GetPromoData", "HidePromoData", "DismissSuggestion", "GetCountriesList", "GetPremiumPromo", "GetPeerColors", "GetPeerProfileColors", "GetTimezonesList"]
