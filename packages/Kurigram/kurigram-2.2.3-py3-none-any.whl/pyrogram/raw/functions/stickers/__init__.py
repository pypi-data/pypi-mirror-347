...
__all__ = ["CreateStickerSet", "RemoveStickerFromSet", "ChangeStickerPosition", "AddStickerToSet", "SetStickerSetThumb", "CheckShortName", "SuggestShortName", "ChangeSticker", "RenameStickerSet", "DeleteStickerSet", "ReplaceSticker"]
