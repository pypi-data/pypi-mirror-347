...
__all__ = ["Dialogs", "Messages", "Chats", "ChatFull", "AffectedHistory", "DhConfig", "SentEncryptedMessage", "Stickers", "AllStickers", "AffectedMessages", "StickerSet", "SavedGifs", "BotResults", "BotCallbackAnswer", "MessageEditData", "PeerDialogs", "FeaturedStickers", "RecentStickers", "ArchivedStickers", "StickerSetInstallResult", "HighScores", "FavedStickers", "FoundStickerSets", "SearchCounter", "InactiveChats", "VotesList", "MessageViews", "DiscussionMessage", "HistoryImport", "HistoryImportParsed", "AffectedFoundMessages", "ExportedChatInvites", "ExportedChatInvite", "ChatInviteImporters", "ChatAdminsWithInvites", "CheckedHistoryImportPeer", "SponsoredMessages", "SearchResultsCalendar", "SearchResultsPositions", "PeerSettings", "MessageReactionsList", "AvailableReactions", "TranscribedAudio", "Reactions", "ForumTopics", "EmojiGroups", "TranslatedText", "BotApp", "WebPage", "SavedDialogs", "SavedReactionTags", "QuickReplies", "DialogFilters", "MyStickers", "InvitedUsers", "AvailableEffects", "BotPreparedInlineMessage", "PreparedInlineMessage", "FoundStickers", "WebPagePreview"]
