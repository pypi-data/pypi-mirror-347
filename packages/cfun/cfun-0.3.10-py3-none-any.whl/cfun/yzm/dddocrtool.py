...
class ImageDet:
    ...
    def extendCJYRecognition(self, ocrdata: list, image_path: str) -> list:
        ...
        Args:
            ocrdata (list): 超级鹰识别的结果， 需要是一个列表， 里面是字典， 字典的格式是 {"name": "之", "coordinates": [207, 115]}
            image_path (str): 图片路径

        Returns:
            list: 扩展后的结果， 里面是字典， 字典的格式是 {"name": "之", "coordinates": [207, 115], "points": [[x1, y1], [x2, y1], [x2, y2], [x1, y2]], "image_width": 100, "image_height": 100}
