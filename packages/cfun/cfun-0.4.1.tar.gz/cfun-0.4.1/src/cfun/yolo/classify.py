...
class YOLOClassifier:
    ...
    def _classify_single(
        ...
        Example:
            ...
            classifier = YOLOClassifier(model="model.onnx", names={0: "cat", 1: "dog"})
    ...
    def similarity(
        ...
        Example:
            ...
            from cfun.yolo.classify import YOLOClassifier
            # 假设你有一个名为 "model.onnx" 的 ONNX 模型文件
            classifier = YOLOClassifier(model="model.onnx")
...
if __name__ == "__main__":
    ...
    # 加载自己的模型文件
    classifier = YOLOClassifier(model=cdata.DX_CLS_ONNX)
