...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGURE_CFLAGS': ' -fPIC  '
                     '',
 'CONFIGURE_CFLAGS_NODIST': '-flto=thin -g -fno-pie -std=c11 -Wextra '
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "'--enable-optimizations' '--enable-bolt' '--with-lto' "
                ...
                ' -fPIC  '
                "' 'LDFLAGS=  "
                "-Wl,--exclude-libs,ALL -LModules/_hacl' 'CPPFLAGS= "
                ' -fPIC  '
                "'",
 'CONFINCLUDEDIR': '/install/include',
 'CONFINCLUDEPY': '/install/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.12.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.12.6/lcov-report',
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
                    ...
                    '  '
                    '-flto=thin -g -fno-pie -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden '
                    '-fprofile-instr-use=/build/Python-3.12.6/code.profclangd '
 ...
 'LLVM_PROF_MERGER': '/tools/llvm/bin/llvm-profdata merge -output="$(shell '
 ...
 'LOCALMODLIBS': '-lbz2          -lffi -ldl  -lm  -lncursesw  -lpanelw '
                 ...
                 '-l:libatomic.a     -llzma       -lrt      '
                 '-l:libHacl_Hash_SHA2.a    -lsqlite3  -lssl -lcrypto '
                 '-l:libatomic.a         -ltcl8.6 -ltk8.6 -lX11 -lxcb -lXau   '
 ...
 'MODLIBS': '-lbz2          -lffi -ldl  -lm  -lncursesw  -lpanelw -lncursesw   '
            ...
            '-lrt      -l:libHacl_Hash_SHA2.a    -lsqlite3  -lssl -lcrypto '
            '-l:libatomic.a         -ltcl8.6 -ltk8.6 -lX11 -lxcb -lXau   '
            '-luuid         -lm    -lm    -lexpat  -ledit -lncursesw         '
            '-lz',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.12.6 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.12.6/`cat pybuilddir.txt`:)./Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare '
                             ...
                             ' '
                             ' -flto=thin -g '
                             '-fno-pie -std=c11 -Wextra -Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden '
 ...
 'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -O3 -Wall  -fPIC '
              ' ',
 'PY_CFLAGS_NODIST': '-flto=thin -g -fno-pie -std=c11 -Wextra '
                     '-Wno-unused-parameter -Wno-missing-field-initializers '
                     '-Wstrict-prototypes '
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.12.6',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.12.6 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.12.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.6/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
               '/tools/host/bin/python3.12',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.12.6 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.12.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.6/`cat pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/build/Python-3.12.6',
 'abs_srcdir': '/build/Python-3.12.6',
