...
PackageSettingTransformCase: TypeAlias = Union[Literal["never"], Literal["shallow"], Literal["everything"]]
...
PackageNpmClientVersion: TypeAlias = Union[Literal[0], Literal[1]]
...
PackagePipClientVersion: TypeAlias = Union[Literal[0], Literal[1]]
