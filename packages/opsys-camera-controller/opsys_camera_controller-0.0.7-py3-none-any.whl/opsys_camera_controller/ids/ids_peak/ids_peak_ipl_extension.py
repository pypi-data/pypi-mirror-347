...
def BufferToImage(buffer: "std::shared_ptr< peak::core::Buffer > const &") -> "peak::ipl::Image":
    r"""
    Converts a peak::core::Buffer into a peak::ipl::Image.

    This creates a peak::ipl::Image as a shallow copy of the buffer (i.e. using the same memory).
    Remember that the buffer's memory is only under your control until you re-queue the buffer.
    """
