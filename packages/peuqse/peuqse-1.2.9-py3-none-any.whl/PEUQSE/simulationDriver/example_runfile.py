...
def main():
    ...
    # d) The yaml_top_info_string. Right now, this file is made 'manually'.
    ...
    #This time we are going to get the yaml_top_info string so that we don't waste time reading it repeatedly.        
    ...
    #This time we are again going to get the yaml_top_info string so that we don't waste time reading it repeatedly.        
    yaml_top_info_filename = model_name + "_yaml_top_info.yaml"
    with open(yaml_top_info_filename, "r") as yaml_top_info_file:
        yaml_top_info_string = yaml_top_info_file.read()     
