...
class PaidClient:
    ...
    DUMMY_ORG_ID = 'org'  # or any string, it doesn't matter
    ...
    def create_agent(self, agent: CreateAgentRequest) -> Agent:
        ...
        try:
            ...
            if 'data' in data:
                ...
                # Set agentAttributes to empty list if null
                if 'agentAttributes' in data['data'] and data['data']['agentAttributes'] is None:
                    data['data']['agentAttributes'] = []
    ...
    def get_agent_by_external_id(self, external_id: str) -> Agent:
        ...
        Returns:
            Agent: The requested agent.
        """
        url = f"{self.api_url}/api/organizations/{self.DUMMY_ORG_ID}/products/external/{external_id}"
        headers = {
            'Authorization': f'Bearer {self.api_key}',
            'Content-Type': 'application/json'
        }
    ...
    def get_contact_by_external_id(self, external_id: str) -> Contact:
        ...
        """
        url = f"{self.api_url}/api/organizations/{self.DUMMY_ORG_ID}/contacts/external/{external_id}"
        headers = {
            'Authorization': f'Bearer {self.api_key}',
            'Content-Type': 'application/json'
        }
