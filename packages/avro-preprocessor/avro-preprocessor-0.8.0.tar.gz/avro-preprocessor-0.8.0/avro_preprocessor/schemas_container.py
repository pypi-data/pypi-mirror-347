...
class SchemasContainer:
    ...
    def read_schemas(self) -> None:
        ...
        """
        for namespace in [self.paths.base_namespace] + self.paths.extra_namespaces:
            self.paths.traverse_path(
                self.paths.input_path, namespace, self.paths.input_schema_file_extension, self._get_schema)
