...
UseCase 'deleteWebhookEventType' error: Invalid external interactions data -> "algorithm"
...
UseCase 'registerWebhookEventType' error: Each external interaction must be a dictionary.
UseCase 'getWebhookPlatformReceiver' error: Each external interaction must be a dictionary.
UseCase 'registerWebhookPlatformReceiver' error: Each trigger must be a dictionary.
ExternalInteraction 'registerWebhookPlatformReceiver' error: The 'operation' must be a string or a list of strings.
ExternalInteraction 'registerWebhookPlatformReceiver' error: The 'type_interaction' field must be a string if provided.""".split("\n")
