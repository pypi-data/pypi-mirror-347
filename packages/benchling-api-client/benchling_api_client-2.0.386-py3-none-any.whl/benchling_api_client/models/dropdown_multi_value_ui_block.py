...
T = TypeVar("T", bound="DropdownMultiValueUiBlock")
...
class DropdownMultiValueUiBlock:
    ...
    _type: DropdownMultiValueUiBlockType
    _id: str
    ...
    def __repr__(self):
        ...
        return "DropdownMultiValueUiBlock({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> DropdownMultiValueUiBlockType:
            _type = d.pop("type")
            try:
        ...
        try:
            ...
            if strict:
                raise
            type = cast(DropdownMultiValueUiBlockType, UNSET)
        ...
        dropdown_multi_value_ui_block = cls(
            type=type,
            id=id,
        ...
        dropdown_multi_value_ui_block.additional_properties = d
        return dropdown_multi_value_ui_block
