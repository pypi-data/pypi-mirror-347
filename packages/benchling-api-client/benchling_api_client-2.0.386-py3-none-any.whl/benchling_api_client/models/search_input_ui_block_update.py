...
T = TypeVar("T", bound="SearchInputUiBlockUpdate")
...
class SearchInputUiBlockUpdate:
    ...
    def __repr__(self):
        ...
        return "SearchInputUiBlockUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        search_input_ui_block_update = cls(
            id=id,
            type=type,
            item_type=item_type,
            schema_id=schema_id,
        ...
        search_input_ui_block_update.additional_properties = d
        return search_input_ui_block_update
