...
T = TypeVar("T", bound="DropdownUiBlockCreate")
...
class DropdownUiBlockCreate:
    ...
    _id: str
    _type: Union[Unset, DropdownUiBlockType] = UNSET
    ...
    def __repr__(self):
        ...
        return "DropdownUiBlockCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, DropdownUiBlockType]:
            type = UNSET
            _type = d.pop("type")
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, DropdownUiBlockType], UNSET)
        ...
        dropdown_ui_block_create.additional_properties = d
        return dropdown_ui_block_create
