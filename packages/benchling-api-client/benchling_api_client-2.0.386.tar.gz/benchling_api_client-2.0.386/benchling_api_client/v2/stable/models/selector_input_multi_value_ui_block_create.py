...
T = TypeVar("T", bound="SelectorInputMultiValueUiBlockCreate")
...
class SelectorInputMultiValueUiBlockCreate:
    ...
    def __repr__(self):
        ...
        return "SelectorInputMultiValueUiBlockCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        selector_input_multi_value_ui_block_create = cls(
            id=id,
            type=type,
            options=options,
            label=label,
        ...
        selector_input_multi_value_ui_block_create.additional_properties = d
        return selector_input_multi_value_ui_block_create
