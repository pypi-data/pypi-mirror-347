...
T = TypeVar("T", bound="SelectorInputMultiValueUiBlockUpdate")
...
class SelectorInputMultiValueUiBlockUpdate:
    ...
    def __repr__(self):
        ...
        return "SelectorInputMultiValueUiBlockUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, SelectorInputMultiValueUiBlockType]:
            type = UNSET
            _type = d.pop("type")
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, SelectorInputMultiValueUiBlockType], UNSET)
        ...
        selector_input_multi_value_ui_block_update = cls(
            id=id,
            type=type,
            options=options,
            label=label,
        ...
        selector_input_multi_value_ui_block_update.additional_properties = d
        return selector_input_multi_value_ui_block_update
