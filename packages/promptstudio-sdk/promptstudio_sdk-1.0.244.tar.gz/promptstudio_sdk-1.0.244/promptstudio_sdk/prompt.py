            ...
            if self.bypass:
                ...
                if is_session_enabled is False:
                    return await self._no_cache_direct_ai_request(
                        ...
                        memory_type, tag , base_url , format , credentials
                    )
...
def gemini_interaction_chat_with_prompt(
    ...
    try:
        # 5. Call generate_content (non‑streaming)
...
def modify_messages_vertex_format(
    ...
    Returns:
      - vertex_contents: list of Content(role, parts)
    ...
    for m in messages:
        ...
        # 3. Create a single text part (staticmethod call)
    ...
    return vertex_contents, system_prompt
