...
from mastapy._private.system_model.part_model import _2537, _2538
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2270, _2273
...
class DutyCycleImporter(_0.APIBase):
    ...
    @property
    def duty_cycles_to_import(self: "Self") -> "List[_2273.IncludeDutyCycleOption]":
    ...
    def point_load_destinations(
        self: "Self",
    ) -> "List[_2270.DutyCycleImporterDesignEntityMatch[_2537.PointLoad]]":
    ...
    def power_load_destinations(
        self: "Self",
    ) -> "List[_2270.DutyCycleImporterDesignEntityMatch[_2538.PowerLoad]]":
