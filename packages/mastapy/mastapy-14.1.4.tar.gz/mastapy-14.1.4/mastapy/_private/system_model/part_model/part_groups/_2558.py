...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2553, _2556, _2559
...
class ParallelPartGroupSelection(_2557.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    @property
    def design_measurements(self: "Self") -> "List[_2556.DesignMeasurements]":
