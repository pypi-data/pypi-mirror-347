...
from mastapy._private.system_model.part_model import _2499, _2519
...
class Shaft(_2499.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2519.GuideDxfModel") -> None:
        wrapper_type = (
    ...
    @property
    def guide_image(self: "Self") -> "_2520.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: "Self") -> "_2447.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2530.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
