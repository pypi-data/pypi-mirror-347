...
class StraightBevelGearSet(_2589.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self: "Self") -> "List[_2616.StraightBevelGear]":
    ...
    @property
    def straight_bevel_meshes(self: "Self") -> "List[_2390.StraightBevelGearMesh]":
