...
from mastapy._private.bearings.bearing_results import _2004, _2023
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1930, _1934, _1947
...
class Bearing(_2511.Connector):
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(
        self: "Self", value: "_1964.BearingToleranceClass"
    ) -> None:
    ...
    def bearing_tolerance_definition(
        self: "Self",
    ) -> "_1965.BearingToleranceDefinitionOptions":
    ...
    @property
    def damping_options(self: "Self") -> "_1934.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1934", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(
        self: "Self", value: "_1934.BearingDampingMatrixOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2504", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: "Self", value: "_2504.BearingF0InputMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: "Self") -> "_1845.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: "Self") -> "_1947.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1947", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: "Self", value: "_1947.JournalBearingType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: "Self", value: "_1938.BearingModel") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: "Self") -> "_1845.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: "Self", value: "_2023.PreloadType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def axial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2502.AxialInternalClearanceTolerance":
    ...
    @property
    def detail(self: "Self") -> "_2192.BearingDesign":
    ...
    def radial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2539.RadialInternalClearanceTolerance":
    ...
    @property
    def ring_tolerance_inner(self: "Self") -> "_1967.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: "Self") -> "_1978.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: "Self") -> "_1973.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: "Self") -> "_1978.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: "Self") -> "_2192.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: "Self") -> "_1968.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: "Self") -> "_1983.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: "Self") -> "_1974.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: "Self") -> "_1983.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: "Self") -> "List[_2505.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: "Self") -> "List[_1985.ToleranceCombination]":
    ...
    def try_attach_right_side_to(
        self: "Self", shaft: "_2549.Shaft", offset: "float" = float("nan")
    ...
    def set_detail_from_catalogue(
        self: "Self", catalogue: "_1930.BearingCatalog", designation: "str"
    ) -> None:
