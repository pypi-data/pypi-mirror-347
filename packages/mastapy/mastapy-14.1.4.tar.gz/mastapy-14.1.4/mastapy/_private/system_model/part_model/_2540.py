...
class _Cast_RollingBearingElementLoadCase:
    ...
    @property
    def rolling_bearing_element(self: "CastSelf") -> "_2228.RollingBearingElement":
        return self.__parent__._cast(_2228.RollingBearingElement)
...
class RollingBearingElementLoadCase(_2228.RollingBearingElement):
    """RollingBearingElementLoadCase
