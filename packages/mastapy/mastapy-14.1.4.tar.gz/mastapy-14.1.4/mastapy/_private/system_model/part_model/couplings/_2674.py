...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.stiffness_calculators import _1594
...
class _Cast_SplineLeadRelief:
    ...
    @property
    def rigid_connector_settings(self: "CastSelf") -> "_2663.RigidConnectorSettings":
        return self.__parent__._cast(_2663.RigidConnectorSettings)
...
class SplineLeadRelief(_2663.RigidConnectorSettings):
    """SplineLeadRelief
    ...
    @property
    def contact_position(self: "Self") -> "_1594.IndividualContactPosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.stiffness_calculators._1594",
    ...
    @property
    def microgeometry_clearance_chart(self: "Self") -> "_1928.TwoDChartDefinition":
    ...
    @property
    def crowning(self: "Self") -> "_2656.CrowningSpecification":
