...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2554, _2558, _2559
...
class _Cast_ParallelPartGroup:
    ...
    def concentric_or_parallel_part_group(
        self: "CastSelf",
    ) -> "_2553.ConcentricOrParallelPartGroup":
        return self.__parent__._cast(_2553.ConcentricOrParallelPartGroup)
...
class ParallelPartGroup(_2553.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self: "Self") -> "List[_2554.ConcentricPartGroup]":
