...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2594, _2611
...
class CylindricalGearSet(_2601.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self: "Self") -> "_2632.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_meshes(self: "Self") -> "List[_2372.CylindricalGearMesh]":
    ...
    def add_gear(self: "Self") -> "_2594.CylindricalGear":
