...
from mastapy._private.bearings.bearing_results import _2025, _2026
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2522, _2533
...
class _Cast_BearingRaceMountingOptions:
    ...
    def inner_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2522.InnerBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2522

        return self.__parent__._cast(_2522.InnerBearingRaceMountingOptions)

    @property
    def outer_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2533.OuterBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2533

        return self.__parent__._cast(_2533.OuterBearingRaceMountingOptions)
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def axial_mounting(self: "Self", value: "_2025.RaceAxialMountingType") -> None:
    ...
    @enforce_parameter_types
    def simple_radial_mounting(
        self: "Self", value: "_2026.RaceRadialMountingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
