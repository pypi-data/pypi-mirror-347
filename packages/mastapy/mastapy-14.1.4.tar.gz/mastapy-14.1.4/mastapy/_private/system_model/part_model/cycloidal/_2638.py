...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2500, _2508, _2525, _2534
...
class CycloidalDisc(_2499.AbstractShaft):
    """CycloidalDisc
    ...
    def planetary_bearing_sockets(
        self: "Self",
    ) -> "List[_2402.CycloidalDiscPlanetaryBearingSocket]":
