...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2508, _2525, _2534
...
class PlanetCarrier(_2530.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def load_sharing_settings(self: "Self") -> "_2525.LoadSharingSettings":
    ...
    @property
    def planetary_sockets(self: "Self") -> "List[_2351.PlanetarySocket]":
