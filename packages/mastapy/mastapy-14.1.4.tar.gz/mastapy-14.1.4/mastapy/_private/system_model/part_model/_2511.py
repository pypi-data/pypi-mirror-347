...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets import _2335, _2339
...
class Connector(_2530.MountableComponent):
    """Connector
    ...
    @property
    def outer_component(self: "Self") -> "_2499.AbstractShaft":
    ...
    @property
    def outer_connection(self: "Self") -> "_2335.Connection":
    ...
    @property
    def outer_socket(self: "Self") -> "_2339.CylindricalSocket":
