...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2697, _2699, _2702
...
class AcousticAnalysisSetup(_0.APIBase):
    ...
    @property
    def analysis_options(self: "Self") -> "_2697.AcousticAnalysisOptions":
    ...
    @property
    def cache_reporting(self: "Self") -> "_2699.AcousticAnalysisSetupCacheReporting":
    ...
    @property
    def input_surface_options(self: "Self") -> "_2702.AcousticInputSurfaceOptions":
