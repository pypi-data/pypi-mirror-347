...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2523.InternalClearanceTolerance":
        return self.__parent__._cast(_2523.InternalClearanceTolerance)
...
class RadialInternalClearanceTolerance(_2523.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
