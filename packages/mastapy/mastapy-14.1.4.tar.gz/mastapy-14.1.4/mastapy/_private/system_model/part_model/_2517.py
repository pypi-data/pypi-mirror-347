...
class FEPart(_2500.AbstractShaftOrHousing):
    """FEPart
    ...
    @enforce_parameter_types
    def default_fe_substructure(self: "Self", value: "_2447.FESubstructure") -> None:
        wrapper_type = (
    ...
    def create_fe_substructure(self: "Self") -> "_2447.FESubstructure":
    ...
    def remove_fe_substructure(
        self: "Self", fe_substructure: "_2447.FESubstructure"
    ) -> "bool":
        """bool
