...
class FaceGearSetCompoundPowerFlow(_4321.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4180.FaceGearSetPowerFlow]":
    ...
    def face_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4314.FaceGearCompoundPowerFlow]":
    ...
    def face_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4315.FaceGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4180.FaceGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearSetPowerFlow]
