...
class ConceptGearCompoundParametricStudyTool(_4600.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7527.ConceptGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4422.ConceptGearParametricStudyTool]":
