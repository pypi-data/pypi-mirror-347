...
class DutyCycle(_5780.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: "Self",
    ) -> "List[_5787.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: "Self") -> "_7690.TimeSeriesImporter":
    ...
    def add_static_load(self: "Self", static_load: "_7491.StaticLoadCase") -> None:
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: "Self", sub_group: "_5787.SubGroupInSingleDesignState"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: "Self", static_load: "_7491.StaticLoadCase") -> None:
        """Method does not return.
