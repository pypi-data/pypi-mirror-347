...
class HarmonicAnalysis(_7696.CompoundAnalysisCase):
    """HarmonicAnalysis
    ...
    @property
    def acoustic_analysis(self: "Self") -> "_7482.HarmonicAcousticAnalysis":
