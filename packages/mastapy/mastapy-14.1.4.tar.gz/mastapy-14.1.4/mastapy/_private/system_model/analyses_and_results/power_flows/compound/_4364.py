...
class SpiralBevelGearSetCompoundPowerFlow(_4279.BevelGearSetCompoundPowerFlow):
    """SpiralBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4232.SpiralBevelGearSetPowerFlow]":
    ...
    def spiral_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4362.SpiralBevelGearCompoundPowerFlow]":
    ...
    def spiral_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4363.SpiralBevelGearMeshCompoundPowerFlow]":
