...
class GearCompoundPowerFlow(_4340.MountableComponentCompoundPowerFlow):
    """GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4186.GearPowerFlow]":
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4186.GearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.GearPowerFlow]
