...
class MassDiscCompoundPowerFlow(_4385.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4202.MassDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4202.MassDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MassDiscPowerFlow]
