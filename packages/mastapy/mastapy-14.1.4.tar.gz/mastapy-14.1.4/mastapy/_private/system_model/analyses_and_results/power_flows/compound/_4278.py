...
class BevelGearMeshCompoundPowerFlow(_4266.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """BevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4140.BevelGearMeshPowerFlow]":
