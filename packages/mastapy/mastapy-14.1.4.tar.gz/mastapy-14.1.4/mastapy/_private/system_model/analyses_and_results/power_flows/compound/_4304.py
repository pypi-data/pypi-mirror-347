...
class CycloidalAssemblyCompoundPowerFlow(_4361.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2637.CycloidalAssembly":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4167.CycloidalAssemblyPowerFlow]":
