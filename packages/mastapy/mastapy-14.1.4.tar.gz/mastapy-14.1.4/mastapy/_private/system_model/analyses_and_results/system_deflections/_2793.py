...
class ConceptGearSetSystemDeflection(_2832.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4155.ConceptGearSetPowerFlow":
    ...
    def gears_system_deflection(
        self: "Self",
    ) -> "List[_2794.ConceptGearSystemDeflection]":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2792.ConceptGearMeshSystemDeflection]":
