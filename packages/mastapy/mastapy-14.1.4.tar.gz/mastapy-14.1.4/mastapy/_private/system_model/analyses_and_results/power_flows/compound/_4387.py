...
class WormGearMeshCompoundPowerFlow(_4320.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4255.WormGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4255.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
