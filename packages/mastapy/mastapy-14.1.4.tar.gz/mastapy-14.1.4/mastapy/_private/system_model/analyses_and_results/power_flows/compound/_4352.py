...
class RingPinsCompoundPowerFlow(_4340.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4220.RingPinsPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4220.RingPinsPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RingPinsPowerFlow]
