...
class OilSealCompoundDynamicAnalysis(_6575.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6488.OilSealDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6488.OilSealDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.OilSealDynamicAnalysis]
