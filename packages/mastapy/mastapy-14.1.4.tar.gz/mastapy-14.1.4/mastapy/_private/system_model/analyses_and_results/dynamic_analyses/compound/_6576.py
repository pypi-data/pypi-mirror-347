...
class CouplingCompoundDynamicAnalysis(_6639.SpecialisedAssemblyCompoundDynamicAnalysis):
    """CouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6444.CouplingDynamicAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6444.CouplingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CouplingDynamicAnalysis]
