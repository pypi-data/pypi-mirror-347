...
class ZerolBevelGearSetLoadCase(_7515.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7674.ZerolBevelGearLoadCase]":
    ...
    def zerol_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7674.ZerolBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7675.ZerolBevelGearMeshLoadCase]":
