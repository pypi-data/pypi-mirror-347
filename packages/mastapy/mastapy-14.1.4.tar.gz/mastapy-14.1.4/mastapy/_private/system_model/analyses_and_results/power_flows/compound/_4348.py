...
class PlanetCarrierCompoundPowerFlow(_4340.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4214.PlanetCarrierPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4214.PlanetCarrierPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]
