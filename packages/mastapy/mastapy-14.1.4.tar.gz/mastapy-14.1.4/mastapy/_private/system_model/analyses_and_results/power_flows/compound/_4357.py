...
class RootAssemblyCompoundPowerFlow(_4268.AssemblyCompoundPowerFlow):
    """RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self: "Self") -> "_5780.AbstractStaticLoadCaseGroup":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4225.RootAssemblyPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4225.RootAssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RootAssemblyPowerFlow]
