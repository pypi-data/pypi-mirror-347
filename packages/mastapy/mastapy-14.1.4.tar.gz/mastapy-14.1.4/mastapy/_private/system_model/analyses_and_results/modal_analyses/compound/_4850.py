...
class BoltCompoundModalAnalysis(_4856.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4693.BoltModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4693.BoltModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltModalAnalysis]
