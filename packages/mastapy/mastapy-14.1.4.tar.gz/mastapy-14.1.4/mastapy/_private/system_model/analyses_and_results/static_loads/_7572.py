...
class FaceGearSetLoadCase(_7581.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7570.FaceGearLoadCase]":
    ...
    @property
    def face_gears_load_case(self: "Self") -> "List[_7570.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7571.FaceGearMeshLoadCase]":
    ...
    @property
    def face_meshes_load_case(self: "Self") -> "List[_7571.FaceGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearMeshLoadCase]
