...
class GearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self: "Self") -> "List[_1566.Eigenmodes]":
    ...
    def gears_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7004.GearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def meshes_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7005.GearMeshAdvancedTimeSteppingAnalysisForModulation]":
