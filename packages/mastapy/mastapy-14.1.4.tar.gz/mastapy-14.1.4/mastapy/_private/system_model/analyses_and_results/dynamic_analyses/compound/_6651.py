...
class StraightBevelGearSetCompoundDynamicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6520.StraightBevelGearSetDynamicAnalysis]":
    ...
    def straight_bevel_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6649.StraightBevelGearCompoundDynamicAnalysis]":
    ...
    def straight_bevel_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6650.StraightBevelGearMeshCompoundDynamicAnalysis]":
