...
class ConceptGearSetModalAnalysisAtAStiffness(_5023.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    def gears_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_4992.ConceptGearModalAnalysisAtAStiffness]":
    ...
    def meshes_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_4991.ConceptGearMeshModalAnalysisAtAStiffness]":
