...
class FEPartCompoundPowerFlow(_4263.AbstractShaftOrHousingCompoundPowerFlow):
    """FEPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4183.FEPartPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4183.FEPartPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FEPartPowerFlow]
