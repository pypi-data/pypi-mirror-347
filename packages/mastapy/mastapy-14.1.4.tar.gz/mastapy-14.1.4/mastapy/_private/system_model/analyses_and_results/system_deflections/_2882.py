...
class SpiralBevelGearSetSystemDeflection(_2779.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4232.SpiralBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2883.SpiralBevelGearSystemDeflection]":
