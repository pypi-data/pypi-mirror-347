...
class ConicalGearSetModalAnalysis(_4738.GearSetModalAnalysis):
    """ConicalGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4706.ConicalGearModalAnalysis]":
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4705.ConicalGearMeshModalAnalysis]":
