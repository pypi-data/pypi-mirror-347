...
class ConceptGearSetStabilityAnalysis(_3912.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_3882.ConceptGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3880.ConceptGearMeshStabilityAnalysis]":
