...
class SpiralBevelGearSetModalAnalysisAtASpeed(_5244.BevelGearSetModalAnalysisAtASpeed):
    """SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    def bevel_gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5329.SpiralBevelGearModalAnalysisAtASpeed]":
    ...
    def bevel_meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5328.SpiralBevelGearMeshModalAnalysisAtASpeed]":
