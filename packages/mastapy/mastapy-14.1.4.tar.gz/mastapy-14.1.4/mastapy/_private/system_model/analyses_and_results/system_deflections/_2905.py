...
class TorqueConverterTurbineSystemDeflection(_2802.CouplingHalfSystemDeflection):
    """TorqueConverterTurbineSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7664.TorqueConverterTurbineLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4252.TorqueConverterTurbinePowerFlow":
