...
class WormGearSetDynamicAnalysis(_6468.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6533.WormGearDynamicAnalysis]":
    ...
    def worm_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6533.WormGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.WormGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6534.WormGearMeshDynamicAnalysis]":
