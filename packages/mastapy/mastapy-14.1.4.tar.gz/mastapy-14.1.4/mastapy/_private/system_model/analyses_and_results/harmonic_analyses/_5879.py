...
class GearSetHarmonicAnalysis(_5933.SpecialisedAssemblyHarmonicAnalysis):
    """GearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5874.GearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5876.GearMeshHarmonicAnalysis]":
