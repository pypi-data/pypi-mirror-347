...
class StraightBevelGearSetDynamicAnalysis(_6424.BevelGearSetDynamicAnalysis):
    """StraightBevelGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6518.StraightBevelGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6519.StraightBevelGearMeshDynamicAnalysis]":
