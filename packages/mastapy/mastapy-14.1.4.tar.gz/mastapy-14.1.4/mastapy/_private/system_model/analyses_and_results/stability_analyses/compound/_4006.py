...
class BoltCompoundStabilityAnalysis(_4012.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3871.BoltStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3871.BoltStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BoltStabilityAnalysis]
