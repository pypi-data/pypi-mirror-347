...
class WormGearSetCompoundDynamicAnalysis(_6599.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6535.WormGearSetDynamicAnalysis]":
    ...
    def worm_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6664.WormGearCompoundDynamicAnalysis]":
    ...
    def worm_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6665.WormGearMeshCompoundDynamicAnalysis]":
