...
class _Cast_ResultsForMultipleOrders:
    ...
    def results_for_multiple_orders_for_fe_surface(
        self: "CastSelf",
    ) -> "_5990.ResultsForMultipleOrdersForFESurface":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5990,
        )

        return self.__parent__._cast(_5990.ResultsForMultipleOrdersForFESurface)

    @property
    def results_for_multiple_orders_for_groups(
        self: "CastSelf",
    ) -> "_5991.ResultsForMultipleOrdersForGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5991,
        )

        return self.__parent__._cast(_5991.ResultsForMultipleOrdersForGroups)
