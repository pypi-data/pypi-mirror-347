...
class DatumCompoundParametricStudyTool(_4567.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7555.DatumLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4443.DatumParametricStudyTool]":
