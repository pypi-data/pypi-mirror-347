...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: "Self") -> "_6672.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: "Self") -> "_6675.MASTAFileDetails":
    ...
    @property
    def working_folder(self: "Self") -> "_1656.SelectableFolder":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6674.ExcelSheetDesignStateSelector]":
