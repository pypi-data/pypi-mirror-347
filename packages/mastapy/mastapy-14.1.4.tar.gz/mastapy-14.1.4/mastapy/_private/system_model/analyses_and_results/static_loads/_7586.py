...
from mastapy._private.system_model.analyses_and_results.static_loads import _7565, _7584
...
class HarmonicLoadDataFluxImport(
    _7584.HarmonicLoadDataCSVImport[_7565.ElectricMachineHarmonicLoadFluxImportOptions]
):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self: "Self") -> "_7596.InnerDiameterReference":
    ...
    def inner_diameter_reference(
        self: "Self", value: "_7596.InnerDiameterReference"
    ) -> None:
