...
class BoltCompoundPowerFlow(_4286.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4144.BoltPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4144.BoltPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltPowerFlow]
