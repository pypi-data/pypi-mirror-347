...
class _Cast_DynamicTorqueResultAtTime:
    ...
    def abstract_measured_dynamic_response_at_time(
        self: "CastSelf",
    ) -> "_5640.AbstractMeasuredDynamicResponseAtTime":
        return self.__parent__._cast(_5640.AbstractMeasuredDynamicResponseAtTime)
...
class DynamicTorqueResultAtTime(_5640.AbstractMeasuredDynamicResponseAtTime):
    """DynamicTorqueResultAtTime
