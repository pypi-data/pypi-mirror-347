...
class TimeSeriesLoadCase(_7490.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self: "Self") -> "_5575.MBDAnalysisOptions":
    ...
    @property
    def multibody_dynamics_analysis(self: "Self") -> "_5581.MultibodyDynamicsAnalysis":
    ...
    @property
    def time_series_load_case_group(self: "Self") -> "_5791.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5791.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
