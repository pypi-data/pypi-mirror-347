...
class PointLoadCompoundPowerFlow(_4385.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4215.PointLoadPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PointLoadPowerFlow]
