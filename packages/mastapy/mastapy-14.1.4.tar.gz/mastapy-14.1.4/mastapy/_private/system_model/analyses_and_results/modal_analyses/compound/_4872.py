...
class CVTCompoundModalAnalysis(_4841.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4715.CVTModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4715.CVTModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CVTModalAnalysis]
