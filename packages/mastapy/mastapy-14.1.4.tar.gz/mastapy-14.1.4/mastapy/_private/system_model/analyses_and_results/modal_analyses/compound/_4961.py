...
class ZerolBevelGearSetCompoundModalAnalysis(_4849.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4818.ZerolBevelGearSetModalAnalysis]":
    ...
    def zerol_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4959.ZerolBevelGearCompoundModalAnalysis]":
    ...
    def zerol_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4960.ZerolBevelGearMeshCompoundModalAnalysis]":
