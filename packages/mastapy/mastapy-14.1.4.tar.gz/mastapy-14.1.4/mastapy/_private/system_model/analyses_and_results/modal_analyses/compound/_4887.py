...
class FEPartCompoundModalAnalysis(_4833.AbstractShaftOrHousingCompoundModalAnalysis):
    """FEPartCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4733.FEPartModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4733.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
