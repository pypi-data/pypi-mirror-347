...
class ZerolBevelGearSetHarmonicAnalysis(_5817.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5964.ZerolBevelGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5965.ZerolBevelGearMeshHarmonicAnalysis]":
