...
class PerModeResultsReport(_1815.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self: "Self") -> "_1881.TableAndChartOptions":
    ...
    def display_option(self: "Self", value: "_1881.TableAndChartOptions") -> None:
