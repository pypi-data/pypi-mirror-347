...
class ZerolBevelGearSetCompoundPowerFlow(_4279.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4260.ZerolBevelGearSetPowerFlow]":
    ...
    def zerol_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4389.ZerolBevelGearCompoundPowerFlow]":
    ...
    def zerol_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4390.ZerolBevelGearMeshCompoundPowerFlow]":
