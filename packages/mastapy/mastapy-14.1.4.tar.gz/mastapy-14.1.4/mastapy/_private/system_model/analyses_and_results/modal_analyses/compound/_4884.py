...
class FaceGearCompoundModalAnalysis(_4889.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4731.FaceGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4731.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
