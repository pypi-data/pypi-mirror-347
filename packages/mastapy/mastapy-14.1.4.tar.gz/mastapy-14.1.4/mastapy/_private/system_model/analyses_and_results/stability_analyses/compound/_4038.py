...
class DatumCompoundStabilityAnalysis(_4012.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3903.DatumStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3903.DatumStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.DatumStabilityAnalysis]
