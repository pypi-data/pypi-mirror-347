...
class ConceptGearCompoundPowerFlow(_4319.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4154.ConceptGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4154.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
