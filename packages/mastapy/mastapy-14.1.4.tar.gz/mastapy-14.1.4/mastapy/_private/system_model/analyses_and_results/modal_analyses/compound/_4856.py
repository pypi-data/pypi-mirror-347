...
class ComponentCompoundModalAnalysis(_4912.PartCompoundModalAnalysis):
    """ComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4698.ComponentModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4698.ComponentModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ComponentModalAnalysis]
