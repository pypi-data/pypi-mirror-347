...
class SynchroniserSystemDeflection(_2880.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4246.SynchroniserPowerFlow":
    ...
    @property
    def cones(self: "Self") -> "List[_2895.SynchroniserHalfSystemDeflection]":
