...
class FaceGearCompoundPowerFlow(_4319.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4179.FaceGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4179.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
