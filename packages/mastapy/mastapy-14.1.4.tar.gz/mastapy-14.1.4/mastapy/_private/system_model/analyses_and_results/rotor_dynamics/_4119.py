...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1663.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1663.MeasurementBase")
...
class _Cast_ShaftComplexShape:
    ...
    @property
    def shaft_forced_complex_shape(self: "CastSelf") -> "_4120.ShaftForcedComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4120,
        )

        return self.__parent__._cast(_4120.ShaftForcedComplexShape)

    @property
    def shaft_modal_complex_shape(self: "CastSelf") -> "_4121.ShaftModalComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4121,
        )

        return self.__parent__._cast(_4121.ShaftModalComplexShape)
