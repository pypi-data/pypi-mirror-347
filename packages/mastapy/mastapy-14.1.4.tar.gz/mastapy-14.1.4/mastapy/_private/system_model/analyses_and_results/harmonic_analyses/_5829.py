...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5874
...
class ConceptGearHarmonicAnalysis(_5874.GearHarmonicAnalysis):
    """ConceptGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2794.ConceptGearSystemDeflection":
