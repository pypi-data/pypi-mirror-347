...
class _Cast_FEPartHarmonicAnalysisResultsPropertyAccessor:
    ...
    def harmonic_analysis_results_property_accessor(
        self: "CastSelf",
    ) -> "_5988.HarmonicAnalysisResultsPropertyAccessor":
        return self.__parent__._cast(_5988.HarmonicAnalysisResultsPropertyAccessor)
...
class FEPartHarmonicAnalysisResultsPropertyAccessor(
    ...
    @property
    def combined_orders(self: "Self") -> "_5990.ResultsForMultipleOrdersForFESurface":
    ...
    def excitations(
        self: "Self",
    ) -> "List[_5981.FEPartSingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: "Self",
    ) -> "List[_5995.ResultsForOrderIncludingSurfaces]":
