...
class WormGearCompoundParametricStudyTool(_4600.GearCompoundParametricStudyTool):
    """WormGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7671.WormGearLoadCase":
