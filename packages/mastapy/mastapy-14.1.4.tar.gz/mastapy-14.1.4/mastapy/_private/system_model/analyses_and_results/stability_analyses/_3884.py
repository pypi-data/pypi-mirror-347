...
class ConicalGearSetStabilityAnalysis(_3912.GearSetStabilityAnalysis):
    """ConicalGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_3885.ConicalGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3883.ConicalGearMeshStabilityAnalysis]":
