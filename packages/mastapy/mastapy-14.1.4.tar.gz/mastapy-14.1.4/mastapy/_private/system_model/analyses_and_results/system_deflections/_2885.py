...
class SpringDamperHalfSystemDeflection(_2802.CouplingHalfSystemDeflection):
    """SpringDamperHalfSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7645.SpringDamperHalfLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4234.SpringDamperHalfPowerFlow":
