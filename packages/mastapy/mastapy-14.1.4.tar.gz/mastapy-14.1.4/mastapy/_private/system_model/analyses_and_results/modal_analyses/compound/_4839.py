...
class BearingCompoundModalAnalysis(_4867.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4681.BearingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4681.BearingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BearingModalAnalysis]
