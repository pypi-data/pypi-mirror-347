...
class CVTPulleyCompoundModalAnalysis(_4921.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4716.CVTPulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4716.CVTPulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CVTPulleyModalAnalysis]
