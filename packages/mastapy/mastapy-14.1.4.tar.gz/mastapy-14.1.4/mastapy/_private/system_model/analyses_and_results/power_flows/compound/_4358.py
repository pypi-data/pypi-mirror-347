...
class ShaftCompoundPowerFlow(_4262.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4227.ShaftPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4227.ShaftPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ShaftPowerFlow]
