...
from mastapy._private.math_utility import _1553, _1585
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1578, _1591
    from mastapy._private.math_utility.measured_data_scaling import _1626
    ...
    from mastapy._private.system_model.drawing.options import _2324, _2326
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @chart_type.setter
    @enforce_parameter_types
    def chart_type(self: "Self", value: "_4727.DynamicsResponse3DChartType") -> None:
    ...
    @enforce_parameter_types
    def complex_component(
        self: "Self", value: "_1553.ComplexPartDisplayOption"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def connected_component_type(self: "Self") -> "_5967.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5967",
    ...
    def connected_component_type(
        self: "Self", value: "_5967.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    @property
    def coordinate_system(self: "Self") -> "_4710.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4710",
    ...
    def coordinate_system(
        self: "Self", value: "_4710.CoordinateSystemForWhine"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
    ...
    @enforce_parameter_types
    def response_type(self: "Self", value: "_4728.DynamicsResponseType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4762.MultipleExcitationsSpeedRangeOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4762",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4762.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    @property
    def translation_or_rotation(self: "Self") -> "_1591.TranslationRotation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1591", "TranslationRotation"
        )(value)

    @translation_or_rotation.setter
    @enforce_parameter_types
    def translation_or_rotation(
        self: "Self", value: "_1591.TranslationRotation"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def vector_magnitude_method(self: "Self") -> "_1578.ComplexMagnitudeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1578", "ComplexMagnitudeMethod"
        )(value)

    @vector_magnitude_method.setter
    @enforce_parameter_types
    def vector_magnitude_method(
        self: "Self", value: "_1578.ComplexMagnitudeMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4811.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4811",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4811.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    def data_scaling(self: "Self") -> "_1626.DataScalingOptions":
    ...
    def modal_contribution_view_options(
        self: "Self",
    ) -> "_2326.ModalContributionViewOptions":
    ...
    def mode_view_options(
        self: "Self",
    ) -> "_2324.AdvancedTimeSteppingAnalysisForModulationModeViewOptions":
    ...
    @property
    def order_cuts_chart_settings(self: "Self") -> "_4764.OrderCutsChartSettings":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_5975.ResultLocationSelectionGroups":
    ...
    @property
    def selected_excitations(self: "Self") -> "_5970.ExcitationSourceSelectionGroup":
    ...
    @property
    def waterfall_chart_settings(self: "Self") -> "_4810.WaterfallChartSettings":
    ...
    @property
    def active_result_locations(self: "Self") -> "List[_5976.ResultNodeSelection]":
    ...
    def degrees_of_freedom(
        self: "Self",
    ) -> "List[_1904.EnumWithBoolean[_1585.ResultOptionsFor3DVector]]":
