...
class ZerolBevelGearSetStabilityAnalysis(_3868.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3986.ZerolBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3984.ZerolBevelGearMeshStabilityAnalysis]":
