...
class PulleyCompoundPowerFlow(_4300.CouplingHalfCompoundPowerFlow):
    """PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4219.PulleyPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4219.PulleyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PulleyPowerFlow]
