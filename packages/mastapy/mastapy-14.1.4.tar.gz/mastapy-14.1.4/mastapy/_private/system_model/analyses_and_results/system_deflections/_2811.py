...
class CylindricalGearMeshSystemDeflection(_2831.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: "Self") -> "_2817.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2817.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4172.CylindricalGearMeshPowerFlow":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: "Self",
    ) -> "List[_2821.CylindricalMeshedGearSystemDeflection]":
    ...
    def mesh_deflections_left_flank(
        self: "Self",
    ) -> "List[_2919.MeshDeflectionResults]":
    ...
    @property
    def gear_set(self: "Self") -> "_2814.CylindricalGearSetSystemDeflection":
