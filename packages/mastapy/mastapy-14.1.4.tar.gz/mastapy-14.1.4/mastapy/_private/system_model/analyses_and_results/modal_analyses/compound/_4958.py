...
class WormGearSetCompoundModalAnalysis(_4891.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4815.WormGearSetModalAnalysis]":
    ...
    def worm_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4956.WormGearCompoundModalAnalysis]":
    ...
    def worm_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4957.WormGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4815.WormGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearSetModalAnalysis]
