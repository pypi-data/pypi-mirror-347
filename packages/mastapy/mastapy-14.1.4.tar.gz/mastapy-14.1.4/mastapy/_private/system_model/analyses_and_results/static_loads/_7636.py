...
class RootAssemblyLoadCase(_7504.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self: "Self") -> "_1634.PIDControlSettings":
    ...
    def supercharger_rotor_sets(
        self: "Self",
    ) -> "List[_7551.CylindricalGearSetLoadCase]":
