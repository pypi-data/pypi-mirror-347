...
class ConceptGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5524.ConceptGearSetMultibodyDynamicsAnalysis]":
    ...
    def concept_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5676.ConceptGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5677.ConceptGearMeshCompoundMultibodyDynamicsAnalysis]":
