...
class BearingAdvancedSystemDeflection(_7248.ConnectorAdvancedSystemDeflection):
    """BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self: "Self") -> "_2010.LoadedBearingDutyCycle":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2770.BearingSystemDeflection]":
