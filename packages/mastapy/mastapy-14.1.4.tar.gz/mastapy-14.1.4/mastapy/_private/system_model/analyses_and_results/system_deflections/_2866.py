...
class PowerLoadSystemDeflection(_2909.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4218.PowerLoadPowerFlow":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_2907.TransmissionErrorResult]":
