...
class CylindricalGearManufactureError(_7577.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    def pitch_errors_left_flank(self: "Self") -> "_1592.Vector2DListAccessor":
    ...
    @property
    def pitch_errors_right_flank(self: "Self") -> "_1592.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
