...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2909
...
class MeasurementComponentSystemDeflection(_2909.VirtualComponentSystemDeflection):
    """MeasurementComponentSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2527.MeasurementComponent":
    ...
    @property
    def component_load_case(self: "Self") -> "_7608.MeasurementComponentLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4203.MeasurementComponentPowerFlow":
