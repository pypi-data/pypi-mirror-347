...
class OilSealCompoundModalAnalysis(_4867.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4763.OilSealModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4763.OilSealModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.OilSealModalAnalysis]
