...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    def magnitude(
        self: "Self",
    ) -> "_5998.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic":
    ...
    def result_at_reference_speed(
        self: "Self",
    ) -> "_5978.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic":
    ...
    def data_points(
        self: "Self",
    ) -> "List[_5978.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic]":
