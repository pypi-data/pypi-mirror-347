...
class BearingCompoundSystemDeflection(_2961.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_2010.LoadedBearingDutyCycle":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2770.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
