...
class MassDiscCompoundDynamicAnalysis(_6663.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6483.MassDiscDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6483.MassDiscDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.MassDiscDynamicAnalysis]
