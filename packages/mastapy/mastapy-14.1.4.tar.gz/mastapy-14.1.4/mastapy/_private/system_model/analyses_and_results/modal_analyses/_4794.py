...
class StraightBevelDiffGearSetModalAnalysis(_4691.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4793.StraightBevelDiffGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4792.StraightBevelDiffGearMeshModalAnalysis]":
