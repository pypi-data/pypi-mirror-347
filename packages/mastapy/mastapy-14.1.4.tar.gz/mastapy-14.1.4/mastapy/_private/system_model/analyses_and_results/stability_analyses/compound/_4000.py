...
class BevelDifferentialGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3863.BevelDifferentialGearSetStabilityAnalysis]":
    ...
    def bevel_differential_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_3998.BevelDifferentialGearCompoundStabilityAnalysis]":
    ...
    def bevel_differential_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_3999.BevelDifferentialGearMeshCompoundStabilityAnalysis]":
