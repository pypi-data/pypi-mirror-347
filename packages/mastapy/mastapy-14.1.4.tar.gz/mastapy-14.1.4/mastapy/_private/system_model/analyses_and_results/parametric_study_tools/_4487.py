...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2266, _2271
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self", value: "_7503.AnalysisType") -> None:
    ...
    @property
    def parametric_study_type(self: "Self") -> "_7615.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7615",
            "ParametricStudyType",
        )(value)

    @parametric_study_type.setter
    @enforce_parameter_types
    def parametric_study_type(self: "Self", value: "_7615.ParametricStudyType") -> None:
    ...
    @property
    def step_save_method(self: "Self") -> "_4490.ParametricStudyToolStepSaveMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.parametric_study_tools._4490",
    ...
    def step_save_method(
        self: "Self", value: "_4490.ParametricStudyToolStepSaveMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.ParametricStudyToolStepSaveMethod",
    ...
    @property
    def external_full_fe_loader(self: "Self") -> "_2271.ExternalFullFELoader":
    ...
    @property
    def step_results(self: "Self") -> "List[_4489.ParametricStudyToolStepResult]":
    ...
    @property
    def study_variables(self: "Self") -> "List[_4491.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: "Self",
    ) -> "List[_2720.AnalysisCaseVariable]":
    ...
    def add_logging_variable(
        self: "Self", design_entity: "_2266.DesignEntity", path: "List[str]"
    ) -> "_2720.AnalysisCaseVariable":
    ...
    def move_study_variable_down(
        self: "Self", study_variable: "_4491.ParametricStudyVariable"
    ) -> None:
        """Method does not return.
    ...
    def remove_logging_variable(
        self: "Self", analysis_variable: "_2720.AnalysisCaseVariable"
    ) -> None:
        """Method does not return.
