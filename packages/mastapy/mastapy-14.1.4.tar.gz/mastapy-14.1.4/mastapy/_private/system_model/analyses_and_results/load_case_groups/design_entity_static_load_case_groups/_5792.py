...
TAssembly = TypeVar("TAssembly", bound="_2498.AbstractAssembly")
TAssemblyStaticLoad = TypeVar(
    "TAssemblyStaticLoad", bound="_7492.AbstractAssemblyLoadCase"
)
...
class AbstractAssemblyStaticLoadCaseGroup(
    _5797.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]
):
    """AbstractAssemblyStaticLoadCaseGroup
