...
class CylindricalGearSetCompoundPowerFlow(_4321.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4174.CylindricalGearSetPowerFlow]":
    ...
    def cylindrical_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4308.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4309.CylindricalGearMeshCompoundPowerFlow]":
