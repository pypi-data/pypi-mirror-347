...
class ConicalGearSetModalAnalysisAtAStiffness(_5023.GearSetModalAnalysisAtAStiffness):
    """ConicalGearSetModalAnalysisAtAStiffness
    ...
    def gears_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_4995.ConicalGearModalAnalysisAtAStiffness]":
    ...
    def meshes_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_4994.ConicalGearMeshModalAnalysisAtAStiffness]":
