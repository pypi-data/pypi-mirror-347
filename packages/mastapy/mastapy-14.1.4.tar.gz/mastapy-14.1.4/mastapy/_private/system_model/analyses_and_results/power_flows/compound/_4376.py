...
class SynchroniserCompoundPowerFlow(_4361.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4246.SynchroniserPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4246.SynchroniserPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPowerFlow]
