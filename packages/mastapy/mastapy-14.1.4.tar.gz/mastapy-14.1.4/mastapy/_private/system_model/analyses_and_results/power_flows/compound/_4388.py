...
class WormGearSetCompoundPowerFlow(_4321.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4257.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4386.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4387.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4257.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]
