...
class BevelDifferentialGearSetSystemDeflection(_2779.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4137.BevelDifferentialGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2775.BevelDifferentialGearSystemDeflection]":
