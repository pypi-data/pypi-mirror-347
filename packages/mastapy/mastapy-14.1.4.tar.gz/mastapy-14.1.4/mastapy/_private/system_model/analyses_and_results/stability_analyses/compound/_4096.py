...
class StraightBevelDiffGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3964.StraightBevelDiffGearSetStabilityAnalysis]":
    ...
    def straight_bevel_diff_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4094.StraightBevelDiffGearCompoundStabilityAnalysis]":
    ...
    def straight_bevel_diff_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4095.StraightBevelDiffGearMeshCompoundStabilityAnalysis]":
