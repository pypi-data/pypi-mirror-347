...
class BoltedJointCompoundPowerFlow(_4361.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4143.BoltedJointPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4143.BoltedJointPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltedJointPowerFlow]
