...
class BearingCompoundDynamicAnalysis(_6575.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6414.BearingDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6414.BearingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BearingDynamicAnalysis]
