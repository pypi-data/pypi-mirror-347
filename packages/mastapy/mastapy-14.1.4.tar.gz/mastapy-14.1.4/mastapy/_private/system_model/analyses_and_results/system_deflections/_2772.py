...
class BeltDriveSystemDeflection(_2880.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4134.BeltDrivePowerFlow":
    ...
    @property
    def belts(self: "Self") -> "List[_2771.BeltConnectionSystemDeflection]":
