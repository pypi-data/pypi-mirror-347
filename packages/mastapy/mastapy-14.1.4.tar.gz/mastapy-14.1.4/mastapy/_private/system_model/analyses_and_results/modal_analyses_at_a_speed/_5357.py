...
class ZerolBevelGearSetModalAnalysisAtASpeed(_5244.BevelGearSetModalAnalysisAtASpeed):
    """ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    def bevel_gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5356.ZerolBevelGearModalAnalysisAtASpeed]":
    ...
    def bevel_meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5355.ZerolBevelGearMeshModalAnalysisAtASpeed]":
