...
class CylindricalGearSetCompoundHarmonicAnalysis(_6062.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5849.CylindricalGearSetHarmonicAnalysis]":
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6049.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6050.CylindricalGearMeshCompoundHarmonicAnalysis]":
