...
class CVTHarmonicAnalysis(_5809.BeltDriveHarmonicAnalysis):
    """CVTHarmonicAnalysis
    ...
    @property
    def assembly_design(self: "Self") -> "_2657.CVT":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2806.CVTSystemDeflection":
