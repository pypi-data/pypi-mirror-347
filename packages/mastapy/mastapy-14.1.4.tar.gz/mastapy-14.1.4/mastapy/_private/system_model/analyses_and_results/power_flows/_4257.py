...
class WormGearSetPowerFlow(_4187.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4256.WormGearPowerFlow]":
    ...
    @property
    def worm_gears_power_flow(self: "Self") -> "List[_4256.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4255.WormGearMeshPowerFlow]":
    ...
    @property
    def worm_meshes_power_flow(self: "Self") -> "List[_4255.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
