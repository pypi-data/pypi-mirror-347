...
class _Cast_SingleExcitationResultsModalAnalysis:
    ...
    def design_entity_modal_analysis_group_results(
        self: "CastSelf",
    ) -> "_4822.DesignEntityModalAnalysisGroupResults":
        return self.__parent__._cast(_4822.DesignEntityModalAnalysisGroupResults)
...
class SingleExcitationResultsModalAnalysis(_4822.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4825.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):
