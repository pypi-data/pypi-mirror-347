...
class GearCompoundStabilityAnalysis(_4066.MountableComponentCompoundStabilityAnalysis):
    """GearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3913.GearStabilityAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3913.GearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.GearStabilityAnalysis]
