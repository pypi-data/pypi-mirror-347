...
class WormGearSetCompoundSystemDeflection(_2986.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2911.WormGearSetSystemDeflection]":
    ...
    def worm_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3052.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3053.WormGearMeshCompoundSystemDeflection]":
