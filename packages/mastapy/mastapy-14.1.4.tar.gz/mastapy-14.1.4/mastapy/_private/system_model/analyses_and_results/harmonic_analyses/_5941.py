...
class StiffnessOptionsForHarmonicAnalysis(
    _7695.AbstractAnalysisOptions[_7491.StaticLoadCase]
):
    """StiffnessOptionsForHarmonicAnalysis
    ...
    @property
    def curve_with_stiffness_steps(self: "Self") -> "_1928.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def torque_input_type(
        self: "Self", value: "_5890.HarmonicAnalysisTorqueInputType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def torque_speed_curve(self: "Self") -> "_1592.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def torque_speed_curve(self: "Self", value: "_1592.Vector2DListAccessor") -> None:
