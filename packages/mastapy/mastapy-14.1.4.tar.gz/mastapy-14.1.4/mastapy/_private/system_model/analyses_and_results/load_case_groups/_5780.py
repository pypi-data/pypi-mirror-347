...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5779
...
from mastapy._private.system_model.connections_and_sockets.gears import _2372, _2376
from mastapy._private.system_model.part_model import _2503, _2517, _2537, _2538
from mastapy._private.system_model.part_model.gears import _2594, _2595, _2599, _2601
...
class _Cast_AbstractStaticLoadCaseGroup:
    ...
    @property
    def design_state(self: "CastSelf") -> "_5783.DesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5783,
        )

        return self.__parent__._cast(_5783.DesignState)

    @property
    def duty_cycle(self: "CastSelf") -> "_5784.DutyCycle":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5784,
        )

        return self.__parent__._cast(_5784.DutyCycle)

    @property
    def sub_group_in_single_design_state(
        self: "CastSelf",
    ) -> "_5787.SubGroupInSingleDesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5787,
        )

        return self.__parent__._cast(_5787.SubGroupInSingleDesignState)
...
class AbstractStaticLoadCaseGroup(_5779.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    def bearings(
        ...
        "List[_5793.ComponentStaticLoadCaseGroup[_2503.Bearing, _7505.BearingLoadCase]]"
    ):
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5796.GearSetStaticLoadCaseGroup[_2595.CylindricalGearSet, _2594.CylindricalGear, _7547.CylindricalGearLoadCase, _2372.CylindricalGearMesh, _7549.CylindricalGearMeshLoadCase, _7551.CylindricalGearSetLoadCase]]":
    ...
    @property
    def design_states(self: "Self") -> "List[_5778.AbstractDesignStateLoadCaseGroup]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_5793.ComponentStaticLoadCaseGroup[_2517.FEPart, _7573.FEPartLoadCase]]":
    ...
    def gear_sets(
        self: "Self",
    ) -> "List[_5796.GearSetStaticLoadCaseGroup[_2601.GearSet, _2599.Gear, _7576.GearLoadCase, _2376.GearMesh, _7578.GearMeshLoadCase, _7581.GearSetLoadCase]]":
    ...
    @property
    def parts_with_excitations(self: "Self") -> "List[_5797.PartStaticLoadCaseGroup]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5793.ComponentStaticLoadCaseGroup[_2537.PointLoad, _7626.PointLoadLoadCase]]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5793.ComponentStaticLoadCaseGroup[_2538.PowerLoad, _7627.PowerLoadLoadCase]]":
    ...
    @property
    def compound_system_deflection(self: "Self") -> "_2753.CompoundSystemDeflection":
    ...
    @property
    def compound_power_flow(self: "Self") -> "_2748.CompoundPowerFlow":
    ...
    @property
    def compound_harmonic_analysis(self: "Self") -> "_2740.CompoundHarmonicAnalysis":
    ...
    @property
    def compound_modal_analysis(self: "Self") -> "_2743.CompoundModalAnalysis":
    ...
    @property
    def compound_stability_analysis(self: "Self") -> "_2749.CompoundStabilityAnalysis":
