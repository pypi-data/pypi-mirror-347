...
class PowerLoadCompoundParametricStudyTool(
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7627.PowerLoadLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4500.PowerLoadParametricStudyTool]":
    ...
    @property
    def load_cases(self: "Self") -> "List[_7627.PowerLoadLoadCase]":
