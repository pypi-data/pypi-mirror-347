...
class SpiralBevelGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3955.SpiralBevelGearSetStabilityAnalysis]":
    ...
    def spiral_bevel_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4088.SpiralBevelGearCompoundStabilityAnalysis]":
    ...
    def spiral_bevel_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4089.SpiralBevelGearMeshCompoundStabilityAnalysis]":
