...
class CVTCompoundSystemDeflection(_2935.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2806.CVTSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_2806.CVTSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTSystemDeflection]
