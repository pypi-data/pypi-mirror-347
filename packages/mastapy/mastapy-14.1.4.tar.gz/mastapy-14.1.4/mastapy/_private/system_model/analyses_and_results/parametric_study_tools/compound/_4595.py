...
class FaceGearCompoundParametricStudyTool(_4600.GearCompoundParametricStudyTool):
    """FaceGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7570.FaceGearLoadCase":
