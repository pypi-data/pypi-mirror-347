...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_5989.ResultsForMultipleOrders":
        return self.__parent__._cast(_5989.ResultsForMultipleOrders)
...
class ResultsForMultipleOrdersForFESurface(_5989.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
