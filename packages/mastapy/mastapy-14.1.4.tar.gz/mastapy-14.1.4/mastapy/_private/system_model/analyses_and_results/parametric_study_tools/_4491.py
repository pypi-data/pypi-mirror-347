...
class _Cast_ParametricStudyVariable:
    ...
    @property
    def analysis_case_variable(self: "CastSelf") -> "_2720.AnalysisCaseVariable":
        return self.__parent__._cast(_2720.AnalysisCaseVariable)
...
class ParametricStudyVariable(_2720.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    def dimension(self: "Self") -> "_4481.ParametricStudyDimension":
    ...
    def dimension(self: "Self", value: "_4481.ParametricStudyDimension") -> None:
    ...
    @property
    def distribution(self: "Self") -> "_4478.MonteCarloDistribution":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.parametric_study_tools._4478",
            "MonteCarloDistribution",
        )(value)

    @distribution.setter
    @enforce_parameter_types
    def distribution(self: "Self", value: "_4478.MonteCarloDistribution") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution",
        )
    ...
    @property
    def doe_variable_setter(self: "Self") -> "_4444.DesignOfExperimentsVariableSetter":
