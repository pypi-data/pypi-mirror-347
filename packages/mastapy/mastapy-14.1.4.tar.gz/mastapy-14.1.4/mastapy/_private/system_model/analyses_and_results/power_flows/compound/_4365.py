...
class SpringDamperCompoundPowerFlow(_4298.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4235.SpringDamperPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4235.SpringDamperPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpringDamperPowerFlow]
