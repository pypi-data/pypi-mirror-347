...
class ConceptGearSetModalAnalysisAtASpeed(_5286.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5256.ConceptGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5255.ConceptGearMeshModalAnalysisAtASpeed]":
