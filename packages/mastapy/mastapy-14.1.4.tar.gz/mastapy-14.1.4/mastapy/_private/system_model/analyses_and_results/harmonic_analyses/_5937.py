...
class SpiralBevelGearSetHarmonicAnalysis(_5817.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5935.SpiralBevelGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5936.SpiralBevelGearMeshHarmonicAnalysis]":
