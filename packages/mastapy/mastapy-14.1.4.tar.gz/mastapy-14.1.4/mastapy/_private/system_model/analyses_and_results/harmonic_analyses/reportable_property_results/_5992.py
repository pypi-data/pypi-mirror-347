...
class _Cast_ResultsForOrder:
    ...
    def results_for_order_including_groups(
        self: "CastSelf",
    ) -> "_5993.ResultsForOrderIncludingGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5993,
        )

        return self.__parent__._cast(_5993.ResultsForOrderIncludingGroups)

    @property
    def results_for_order_including_nodes(
        self: "CastSelf",
    ) -> "_5994.ResultsForOrderIncludingNodes":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5994,
        )

        return self.__parent__._cast(_5994.ResultsForOrderIncludingNodes)

    @property
    def results_for_order_including_surfaces(
        self: "CastSelf",
    ) -> "_5995.ResultsForOrderIncludingSurfaces":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5995,
        )

        return self.__parent__._cast(_5995.ResultsForOrderIncludingSurfaces)
...
class ResultsForOrder(_0.APIBase):
    ...
    def component(
        self: "Self",
    ) -> "_5983.HarmonicAnalysisResultsBrokenDownByComponentWithinAHarmonic":
