...
class CVTCompoundDynamicAnalysis(_6549.BeltDriveCompoundDynamicAnalysis):
    """CVTCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_6447.CVTDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6447.CVTDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CVTDynamicAnalysis]
