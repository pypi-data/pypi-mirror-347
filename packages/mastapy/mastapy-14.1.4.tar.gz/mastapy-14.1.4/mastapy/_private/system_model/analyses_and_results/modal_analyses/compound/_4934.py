...
class SpiralBevelGearSetCompoundModalAnalysis(_4849.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4788.SpiralBevelGearSetModalAnalysis]":
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4932.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4933.SpiralBevelGearMeshCompoundModalAnalysis]":
