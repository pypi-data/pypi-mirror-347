...
class ConceptGearSetCompoundModalAnalysis(_4891.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4704.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4860.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4861.ConceptGearMeshCompoundModalAnalysis]":
