...
class _Cast_GearManufactureError:
    ...
    def conical_gear_manufacture_error(
        self: "CastSelf",
    ) -> "_7531.ConicalGearManufactureError":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7531,
        )

        return self.__parent__._cast(_7531.ConicalGearManufactureError)

    @property
    def cylindrical_gear_manufacture_error(
        self: "CastSelf",
    ) -> "_7548.CylindricalGearManufactureError":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7548,
        )

        return self.__parent__._cast(_7548.CylindricalGearManufactureError)
