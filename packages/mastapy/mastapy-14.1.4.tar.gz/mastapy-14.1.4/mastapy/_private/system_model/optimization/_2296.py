...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2290, _2293, _2295
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2290.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2290

        return self.__parent__._cast(_2290.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2293.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2293

        return self.__parent__._cast(_2293.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self: "Self") -> "_2295.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.optimization._2295",
    ...
    def optimisation_target(
        self: "Self", value: "_2295.MicroGeometryOptimisationTarget"
    ) -> None:
