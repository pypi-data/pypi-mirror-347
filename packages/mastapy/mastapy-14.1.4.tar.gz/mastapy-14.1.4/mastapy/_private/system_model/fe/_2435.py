...
class _Cast_DegreeOfFreedomBoundaryConditionAngular:
    ...
    def degree_of_freedom_boundary_condition(
        self: "CastSelf",
    ) -> "_2434.DegreeOfFreedomBoundaryCondition":
        return self.__parent__._cast(_2434.DegreeOfFreedomBoundaryCondition)
...
class DegreeOfFreedomBoundaryConditionAngular(_2434.DegreeOfFreedomBoundaryCondition):
    """DegreeOfFreedomBoundaryConditionAngular
