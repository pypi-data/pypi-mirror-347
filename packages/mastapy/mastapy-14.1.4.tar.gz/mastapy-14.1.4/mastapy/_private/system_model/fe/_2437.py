...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @enforce_parameter_types
    def node_for_first_tooth(self: "Self", value: "_2449.FESubstructureNode") -> None:
    ...
    @property
    def torque_ripple_input_type(self: "Self") -> "_7665.TorqueRippleInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7665",
    ...
    def torque_ripple_input_type(
        self: "Self", value: "_7665.TorqueRippleInputType"
    ) -> None:
