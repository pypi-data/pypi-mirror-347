...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_method(self: "Self") -> "_5973.ModalContributionFilteringMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5973",
    ...
    def filtering_method(
        self: "Self", value: "_5973.ModalContributionFilteringMethod"
    ) -> None:
    ...
    @property
    def modes_to_display(self: "Self") -> "_5972.ModalContributionDisplayMethod":
    ...
    def modes_to_display(
        self: "Self", value: "_5972.ModalContributionDisplayMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ModalContributionDisplayMethod",
