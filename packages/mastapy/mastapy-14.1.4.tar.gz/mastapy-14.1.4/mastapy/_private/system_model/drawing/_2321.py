...
class _Cast_SteadyStateSynchronousResponseViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2318.RotorDynamicsViewable":
        return self.__parent__._cast(_2318.RotorDynamicsViewable)
...
class SteadyStateSynchronousResponseViewable(_2318.RotorDynamicsViewable):
    """SteadyStateSynchronousResponseViewable
