...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2264, _2266
...
class SpringDamperConnection(_2409.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self: "Self") -> "_2264.ComponentDampingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2264", "ComponentDampingOption"
        )(value)

    @damping_option.setter
    @enforce_parameter_types
    def damping_option(self: "Self", value: "_2264.ComponentDampingOption") -> None:
