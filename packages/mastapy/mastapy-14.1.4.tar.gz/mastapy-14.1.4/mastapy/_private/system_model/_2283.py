...
T = TypeVar("T", bound="_2508.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self: "Self") -> "_1549.AlignmentAxis":
    ...
    def alignment_axis(self: "Self", value: "_1549.AlignmentAxis") -> None:
    ...
    @property
    def axial_offset(self: "Self") -> "_2284.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2284", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: "Self", value: "_2284.RelativeOffsetOption") -> None:
        value = conversion.mp_to_pn_enum(
