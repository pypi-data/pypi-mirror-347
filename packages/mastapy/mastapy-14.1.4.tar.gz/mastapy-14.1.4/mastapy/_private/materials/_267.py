...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self: "Self") -> "_1592.Vector2DListAccessor":
    ...
    def bh_curve(self: "Self", value: "_1592.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "BHCurve", value.wrapped)

    @property
    def bh_curve_plot(self: "Self") -> "_1928.TwoDChartDefinition":
