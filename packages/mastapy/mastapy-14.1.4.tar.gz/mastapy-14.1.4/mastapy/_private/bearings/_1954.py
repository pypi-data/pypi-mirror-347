...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1930, _1946, _1957
...
class RollingBearingDatabase(
    _1892.SQLDatabase[_1955.RollingBearingKey, _2227.RollingBearing]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: "Self", bearing: "_2227.RollingBearing") -> None:
    ...
    @enforce_parameter_types
    def create_bearing(
        self: "Self", type_: "_1957.RollingBearingType", designation: "str" = "None"
    ) -> "_2227.RollingBearing":
    ...
    @enforce_parameter_types
    def remove_from_database(self: "Self", bearing: "_2227.RollingBearing") -> None:
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: "Self", catalog: "_1930.BearingCatalog"
    ) -> "List[_2227.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: "Self", designation: "str", catalog: "_1930.BearingCatalog"
    ) -> "_2227.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: "Self",
        designation: "str",
        catalog: "_1930.BearingCatalog",
        type_: "_1957.RollingBearingType",
    ) -> "List[_2227.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        number_of_rows: "int",
        material_type: "_1946.HybridSteelAll",
    ) -> "List[_2227.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
