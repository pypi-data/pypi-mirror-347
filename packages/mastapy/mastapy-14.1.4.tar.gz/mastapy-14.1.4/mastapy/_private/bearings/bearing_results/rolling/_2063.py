...
class _Cast_LoadedBallBearingRaceResults:
    ...
    def loaded_rolling_bearing_race_results(
        self: "CastSelf",
    ) -> "_2094.LoadedRollingBearingRaceResults":
        return self.__parent__._cast(_2094.LoadedRollingBearingRaceResults)

    @property
    def loaded_four_point_contact_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2078.LoadedFourPointContactBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2078

        return self.__parent__._cast(_2078.LoadedFourPointContactBallBearingRaceResults)
...
class LoadedBallBearingRaceResults(_2094.LoadedRollingBearingRaceResults):
    """LoadedBallBearingRaceResults
