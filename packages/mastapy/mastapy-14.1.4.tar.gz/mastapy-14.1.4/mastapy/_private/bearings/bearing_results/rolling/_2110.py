...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2091, _2095
...
class LoadedTaperRollerBearingResults(_2086.LoadedNonBarrelRollerBearingResults):
    """LoadedTaperRollerBearingResults
