...
class _Cast_RingFittingThermalResults:
    ...
    def inner_ring_fitting_thermal_results(
        ...
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2172

        return self.__parent__._cast(_2172.InnerRingFittingThermalResults)

    @property
    def outer_ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2174.OuterRingFittingThermalResults":
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2174

        return self.__parent__._cast(_2174.OuterRingFittingThermalResults)
...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    def interference_values(self: "Self") -> "List[_2173.InterferenceComponents]":
