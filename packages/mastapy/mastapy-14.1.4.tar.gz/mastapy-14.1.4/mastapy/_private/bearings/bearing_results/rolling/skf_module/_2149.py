...
class GreaseLifeAndRelubricationInterval(_2158.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease(self: "Self") -> "_2148.Grease":
    ...
    @property
    def grease_quantity(self: "Self") -> "_2150.GreaseQuantity":
    ...
    @property
    def initial_fill(self: "Self") -> "_2151.InitialFill":
