...
class _Cast_LoadedTiltingJournalPad:
    ...
    def loaded_fluid_film_bearing_pad(
        self: "CastSelf",
    ) -> "_2180.LoadedFluidFilmBearingPad":
        return self.__parent__._cast(_2180.LoadedFluidFilmBearingPad)
...
class LoadedTiltingJournalPad(_2180.LoadedFluidFilmBearingPad):
    """LoadedTiltingJournalPad
