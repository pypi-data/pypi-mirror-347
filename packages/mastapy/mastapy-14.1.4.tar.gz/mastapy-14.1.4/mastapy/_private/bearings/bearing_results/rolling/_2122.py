...
class _Cast_MaximumStaticContactStress:
    ...
    def maximum_static_contact_stress_results_abstract(
        self: "CastSelf",
    ) -> "_2124.MaximumStaticContactStressResultsAbstract":
        return self.__parent__._cast(_2124.MaximumStaticContactStressResultsAbstract)
...
class MaximumStaticContactStress(_2124.MaximumStaticContactStressResultsAbstract):
    """MaximumStaticContactStress
