...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2076, _2082, _2090
...
class LoadedCylindricalRollerBearingElement(_2089.LoadedNonBarrelRollerElement):
    """LoadedCylindricalRollerBearingElement
