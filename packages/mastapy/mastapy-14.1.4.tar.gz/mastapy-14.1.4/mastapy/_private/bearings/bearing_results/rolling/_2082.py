...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2076, _2089, _2090
...
class LoadedNeedleRollerBearingElement(_2070.LoadedCylindricalRollerBearingElement):
    """LoadedNeedleRollerBearingElement
