...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2086, _2091, _2095
...
class LoadedNeedleRollerBearingResults(_2071.LoadedCylindricalRollerBearingResults):
    """LoadedNeedleRollerBearingResults
