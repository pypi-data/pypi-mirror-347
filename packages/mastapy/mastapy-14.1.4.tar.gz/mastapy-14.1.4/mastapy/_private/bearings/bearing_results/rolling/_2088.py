...
class _Cast_LoadedNonBarrelRollerBearingStripLoadResults:
    ...
    def loaded_roller_strip_load_results(
        self: "CastSelf",
    ) -> "_2093.LoadedRollerStripLoadResults":
        return self.__parent__._cast(_2093.LoadedRollerStripLoadResults)
...
class LoadedNonBarrelRollerBearingStripLoadResults(_2093.LoadedRollerStripLoadResults):
    """LoadedNonBarrelRollerBearingStripLoadResults
