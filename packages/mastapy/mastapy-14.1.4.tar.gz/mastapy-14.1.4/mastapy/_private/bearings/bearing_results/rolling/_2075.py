...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2074, _2096
...
class LoadedDeepGrooveBallBearingRow(_2065.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2074.LoadedDeepGrooveBallBearingResults":
