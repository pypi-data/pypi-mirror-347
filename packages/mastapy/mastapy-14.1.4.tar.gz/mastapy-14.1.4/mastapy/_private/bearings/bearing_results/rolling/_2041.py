...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2040, _2042
...
class _Cast_ISOTR141792001Results:
    ...
    @property
    def isotr1417912001_results(self: "CastSelf") -> "_2040.ISOTR1417912001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2040

        return self.__parent__._cast(_2040.ISOTR1417912001Results)

    @property
    def isotr1417922001_results(self: "CastSelf") -> "_2042.ISOTR1417922001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2042

        return self.__parent__._cast(_2042.ISOTR1417922001Results)
