...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: "Self") -> "_2138.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: "Self") -> "_2140.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: "Self") -> "_2141.BearingRatingLife":
    ...
    @property
    def frequencies(self: "Self") -> "_2143.Frequencies":
    ...
    @property
    def friction(self: "Self") -> "_2145.Friction":
    ...
    @property
    def minimum_load(self: "Self") -> "_2153.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: "Self") -> "_2161.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: "Self") -> "_2162.Viscosities":
