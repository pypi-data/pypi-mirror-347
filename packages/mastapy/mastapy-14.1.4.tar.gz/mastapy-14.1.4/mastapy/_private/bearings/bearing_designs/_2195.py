...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1938, _1943
...
class LinearBearing(_2192.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self: "Self") -> "_1943.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1943", "BearingStiffnessMatrixOption"
        )(value)

    @stiffness_options.setter
    @enforce_parameter_types
    def stiffness_options(
        self: "Self", value: "_1943.BearingStiffnessMatrixOption"
    ) -> None:
