...
from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2239
...
class _Cast_XMLVariableAssignment:
    ...
    def abstract_xml_variable_assignment(
        self: "CastSelf",
    ) -> "_2239.AbstractXmlVariableAssignment":
        return self.__parent__._cast(_2239.AbstractXmlVariableAssignment)
...
class XMLVariableAssignment(_2239.AbstractXmlVariableAssignment, Generic[T]):
    """XMLVariableAssignment
