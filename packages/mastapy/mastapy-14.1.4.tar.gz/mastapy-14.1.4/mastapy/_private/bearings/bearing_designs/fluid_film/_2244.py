...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2245, _2246
...
class _Cast_AxialFeedJournalBearing:
    ...
    def axial_groove_journal_bearing(
        self: "CastSelf",
    ) -> "_2245.AxialGrooveJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2245

        return self.__parent__._cast(_2245.AxialGrooveJournalBearing)

    @property
    def axial_hole_journal_bearing(self: "CastSelf") -> "_2246.AxialHoleJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2246

        return self.__parent__._cast(_2246.AxialHoleJournalBearing)
