...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2248, _2249, _2251
...
class _Cast_PlainJournalHousing:
    ...
    def cylindrical_housing_journal_bearing(
        self: "CastSelf",
    ) -> "_2248.CylindricalHousingJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2248

        return self.__parent__._cast(_2248.CylindricalHousingJournalBearing)

    @property
    def machinery_encased_journal_bearing(
        self: "CastSelf",
    ) -> "_2249.MachineryEncasedJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2249

        return self.__parent__._cast(_2249.MachineryEncasedJournalBearing)

    @property
    def pedestal_journal_bearing(self: "CastSelf") -> "_2251.PedestalJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2251

        return self.__parent__._cast(_2251.PedestalJournalBearing)
...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self: "Self") -> "_2005.DefaultOrUserInput":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results._2005", "DefaultOrUserInput"
        )(value)

    @heat_emitting_area_method.setter
    @enforce_parameter_types
    def heat_emitting_area_method(
        self: "Self", value: "_2005.DefaultOrUserInput"
    ) -> None:
