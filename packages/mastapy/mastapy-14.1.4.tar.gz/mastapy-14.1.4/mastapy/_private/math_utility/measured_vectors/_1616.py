...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1617, _1618, _1621
...
class _Cast_AbstractForceAndDisplacementResults:
    ...
    def force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1617.ForceAndDisplacementResults":
        from mastapy._private.math_utility.measured_vectors import _1617

        return self.__parent__._cast(_1617.ForceAndDisplacementResults)

    @property
    def force_results(self: "CastSelf") -> "_1618.ForceResults":
        from mastapy._private.math_utility.measured_vectors import _1618

        return self.__parent__._cast(_1618.ForceResults)
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self: "Self") -> "_1621.VectorWithLinearAndAngularComponents":
