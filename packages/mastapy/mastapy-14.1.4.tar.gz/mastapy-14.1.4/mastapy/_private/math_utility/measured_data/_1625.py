...
class TwodimensionalFunctionLookupTable(
    _1623.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1622.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: "Self", value: "_1622.GriddedSurfaceAccessor") -> None:
