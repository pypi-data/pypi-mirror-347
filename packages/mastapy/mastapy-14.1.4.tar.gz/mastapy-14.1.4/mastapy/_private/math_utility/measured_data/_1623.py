...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_data import _1624, _1625
...
class LookupTableBase(_1644.IndependentReportablePropertiesBase[T]):
    """LookupTableBase
    ...
    def extrapolation_option(self: "Self", value: "_1568.ExtrapolationOptions") -> None:
