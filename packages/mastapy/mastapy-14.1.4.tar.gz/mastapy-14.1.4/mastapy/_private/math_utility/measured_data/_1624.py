...
class OnedimensionalFunctionLookupTable(
    _1623.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1592.Vector2DListAccessor":
    ...
    def lookup_table(self: "Self", value: "_1592.Vector2DListAccessor") -> None:
