...
class _Cast_Optimisable:
    ...
    @property
    def abstract_optimisable(self: "CastSelf") -> "_1596.AbstractOptimisable":
        return self.__parent__._cast(_1596.AbstractOptimisable)
...
class Optimisable(_1596.AbstractOptimisable):
    """Optimisable
