...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1601, _1613
...
class _Cast_OptimizationVariable:
    ...
    @property
    def optimization_input(self: "CastSelf") -> "_1601.OptimizationInput":
        from mastapy._private.math_utility.optimisation import _1601

        return self.__parent__._cast(_1601.OptimizationInput)

    @property
    def reporting_optimization_input(
        self: "CastSelf",
    ) -> "_1613.ReportingOptimizationInput":
        from mastapy._private.math_utility.optimisation import _1613

        return self.__parent__._cast(_1613.ReportingOptimizationInput)
...
class OptimizationVariable(_0.APIBase):
    ...
    @property
    def measurement(self: "Self") -> "_1663.MeasurementBase":
    ...
    def measurement(self: "Self", value: "_1663.MeasurementBase") -> None:
