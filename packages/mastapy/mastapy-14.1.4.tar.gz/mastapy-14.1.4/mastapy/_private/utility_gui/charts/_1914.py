...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _1919, _1925
...
class _Cast_ConstantLine:
    ...
    @property
    def mode_constant_line(self: "CastSelf") -> "_1919.ModeConstantLine":
        from mastapy._private.utility_gui.charts import _1919

        return self.__parent__._cast(_1919.ModeConstantLine)
...
class ConstantLine(_0.APIBase):
    ...
    @property
    def axis(self: "Self") -> "_1925.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility_gui.charts._1925", "SMTAxis"
        )(value)
