...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui import _1910
...
class _Cast_DataLoggerWithCharts:
    ...
    @property
    def data_logger(self: "CastSelf") -> "_1633.DataLogger":
        return self.__parent__._cast(_1633.DataLogger)
...
class DataLoggerWithCharts(_1633.DataLogger):
    """DataLoggerWithCharts
    ...
    @property
    def logged_items(self: "Self") -> "List[_1910.DataLoggerItem]":
