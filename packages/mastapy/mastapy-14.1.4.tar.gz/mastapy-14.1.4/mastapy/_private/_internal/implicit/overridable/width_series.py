...
class Overridable_WidthSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_WidthSeries]") -> "_2238.WidthSeries":
    ...
    def implicit_type(cls: "Type[Overridable_WidthSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2238.WidthSeries.type_()

    @property
    def value(self: "Self") -> "_2238.WidthSeries":
    ...
    @property
    def override_value(self: "Self") -> "_2238.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
    ...
    @property
    def calculated_value(self: "Self") -> "_2238.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
