...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BallBearingAnalysisMethod]",
    ) -> "_2028.BallBearingAnalysisMethod":
        ...
        Returns:
            _2028.BallBearingAnalysisMethod
        """
        return _2028.BallBearingAnalysisMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2028.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2028.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2028.BallBearingAnalysisMethod]":
