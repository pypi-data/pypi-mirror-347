...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5552.GearMeshStiffnessModel
        """
        return _5552.GearMeshStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5552.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5552.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5552.GearMeshStiffnessModel]":
