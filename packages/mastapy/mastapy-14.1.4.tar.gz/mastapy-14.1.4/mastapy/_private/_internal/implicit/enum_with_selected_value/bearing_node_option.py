...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2426.BearingNodeOption
        """
        return _2426.BearingNodeOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BearingNodeOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2426.BearingNodeOption.type_()

    @property
    def selected_value(self: "Self") -> "_2426.BearingNodeOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2426.BearingNodeOption]":
