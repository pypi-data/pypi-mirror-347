...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    def wrapped_type(
        ...
        Returns:
            _1564.DynamicsResponseScaling
        """
        return _1564.DynamicsResponseScaling
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1564.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: "Self") -> "_1564.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: "Self") -> "List[_1564.DynamicsResponseScaling]":
