...
class ListWithSelectedItem_GuideDxfModel(
    _2519.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2519.GuideDxfModel.TYPE

    @property
    def selected_value(self: "Self") -> "_2519.GuideDxfModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2519.GuideDxfModel]":
