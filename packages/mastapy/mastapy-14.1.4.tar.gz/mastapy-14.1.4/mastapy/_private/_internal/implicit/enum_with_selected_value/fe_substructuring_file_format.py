...
class EnumWithSelectedValue_FESubstructuringFileFormat(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FESubstructuringFileFormat]",
    ) -> "_181.FESubstructuringFileFormat":
        ...
        Returns:
            _181.FESubstructuringFileFormat
        """
        return _181.FESubstructuringFileFormat
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _181.FESubstructuringFileFormat.type_()

    @property
    def selected_value(self: "Self") -> "_181.FESubstructuringFileFormat":
    ...
    @property
    def available_values(self: "Self") -> "List[_181.FESubstructuringFileFormat]":
