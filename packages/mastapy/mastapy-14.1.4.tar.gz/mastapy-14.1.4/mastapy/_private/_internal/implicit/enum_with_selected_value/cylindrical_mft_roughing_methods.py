...
from mastapy._private.gears.manufacturing.cylindrical import _655
...
class EnumWithSelectedValue_CylindricalMftRoughingMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalMftRoughingMethods]",
    ) -> "_655.CylindricalMftRoughingMethods":
        ...
        Returns:
            _655.CylindricalMftRoughingMethods
        """
        return _655.CylindricalMftRoughingMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _655.CylindricalMftRoughingMethods.type_()

    @property
    def selected_value(self: "Self") -> "_655.CylindricalMftRoughingMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_655.CylindricalMftRoughingMethods]":
