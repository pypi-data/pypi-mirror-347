...
class ListWithSelectedItem_Unit(_1668.Unit, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Unit]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1668.Unit.TYPE

    @property
    def selected_value(self: "Self") -> "_1668.Unit":
    ...
    @property
    def available_values(self: "Self") -> "List[_1668.Unit]":
