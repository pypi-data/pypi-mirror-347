...
class ListWithSelectedItem_RotorSkewSlice(
    _1350.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_RotorSkewSlice]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1350.RotorSkewSlice.TYPE

    @property
    def selected_value(self: "Self") -> "_1350.RotorSkewSlice":
    ...
    @property
    def available_values(self: "Self") -> "List[_1350.RotorSkewSlice]":
