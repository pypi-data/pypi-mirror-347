...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7680.DestinationDesignState
        """
        return _7680.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7680.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7680.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7680.DestinationDesignState]":
