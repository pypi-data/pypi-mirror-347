...
class EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod]",
    ) -> "_356.MicropittingCoefficientOfFrictionCalculationMethod":
        ...
        Returns:
            _356.MicropittingCoefficientOfFrictionCalculationMethod
        """
        return _356.MicropittingCoefficientOfFrictionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _356.MicropittingCoefficientOfFrictionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_356.MicropittingCoefficientOfFrictionCalculationMethod]":
