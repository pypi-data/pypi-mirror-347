...
class Overridable_BearingElementOrbitModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_5498.BearingElementOrbitModel":
        ...
        Returns:
            _5498.BearingElementOrbitModel
        """
        return _5498.BearingElementOrbitModel
    ...
    def implicit_type(cls: "Type[Overridable_BearingElementOrbitModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5498.BearingElementOrbitModel.type_()

    @property
    def value(self: "Self") -> "_5498.BearingElementOrbitModel":
    ...
    @property
    def override_value(self: "Self") -> "_5498.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
    ...
    @property
    def calculated_value(self: "Self") -> "_5498.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
