...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7583.HarmonicExcitationType
        """
        return _7583.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7583.HarmonicExcitationType.type_()

    @property
    def selected_value(self: "Self") -> "_7583.HarmonicExcitationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7583.HarmonicExcitationType]":
