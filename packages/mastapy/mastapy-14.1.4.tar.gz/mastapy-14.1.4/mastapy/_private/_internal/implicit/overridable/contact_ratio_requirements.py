...
class Overridable_ContactRatioRequirements(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _340.ContactRatioRequirements
        """
        return _340.ContactRatioRequirements
    ...
    def implicit_type(cls: "Type[Overridable_ContactRatioRequirements]") -> "Any":
        ...
        Returns:
            Any
        """
        return _340.ContactRatioRequirements.type_()

    @property
    def value(self: "Self") -> "_340.ContactRatioRequirements":
    ...
    @property
    def override_value(self: "Self") -> "_340.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
    ...
    @property
    def calculated_value(self: "Self") -> "_340.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
