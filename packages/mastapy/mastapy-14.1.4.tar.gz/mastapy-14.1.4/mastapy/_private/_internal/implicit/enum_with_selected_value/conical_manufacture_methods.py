...
from mastapy._private.gears.gear_designs.conical import _1206
...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ConicalManufactureMethods]",
    ) -> "_1206.ConicalManufactureMethods":
        ...
        Returns:
            _1206.ConicalManufactureMethods
        """
        return _1206.ConicalManufactureMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1206.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1206.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_1206.ConicalManufactureMethods]":
