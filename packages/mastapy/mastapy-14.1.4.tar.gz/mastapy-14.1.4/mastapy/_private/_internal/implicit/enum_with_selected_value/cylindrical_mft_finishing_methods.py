...
class EnumWithSelectedValue_CylindricalMftFinishingMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalMftFinishingMethods]",
    ) -> "_654.CylindricalMftFinishingMethods":
        ...
        Returns:
            _654.CylindricalMftFinishingMethods
        """
        return _654.CylindricalMftFinishingMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _654.CylindricalMftFinishingMethods.type_()

    @property
    def selected_value(self: "Self") -> "_654.CylindricalMftFinishingMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_654.CylindricalMftFinishingMethods]":
