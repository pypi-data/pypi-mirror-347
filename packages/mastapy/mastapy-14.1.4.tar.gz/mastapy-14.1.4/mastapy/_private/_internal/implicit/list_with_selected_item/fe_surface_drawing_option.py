...
from mastapy._private.nodal_analysis.dev_tools_analyses import _216
...
class ListWithSelectedItem_FESurfaceDrawingOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _216.FESurfaceDrawingOption
        """
        return _216.FESurfaceDrawingOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _216.FESurfaceDrawingOption.type_()
