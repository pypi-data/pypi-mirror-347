...
class Overridable_HelicalGearMicroGeometryOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _529.HelicalGearMicroGeometryOption
        """
        return _529.HelicalGearMicroGeometryOption
    ...
    def implicit_type(cls: "Type[Overridable_HelicalGearMicroGeometryOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _529.HelicalGearMicroGeometryOption.type_()

    @property
    def value(self: "Self") -> "_529.HelicalGearMicroGeometryOption":
    ...
    @property
    def override_value(self: "Self") -> "_529.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
    ...
    @property
    def calculated_value(self: "Self") -> "_529.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
