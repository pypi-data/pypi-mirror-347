...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod]",
    ) -> "_2280.PowerLoadInputTorqueSpecificationMethod":
        ...
        Returns:
            _2280.PowerLoadInputTorqueSpecificationMethod
        """
        return _2280.PowerLoadInputTorqueSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2280.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2280.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2280.PowerLoadInputTorqueSpecificationMethod]":
