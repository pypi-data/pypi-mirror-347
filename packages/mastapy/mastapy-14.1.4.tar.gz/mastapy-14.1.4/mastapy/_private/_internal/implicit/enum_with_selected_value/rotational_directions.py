...
class EnumWithSelectedValue_RotationalDirections(
    ...
    def wrapped_type(
        ...
        Returns:
            _1958.RotationalDirections
        """
        return _1958.RotationalDirections
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RotationalDirections]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1958.RotationalDirections.type_()

    @property
    def selected_value(self: "Self") -> "_1958.RotationalDirections":
    ...
    @property
    def available_values(self: "Self") -> "List[_1958.RotationalDirections]":
