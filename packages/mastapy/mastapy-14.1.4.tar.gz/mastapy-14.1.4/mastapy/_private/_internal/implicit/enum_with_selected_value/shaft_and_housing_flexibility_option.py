...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftAndHousingFlexibilityOption]",
    ) -> "_5600.ShaftAndHousingFlexibilityOption":
        ...
        Returns:
            _5600.ShaftAndHousingFlexibilityOption
        """
        return _5600.ShaftAndHousingFlexibilityOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5600.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: "Self") -> "_5600.ShaftAndHousingFlexibilityOption":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5600.ShaftAndHousingFlexibilityOption]":
