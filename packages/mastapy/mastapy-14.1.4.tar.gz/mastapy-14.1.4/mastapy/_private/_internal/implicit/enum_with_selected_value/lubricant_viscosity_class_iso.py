...
class EnumWithSelectedValue_LubricantViscosityClassISO(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LubricantViscosityClassISO]",
    ) -> "_284.LubricantViscosityClassISO":
        ...
        Returns:
            _284.LubricantViscosityClassISO
        """
        return _284.LubricantViscosityClassISO
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _284.LubricantViscosityClassISO.type_()

    @property
    def selected_value(self: "Self") -> "_284.LubricantViscosityClassISO":
    ...
    @property
    def available_values(self: "Self") -> "List[_284.LubricantViscosityClassISO]":
