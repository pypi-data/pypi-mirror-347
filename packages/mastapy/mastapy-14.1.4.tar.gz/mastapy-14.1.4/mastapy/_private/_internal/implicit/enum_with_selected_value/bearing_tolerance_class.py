...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1964.BearingToleranceClass
        """
        return _1964.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1964.BearingToleranceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1964.BearingToleranceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1964.BearingToleranceClass]":
