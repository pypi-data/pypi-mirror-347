...
class Overridable_GearMeshEfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: "Self") -> "_378.GearMeshEfficiencyRatingMethod":
    ...
    @property
    def override_value(self: "Self") -> "_378.GearMeshEfficiencyRatingMethod":
        """mastapy.gears.rating.GearMeshEfficiencyRatingMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_378.GearMeshEfficiencyRatingMethod":
        """mastapy.gears.rating.GearMeshEfficiencyRatingMethod
