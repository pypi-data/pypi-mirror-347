...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    def wrapped_type(
        ...
        Returns:
            _1217.LoadDistributionFactorMethods
        """
        return _1217.LoadDistributionFactorMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1217.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1217.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_1217.LoadDistributionFactorMethods]":
