...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod]",
    ) -> "_1932.BasicStaticLoadRatingCalculationMethod":
        ...
        Returns:
            _1932.BasicStaticLoadRatingCalculationMethod
        """
        return _1932.BasicStaticLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1932.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1932.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1932.BasicStaticLoadRatingCalculationMethod]":
