...
class EnumWithSelectedValue_OilSealLossCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_OilSealLossCalculationMethod]",
    ) -> "_318.OilSealLossCalculationMethod":
        ...
        Returns:
            _318.OilSealLossCalculationMethod
        """
        return _318.OilSealLossCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _318.OilSealLossCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_318.OilSealLossCalculationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_318.OilSealLossCalculationMethod]":
