...
class EnumWithSelectedValue_LoadCaseOverrideOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1646.LoadCaseOverrideOption
        """
        return _1646.LoadCaseOverrideOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1646.LoadCaseOverrideOption.type_()

    @property
    def selected_value(self: "Self") -> "_1646.LoadCaseOverrideOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1646.LoadCaseOverrideOption]":
