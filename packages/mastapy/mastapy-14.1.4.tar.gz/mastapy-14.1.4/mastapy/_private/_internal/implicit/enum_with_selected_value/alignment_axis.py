...
class EnumWithSelectedValue_AlignmentAxis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_AlignmentAxis]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1549.AlignmentAxis.type_()

    @property
    def selected_value(self: "Self") -> "_1549.AlignmentAxis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1549.AlignmentAxis]":
