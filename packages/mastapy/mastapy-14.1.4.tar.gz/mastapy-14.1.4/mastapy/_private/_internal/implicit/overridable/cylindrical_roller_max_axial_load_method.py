...
class Overridable_CylindricalRollerMaxAxialLoadMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2004.CylindricalRollerMaxAxialLoadMethod
        """
        return _2004.CylindricalRollerMaxAxialLoadMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2004.CylindricalRollerMaxAxialLoadMethod.type_()

    @property
    def value(self: "Self") -> "_2004.CylindricalRollerMaxAxialLoadMethod":
    ...
    @property
    def override_value(self: "Self") -> "_2004.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_2004.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
