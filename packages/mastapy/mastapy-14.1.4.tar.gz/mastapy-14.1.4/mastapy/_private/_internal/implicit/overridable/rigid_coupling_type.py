...
class Overridable_RigidCouplingType(mixins.OverridableMixin, Enum):
    ...
    def implicit_type(cls: "Type[Overridable_RigidCouplingType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _221.RigidCouplingType.type_()

    @property
    def value(self: "Self") -> "_221.RigidCouplingType":
    ...
    @property
    def override_value(self: "Self") -> "_221.RigidCouplingType":
        """mastapy.nodal_analysis.dev_tools_analyses.RigidCouplingType
    ...
    @property
    def calculated_value(self: "Self") -> "_221.RigidCouplingType":
        """mastapy.nodal_analysis.dev_tools_analyses.RigidCouplingType
