...
class ListWithSelectedItem_MeasurementBase(
    _1663.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_MeasurementBase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1663.MeasurementBase.TYPE

    @property
    def selected_value(self: "Self") -> "_1663.MeasurementBase":
    ...
    @property
    def available_values(self: "Self") -> "List[_1663.MeasurementBase]":
