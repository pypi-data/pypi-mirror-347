...
from mastapy._private.detailed_rigid_connectors.splines import _1476
...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1476.SplineRatingTypes
        """
        return _1476.SplineRatingTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineRatingTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1476.SplineRatingTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1476.SplineRatingTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1476.SplineRatingTypes]":
