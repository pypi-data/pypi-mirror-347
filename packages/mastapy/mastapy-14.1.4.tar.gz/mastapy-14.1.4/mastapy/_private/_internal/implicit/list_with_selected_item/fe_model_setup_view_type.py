...
from mastapy._private.nodal_analysis.dev_tools_analyses import _209
...
class ListWithSelectedItem_FEModelSetupViewType(mixins.ListWithSelectedItemMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _209.FEModelSetupViewType
        """
        return _209.FEModelSetupViewType
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FEModelSetupViewType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _209.FEModelSetupViewType.type_()
