...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1291.MaterialPropertyClass
        """
        return _1291.MaterialPropertyClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1291.MaterialPropertyClass.type_()

    @property
    def selected_value(self: "Self") -> "_1291.MaterialPropertyClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1291.MaterialPropertyClass]":
