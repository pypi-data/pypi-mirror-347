...
class EnumWithSelectedValue_ElmerResultType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ElmerResultType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _189.ElmerResultType.type_()

    @property
    def selected_value(self: "Self") -> "_189.ElmerResultType":
    ...
    @property
    def available_values(self: "Self") -> "List[_189.ElmerResultType]":
