...
class EnumWithSelectedValue_ShearAreaFactorMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _134.ShearAreaFactorMethod
        """
        return _134.ShearAreaFactorMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _134.ShearAreaFactorMethod.type_()

    @property
    def selected_value(self: "Self") -> "_134.ShearAreaFactorMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_134.ShearAreaFactorMethod]":
