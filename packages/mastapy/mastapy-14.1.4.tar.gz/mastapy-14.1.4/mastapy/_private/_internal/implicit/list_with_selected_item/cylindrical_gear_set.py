...
class ListWithSelectedItem_CylindricalGearSet(
    _2595.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2595.CylindricalGearSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2595.CylindricalGearSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2595.CylindricalGearSet]":
