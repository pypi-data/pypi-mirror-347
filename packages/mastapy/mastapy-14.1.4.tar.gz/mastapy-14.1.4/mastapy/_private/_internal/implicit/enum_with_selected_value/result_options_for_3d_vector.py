...
class EnumWithSelectedValue_ResultOptionsFor3DVector(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ResultOptionsFor3DVector]",
    ) -> "_1585.ResultOptionsFor3DVector":
        ...
        Returns:
            _1585.ResultOptionsFor3DVector
        """
        return _1585.ResultOptionsFor3DVector
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1585.ResultOptionsFor3DVector.type_()

    @property
    def selected_value(self: "Self") -> "_1585.ResultOptionsFor3DVector":
    ...
    @property
    def available_values(self: "Self") -> "List[_1585.ResultOptionsFor3DVector]":
