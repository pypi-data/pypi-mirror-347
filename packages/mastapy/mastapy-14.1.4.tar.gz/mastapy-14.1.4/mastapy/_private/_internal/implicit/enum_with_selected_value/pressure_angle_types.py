...
from mastapy._private.detailed_rigid_connectors.splines import _1463
...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1463.PressureAngleTypes
        """
        return _1463.PressureAngleTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PressureAngleTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1463.PressureAngleTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1463.PressureAngleTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1463.PressureAngleTypes]":
