...
from mastapy._private.bearings.bearing_results.rolling import _2131
...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2131.RollerAnalysisMethod
        """
        return _2131.RollerAnalysisMethod
    ...
    def implicit_type(cls: "Type[Overridable_RollerAnalysisMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2131.RollerAnalysisMethod.type_()

    @property
    def value(self: "Self") -> "_2131.RollerAnalysisMethod":
    ...
    @property
    def override_value(self: "Self") -> "_2131.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_2131.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
