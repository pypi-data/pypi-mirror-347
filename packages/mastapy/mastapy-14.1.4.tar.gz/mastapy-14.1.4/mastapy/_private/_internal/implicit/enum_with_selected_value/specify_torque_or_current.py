...
from mastapy._private.electric_machines.load_cases_and_analyses import _1430
...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    def wrapped_type(
        ...
        Returns:
            _1430.SpecifyTorqueOrCurrent
        """
        return _1430.SpecifyTorqueOrCurrent
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1430.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: "Self") -> "_1430.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: "Self") -> "List[_1430.SpecifyTorqueOrCurrent]":
