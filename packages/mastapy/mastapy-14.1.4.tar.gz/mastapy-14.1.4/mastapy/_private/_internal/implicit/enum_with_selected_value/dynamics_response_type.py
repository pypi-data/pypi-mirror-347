...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    def wrapped_type(
        ...
        Returns:
            _4728.DynamicsResponseType
        """
        return _4728.DynamicsResponseType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DynamicsResponseType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _4728.DynamicsResponseType.type_()

    @property
    def selected_value(self: "Self") -> "_4728.DynamicsResponseType":
    ...
    @property
    def available_values(self: "Self") -> "List[_4728.DynamicsResponseType]":
