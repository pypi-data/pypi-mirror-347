...
from mastapy._private.detailed_rigid_connectors.splines import _1477
...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_SplineToleranceClassTypes]",
    ) -> "_1477.SplineToleranceClassTypes":
        ...
        Returns:
            _1477.SplineToleranceClassTypes
        """
        return _1477.SplineToleranceClassTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1477.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1477.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1477.SplineToleranceClassTypes]":
