...
class _Cast_ChartDefinition:
    ...
    @property
    def simple_chart_definition(self: "CastSelf") -> "_1845.SimpleChartDefinition":
        from mastapy._private.utility.report import _1845

        return self.__parent__._cast(_1845.SimpleChartDefinition)
    ...
    def legacy_chart_math_chart_definition(
        self: "CastSelf",
    ) -> "_1917.LegacyChartMathChartDefinition":
        from mastapy._private.utility_gui.charts import _1917

        return self.__parent__._cast(_1917.LegacyChartMathChartDefinition)
