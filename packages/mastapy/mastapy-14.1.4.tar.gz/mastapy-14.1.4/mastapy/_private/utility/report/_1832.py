...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1803, _1816, _1837, _1842, _1843, _1846
    from mastapy._private.utility.reporting_property_framework import _1847
...
class _Cast_CustomReportPropertyItem:
    ...
    @property
    def blank_row(self: "CastSelf") -> "_1803.BlankRow":
        from mastapy._private.utility.report import _1803

        return self.__parent__._cast(_1803.BlankRow)

    @property
    def custom_report_chart_item(self: "CastSelf") -> "_1816.CustomReportChartItem":
        from mastapy._private.utility.report import _1816

        return self.__parent__._cast(_1816.CustomReportChartItem)

    @property
    def custom_row(self: "CastSelf") -> "_1837.CustomRow":
        from mastapy._private.utility.report import _1837

        return self.__parent__._cast(_1837.CustomRow)

    @property
    def user_text_row(self: "CastSelf") -> "_1846.UserTextRow":
        from mastapy._private.utility.report import _1846

        return self.__parent__._cast(_1846.UserTextRow)
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_style(self: "Self") -> "_1842.FontStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1842", "FontStyle"
        )(value)

    @font_style.setter
    @enforce_parameter_types
    def font_style(self: "Self", value: "_1842.FontStyle") -> None:
    ...
    @property
    def font_weight(self: "Self") -> "_1843.FontWeight":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1843", "FontWeight"
        )(value)

    @font_weight.setter
    @enforce_parameter_types
    def font_weight(self: "Self", value: "_1843.FontWeight") -> None:
    ...
    @property
    def horizontal_position(self: "Self") -> "_1847.CellValuePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.reporting_property_framework._1847",
            "CellValuePosition",
        )(value)

    @horizontal_position.setter
    @enforce_parameter_types
    def horizontal_position(self: "Self", value: "_1847.CellValuePosition") -> None:
        value = conversion.mp_to_pn_enum(
