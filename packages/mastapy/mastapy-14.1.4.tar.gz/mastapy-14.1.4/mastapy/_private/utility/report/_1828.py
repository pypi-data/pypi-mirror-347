...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1815, _1822, _1830, _1832, _1839
...
TItem = TypeVar("TItem", bound="_1832.CustomReportPropertyItem")
...
class CustomReportMultiPropertyItem(
    _1829.CustomReportMultiPropertyItemBase, Generic[TItem]
):
    """CustomReportMultiPropertyItem
