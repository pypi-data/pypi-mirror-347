...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.scripting import _1799
...
class _Cast_DatabaseKey:
    ...
    @property
    def user_defined_property_key(self: "CastSelf") -> "_1799.UserDefinedPropertyKey":
        from mastapy._private.utility.scripting import _1799

        return self.__parent__._cast(_1799.UserDefinedPropertyKey)

    @property
    def custom_report_key(self: "CastSelf") -> "_1827.CustomReportKey":
        from mastapy._private.utility.report import _1827

        return self.__parent__._cast(_1827.CustomReportKey)

    @property
    def named_key(self: "CastSelf") -> "_1891.NamedKey":
        from mastapy._private.utility.databases import _1891

        return self.__parent__._cast(_1891.NamedKey)

    @property
    def rolling_bearing_key(self: "CastSelf") -> "_1955.RollingBearingKey":
        from mastapy._private.bearings import _1955

        return self.__parent__._cast(_1955.RollingBearingKey)
