...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1637, _1650
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: "Self") -> "_1650.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: "Self") -> "List[_1637.DispatcherHelper]":
