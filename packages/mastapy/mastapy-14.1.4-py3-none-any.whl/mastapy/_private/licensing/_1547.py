...
if TYPE_CHECKING:
    ...
    from mastapy._private.licensing import _7731, _7732, _7733
...
class LicenceServer:
    ...
    @staticmethod
    @enforce_parameter_types
    def update_server_settings(server_details: "_7731.LicenceServerDetails") -> None:
    ...
    @staticmethod
    def get_server_settings() -> "_7731.LicenceServerDetails":
    ...
    @staticmethod
    def get_licensed_module_details() -> "Iterable[_7732.ModuleDetails]":
    ...
    @staticmethod
    def get_available_module_details() -> "Iterable[_7732.ModuleDetails]":
        """Iterable[mastapy.licensing.ModuleDetails]"""
        return conversion.pn_to_mp_objects_in_iterable(
    ...
    @staticmethod
    def get_requested_module_statuses() -> "Iterable[_7733.ModuleLicenceStatus]":
