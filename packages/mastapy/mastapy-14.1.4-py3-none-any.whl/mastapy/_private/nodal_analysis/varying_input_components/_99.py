...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    @property
    def value_vs_angle(self: "Self") -> "_1592.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def value_vs_angle(self: "Self", value: "_1592.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ValueVsAngle", value.wrapped)

    @property
    def value_vs_angle_and_speed(self: "Self") -> "_1622.GriddedSurfaceAccessor":
    ...
    @property
    def value_vs_position(self: "Self") -> "_1592.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_position(self: "Self", value: "_1592.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ValueVsPosition", value.wrapped)

    @property
    def value_vs_time(self: "Self") -> "_1592.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_time(self: "Self", value: "_1592.Vector2DListAccessor") -> None:
