...
class _Cast_MethodOutcomeWithResult:
    ...
    @property
    def method_outcome(self: "CastSelf") -> "_1647.MethodOutcome":
        return self.__parent__._cast(_1647.MethodOutcome)
...
class MethodOutcomeWithResult(_1647.MethodOutcome, Generic[T]):
    """MethodOutcomeWithResult
