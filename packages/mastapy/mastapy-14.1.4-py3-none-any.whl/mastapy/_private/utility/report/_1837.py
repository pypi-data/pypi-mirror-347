...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1803, _1846
...
class _Cast_CustomRow:
    ...
    def custom_report_property_item(
        self: "CastSelf",
    ) -> "_1832.CustomReportPropertyItem":
        return self.__parent__._cast(_1832.CustomReportPropertyItem)
...
class CustomRow(_1832.CustomReportPropertyItem):
    """CustomRow
