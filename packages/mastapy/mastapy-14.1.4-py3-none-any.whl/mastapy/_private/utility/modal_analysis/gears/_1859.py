...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _1860, _1863
...
class GearOrderForTE(_1865.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self: "Self") -> "_1860.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.modal_analysis.gears._1860", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: "Self") -> "List[_1863.OrderForTE]":
