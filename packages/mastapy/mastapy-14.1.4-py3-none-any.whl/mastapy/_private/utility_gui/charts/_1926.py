...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1802, _1807
...
class ThreeDChartDefinition(_1920.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self: "Self") -> "_1802.AxisSettings":
    ...
    def data_points_for_surfaces(self: "Self") -> "List[_1922.PointsForSurface]":
