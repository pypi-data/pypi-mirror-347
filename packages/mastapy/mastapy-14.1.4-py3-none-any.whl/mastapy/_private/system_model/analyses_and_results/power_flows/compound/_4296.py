...
class ConnectionCompoundPowerFlow(_7698.ConnectionCompoundAnalysis):
    """ConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4159.ConnectionPowerFlow]":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4159.ConnectionPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConnectionPowerFlow]
