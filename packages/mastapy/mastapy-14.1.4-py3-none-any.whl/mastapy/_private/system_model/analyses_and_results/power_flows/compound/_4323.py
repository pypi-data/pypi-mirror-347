...
class HypoidGearCompoundPowerFlow(_4265.AGMAGleasonConicalGearCompoundPowerFlow):
    """HypoidGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4190.HypoidGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4190.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
