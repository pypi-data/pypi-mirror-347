...
class MicrophoneArrayCompoundPowerFlow(_4361.SpecialisedAssemblyCompoundPowerFlow):
    """MicrophoneArrayCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4204.MicrophoneArrayPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4204.MicrophoneArrayPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MicrophoneArrayPowerFlow]
