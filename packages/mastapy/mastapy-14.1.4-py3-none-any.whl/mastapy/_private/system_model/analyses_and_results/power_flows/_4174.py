...
class CylindricalGearSetPowerFlow(_4187.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4173.CylindricalGearPowerFlow]":
    ...
    def cylindrical_gears_power_flow(
        self: "Self",
    ) -> "List[_4173.CylindricalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4172.CylindricalGearMeshPowerFlow]":
    ...
    def cylindrical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4172.CylindricalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearMeshPowerFlow]
