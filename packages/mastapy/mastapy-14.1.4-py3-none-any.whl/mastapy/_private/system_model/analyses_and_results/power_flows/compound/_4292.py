...
class ConceptGearSetCompoundPowerFlow(_4321.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4155.ConceptGearSetPowerFlow]":
    ...
    def concept_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4290.ConceptGearCompoundPowerFlow]":
    ...
    def concept_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4291.ConceptGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4155.ConceptGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearSetPowerFlow]
