...
class ConceptGearSetPowerFlow(_4187.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4154.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: "Self") -> "List[_4154.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4153.ConceptGearMeshPowerFlow]":
    ...
    def concept_meshes_power_flow(
        self: "Self",
    ) -> "List[_4153.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]
