...
class UnbalancedMassCompoundPowerFlow(_4385.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4253.UnbalancedMassPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4253.UnbalancedMassPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.UnbalancedMassPowerFlow]
