...
class CycloidalDiscCompoundPowerFlow(_4262.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4170.CycloidalDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4170.CycloidalDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalDiscPowerFlow]
