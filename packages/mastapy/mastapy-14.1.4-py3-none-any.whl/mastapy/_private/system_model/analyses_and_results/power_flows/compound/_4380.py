...
class TorqueConverterCompoundPowerFlow(_4298.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2684.TorqueConverter":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4250.TorqueConverterPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4250.TorqueConverterPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.TorqueConverterPowerFlow]
