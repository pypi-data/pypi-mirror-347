...
class RollingRingCompoundPowerFlow(_4300.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4224.RollingRingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4224.RollingRingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RollingRingPowerFlow]
