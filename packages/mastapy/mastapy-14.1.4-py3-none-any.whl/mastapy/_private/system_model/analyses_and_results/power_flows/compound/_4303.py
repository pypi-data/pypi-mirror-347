...
class CVTPulleyCompoundPowerFlow(_4351.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4166.CVTPulleyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPulleyPowerFlow]
