...
class CouplingCompoundPowerFlow(_4361.SpecialisedAssemblyCompoundPowerFlow):
    """CouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4163.CouplingPowerFlow]":
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4163.CouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CouplingPowerFlow]
