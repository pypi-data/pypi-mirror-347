...
class ConnectorCompoundPowerFlow(_4340.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4160.ConnectorPowerFlow]":
