...
class ComponentCompoundPowerFlow(_4342.PartCompoundPowerFlow):
    """ComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4149.ComponentPowerFlow]":
