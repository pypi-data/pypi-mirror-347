...
class DatumCompoundPowerFlow(_4286.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4176.DatumPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4176.DatumPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.DatumPowerFlow]
