...
class MicrophoneCompoundPowerFlow(_4286.ComponentCompoundPowerFlow):
    """MicrophoneCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4205.MicrophonePowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4205.MicrophonePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MicrophonePowerFlow]
