...
class CVTCompoundPowerFlow(_4271.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4165.CVTPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4165.CVTPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPowerFlow]
