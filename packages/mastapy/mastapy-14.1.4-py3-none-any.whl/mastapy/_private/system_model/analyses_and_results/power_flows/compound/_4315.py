...
class FaceGearMeshCompoundPowerFlow(_4320.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4178.FaceGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4178.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
