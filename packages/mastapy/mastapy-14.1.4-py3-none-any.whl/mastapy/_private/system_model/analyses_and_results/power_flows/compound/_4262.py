...
class AbstractShaftCompoundPowerFlow(_4263.AbstractShaftOrHousingCompoundPowerFlow):
    """AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4126.AbstractShaftPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4126.AbstractShaftPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AbstractShaftPowerFlow]
