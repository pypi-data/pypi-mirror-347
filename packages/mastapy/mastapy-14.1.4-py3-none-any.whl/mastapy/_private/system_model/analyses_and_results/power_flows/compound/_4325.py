...
class HypoidGearSetCompoundPowerFlow(_4267.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2604.HypoidGearSet":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4191.HypoidGearSetPowerFlow]":
    ...
    def hypoid_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4323.HypoidGearCompoundPowerFlow]":
    ...
    def hypoid_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4324.HypoidGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4191.HypoidGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearSetPowerFlow]
