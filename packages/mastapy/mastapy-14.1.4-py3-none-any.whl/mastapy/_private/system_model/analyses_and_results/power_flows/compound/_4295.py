...
class ConicalGearSetCompoundPowerFlow(_4321.GearSetCompoundPowerFlow):
    """ConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4158.ConicalGearSetPowerFlow]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4158.ConicalGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearSetPowerFlow]
