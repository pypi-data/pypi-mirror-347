...
T = TypeVar("T", bound="_7490.LoadCase")
...
class _Cast_AbstractAnalysisOptions:
    ...
    @property
    def system_deflection_options(self: "CastSelf") -> "_2901.SystemDeflectionOptions":
        from mastapy._private.system_model.analyses_and_results.system_deflections import (
            _2901,
        )

        return self.__parent__._cast(_2901.SystemDeflectionOptions)
    ...
    def frequency_response_analysis_options(
        ...
        return self.__parent__._cast(_4735.FrequencyResponseAnalysisOptions)

    @property
    def mbd_run_up_analysis_options(
        self: "CastSelf",
    ) -> "_5576.MBDRunUpAnalysisOptions":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses import (
            _5576,
        )

        return self.__parent__._cast(_5576.MBDRunUpAnalysisOptions)
    ...
    def frequency_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5873.FrequencyOptionsForHarmonicAnalysisResults)
    ...
    def speed_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5934.SpeedOptionsForHarmonicAnalysisResults)

    @property
    def stiffness_options_for_harmonic_analysis(
        self: "CastSelf",
    ) -> "_5941.StiffnessOptionsForHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5941,
        )

        return self.__parent__._cast(_5941.StiffnessOptionsForHarmonicAnalysis)
