...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    def advanced_time_stepping_analysis_method(
        self: "Self",
    ) -> "_7498.AdvancedTimeSteppingAnalysisForModulationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7498",
    ...
    def advanced_time_stepping_analysis_method(
        self: "Self", value: "_7498.AdvancedTimeSteppingAnalysisForModulationType"
    ) -> None:
    ...
    @property
    def time_options(self: "Self") -> "_2756.TimeOptions":
