...
class _Cast_HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation:
    ...
    @property
    def harmonic_analysis_options(self: "CastSelf") -> "_5887.HarmonicAnalysisOptions":
        return self.__parent__._cast(_5887.HarmonicAnalysisOptions)
