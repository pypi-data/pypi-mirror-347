...
class ConicalGearSetModalAnalysisAtASpeed(_5286.GearSetModalAnalysisAtASpeed):
    """ConicalGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5259.ConicalGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5258.ConicalGearMeshModalAnalysisAtASpeed]":
