...
class CVTCompoundModalAnalysisAtASpeed(_5368.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5267.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_5267.CVTModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.CVTModalAnalysisAtASpeed]
