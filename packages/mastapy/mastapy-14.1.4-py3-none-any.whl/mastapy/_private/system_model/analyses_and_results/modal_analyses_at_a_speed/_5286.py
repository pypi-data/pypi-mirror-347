...
class GearSetModalAnalysisAtASpeed(_5327.SpecialisedAssemblyModalAnalysisAtASpeed):
    """GearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5285.GearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5284.GearMeshModalAnalysisAtASpeed]":
