...
class CycloidalDiscSystemDeflection(_2759.AbstractShaftSystemDeflection):
    """CycloidalDiscSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7545.CycloidalDiscLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4170.CycloidalDiscPowerFlow":
