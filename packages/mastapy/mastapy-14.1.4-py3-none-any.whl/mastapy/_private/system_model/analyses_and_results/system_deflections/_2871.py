...
class RollingRingAssemblySystemDeflection(_2880.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7633.RollingRingAssemblyLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4222.RollingRingAssemblyPowerFlow":
