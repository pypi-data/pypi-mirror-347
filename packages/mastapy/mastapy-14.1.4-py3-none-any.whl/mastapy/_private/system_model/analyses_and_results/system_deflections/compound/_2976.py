...
class DatumCompoundSystemDeflection(_2950.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2823.DatumSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2823.DatumSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.DatumSystemDeflection]
