...
class BevelGearSetSystemDeflection(_2762.AGMAGleasonConicalGearSetSystemDeflection):
    """BevelGearSetSystemDeflection
    ...
    def agma_gleason_conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_2780.BevelGearSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4142.BevelGearSetPowerFlow":
