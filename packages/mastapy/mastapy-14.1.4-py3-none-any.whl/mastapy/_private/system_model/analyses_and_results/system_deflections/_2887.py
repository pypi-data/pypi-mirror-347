...
class StraightBevelDiffGearMeshSystemDeflection(_2778.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4236.StraightBevelDiffGearMeshPowerFlow":
