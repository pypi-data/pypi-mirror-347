...
class SpringDamperConnectionSystemDeflection(_2801.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4233.SpringDamperConnectionPowerFlow":
