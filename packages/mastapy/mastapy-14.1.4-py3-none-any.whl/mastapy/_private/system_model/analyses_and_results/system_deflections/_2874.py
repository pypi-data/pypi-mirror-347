...
class RootAssemblySystemDeflection(_2764.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4225.RootAssemblyPowerFlow":
    ...
    @property
    def system_deflection_inputs(self: "Self") -> "_2899.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: "Self",
    ) -> "List[_2788.ConcentricPartGroupCombinationSystemDeflectionResults]":
