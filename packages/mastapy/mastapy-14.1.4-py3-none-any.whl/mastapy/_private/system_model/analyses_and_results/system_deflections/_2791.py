...
class ConceptCouplingSystemDeflection(_2803.CouplingSystemDeflection):
    """ConceptCouplingSystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7526.ConceptCouplingLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4152.ConceptCouplingPowerFlow":
