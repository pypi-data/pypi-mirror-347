...
class AssemblySystemDeflection(_2757.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4131.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: "Self") -> "List[_2770.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_2772.BeltDriveSystemDeflection]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2781.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_2782.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_2806.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_2785.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2787.ComponentSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_2793.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: "Self") -> "List[_2799.ConnectionSystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_2810.CycloidalDiscSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2829.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2827.FaceGearSetSystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2836.HypoidGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_2851.MassDiscSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2855.MicrophoneSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2858.OilSealSystemDeflection]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_2864.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2865.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2866.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_2868.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: "Self") -> "List[_2770.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    @property
    def shafts(self: "Self") -> "List[_2878.ShaftSystemDeflection]":
    ...
    def shafts_and_housings(
        self: "Self",
    ) -> "List[_2758.AbstractShaftOrHousingSystemDeflection]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_2886.SpringDamperSystemDeflection]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_2898.SynchroniserSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_2908.UnbalancedMassSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2911.WormGearSetSystemDeflection]":
