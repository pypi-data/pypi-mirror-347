...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2832
...
class WormGearSetSystemDeflection(_2832.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4257.WormGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_2912.WormGearSystemDeflection]":
    ...
    def worm_gears_system_deflection(
        self: "Self",
    ) -> "List[_2912.WormGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
