...
class CVTPulleySystemDeflection(_2867.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4166.CVTPulleyPowerFlow":
    ...
    @property
    def fixed_sheave_contact_results(self: "Self") -> "List[_1619.NodeResults]":
    ...
    @property
    def moving_sheave_contact_results(self: "Self") -> "List[_1619.NodeResults]":
        """List[mastapy.math_utility.measured_vectors.NodeResults]
