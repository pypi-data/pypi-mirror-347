...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2889
...
class StraightBevelSunGearSystemDeflection(_2889.StraightBevelDiffGearSystemDeflection):
    """StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4243.StraightBevelSunGearPowerFlow":
