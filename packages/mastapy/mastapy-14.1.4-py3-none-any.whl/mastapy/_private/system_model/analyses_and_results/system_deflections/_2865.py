...
class PointLoadSystemDeflection(_2909.VirtualComponentSystemDeflection):
    """PointLoadSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7626.PointLoadLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4215.PointLoadPowerFlow":
