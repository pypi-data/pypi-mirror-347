...
class ConicalGearSetSystemDeflection(_2832.GearSetSystemDeflection):
    """ConicalGearSetSystemDeflection
    ...
    def gears_system_deflection(
        self: "Self",
    ) -> "List[_2798.ConicalGearSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4158.ConicalGearSetPowerFlow":
