...
class SystemDeflection(_7703.FEAnalysis):
    """SystemDeflection
    ...
    @property
    def analysis_options(self: "Self") -> "_2901.SystemDeflectionOptions":
    ...
    def overall_efficiency_results(
        self: "Self",
    ) -> "_2849.LoadCaseOverallEfficiencyResult":
