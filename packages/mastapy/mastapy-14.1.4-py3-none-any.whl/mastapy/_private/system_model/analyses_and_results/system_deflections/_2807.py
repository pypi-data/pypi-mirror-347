...
class CycloidalAssemblySystemDeflection(_2880.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def assembly_design(self: "Self") -> "_2637.CycloidalAssembly":
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7543.CycloidalAssemblyLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4167.CycloidalAssemblyPowerFlow":
