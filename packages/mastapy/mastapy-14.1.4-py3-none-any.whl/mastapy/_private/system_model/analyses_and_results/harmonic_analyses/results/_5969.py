...
class _Cast_ExcitationSourceSelectionBase:
    ...
    def excitation_source_selection(
        self: "CastSelf",
    ) -> "_5968.ExcitationSourceSelection":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _5968,
        )

        return self.__parent__._cast(_5968.ExcitationSourceSelection)

    @property
    def excitation_source_selection_group(
        self: "CastSelf",
    ) -> "_5970.ExcitationSourceSelectionGroup":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _5970,
        )

        return self.__parent__._cast(_5970.ExcitationSourceSelectionGroup)
