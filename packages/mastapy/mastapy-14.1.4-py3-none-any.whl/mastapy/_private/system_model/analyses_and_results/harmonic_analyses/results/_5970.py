...
class _Cast_ExcitationSourceSelectionGroup:
    ...
    def excitation_source_selection_base(
        self: "CastSelf",
    ) -> "_5969.ExcitationSourceSelectionBase":
        return self.__parent__._cast(_5969.ExcitationSourceSelectionBase)
...
class ExcitationSourceSelectionGroup(_5969.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self: "Self") -> "List[_5969.ExcitationSourceSelectionBase]":
    ...
    def include_only_harmonics_with_order(
        self: "Self", order: "_1587.RoundedOrder"
    ) -> None:
