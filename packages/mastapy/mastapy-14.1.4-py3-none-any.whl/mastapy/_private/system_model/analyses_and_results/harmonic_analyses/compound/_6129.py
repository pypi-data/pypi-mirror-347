...
class WormGearSetCompoundHarmonicAnalysis(_6062.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5963.WormGearSetHarmonicAnalysis]":
    ...
    def worm_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6127.WormGearCompoundHarmonicAnalysis]":
    ...
    def worm_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6128.WormGearMeshCompoundHarmonicAnalysis]":
