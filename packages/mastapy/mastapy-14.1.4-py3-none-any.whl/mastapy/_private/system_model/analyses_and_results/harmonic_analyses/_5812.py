...
class BevelDifferentialGearSetHarmonicAnalysis(_5817.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5810.BevelDifferentialGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5811.BevelDifferentialGearMeshHarmonicAnalysis]":
