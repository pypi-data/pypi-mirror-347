...
class BearingCompoundHarmonicAnalysis(_6038.ConnectorCompoundHarmonicAnalysis):
    """BearingCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5807.BearingHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5807.BearingHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.BearingHarmonicAnalysis]
