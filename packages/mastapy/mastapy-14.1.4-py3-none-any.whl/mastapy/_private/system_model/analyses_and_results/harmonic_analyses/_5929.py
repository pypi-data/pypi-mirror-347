...
class ShaftHarmonicAnalysis(
    _5800.AbstractShaftHarmonicAnalysis, _2728.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4782.ShaftModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5889.HarmonicAnalysisShaftExportOptions":
