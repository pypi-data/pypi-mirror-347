...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7591
...
class HypoidGearHarmonicAnalysis(_5803.AGMAGleasonConicalGearHarmonicAnalysis):
    """HypoidGearHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7591.HypoidGearLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2837.HypoidGearSystemDeflection":
