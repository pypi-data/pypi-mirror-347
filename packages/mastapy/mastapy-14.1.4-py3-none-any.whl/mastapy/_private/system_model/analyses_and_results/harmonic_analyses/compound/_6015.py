...
class BevelDifferentialGearSetCompoundHarmonicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5812.BevelDifferentialGearSetHarmonicAnalysis]":
    ...
    def bevel_differential_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6013.BevelDifferentialGearCompoundHarmonicAnalysis]":
    ...
    def bevel_differential_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6014.BevelDifferentialGearMeshCompoundHarmonicAnalysis]":
