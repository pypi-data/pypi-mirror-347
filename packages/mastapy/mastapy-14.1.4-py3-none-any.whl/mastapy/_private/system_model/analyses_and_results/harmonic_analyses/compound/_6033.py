...
class ConceptGearSetCompoundHarmonicAnalysis(_6062.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5831.ConceptGearSetHarmonicAnalysis]":
    ...
    def concept_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6031.ConceptGearCompoundHarmonicAnalysis]":
    ...
    def concept_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6032.ConceptGearMeshCompoundHarmonicAnalysis]":
