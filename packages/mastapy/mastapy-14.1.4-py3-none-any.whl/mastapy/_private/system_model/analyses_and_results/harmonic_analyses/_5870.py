...
class FaceGearSetHarmonicAnalysis(_5879.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5868.FaceGearHarmonicAnalysis]":
    ...
    def face_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5868.FaceGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.FaceGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5869.FaceGearMeshHarmonicAnalysis]":
