...
class RootAssemblyHarmonicAnalysis(
    _5806.AssemblyHarmonicAnalysis, _2727.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: "Self") -> "_5888.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: "Self") -> "_5882.HarmonicAnalysis":
