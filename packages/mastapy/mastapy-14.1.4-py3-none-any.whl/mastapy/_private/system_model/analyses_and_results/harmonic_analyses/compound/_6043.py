...
class CVTCompoundHarmonicAnalysis(_6012.BeltDriveCompoundHarmonicAnalysis):
    """CVTCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5841.CVTHarmonicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_5841.CVTHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.CVTHarmonicAnalysis]
