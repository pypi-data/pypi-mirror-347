...
class ConceptGearSetCriticalSpeedAnalysis(_6739.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6705.ConceptGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6706.ConceptGearMeshCriticalSpeedAnalysis]":
