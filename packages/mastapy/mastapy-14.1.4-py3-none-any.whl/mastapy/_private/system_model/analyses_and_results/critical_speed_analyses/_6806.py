...
class WormGearSetCriticalSpeedAnalysis(_6739.GearSetCriticalSpeedAnalysis):
    """WormGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6804.WormGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6805.WormGearMeshCriticalSpeedAnalysis]":
