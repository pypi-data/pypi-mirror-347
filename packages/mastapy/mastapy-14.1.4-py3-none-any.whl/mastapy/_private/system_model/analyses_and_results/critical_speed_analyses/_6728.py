...
class CylindricalGearSetCriticalSpeedAnalysis(_6739.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6726.CylindricalGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6727.CylindricalGearMeshCriticalSpeedAnalysis]":
