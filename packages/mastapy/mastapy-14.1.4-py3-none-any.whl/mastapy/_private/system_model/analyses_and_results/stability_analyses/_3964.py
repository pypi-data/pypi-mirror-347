...
class StraightBevelDiffGearSetStabilityAnalysis(_3868.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3965.StraightBevelDiffGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3963.StraightBevelDiffGearMeshStabilityAnalysis]":
