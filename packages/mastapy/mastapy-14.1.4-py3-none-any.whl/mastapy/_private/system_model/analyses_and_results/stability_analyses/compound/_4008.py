...
class ClutchCompoundStabilityAnalysis(_4024.CouplingCompoundStabilityAnalysis):
    """ClutchCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3874.ClutchStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_3874.ClutchStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.ClutchStabilityAnalysis]
