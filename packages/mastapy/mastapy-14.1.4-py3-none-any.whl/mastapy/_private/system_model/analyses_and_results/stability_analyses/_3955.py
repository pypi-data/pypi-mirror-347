...
class SpiralBevelGearSetStabilityAnalysis(_3868.BevelGearSetStabilityAnalysis):
    """SpiralBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3956.SpiralBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3954.SpiralBevelGearMeshStabilityAnalysis]":
