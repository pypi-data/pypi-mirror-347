...
class PulleyCompoundStabilityAnalysis(_4026.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3943.PulleyStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3943.PulleyStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.PulleyStabilityAnalysis]
