...
class WormGearSetCompoundStabilityAnalysis(_4047.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3982.WormGearSetStabilityAnalysis]":
    ...
    def worm_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4112.WormGearCompoundStabilityAnalysis]":
    ...
    def worm_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4113.WormGearMeshCompoundStabilityAnalysis]":
