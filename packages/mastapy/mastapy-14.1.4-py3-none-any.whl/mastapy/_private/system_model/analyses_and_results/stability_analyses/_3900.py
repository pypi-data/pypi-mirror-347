...
class CylindricalGearSetStabilityAnalysis(_3912.GearSetStabilityAnalysis):
    """CylindricalGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_3901.CylindricalGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3899.CylindricalGearMeshStabilityAnalysis]":
