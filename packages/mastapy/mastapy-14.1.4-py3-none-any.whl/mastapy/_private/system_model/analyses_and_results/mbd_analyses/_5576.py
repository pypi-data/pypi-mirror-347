...
from mastapy._private.system_model.analyses_and_results.analysis_cases import _7695
...
class _Cast_MBDRunUpAnalysisOptions:
    ...
    @property
    def abstract_analysis_options(self: "CastSelf") -> "_7695.AbstractAnalysisOptions":
        return self.__parent__._cast(_7695.AbstractAnalysisOptions)
...
class MBDRunUpAnalysisOptions(_7695.AbstractAnalysisOptions[_7660.TimeSeriesLoadCase]):
    """MBDRunUpAnalysisOptions
    ...
    def input_velocity_processing_type(
        self: "Self",
    ) -> "_5562.InputVelocityForRunUpProcessingType":
    ...
    @enforce_parameter_types
    def input_velocity_processing_type(
        self: "Self", value: "_5562.InputVelocityForRunUpProcessingType"
    ) -> None:
    ...
    @property
    def run_up_driving_mode(self: "Self") -> "_5599.RunUpDrivingMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5599",
            "RunUpDrivingMode",
        )(value)

    @run_up_driving_mode.setter
    @enforce_parameter_types
    def run_up_driving_mode(self: "Self", value: "_5599.RunUpDrivingMode") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    @property
    def run_up_speed_profile(self: "Self") -> "_1928.TwoDChartDefinition":
    ...
    def shape_of_initial_acceleration_period(
        self: "Self",
    ) -> "_5604.ShapeOfInitialAccelerationPeriodForRunUp":
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: "Self", value: "_5604.ShapeOfInitialAccelerationPeriodForRunUp"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",
