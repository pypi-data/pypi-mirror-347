...
class _Cast_AbstractMeasuredDynamicResponseAtTime:
    ...
    def dynamic_force_result_at_time(
        self: "CastSelf",
    ) -> "_5641.DynamicForceResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5641,
        )

        return self.__parent__._cast(_5641.DynamicForceResultAtTime)

    @property
    def dynamic_torque_result_at_time(
        self: "CastSelf",
    ) -> "_5643.DynamicTorqueResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5643,
        )

        return self.__parent__._cast(_5643.DynamicTorqueResultAtTime)
