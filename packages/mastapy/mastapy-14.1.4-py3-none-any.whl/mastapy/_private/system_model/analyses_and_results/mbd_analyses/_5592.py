...
class PulleyMultibodyDynamicsAnalysis(_5531.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self: "Self") -> "List[_5643.DynamicTorqueResultAtTime]":
