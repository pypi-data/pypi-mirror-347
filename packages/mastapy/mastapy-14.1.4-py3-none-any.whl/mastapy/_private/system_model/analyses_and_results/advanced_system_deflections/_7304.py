...
class PowerLoadAdvancedSystemDeflection(_7340.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2866.PowerLoadSystemDeflection]":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_7338.TransmissionErrorToOtherPowerLoad]":
