...
class ConicalGearSetAdvancedSystemDeflection(_7274.GearSetAdvancedSystemDeflection):
    """ConicalGearSetAdvancedSystemDeflection
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7244.ConicalGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7245.ConicalGearMeshAdvancedSystemDeflection]":
