...
class AGMAGleasonConicalGearSetLoadCase(_7534.ConicalGearSetLoadCase):
    """AGMAGleasonConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7499.AGMAGleasonConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7500.AGMAGleasonConicalGearMeshLoadCase]":
