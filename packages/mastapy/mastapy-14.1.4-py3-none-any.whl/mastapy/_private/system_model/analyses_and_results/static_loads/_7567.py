...
from mastapy._private.system_model.analyses_and_results.static_loads import _7566
...
class _Cast_ElectricMachineHarmonicLoadJMAGImportOptions:
    ...
    def electric_machine_harmonic_load_import_options_base(
        self: "CastSelf",
    ) -> "_7566.ElectricMachineHarmonicLoadImportOptionsBase":
        return self.__parent__._cast(_7566.ElectricMachineHarmonicLoadImportOptionsBase)
