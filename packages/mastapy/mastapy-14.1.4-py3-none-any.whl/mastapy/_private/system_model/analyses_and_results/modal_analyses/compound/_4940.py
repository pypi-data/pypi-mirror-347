...
class StraightBevelDiffGearSetCompoundModalAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4794.StraightBevelDiffGearSetModalAnalysis]":
    ...
    def straight_bevel_diff_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4938.StraightBevelDiffGearCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4939.StraightBevelDiffGearMeshCompoundModalAnalysis]":
