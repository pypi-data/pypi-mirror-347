...
class BevelGearSetModalAnalysis(_4679.AGMAGleasonConicalGearSetModalAnalysis):
    """BevelGearSetModalAnalysis
    ...
    def agma_gleason_conical_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4689.BevelGearMeshModalAnalysis]":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2779.BevelGearSetSystemDeflection":
