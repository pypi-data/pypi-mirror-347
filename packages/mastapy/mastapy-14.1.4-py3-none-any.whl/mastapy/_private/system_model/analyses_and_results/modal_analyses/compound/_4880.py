...
class CylindricalGearSetCompoundModalAnalysis(_4891.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4723.CylindricalGearSetModalAnalysis]":
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4878.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4879.CylindricalGearMeshCompoundModalAnalysis]":
