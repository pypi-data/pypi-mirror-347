...
class MassDiscCompoundModalAnalysis(_4955.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4753.MassDiscModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4753.MassDiscModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MassDiscModalAnalysis]
