...
class ConceptGearSetModalAnalysis(_4738.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4703.ConceptGearModalAnalysis]":
    ...
    def concept_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4703.ConceptGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConceptGearModalAnalysis]
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4702.ConceptGearMeshModalAnalysis]":
