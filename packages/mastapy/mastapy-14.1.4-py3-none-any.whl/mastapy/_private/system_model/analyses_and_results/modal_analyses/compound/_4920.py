...
class PowerLoadCompoundModalAnalysis(_4955.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4773.PowerLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4773.PowerLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PowerLoadModalAnalysis]
