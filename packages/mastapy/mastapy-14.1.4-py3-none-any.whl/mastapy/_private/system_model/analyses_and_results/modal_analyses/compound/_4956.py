...
class WormGearCompoundModalAnalysis(_4889.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4814.WormGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4814.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
