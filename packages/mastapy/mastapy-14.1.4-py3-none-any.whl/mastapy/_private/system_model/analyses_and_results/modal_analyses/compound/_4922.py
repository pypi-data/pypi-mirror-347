...
class RingPinsCompoundModalAnalysis(_4910.MountableComponentCompoundModalAnalysis):
    """RingPinsCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4775.RingPinsModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4775.RingPinsModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RingPinsModalAnalysis]
