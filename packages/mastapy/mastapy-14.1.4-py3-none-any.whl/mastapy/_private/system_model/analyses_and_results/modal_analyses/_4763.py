...
class OilSealModalAnalysis(_4709.ConnectorModalAnalysis):
    """OilSealModalAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7614.OilSealLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2858.OilSealSystemDeflection":
