...
class MicrophoneCompoundModalAnalysis(_4856.ComponentCompoundModalAnalysis):
    """MicrophoneCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4756.MicrophoneModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4756.MicrophoneModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MicrophoneModalAnalysis]
