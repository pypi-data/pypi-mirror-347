...
class SpiralBevelGearSetModalAnalysis(_4691.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4787.SpiralBevelGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4786.SpiralBevelGearMeshModalAnalysis]":
