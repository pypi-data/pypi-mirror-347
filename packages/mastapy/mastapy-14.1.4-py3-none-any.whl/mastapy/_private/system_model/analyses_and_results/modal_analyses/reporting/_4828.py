...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4821.ComponentPerModeResult":
        return self.__parent__._cast(_4821.ComponentPerModeResult)
...
class ShaftPerModeResult(_4821.ComponentPerModeResult):
    """ShaftPerModeResult
