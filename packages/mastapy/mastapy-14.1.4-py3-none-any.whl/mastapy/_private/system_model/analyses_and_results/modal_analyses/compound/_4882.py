...
class DatumCompoundModalAnalysis(_4856.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4725.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]
