...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis import _1857
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2724.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    def excitation_frequencies_at_reference_speed(
        self: "Self",
    ) -> "List[_1857.DesignEntityExcitationDescription]":
