...
class BevelDifferentialGearSetDynamicAnalysis(_6424.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6417.BevelDifferentialGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6418.BevelDifferentialGearMeshDynamicAnalysis]":
