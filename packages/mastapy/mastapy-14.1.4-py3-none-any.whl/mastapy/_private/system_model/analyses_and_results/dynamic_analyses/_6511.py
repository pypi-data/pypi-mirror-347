...
class SpiralBevelGearSetDynamicAnalysis(_6424.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6509.SpiralBevelGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6510.SpiralBevelGearMeshDynamicAnalysis]":
