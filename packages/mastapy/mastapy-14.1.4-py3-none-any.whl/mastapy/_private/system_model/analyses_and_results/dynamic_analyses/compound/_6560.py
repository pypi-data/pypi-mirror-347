...
class ClutchCompoundDynamicAnalysis(_6576.CouplingCompoundDynamicAnalysis):
    """ClutchCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6428.ClutchDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6428.ClutchDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ClutchDynamicAnalysis]
