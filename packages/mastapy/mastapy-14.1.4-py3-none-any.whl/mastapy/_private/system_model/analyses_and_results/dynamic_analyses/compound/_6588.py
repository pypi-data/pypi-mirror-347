...
class CylindricalGearSetCompoundDynamicAnalysis(_6599.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    def cylindrical_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6586.CylindricalGearCompoundDynamicAnalysis]":
    ...
    def cylindrical_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6587.CylindricalGearMeshCompoundDynamicAnalysis]":
