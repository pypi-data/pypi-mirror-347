...
class _Cast_SingleExcitationDetails:
    ...
    def single_harmonic_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7488.SingleHarmonicExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7488,
        )

        return self.__parent__._cast(_7488.SingleHarmonicExcitationAnalysisDetail)

    @property
    def unit_force_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7489.UnitForceExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7489,
        )

        return self.__parent__._cast(_7489.UnitForceExcitationAnalysisDetail)
