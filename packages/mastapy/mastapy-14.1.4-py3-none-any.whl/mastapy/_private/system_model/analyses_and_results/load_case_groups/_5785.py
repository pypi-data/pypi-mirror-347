...
T = TypeVar("T", bound="_2266.DesignEntity")
...
class _Cast_GenericClutchEngagementStatus:
    ...
    @property
    def clutch_engagement_status(self: "CastSelf") -> "_5781.ClutchEngagementStatus":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5781,
        )

        return self.__parent__._cast(_5781.ClutchEngagementStatus)
    ...
    def concept_synchro_gear_engagement_status(
        ...
        return self.__parent__._cast(_5782.ConceptSynchroGearEngagementStatus)
