...
TConnection = TypeVar("TConnection", bound="_2335.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_7535.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5795.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
