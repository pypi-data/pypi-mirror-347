...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2599, _2601
...
TGearSet = TypeVar("TGearSet", bound="_2601.GearSet")
TGear = TypeVar("TGear", bound="_2599.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_7576.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2376.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_7578.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_7581.GearSetLoadCase")
...
class _Cast_GearSetStaticLoadCaseGroup:
    ...
    def design_entity_static_load_case_group(
        self: "CastSelf",
    ) -> "_5795.DesignEntityStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5795,
        )

        return self.__parent__._cast(_5795.DesignEntityStaticLoadCaseGroup)
...
class GearSetStaticLoadCaseGroup(
    ...
    def gears_load_cases(
        self: "Self",
    ) -> "List[_5793.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: "Self",
    ) -> "List[_5794.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
