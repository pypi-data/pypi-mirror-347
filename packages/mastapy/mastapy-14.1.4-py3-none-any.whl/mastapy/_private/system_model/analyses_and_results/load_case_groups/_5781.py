...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5785.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5785.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5785.GenericClutchEngagementStatus[_2405.ClutchConnection]
):
    """ClutchEngagementStatus
