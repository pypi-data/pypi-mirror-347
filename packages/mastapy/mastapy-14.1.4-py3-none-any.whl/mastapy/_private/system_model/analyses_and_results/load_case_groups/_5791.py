...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2719, _2747
...
class TimeSeriesLoadCaseGroup(_5779.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: "Self") -> "List[_7660.TimeSeriesLoadCase]":
