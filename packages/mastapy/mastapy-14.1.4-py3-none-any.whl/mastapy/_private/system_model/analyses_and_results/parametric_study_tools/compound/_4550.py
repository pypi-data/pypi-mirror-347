...
class BearingCompoundParametricStudyTool(_4578.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self: "Self") -> "_2010.LoadedBearingDutyCycle":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7505.BearingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4400.BearingParametricStudyTool]":
