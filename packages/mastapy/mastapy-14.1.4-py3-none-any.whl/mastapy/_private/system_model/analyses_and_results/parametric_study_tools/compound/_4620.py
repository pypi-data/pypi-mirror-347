...
class MicrophoneCompoundParametricStudyTool(_4567.ComponentCompoundParametricStudyTool):
    """MicrophoneCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7611.MicrophoneLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4477.MicrophoneParametricStudyTool]":
