...
class CylindricalGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4441.CylindricalGearSetParametricStudyTool]":
    ...
    def cylindrical_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4589.CylindricalGearCompoundParametricStudyTool]":
    ...
    def cylindrical_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4590.CylindricalGearMeshCompoundParametricStudyTool]":
