...
class CVTCompoundParametricStudyTool(_4552.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7541.CVTLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4433.CVTParametricStudyTool]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4433.CVTParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.CVTParametricStudyTool]
