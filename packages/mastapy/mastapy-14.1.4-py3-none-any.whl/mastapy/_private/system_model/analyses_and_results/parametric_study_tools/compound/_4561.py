...
class BoltCompoundParametricStudyTool(_4567.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7517.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4412.BoltParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4412.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
