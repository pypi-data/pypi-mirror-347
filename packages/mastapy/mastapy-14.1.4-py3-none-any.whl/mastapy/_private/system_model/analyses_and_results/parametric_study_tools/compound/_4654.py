...
class StraightBevelGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4523.StraightBevelGearSetParametricStudyTool]":
    ...
    def straight_bevel_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4652.StraightBevelGearCompoundParametricStudyTool]":
    ...
    def straight_bevel_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4653.StraightBevelGearMeshCompoundParametricStudyTool]":
