...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2334.ComponentMeasurer":
        return self.__parent__._cast(_2334.ComponentMeasurer)
...
class ComponentConnection(_2334.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    def connected_component(self: "Self") -> "_2508.Component":
