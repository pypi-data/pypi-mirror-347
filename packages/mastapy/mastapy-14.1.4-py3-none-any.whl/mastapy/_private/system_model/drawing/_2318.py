...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2310, _2320, _2321
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2310.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2310

        return self.__parent__._cast(_2310.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2320.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2320

        return self.__parent__._cast(_2320.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2321.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2321

        return self.__parent__._cast(_2321.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self: "Self") -> "_4118.RotorDynamicsDrawStyle":
