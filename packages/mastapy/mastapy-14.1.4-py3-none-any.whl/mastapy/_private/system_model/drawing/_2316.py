...
from mastapy._private.utility.enums import _1883, _1884
...
class _Cast_PartAnalysisCaseWithContourViewable:
    ...
    def abstract_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2306.AbstractSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2306

        return self.__parent__._cast(_2306.AbstractSystemDeflectionViewable)

    @property
    def advanced_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2307.AdvancedSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2307

        return self.__parent__._cast(_2307.AdvancedSystemDeflectionViewable)
    ...
    def system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2323.SystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2323

        return self.__parent__._cast(_2323.SystemDeflectionViewable)
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    def contour(
        self: "Self", value: "_1883.ThreeDViewContourOptionFirstSelection"
    ) -> None:
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: "Self", value: "_1884.ThreeDViewContourOptionSecondSelection"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
