...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2681, _2683
...
class Synchroniser(_2543.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self: "Self") -> "_2405.ClutchConnection":
    ...
    @property
    def clutch_connection_right(self: "Self") -> "_2405.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    def hub_and_sleeve(self: "Self") -> "_2683.SynchroniserSleeve":
    ...
    @property
    def left_cone(self: "Self") -> "_2681.SynchroniserHalf":
    ...
    @property
    def right_cone(self: "Self") -> "_2681.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf
