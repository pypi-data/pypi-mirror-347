...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2685, _2687
...
class TorqueConverter(_2654.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self: "Self") -> "_2685.TorqueConverterPump":
    ...
    @property
    def turbine(self: "Self") -> "_2687.TorqueConverterTurbine":
