...
from mastapy._private.system_model.part_model.couplings import _2664, _2667, _2668
...
class ShaftHubConnection(_2511.Connector):
    """ShaftHubConnection
    ...
    @enforce_parameter_types
    def stiffness_type(
        self: "Self", value: "_2664.RigidConnectorStiffnessType"
    ) -> None:
    ...
    @property
    def tilt_stiffness_type(self: "Self") -> "_2665.RigidConnectorTiltStiffnessTypes":
    ...
    def tilt_stiffness_type(
        self: "Self", value: "_2665.RigidConnectorTiltStiffnessTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(
        self: "Self", value: "_2667.RigidConnectorToothSpacingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2668.RigidConnectorTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def external_half_manufacturing_error(
        self: "Self",
    ) -> "_2673.SplineHalfManufacturingError":
    ...
    @property
    def left_flank_lead_relief(self: "Self") -> "_2674.SplineLeadRelief":
    ...
    @property
    def major_fit_options(self: "Self") -> "_2672.SplineFitOptions":
    ...
    @property
    def minor_fit_options(self: "Self") -> "_2672.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    def right_flank_lead_relief(self: "Self") -> "_2674.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    def spline_pitch_error_options(self: "Self") -> "_2676.SplinePitchErrorOptions":
    ...
    @property
    def fit_options(self: "Self") -> "List[_2672.SplineFitOptions]":
    ...
    @property
    def lead_reliefs(self: "Self") -> "List[_2674.SplineLeadRelief]":
    ...
    def spline_half_manufacturing_errors(
        self: "Self",
    ) -> "List[_2673.SplineHalfManufacturingError]":
    ...
    def tooth_locations_external_spline_half(
        self: "Self",
    ) -> "List[_2666.RigidConnectorToothLocation]":
