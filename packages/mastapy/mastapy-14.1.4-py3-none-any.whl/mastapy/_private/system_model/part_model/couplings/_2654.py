...
class Coupling(_2543.SpecialisedAssembly):
    """Coupling
    ...
    @property
    def halves(self: "Self") -> "List[_2655.CouplingHalf]":
    ...
    @property
    def half_a(self: "Self") -> "_2655.CouplingHalf":
    ...
    @property
    def half_b(self: "Self") -> "_2655.CouplingHalf":
        """mastapy.system_model.part_model.couplings.CouplingHalf
