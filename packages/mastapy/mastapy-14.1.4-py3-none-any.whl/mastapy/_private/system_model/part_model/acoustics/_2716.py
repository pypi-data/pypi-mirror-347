...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2713, _2714
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2713.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2713

        return self.__parent__._cast(_2713.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2714.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2714

        return self.__parent__._cast(_2714.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2508.Component") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2267.DesignEntityId") -> None:
