...
class AcousticAnalysisOptions(_0.APIBase):
    ...
    @property
    def initial_guess(self: "Self") -> "_7483.InitialGuessOption":
    ...
    @enforce_parameter_types
    def initial_guess(self: "Self", value: "_7483.InitialGuessOption") -> None:
    ...
    @property
    def m2l_cache_type(self: "Self") -> "_7484.M2LHfCacheType":
    ...
    @enforce_parameter_types
    def m2l_cache_type(self: "Self", value: "_7484.M2LHfCacheType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.M2LHfCacheType",
        )
    ...
    def near_field_integrals_cache_type(
        self: "Self",
    ) -> "_7485.NearFieldIntegralsCacheType":
    ...
    @enforce_parameter_types
    def near_field_integrals_cache_type(
        self: "Self", value: "_7485.NearFieldIntegralsCacheType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.NearFieldIntegralsCacheType",
    ...
    @property
    def octree_creation_method(self: "Self") -> "_7486.OctreeCreationMethod":
    ...
    def octree_creation_method(
        self: "Self", value: "_7486.OctreeCreationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.OctreeCreationMethod",
    ...
    @property
    def preconditioner(self: "Self") -> "_7479.AcousticPreconditionerType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7479",
            "AcousticPreconditionerType",
        )(value)

    @preconditioner.setter
    @enforce_parameter_types
    def preconditioner(self: "Self", value: "_7479.AcousticPreconditionerType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.AcousticPreconditionerType",
        )
