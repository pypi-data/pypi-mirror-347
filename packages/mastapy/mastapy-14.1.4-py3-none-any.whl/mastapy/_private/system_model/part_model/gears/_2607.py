...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2592, _2599
...
class KlingelnbergCycloPalloidHypoidGear(_2605.KlingelnbergCycloPalloidConicalGear):
    """KlingelnbergCycloPalloidHypoidGear
