...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2498, _2528, _2534
...
class MicrophoneArray(_2543.SpecialisedAssembly):
    """MicrophoneArray
    ...
    @property
    def array_design(self: "Self") -> "_2711.MicrophoneArrayDesign":
