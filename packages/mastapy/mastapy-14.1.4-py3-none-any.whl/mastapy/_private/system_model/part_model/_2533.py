...
class _Cast_OuterBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2505.BearingRaceMountingOptions":
        return self.__parent__._cast(_2505.BearingRaceMountingOptions)
...
class OuterBearingRaceMountingOptions(_2505.BearingRaceMountingOptions):
    """OuterBearingRaceMountingOptions
