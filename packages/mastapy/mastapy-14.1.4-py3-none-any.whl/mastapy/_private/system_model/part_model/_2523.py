...
from mastapy._private.bearings.tolerances import _1963, _1965
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2502, _2539
...
class _Cast_InternalClearanceTolerance:
    ...
    def axial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2502.AxialInternalClearanceTolerance)
    ...
    def radial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2539.RadialInternalClearanceTolerance)
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    def clearance_class(self: "Self", value: "_1963.InternalClearanceClass") -> None:
