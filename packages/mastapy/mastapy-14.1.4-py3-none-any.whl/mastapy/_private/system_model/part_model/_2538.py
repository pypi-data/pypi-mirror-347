...
class PowerLoad(_2546.VirtualComponent):
    """PowerLoad
    ...
    def electric_machine_search_region_specification_method(
        self: "Self",
    ) -> "_2513.ElectricMachineSearchRegionSpecificationMethod":
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: "Self", value: "_2513.ElectricMachineSearchRegionSpecificationMethod"
    ) -> None:
    ...
    @property
    def engine_fuel_consumption_grid(self: "Self") -> "_1622.GriddedSurfaceAccessor":
    ...
    @property
    def engine_torque_grid(self: "Self") -> "_1622.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: "Self", value: "_1622.GriddedSurfaceAccessor") -> None:
    ...
    @enforce_parameter_types
    def power_load_type(self: "Self", value: "_2282.PowerLoadType") -> None:
    ...
    @property
    def single_blade_details(self: "Self") -> "_2548.WindTurbineSingleBladeDetails":
