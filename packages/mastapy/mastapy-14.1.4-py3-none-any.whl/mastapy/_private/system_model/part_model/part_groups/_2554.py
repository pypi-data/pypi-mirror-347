...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2555, _2559
...
class ConcentricPartGroup(_2553.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    def parallel_groups(
        self: "Self",
    ) -> "List[_2555.ConcentricPartGroupParallelToThis]":
