...
class CylindricalGearFromCAD(_2572.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2595.CylindricalGearSet") -> None:
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2594.CylindricalGear") -> None:
        wrapper_type = (
