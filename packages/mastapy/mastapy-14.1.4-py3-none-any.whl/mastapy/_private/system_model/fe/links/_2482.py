...
from mastapy._private.system_model.fe import _2426, _2449, _2462, _2466
...
class _Cast_FELink:
    ...
    @property
    def single_node_fe_link(self: "CastSelf") -> "_2496.SingleNodeFELink":
        from mastapy._private.system_model.fe.links import _2496

        return self.__parent__._cast(_2496.SingleNodeFELink)
...
class FELink(_0.APIBase):
    ...
    @enforce_parameter_types
    def bearing_node_link_option(
        self: "Self", value: "_2426.BearingNodeOption"
    ) -> None:
    ...
    @enforce_parameter_types
    def link_node_source(self: "Self", value: "_2462.LinkNodeSource") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def node_selection_depth(
        self: "Self",
        value: "Union[_2466.NodeSelectionDepthOption, Tuple[_2466.NodeSelectionDepthOption, bool]]",
    ) -> None:
    ...
    def alignment_in_component_coordinate_system(
        self: "Self",
    ) -> "_2461.LinkComponentAxialPositionErrorReporter":
    ...
    @property
    def component(self: "Self") -> "_2530.MountableComponent":
    ...
    @property
    def socket(self: "Self") -> "_2359.Socket":
    ...
    def nodes_grouped_by_angle(
        self: "Self",
    ) -> "OrderedDict[float, List[_2449.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: "Self", node: "_2449.FESubstructureNode") -> None:
