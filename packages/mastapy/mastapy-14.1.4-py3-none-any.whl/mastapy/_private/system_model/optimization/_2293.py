...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2296.OptimizationStep":
        return self.__parent__._cast(_2296.OptimizationStep)
...
class CylindricalGearOptimizationStep(_2296.OptimizationStep):
    """CylindricalGearOptimizationStep
