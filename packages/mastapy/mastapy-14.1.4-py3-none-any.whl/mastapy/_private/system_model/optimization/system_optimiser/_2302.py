...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2595, _2601
    from mastapy._private.utility.logging import _1869
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5784.DutyCycle"
    ) -> None:
        wrapper_type = (
    ...
    @property
    def design(self: "Self") -> "_2263.Design":
    ...
    @property
    def details(self: "Self") -> "_2303.SystemOptimiserDetails":
    ...
    @property
    def log(self: "Self") -> "_1869.Logger":
    ...
    @property
    def tooth_number_finder(self: "Self") -> "_2304.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5788.SystemOptimisationGearSet]":
    ...
    @property
    def system_optimiser_duty_cycle(self: "Self") -> "_5784.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5784.DutyCycle") -> None:
