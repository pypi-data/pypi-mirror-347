...
class EnumWithSelectedValue_DegreeOfFreedom(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DegreeOfFreedom]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1562.DegreeOfFreedom.type_()

    @property
    def selected_value(self: "Self") -> "_1562.DegreeOfFreedom":
    ...
    @property
    def available_values(self: "Self") -> "List[_1562.DegreeOfFreedom]":
