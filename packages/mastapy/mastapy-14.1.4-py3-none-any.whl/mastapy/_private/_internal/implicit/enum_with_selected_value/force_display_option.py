...
from mastapy._private.electric_machines.harmonic_load_data import _1437
...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1437.ForceDisplayOption
        """
        return _1437.ForceDisplayOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ForceDisplayOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1437.ForceDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1437.ForceDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1437.ForceDisplayOption]":
