...
class EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption]",
    ) -> "_1193.CylindricalGearPairCreationOptions.DerivedParameterOption":
        ...
        Returns:
            _1193.CylindricalGearPairCreationOptions.DerivedParameterOption
        """
        return _1193.CylindricalGearPairCreationOptions.DerivedParameterOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1193.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1193.CylindricalGearPairCreationOptions.DerivedParameterOption]":
