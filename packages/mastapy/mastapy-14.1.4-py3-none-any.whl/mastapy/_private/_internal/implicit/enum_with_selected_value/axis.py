...
class EnumWithSelectedValue_Axis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Axis]") -> "_1550.Axis":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Axis]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1550.Axis.type_()

    @property
    def selected_value(self: "Self") -> "_1550.Axis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1550.Axis]":
