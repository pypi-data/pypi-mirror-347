...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _677
...
class EnumWithSelectedValue_MicroGeometryDefinitionType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_MicroGeometryDefinitionType]",
    ) -> "_677.MicroGeometryDefinitionType":
        ...
        Returns:
            _677.MicroGeometryDefinitionType
        """
        return _677.MicroGeometryDefinitionType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _677.MicroGeometryDefinitionType.type_()

    @property
    def selected_value(self: "Self") -> "_677.MicroGeometryDefinitionType":
    ...
    @property
    def available_values(self: "Self") -> "List[_677.MicroGeometryDefinitionType]":
