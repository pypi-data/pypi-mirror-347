...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_1931.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _1931.BasicDynamicLoadRatingCalculationMethod
        """
        return _1931.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1931.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1931.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1931.BasicDynamicLoadRatingCalculationMethod]":
