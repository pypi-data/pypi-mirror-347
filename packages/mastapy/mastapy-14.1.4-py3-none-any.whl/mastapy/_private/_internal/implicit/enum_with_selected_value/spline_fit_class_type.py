...
from mastapy._private.detailed_rigid_connectors.splines import _1471
...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1471.SplineFitClassType
        """
        return _1471.SplineFitClassType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineFitClassType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1471.SplineFitClassType.type_()

    @property
    def selected_value(self: "Self") -> "_1471.SplineFitClassType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1471.SplineFitClassType]":
