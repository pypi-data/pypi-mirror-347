...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7665.TorqueRippleInputType
        """
        return _7665.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7665.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7665.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7665.TorqueRippleInputType]":
