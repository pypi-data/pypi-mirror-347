...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification]",
    ) -> "_7626.PointLoadLoadCase.ForceSpecification":
        ...
        Returns:
            _7626.PointLoadLoadCase.ForceSpecification
        """
        return _7626.PointLoadLoadCase.ForceSpecification
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7626.PointLoadLoadCase.ForceSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_7626.PointLoadLoadCase.ForceSpecification":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7626.PointLoadLoadCase.ForceSpecification]":
