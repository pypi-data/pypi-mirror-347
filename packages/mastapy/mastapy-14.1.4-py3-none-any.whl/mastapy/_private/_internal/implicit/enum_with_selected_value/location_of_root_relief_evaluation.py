...
from mastapy._private.gears.micro_geometry import _594
...
class EnumWithSelectedValue_LocationOfRootReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfRootReliefEvaluation]",
    ) -> "_594.LocationOfRootReliefEvaluation":
        ...
        Returns:
            _594.LocationOfRootReliefEvaluation
        """
        return _594.LocationOfRootReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _594.LocationOfRootReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_594.LocationOfRootReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_594.LocationOfRootReliefEvaluation]":
