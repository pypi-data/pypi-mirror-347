...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_GeometrySpecificationType]",
    ) -> "_1088.GeometrySpecificationType":
        ...
        Returns:
            _1088.GeometrySpecificationType
        """
        return _1088.GeometrySpecificationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1088.GeometrySpecificationType.type_()

    @property
    def selected_value(self: "Self") -> "_1088.GeometrySpecificationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1088.GeometrySpecificationType]":
