...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1963.InternalClearanceClass
        """
        return _1963.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1963.InternalClearanceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1963.InternalClearanceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1963.InternalClearanceClass]":
