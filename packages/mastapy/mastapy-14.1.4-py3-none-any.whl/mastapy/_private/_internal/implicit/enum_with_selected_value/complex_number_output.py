...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5885
...
class EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput]",
    ) -> "_5885.HarmonicAnalysisFEExportOptions.ComplexNumberOutput":
        ...
        Returns:
            _5885.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
        """
        return _5885.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5885.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5885.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]":
