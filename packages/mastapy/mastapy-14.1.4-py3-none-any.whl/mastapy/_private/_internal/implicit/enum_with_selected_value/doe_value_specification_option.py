...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4445.DoeValueSpecificationOption":
        ...
        Returns:
            _4445.DoeValueSpecificationOption
        """
        return _4445.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4445.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4445.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4445.DoeValueSpecificationOption]":
