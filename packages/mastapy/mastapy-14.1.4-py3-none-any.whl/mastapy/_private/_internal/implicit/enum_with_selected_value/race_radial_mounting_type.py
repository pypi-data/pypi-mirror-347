...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2026.RaceRadialMountingType
        """
        return _2026.RaceRadialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2026.RaceRadialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2026.RaceRadialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2026.RaceRadialMountingType]":
