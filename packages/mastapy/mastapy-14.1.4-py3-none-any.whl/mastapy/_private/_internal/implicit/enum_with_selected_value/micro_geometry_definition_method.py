...
class EnumWithSelectedValue_MicroGeometryDefinitionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _676.MicroGeometryDefinitionMethod
        """
        return _676.MicroGeometryDefinitionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _676.MicroGeometryDefinitionMethod.type_()

    @property
    def selected_value(self: "Self") -> "_676.MicroGeometryDefinitionMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_676.MicroGeometryDefinitionMethod]":
