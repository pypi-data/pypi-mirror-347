...
class EnumWithSelectedValue_ChartType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_ChartType]") -> "_674.ChartType":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ChartType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _674.ChartType.type_()

    @property
    def selected_value(self: "Self") -> "_674.ChartType":
    ...
    @property
    def available_values(self: "Self") -> "List[_674.ChartType]":
