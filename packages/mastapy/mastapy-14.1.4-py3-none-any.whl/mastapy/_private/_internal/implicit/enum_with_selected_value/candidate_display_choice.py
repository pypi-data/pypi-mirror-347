...
class EnumWithSelectedValue_CandidateDisplayChoice(
    ...
    def wrapped_type(
        ...
        Returns:
            _934.CandidateDisplayChoice
        """
        return _934.CandidateDisplayChoice
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _934.CandidateDisplayChoice.type_()

    @property
    def selected_value(self: "Self") -> "_934.CandidateDisplayChoice":
    ...
    @property
    def available_values(self: "Self") -> "List[_934.CandidateDisplayChoice]":
