...
class EnumWithSelectedValue_CoilPositionInSlot(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1304.CoilPositionInSlot
        """
        return _1304.CoilPositionInSlot
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CoilPositionInSlot]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1304.CoilPositionInSlot.type_()

    @property
    def selected_value(self: "Self") -> "_1304.CoilPositionInSlot":
    ...
    @property
    def available_values(self: "Self") -> "List[_1304.CoilPositionInSlot]":
