...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2667.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2667.RigidConnectorToothSpacingType
        """
        return _2667.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2667.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2667.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2667.RigidConnectorToothSpacingType]":
