...
class EnumWithSelectedValue_AnalysisType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_AnalysisType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7503.AnalysisType.type_()

    @property
    def selected_value(self: "Self") -> "_7503.AnalysisType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7503.AnalysisType]":
