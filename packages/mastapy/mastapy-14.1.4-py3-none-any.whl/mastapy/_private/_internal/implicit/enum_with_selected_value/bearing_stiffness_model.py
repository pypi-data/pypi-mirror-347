...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5500.BearingStiffnessModel
        """
        return _5500.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5500.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5500.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5500.BearingStiffnessModel]":
