...
class EnumWithSelectedValue_LocationOfEvaluationLowerLimit(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfEvaluationLowerLimit]",
    ) -> "_592.LocationOfEvaluationLowerLimit":
        ...
        Returns:
            _592.LocationOfEvaluationLowerLimit
        """
        return _592.LocationOfEvaluationLowerLimit
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _592.LocationOfEvaluationLowerLimit.type_()

    @property
    def selected_value(self: "Self") -> "_592.LocationOfEvaluationLowerLimit":
    ...
    @property
    def available_values(self: "Self") -> "List[_592.LocationOfEvaluationLowerLimit]":
