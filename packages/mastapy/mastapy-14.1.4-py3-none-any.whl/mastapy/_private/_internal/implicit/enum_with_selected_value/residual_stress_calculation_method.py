...
class EnumWithSelectedValue_ResidualStressCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ResidualStressCalculationMethod]",
    ) -> "_1109.ResidualStressCalculationMethod":
        ...
        Returns:
            _1109.ResidualStressCalculationMethod
        """
        return _1109.ResidualStressCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1109.ResidualStressCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1109.ResidualStressCalculationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_1109.ResidualStressCalculationMethod]":
