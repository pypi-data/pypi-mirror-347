...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod]",
    ) -> "_1631.HertzianContactDeflectionCalculationMethod":
        ...
        Returns:
            _1631.HertzianContactDeflectionCalculationMethod
        """
        return _1631.HertzianContactDeflectionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1631.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1631.HertzianContactDeflectionCalculationMethod]":
