...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PreloadType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2023.PreloadType.type_()

    @property
    def selected_value(self: "Self") -> "_2023.PreloadType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2023.PreloadType]":
