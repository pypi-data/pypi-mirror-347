...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods]",
    ) -> "_1227.AGMAGleasonConicalGearGeometryMethods":
        ...
        Returns:
            _1227.AGMAGleasonConicalGearGeometryMethods
        """
        return _1227.AGMAGleasonConicalGearGeometryMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1227.AGMAGleasonConicalGearGeometryMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1227.AGMAGleasonConicalGearGeometryMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1227.AGMAGleasonConicalGearGeometryMethods]":
