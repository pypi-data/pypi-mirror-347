...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1804.CadPageOrientation
        """
        return _1804.CadPageOrientation
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CadPageOrientation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1804.CadPageOrientation.type_()

    @property
    def selected_value(self: "Self") -> "_1804.CadPageOrientation":
    ...
    @property
    def available_values(self: "Self") -> "List[_1804.CadPageOrientation]":
