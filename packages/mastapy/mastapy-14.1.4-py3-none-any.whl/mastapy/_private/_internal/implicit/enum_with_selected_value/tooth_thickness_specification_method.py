...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ToothThicknessSpecificationMethod]",
    ) -> "_1238.ToothThicknessSpecificationMethod":
        ...
        Returns:
            _1238.ToothThicknessSpecificationMethod
        """
        return _1238.ToothThicknessSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1238.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1238.ToothThicknessSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1238.ToothThicknessSpecificationMethod]":
