...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5626.TorqueConverterLockupRule":
        ...
        Returns:
            _5626.TorqueConverterLockupRule
        """
        return _5626.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5626.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5626.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5626.TorqueConverterLockupRule]":
