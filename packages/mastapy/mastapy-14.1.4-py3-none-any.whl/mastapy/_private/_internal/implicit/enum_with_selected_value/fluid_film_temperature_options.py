...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1945.FluidFilmTemperatureOptions
        """
        return _1945.FluidFilmTemperatureOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1945.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1945.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: "Self") -> "List[_1945.FluidFilmTemperatureOptions]":
