...
class EnumWithSelectedValue_LocationOfTipReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfTipReliefEvaluation]",
    ) -> "_595.LocationOfTipReliefEvaluation":
        ...
        Returns:
            _595.LocationOfTipReliefEvaluation
        """
        return _595.LocationOfTipReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _595.LocationOfTipReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_595.LocationOfTipReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_595.LocationOfTipReliefEvaluation]":
