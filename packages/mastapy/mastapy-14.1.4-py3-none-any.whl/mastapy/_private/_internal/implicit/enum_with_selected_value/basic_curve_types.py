...
class EnumWithSelectedValue_BasicCurveTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BasicCurveTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _331.BasicCurveTypes.type_()

    @property
    def selected_value(self: "Self") -> "_331.BasicCurveTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_331.BasicCurveTypes]":
