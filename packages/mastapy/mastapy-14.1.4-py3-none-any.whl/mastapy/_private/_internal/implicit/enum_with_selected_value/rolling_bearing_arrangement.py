...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_1953.RollingBearingArrangement":
        ...
        Returns:
            _1953.RollingBearingArrangement
        """
        return _1953.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1953.RollingBearingArrangement.type_()

    @property
    def selected_value(self: "Self") -> "_1953.RollingBearingArrangement":
    ...
    @property
    def available_values(self: "Self") -> "List[_1953.RollingBearingArrangement]":
