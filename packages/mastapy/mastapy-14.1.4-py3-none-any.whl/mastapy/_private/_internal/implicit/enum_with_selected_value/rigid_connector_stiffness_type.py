...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2664.RigidConnectorStiffnessType":
        ...
        Returns:
            _2664.RigidConnectorStiffnessType
        """
        return _2664.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2664.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: "Self") -> "_2664.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2664.RigidConnectorStiffnessType]":
