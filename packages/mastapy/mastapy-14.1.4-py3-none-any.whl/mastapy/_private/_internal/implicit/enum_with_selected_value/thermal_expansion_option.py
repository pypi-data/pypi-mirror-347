...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2475.ThermalExpansionOption
        """
        return _2475.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2475.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2475.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2475.ThermalExpansionOption]":
