...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StressConcentrationMethod]",
    ) -> "_2171.StressConcentrationMethod":
        ...
        Returns:
            _2171.StressConcentrationMethod
        """
        return _2171.StressConcentrationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2171.StressConcentrationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2171.StressConcentrationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2171.StressConcentrationMethod]":
