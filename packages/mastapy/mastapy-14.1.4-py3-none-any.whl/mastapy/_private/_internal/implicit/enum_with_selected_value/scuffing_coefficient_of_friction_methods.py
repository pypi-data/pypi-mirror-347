...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    def wrapped_type(
        ...
        Returns:
            _1112.ScuffingCoefficientOfFrictionMethods
        """
        return _1112.ScuffingCoefficientOfFrictionMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1112.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1112.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1112.ScuffingCoefficientOfFrictionMethods]":
