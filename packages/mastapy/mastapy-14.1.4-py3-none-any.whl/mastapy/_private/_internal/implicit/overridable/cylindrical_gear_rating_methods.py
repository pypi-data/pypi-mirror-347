...
class Overridable_CylindricalGearRatingMethods(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_270.CylindricalGearRatingMethods":
        ...
        Returns:
            _270.CylindricalGearRatingMethods
        """
        return _270.CylindricalGearRatingMethods
    ...
    def implicit_type(cls: "Type[Overridable_CylindricalGearRatingMethods]") -> "Any":
        ...
        Returns:
            Any
        """
        return _270.CylindricalGearRatingMethods.type_()

    @property
    def value(self: "Self") -> "_270.CylindricalGearRatingMethods":
    ...
    @property
    def override_value(self: "Self") -> "_270.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
    ...
    @property
    def calculated_value(self: "Self") -> "_270.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
