...
class Overridable_BallBearingContactCalculation(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2029.BallBearingContactCalculation
        """
        return _2029.BallBearingContactCalculation
    ...
    def implicit_type(cls: "Type[Overridable_BallBearingContactCalculation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2029.BallBearingContactCalculation.type_()

    @property
    def value(self: "Self") -> "_2029.BallBearingContactCalculation":
    ...
    @property
    def override_value(self: "Self") -> "_2029.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
    ...
    @property
    def calculated_value(self: "Self") -> "_2029.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
