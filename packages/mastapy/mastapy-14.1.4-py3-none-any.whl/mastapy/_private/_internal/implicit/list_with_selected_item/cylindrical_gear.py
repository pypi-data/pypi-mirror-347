...
class ListWithSelectedItem_CylindricalGear(
    _2594.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2594.CylindricalGear.TYPE

    @property
    def selected_value(self: "Self") -> "_2594.CylindricalGear":
    ...
    @property
    def available_values(self: "Self") -> "List[_2594.CylindricalGear]":
