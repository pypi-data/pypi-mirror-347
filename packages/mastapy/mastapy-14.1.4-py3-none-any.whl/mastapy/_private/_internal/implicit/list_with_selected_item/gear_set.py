...
class ListWithSelectedItem_GearSet(_2601.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2601.GearSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2601.GearSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2601.GearSet]":
