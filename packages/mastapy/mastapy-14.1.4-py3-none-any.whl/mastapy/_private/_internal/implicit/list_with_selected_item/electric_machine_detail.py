...
class ListWithSelectedItem_ElectricMachineDetail(
    _1312.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ElectricMachineDetail]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1312.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: "Self") -> "_1312.ElectricMachineDetail":
    ...
    @property
    def available_values(self: "Self") -> "List[_1312.ElectricMachineDetail]":
