...
class ListWithSelectedItem_PowerLoad(_2538.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_PowerLoad]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2538.PowerLoad.TYPE

    @property
    def selected_value(self: "Self") -> "_2538.PowerLoad":
    ...
    @property
    def available_values(self: "Self") -> "List[_2538.PowerLoad]":
