...
class ListWithSelectedItem_FESubstructure(
    _2447.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructure]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2447.FESubstructure.TYPE

    @property
    def selected_value(self: "Self") -> "_2447.FESubstructure":
    ...
    @property
    def available_values(self: "Self") -> "List[_2447.FESubstructure]":
