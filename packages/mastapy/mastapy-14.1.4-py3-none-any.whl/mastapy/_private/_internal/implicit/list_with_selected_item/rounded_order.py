...
class ListWithSelectedItem_RoundedOrder(
    _1587.RoundedOrder, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_RoundedOrder]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1587.RoundedOrder.TYPE

    @property
    def selected_value(self: "Self") -> "_1587.RoundedOrder":
    ...
    @property
    def available_values(self: "Self") -> "List[_1587.RoundedOrder]":
