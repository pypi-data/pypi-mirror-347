...
class ListWithSelectedItem_SystemDirectory(
    _1658.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_SystemDirectory]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1658.SystemDirectory.TYPE

    @property
    def selected_value(self: "Self") -> "_1658.SystemDirectory":
    ...
    @property
    def available_values(self: "Self") -> "List[_1658.SystemDirectory]":
