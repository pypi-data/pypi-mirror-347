...
class ListWithSelectedItem_GearSetDesign(
    _982.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GearSetDesign]") -> "Any":
        ...
        Returns:
            Any
        """
        return _982.GearSetDesign.TYPE

    @property
    def selected_value(self: "Self") -> "_982.GearSetDesign":
    ...
    @property
    def available_values(self: "Self") -> "List[_982.GearSetDesign]":
