...
from mastapy._private.electric_machines.harmonic_load_data import _1441
...
class ListWithSelectedItem_SimpleElectricMachineTooth(
    _1441.SimpleElectricMachineTooth, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1441.SimpleElectricMachineTooth.TYPE

    @property
    def selected_value(self: "Self") -> "_1441.SimpleElectricMachineTooth":
    ...
    @property
    def available_values(self: "Self") -> "List[_1441.SimpleElectricMachineTooth]":
