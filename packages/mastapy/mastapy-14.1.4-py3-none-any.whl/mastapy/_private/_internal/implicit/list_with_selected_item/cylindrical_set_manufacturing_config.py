...
class ListWithSelectedItem_CylindricalSetManufacturingConfig(
    _656.CylindricalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _656.CylindricalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: "Self") -> "_656.CylindricalSetManufacturingConfig":
