...
class ListWithSelectedItem_ColumnTitle(
    _1878.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ColumnTitle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1878.ColumnTitle.TYPE

    @property
    def selected_value(self: "Self") -> "_1878.ColumnTitle":
    ...
    @property
    def available_values(self: "Self") -> "List[_1878.ColumnTitle]":
