...
class ListWithSelectedItem_ElectricMachineSetup(
    _1318.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ElectricMachineSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1318.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: "Self") -> "_1318.ElectricMachineSetup":
    ...
    @property
    def available_values(self: "Self") -> "List[_1318.ElectricMachineSetup]":
