...
class ListWithSelectedItem_FEPart(_2517.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FEPart]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2517.FEPart.TYPE

    @property
    def selected_value(self: "Self") -> "_2517.FEPart":
    ...
    @property
    def available_values(self: "Self") -> "List[_2517.FEPart]":
