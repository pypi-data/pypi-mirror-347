...
class ListWithSelectedItem_ShaftHubConnection(
    _2671.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2671.ShaftHubConnection.TYPE

    @property
    def selected_value(self: "Self") -> "_2671.ShaftHubConnection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2671.ShaftHubConnection]":
