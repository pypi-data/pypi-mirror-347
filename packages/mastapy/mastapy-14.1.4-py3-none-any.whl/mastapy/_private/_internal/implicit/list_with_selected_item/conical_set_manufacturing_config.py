...
class ListWithSelectedItem_ConicalSetManufacturingConfig(
    _822.ConicalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _822.ConicalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: "Self") -> "_822.ConicalSetManufacturingConfig":
    ...
    @property
    def available_values(self: "Self") -> "List[_822.ConicalSetManufacturingConfig]":
