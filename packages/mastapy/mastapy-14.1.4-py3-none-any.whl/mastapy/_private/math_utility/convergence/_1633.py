...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.convergence import _1632
...
class _Cast_DataLogger:
    ...
    @property
    def convergence_logger(self: "CastSelf") -> "_1632.ConvergenceLogger":
        from mastapy._private.math_utility.convergence import _1632

        return self.__parent__._cast(_1632.ConvergenceLogger)

    @property
    def data_logger_with_charts(self: "CastSelf") -> "_1911.DataLoggerWithCharts":
        from mastapy._private.utility_gui import _1911

        return self.__parent__._cast(_1911.DataLoggerWithCharts)
