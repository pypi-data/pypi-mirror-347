...
class _Cast_ReportingOptimizationInput:
    ...
    @property
    def optimization_variable(self: "CastSelf") -> "_1602.OptimizationVariable":
        from mastapy._private.math_utility.optimisation import _1602

        return self.__parent__._cast(_1602.OptimizationVariable)
...
class ReportingOptimizationInput(_1601.OptimizationInput):
    """ReportingOptimizationInput
