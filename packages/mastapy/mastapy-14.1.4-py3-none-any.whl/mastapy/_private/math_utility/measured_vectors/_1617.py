...
from mastapy._private.math_utility.measured_vectors import _1616
...
class _Cast_ForceAndDisplacementResults:
    ...
    def abstract_force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1616.AbstractForceAndDisplacementResults":
        return self.__parent__._cast(_1616.AbstractForceAndDisplacementResults)
...
class ForceAndDisplacementResults(_1616.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    @property
    def displacement(self: "Self") -> "_1621.VectorWithLinearAndAngularComponents":
