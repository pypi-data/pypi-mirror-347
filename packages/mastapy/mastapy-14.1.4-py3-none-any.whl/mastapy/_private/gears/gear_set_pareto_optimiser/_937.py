...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1598, _1603, _1606
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def filters(self: "Self") -> "List[_1603.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: "Self") -> "List[_1598.InputSetter[TAnalysis]]":
