...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1962, _1967, _1973, _1979
...
class RingTolerance(_1970.InterferenceTolerance):
    """RingTolerance
    ...
    @property
    def roundness_specification(self: "Self") -> "_1979.RoundnessSpecification":
