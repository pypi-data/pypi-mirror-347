...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1975, _1980, _1986
...
class RoundnessSpecification(
    _1644.IndependentReportablePropertiesBase["RoundnessSpecification"]
):
    """RoundnessSpecification
    ...
    @property
    def specification_type(self: "Self") -> "_1980.RoundnessSpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._1980", "RoundnessSpecificationType"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(
        self: "Self", value: "_1980.RoundnessSpecificationType"
    ) -> None:
    ...
    @property
    def type_of_fit(self: "Self") -> "_1986.TypeOfFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._1986", "TypeOfFit"
        )(value)

    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: "Self", value: "_1986.TypeOfFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def user_specified_deviation(self: "Self") -> "_1592.Vector2DListAccessor":
    ...
    @property
    def roundness_distribution(self: "Self") -> "List[_1975.RaceRoundnessAtAngle]":
