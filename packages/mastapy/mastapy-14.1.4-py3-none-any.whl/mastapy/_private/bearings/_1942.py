...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1944, _1951
...
class BearingSettingsItem(_1890.NamedDatabaseItem):
    """BearingSettingsItem
    ...
    @property
    def failure_probability_for_rating_life_percent(self: "Self") -> "_1951.RatingLife":
    ...
    def include_exponent_and_reduction_factors_in_isots162812008(
        self: "Self",
    ) -> "_1944.ExponentAndReductionFactorsInISO16281Calculation":
    ...
    @enforce_parameter_types
    def include_exponent_and_reduction_factors_in_isots162812008(
        self: "Self", value: "_1944.ExponentAndReductionFactorsInISO16281Calculation"
    ) -> None:
    ...
    @enforce_parameter_types
    def lubricant_film_temperature_calculation_pressure_fed_grease_filled_bearings(
        self: "Self", value: "_1945.FluidFilmTemperatureOptions"
    ) -> None:
