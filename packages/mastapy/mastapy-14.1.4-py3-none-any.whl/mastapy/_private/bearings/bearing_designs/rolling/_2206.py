...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self: "Self") -> "_2207.BearingProtectionLevel":
    ...
    @property
    def new_protection_level(self: "Self") -> "_2207.BearingProtectionLevel":
        """mastapy.bearings.bearing_designs.rolling.BearingProtectionLevel"""
    ...
    def new_protection_level(
        self: "Self", value: "_2207.BearingProtectionLevel"
    ) -> None:
