...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2218, _2219
...
class GeometricConstants(_0.APIBase):
    ...
    def geometric_constants_for_rolling_frictional_moments(
        self: "Self",
    ) -> "_2218.GeometricConstantsForRollingFrictionalMoments":
    ...
    def geometric_constants_for_sliding_frictional_moments(
        self: "Self",
    ) -> "_2219.GeometricConstantsForSlidingFrictionalMoments":
