...
class _Cast_CylindricalHousingJournalBearing:
    ...
    @property
    def plain_journal_housing(self: "CastSelf") -> "_2255.PlainJournalHousing":
        return self.__parent__._cast(_2255.PlainJournalHousing)
...
class CylindricalHousingJournalBearing(_2255.PlainJournalHousing):
    """CylindricalHousingJournalBearing
