...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2253, _2255
...
class PlainGreaseFilledJournalBearing(_2254.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    def housing_type(
        self: "Self",
    ) -> "_2253.PlainGreaseFilledJournalBearingHousingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.fluid_film._2253",
    ...
    def housing_type(
        self: "Self", value: "_2253.PlainGreaseFilledJournalBearingHousingType"
    ) -> None:
    ...
    @property
    def housing_detail(self: "Self") -> "_2255.PlainJournalHousing":
