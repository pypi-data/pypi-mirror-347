...
class _Cast_AxialGrooveJournalBearing:
    ...
    @property
    def axial_feed_journal_bearing(self: "CastSelf") -> "_2244.AxialFeedJournalBearing":
        return self.__parent__._cast(_2244.AxialFeedJournalBearing)
...
class AxialGrooveJournalBearing(_2244.AxialFeedJournalBearing):
    """AxialGrooveJournalBearing
