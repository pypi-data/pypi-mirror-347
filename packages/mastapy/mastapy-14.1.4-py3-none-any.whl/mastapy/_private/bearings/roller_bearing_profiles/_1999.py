...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _1988, _1990, _2001
...
class RollerBearingUserSpecifiedProfile(_1997.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self: "Self") -> "_1988.ProfileDataToUse":
    ...
    def data_to_use(self: "Self", value: "_1988.ProfileDataToUse") -> None:
    ...
    @property
    def profile_to_fit(self: "Self") -> "_1990.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._1990", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: "Self", value: "_1990.ProfileToFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: "Self") -> "List[_2001.UserSpecifiedProfilePoint]":
