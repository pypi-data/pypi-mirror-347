...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2188, _2191
...
class _Cast_LoadedFluidFilmBearingPad:
    ...
    @property
    def loaded_tilting_journal_pad(self: "CastSelf") -> "_2188.LoadedTiltingJournalPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2188

        return self.__parent__._cast(_2188.LoadedTiltingJournalPad)

    @property
    def loaded_tilting_thrust_pad(self: "CastSelf") -> "_2191.LoadedTiltingThrustPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2191

        return self.__parent__._cast(_2191.LoadedTiltingThrustPad)
