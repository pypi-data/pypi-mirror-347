...
class _Cast_ISOTR1417912001Results:
    ...
    @property
    def isotr141792001_results(self: "CastSelf") -> "_2041.ISOTR141792001Results":
        return self.__parent__._cast(_2041.ISOTR141792001Results)
...
class ISOTR1417912001Results(_2041.ISOTR141792001Results):
    """ISOTR1417912001Results
