...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2034, _2095
...
class LoadedFourPointContactBallBearingResults(_2064.LoadedBallBearingResults):
    """LoadedFourPointContactBallBearingResults
    ...
    @property
    def raceway_control(self: "Self") -> "_2034.FrictionModelForGyroscopicMoment":
