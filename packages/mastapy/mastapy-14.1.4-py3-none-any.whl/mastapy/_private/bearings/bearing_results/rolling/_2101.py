...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2076, _2100, _2107
...
class LoadedSphericalRollerBearingElement(_2090.LoadedRollerBearingElement):
    """LoadedSphericalRollerBearingElement
