...
class _Cast_OuterRingFittingThermalResults:
    ...
    def ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2175.RingFittingThermalResults":
        return self.__parent__._cast(_2175.RingFittingThermalResults)
...
class OuterRingFittingThermalResults(_2175.RingFittingThermalResults):
    """OuterRingFittingThermalResults
