...
class Frequencies(_2158.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: "Self") -> "_2144.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: "Self") -> "_2156.RotationalFrequency":
