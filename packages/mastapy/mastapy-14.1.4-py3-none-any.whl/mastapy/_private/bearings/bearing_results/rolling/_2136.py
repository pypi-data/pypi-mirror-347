...
class _Cast_ThreePointContactInternalClearance:
    ...
    @property
    def internal_clearance(self: "CastSelf") -> "_2035.InternalClearance":
        return self.__parent__._cast(_2035.InternalClearance)
...
class ThreePointContactInternalClearance(_2035.InternalClearance):
    """ThreePointContactInternalClearance
