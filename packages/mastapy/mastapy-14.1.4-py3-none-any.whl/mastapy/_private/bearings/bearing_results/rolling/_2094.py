...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2063, _2078
...
class _Cast_LoadedRollingBearingRaceResults:
    ...
    def loaded_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2063.LoadedBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2063

        return self.__parent__._cast(_2063.LoadedBallBearingRaceResults)
