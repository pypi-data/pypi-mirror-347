...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2067, _2096
...
class LoadedCrossedRollerBearingRow(_2092.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2067.LoadedCrossedRollerBearingResults":
