...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2076, _2077, _2112
...
class LoadedMultiPointContactBallBearingElement(_2062.LoadedBallBearingElement):
    """LoadedMultiPointContactBallBearingElement
