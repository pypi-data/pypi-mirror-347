...
if __tc:
    ...
    from mastapy._private.nodal_analysis.system_solvers._122 import TransientSolver
    ...
    __import_structure = {
        ...
        "_private.nodal_analysis.system_solvers._122": ["TransientSolver"],
        "_private.nodal_analysis.system_solvers._123": ["WilsonThetaTransientSolver"],
    }
