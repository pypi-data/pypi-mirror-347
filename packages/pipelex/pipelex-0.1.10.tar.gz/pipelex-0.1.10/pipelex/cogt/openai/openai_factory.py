...
class OpenAIFactory:
    ...
    def make_openai_image_url(cls, prompt_image: PromptImage) -> ImageURL:
        if isinstance(prompt_image, PromptImageUrl):
            ...
            url_with_bytes: str = f"data:image/jpeg;base64,{prompt_image.image_bytes.decode('utf-8')}"
            ...
            return cls.make_openai_image_url(PromptImageBytes(image_bytes=image_bytes))
        else:
