...
def emoji_for_channel(channel_name: str) -> Optional[str]:
    ...
    if emoji == "":
        # blank emoji is OK (it's actually used for root)
        return emoji
    elif emoji:
        return emoji
    ...
    #     return f"📡 '{channel_name}'"
        ...
        # space added to make it look better
        return "🧿 "
    elif channel_name.startswith("cogt"):
        return "🧠"
    elif channel_name.startswith("deep_flow"):
        return "🧩"
    elif channel_name.startswith("pipelex"):
        return "🍔"
    elif channel_name.startswith("docs"):
        return "📑"
    elif channel_name.startswith("lunar_halo"):
        return "🌖"
    elif channel_name.startswith("api"):
        return "🎈"
    elif channel_name.startswith("sentinel"):
        return "🏮"
    elif channel_name.startswith("flask"):
        return "🏺"
    else:
        return None
