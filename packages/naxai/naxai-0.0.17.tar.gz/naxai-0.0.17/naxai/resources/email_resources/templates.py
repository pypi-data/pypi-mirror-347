...
class TemplatesResource:
    ...
    def get_shared(self, template_id: str):
        ...
        Example:
            ...
            >>> shared_template = client.email.templates.get_shared("tmpl_123abc")
            >>> 
    ...
    def list_shared(self,
        ...
        Example:
            ...
            >>> onboarding_templates = client.email.templates.list_shared(tags=["onboarding"])
    ...
    def delete(self, template_id: str):
        ...
        Example:
            ...
            >>> try:
            ...     result = client.email.templates.delete("tmpl_123abc")
    ...
    def update(self, template_id: str, data: CreateEmailTemplateRequest):
        ...
        Example:
            ...
            ... )
            >>> 
            >>> result = client.email.templates.update("tmpl_123abc", thumbnail_update)
    ...
    def get(self, template_id: str):
        ...
        Example:
            ...
            >>> template = client.email.templates.get("tmpl_123abc")
            >>> 
    ...
    def list(self,
        ...
        Example:
            ...
            >>> more_templates = client.email.templates.list(page=2, page_size=10)
    ...
    def create(self, data: CreateEmailTemplateRequest):
        ...
        Example:
            ...
            ... )
            >>> 
            >>> new_template = client.email.templates.create(template_data)
            >>> 
            ...
            ... )
            >>> 
            >>> result = client.email.templates.create(editor_template)
