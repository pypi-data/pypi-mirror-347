...
class OutboundResource:
    ...
    def list(self,
        ...
        return ListOutboundMetricsResponse.model_validate_json(json.dumps(self._client._request("GET", self.root_path, params=params, headers=self.headers)))
    ...
    def list_by_country(self,
        ...
        return ListOutboundCallsByCountryMetricsResponse.model_validate_json(json.dumps(self._client._request("GET", self.previous_path + "/outbound-by-country", params=params, headers=self.headers)))