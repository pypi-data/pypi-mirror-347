...
class MetricsResource:
    ...
    async def get(self, broadcast_id: str):
        ...
        return GetBroadcastMetricsResponse.model_validate_json(json.dumps(await self._client._request("GET", self.root_path + "/" + broadcast_id + "/metrics", headers=self.headers)))