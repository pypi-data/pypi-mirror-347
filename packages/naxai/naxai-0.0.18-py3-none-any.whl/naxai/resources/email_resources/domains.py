...
class DomainsResource:
    ...
    def verify(self, domain_id:str):
        ...
        Example:
            ...
            >>> verification = client.email.domains.verify(domain_id="dom_123abc")
            >>> 
    ...
    def get(self, domain_id: str):
        ...
        Example:
            ...
            >>> domain = client.email.domains.get(domain_id="dom_123abc")
            >>> 
    ...
    def create(self,
        ...
        Example:
            ...
            >>> new_domain = client.email.domains.create(
            ...
            >>> print(f"client.email.domains.verify(domain_id=\"{new_domain.id}\")")
