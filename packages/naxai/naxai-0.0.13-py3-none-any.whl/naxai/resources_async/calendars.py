...
class CalendarsResource:
    ...
    async def check(self,
        ...
        Example:
            >>> # Check current time
            >>> response = await client.calendars.check("cal_123abc")
            >>> if response.match_:
    ...
    async def delete_exclusions(self, calendar_id: str, exclusions: list[str]):
        ...
        Example:
            ...
            >>> result = await client.calendars.delete_exclusions(
            ...     "cal_123abc",
        ...
        return ExclusionResponse.model_validate_json(json.dumps(await self._client._request("POST", self.root_path + "/" + calendar_id + "/exclusions/remove", json={"exclusions": exclusions}, headers=self.headers)))
    ...
    async def add_exclusions(self, calendar_id: str, exclusions: list[str]):
        ...
        Example:
            ...
            >>> result = await client.calendars.add_exclusions(
            ...     "cal_123abc",
        ...
        return ExclusionResponse.model_validate_json(json.dumps(await self._client._request("POST", self.root_path + "/" + calendar_id + "/exclusions/add", json={"exclusions": exclusions}, headers=self.headers)))
    ...
    async def update(self, calendar_id: str, data: CreateCalendarRequest):
        ...
        Example:
            ...
            ...     ]
            ... )
            >>> updated_calendar = await client.calendars.update("cal_123abc", update_data)
        ...
        """
        return Calendar.model_validate_json(json.dumps(await self._client._request("PUT", self.root_path + "/" + calendar_id, json=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)))
    ...
    async def get(self, calendar_id: str):
        ...
        Example:
            >>> calendar = await client.calendars.get("cal_123abc")
            >>> print(calendar.name)
        ...
        return Calendar.model_validate_json(json.dumps(await self._client._request("GET", self.root_path + "/" + calendar_id, headers=self.headers)))
    ...
    async def create(self,
        ...
        Example:
            >>> new_calendar = await client.calendars.create(
            ...
            ... )
        """
        response = await self._client._request("POST", self.root_path, json=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)
