...
class ReportingResource:
    ...
    def list_outgoing_metrics(self,
        ...
        Example:
            ...
            >>> daily_metrics = client.sms.reporting.list_outgoing_metrics(
            ...     group="day",
            ...
            >>> hourly_metrics = client.sms.reporting.list_outgoing_metrics(
            ...     group="hour",
        ...
        return ListOutgoingSMSMetricsResponse.model_validate_json(json.dumps(self._client._request("GET", self.root_path + "/outgoing", params=params, headers=self.headers)))

    def list_outgoing_metrics_by_country(self,
                                        start_date: str,
                                        stop_date: str
                                        ):
        """
        ...
        return ListOutgoingSMSByCountryMetricsResponse.model_validate_json(json.dumps(self._client._request("GET", self.root_path + "/outgoing-by-country", params=params, headers=self.headers)))

    def list_incoming_metrics(self,
                            group: Literal["hour", "day", "month"],
                            start_date: str = Field(default=None),
                            stop_date: str = Field(default=None)
                            ):
        ...
        Example:
            ...
            >>> daily_metrics = client.sms.reporting.list_incoming_metrics(
            ...     group="day",
            ...     start_date="2023-01-01",
            ...     stop_date="2023-01-31"
            ... )
        ...
        return ListIncomingSMSMetricsResponse.model_validate_json(json.dumps(self._client._request("GET", self.root_path + "/incoming", params=params, headers=self.headers)))
    
    def list_delivery_errors_metrics(self,
                                    start_date: str,
                                    stop_date: str
                                    ):
        """
        ...
        Example:
            >>> error_metrics = client.sms.reporting.list_delivery_errors_metrics(
            ...     start_date="2023-01-01",
            ...     stop_date="2023-01-31"
            ... )
        ...
        return ListDeliveryErrorMetricsResponse.model_validate_json(json.dumps(self._client._request("GET", self.root_path + "/delivery-errors", params=params, headers=self.headers)))
