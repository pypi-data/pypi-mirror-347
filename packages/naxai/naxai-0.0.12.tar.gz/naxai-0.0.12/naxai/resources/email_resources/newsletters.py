...
class NewslettersResource:
    ...
    def create(self, data:CreateEmailNewsletterRequest):
        ...
        Example:
            ...
            ... )
            >>> 
            >>> new_newsletter = client.email.newsletters.create(newsletter_request)
            >>> 
            ...
            ... )
            >>> 
            >>> result = client.email.newsletters.create(scheduled_newsletter)
            >>> 
    ...
    def list(self, page: int = 1, page_size: int = Field(default=25, le=100, ge=1)):
        ...
        Example:
            ...
            >>> more_newsletters = client.email.newsletters.list(page=2, page_size=50)
    ...
    def get(self, newsletter_id: str):
        ...
        Example:
            ...
            >>> newsletter = client.email.newsletters.get("nws_123abc")
            >>> 
    ...
    def update(self, data: CreateEmailNewsletterRequest, newsletter_id: str):
        ...
        Example:
            ...
            >>> updated = client.email.newsletters.update(update_request, newsletter.newsletter_id)
            >>> 
            ...
            >>> existing = client.email.newsletters.get("nws_456def")
            >>> 
    ...
    def delete(self, newsletter_id: str):
        ...
        Example:
            ...
            ...     try:
            ...         client.email.newsletters.get(old_draft.newsletter_id)
            ...
            >>> try:
            ...     client.email.newsletters.delete("nws_456def")  # ID of a sent newsletter
            ... except Exception as e:
            ...     print(f"Error: {str(e)}")
