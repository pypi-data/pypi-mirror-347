...
class TransferResource:
    ...
    async def list(self,
        ...
        return ListTransferredMetricsResponse.model_validate_json(json.dumps(await self._client._request("GET", self.root_path, params=params, headers=self.headers)))