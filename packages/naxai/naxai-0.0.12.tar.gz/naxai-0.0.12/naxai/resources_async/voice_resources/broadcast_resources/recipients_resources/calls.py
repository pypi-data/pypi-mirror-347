...
class CallsResource:
    ...
    async def list(self, broadcast_id: str, recipient_id: str):
        ...
        return GetBroadcastRecipientCallsResponse.model_validate_json(json.dumps(await self._client._request("GET", self.root_path + "/" + broadcast_id + "/recipients/" + recipient_id + "/calls", headers=self.headers)))