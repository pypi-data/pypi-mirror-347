...
class ActivityLogsResource:
    ...
    async def list(self,
        ...
        Example:
            ...
            >>> response = await client.sms.activity_logs.list(
            ...     page=1,
            ...     page_size=50
            ... )
            ...
            >>> delivered = await client.sms.activity_logs.list(
            ...     start=one_week_ago,
            ...     stop=now,
            ...     direction="outbound",
            ...     status="delivered"
            ...
            >>> specific_number = await client.sms.activity_logs.list(
            ...
            >>> campaign_messages = await client.sms.activity_logs.list(
        ...
        return ListSMSActivityLogsResponse.model_validate_json(json.dumps(await self._client._request("GET", self.root_path, params=params, headers=self.headers)))
    ...
    async def get(self, message_id:str):
        ...
        Example:
            >>> message = await client.sms.activity_logs.get(
        ...
        """
        return GetSMSActivityLogsResponse.model_validate_json(json.dumps(await self._client._request("GET", self.root_path + "/" + message_id, headers=self.headers)))
