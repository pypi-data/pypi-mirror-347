...
class ActivityLogsResource:
    ...
    def get(self, message_id: str, email: str):
        ...
        """
        return GetEmailActivityLogsResponse.model_validate_json(json.dumps(self._client._request("GET", self.root_path + "/" + message_id + "/" + email, headers=self.headers)))
    ...
    def list(self,
        ...
        return ListEmailActivityLogsResponse.model_validate_json(json.dumps(self._client._request("GET", self.root_path, params=params, headers=self.headers)))