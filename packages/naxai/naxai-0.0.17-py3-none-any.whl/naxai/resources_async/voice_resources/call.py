...
class CallResource:
    ...
    async def _create(self, data: CreateCallRequest):
        """
        Creates a new call.
        ...
        Example:
            ...
            ... )
        """
        return await self._client._request("POST", "/voice/call", json=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)
    ...
    async def create(self,
        ...
        Example:
            ...
            >>> call = await client.voice.call.create(
