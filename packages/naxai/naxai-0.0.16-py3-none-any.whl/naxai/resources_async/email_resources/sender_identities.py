...
class SenderIdentitiesResource:
    ...
    async def update(self, sender_id: str, name: str, email: str):
        """
        ...
        Example:
            ...
            >>> updated_sender = await client.email.sender_identities.update(
            ...
            >>> current_sender = await client.email.sender_identities.get("snd_456def")
            >>> updated = await client.email.sender_identities.update(
        ...
        return UpdateSenderResponse.model_validate_json(json.dumps(await self._client._request("PUT", self.root_path + "/" + sender_id, json=payload, headers=self.headers)))

    async def delete(self, sender_id: str):
        """
        ...
        Example:
            ...
            >>> try:
            ...     result = await client.email.sender_identities.delete("snd_123abc")
            ...
            >>> try:
            ...     await client.email.sender_identities.delete("snd_456def")
            ... except Exception as e:
            ...     print(f"Error: {str(e)}")
        ...
        """
        return await self._client._request("DELETE", self.root_path + "/" + sender_id, headers=self.headers)
    ...
    async def get(self, sender_id: str):
        ...
        Example:
            ...
            >>> sender = await client.email.sender_identities.get("snd_123abc")
            >>> 
        ...
        See Also:
            ...
            delete: For removing a sender identity
        """
        return GetSenderResponse.model_validate_json(json.dumps(await self._client._request("GET", self.root_path + "/" + sender_id, headers=self.headers)))

    #TODO: email validation
    async def create(self, domain_id: str, email: str, name: str):
        """
        ...
        Example:
            ...
            >>> new_sender = await client.email.sender_identities.create(
            ...
            >>> marketing_sender = await client.email.sender_identities.create(
            ...     domain_id="dom_123abc",
        ...
        return CreateSenderResponse.model_validate_json(json.dumps(await self._client._request("POST", self.root_path, json=payload, headers=self.headers)))
    ...
    async def list(self,
        ...
        Example:
            ...
            >>> all_senders = await client.email.sender_identities.list()
        ...
        return ListSendersResponse.model_validate_json(json.dumps(await self._client._request("GET", self.root_path, params=params, headers=self.headers)))
