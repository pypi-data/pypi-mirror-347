...
class ContactUserExternalLocal(GenericMapping, metaclass=MetaLogger,
    ...
    # TODO Where do we insert the contact to the database?
    def insert_contact_and_link_to_existing_or_new_user_external(
        ...
        if user_external_dict:
            ...
            username = user_external_dict.get("username")
        ...
        if not user_external_id:
            ...
            profiles_ids_dicts = self.__get_external_profile_id_dict_from_urls(
                urls=[url, website1, website2, website3])
                ...
                for profile_id_dict in profiles_ids_dicts:
                    ...
                    for key, value in profile_id_dict.items():
                        ...
                        contact_user_external_id = \
                            self.insert_contact_user_external(contact_id, user_external_id)
        else:
    ...
    def insert_contact_user_external(
            self,
            contact_id: int,
            user_external_id: int) -> int or None:
