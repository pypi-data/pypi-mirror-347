...
let applyDiffToContent;
try {
    const diffUtils = require('../lib/utils/diff-utils');
    applyDiffToContent = diffUtils.applyDiffToContent;
...
function testDiffApplication() {
    ...
    // The expected result should have the new function added at the end (based on our improved implementation)
    ...
    // Note: This test is different because it has proper line numbers, so it will insert at the beginning
    const diff3 = '--- app.py\n+++ app.py\n@@ -1,5 +3,2 @@\n+def sample_function():\n+    print("This is a sample function for testing diffToFile.")\n';
    ...
    // With proper line numbers, the function is added at the beginning
    const expected3 = 'def sample_function():\n    print("This is a sample function for testing diffToFile.")\ndef main():\n    print("Hello, world!")\n\nif __name__ == "__main__":\n    main()';
    console.log('Expected content:', expected3);
    console.log('Test 3 result:', patchedContent3 === expected3 ? 'PASSED' : 'FAILED');
