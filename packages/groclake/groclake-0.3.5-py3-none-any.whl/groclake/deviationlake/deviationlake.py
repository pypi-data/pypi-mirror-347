    ...
    "properties": {
        ...
        "entities": {
            ...
            "properties": {
                ...
                "observation_id": {"type": "date"},
                "monitor_metric": {
                    "type": "nested",
                    "properties": {
                        "metric_name": {"type": "keyword"},
                        "metric_entities": {"type": "keyword"},  # can be keyword or text array
        ...
        "metadata": {
            "properties": {
                "deviationlake_id": {"type": "keyword"},
                "deviationlake_name": {"type": "text"},
                "ai_deviationlake_description": {"type": "text"},
