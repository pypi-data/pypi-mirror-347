...
class DeprecatedPass():
    ...
    def handle_logical(self, node: ir.Logical, parent: ir.Node):
        ...
        return node.reconstruct(node.engine, hoisted, body, node.annotations)
    ...
    def handle_output(self, node: ir.Output, parent: ir.Node):
        ...
        aliases = cast(
            ...
            rewrite_set(
                ...
                rewrite_alias,
                node.aliases))
        return node.reconstruct(node.engine, aliases, node.annotations)
    ...
    def handle_rank(self, node: ir.Rank, parent: ir.Node):
        ...
        return node.reconstruct(node.engine, relation, projection, group, args, node.arg_is_ascending, result, node.annotations)
