...
# TODO: this is an incomplete relation for ranking.
# It's mainly there to help type inference with the type of the result.
# It should not be used outside this context as it's not a valid relation.
rank = f.relation("rank", [
    f.input_field("projection", types.AnyList),
    f.input_field("group", types.AnyList),
    f.input_field("args", types.AnyList),
    f.input_field("arg_is_ascending", types.AnyList),
    f.field("result", types.Int),
])
