...
from ..clients.util import IdentityParser, escape_for_f_string, get_with_retries, poll_with_specified_overhead, safe_json_loads, sanitize_module_name, scrub_exception, wrap_with_request_id
...
class Resources(ResourcesBase):
    ...
    def get_export_code(self, params: ExportParams, all_installs):
        ...
        python_code = process_jinja_template(
            ...
            install_code=all_installs.replace("\\", '\\\\').replace("\"", "\\\"").replace("\n", "\\n"),
    ...
    def get_sproc_models(self, params: ExportParams):
        ...
        with debugging.span("get_sproc_models"):
            ...
            def output(name, model):
                ...
                and not starts_with(name, "pyrel_batch_0")
            """
