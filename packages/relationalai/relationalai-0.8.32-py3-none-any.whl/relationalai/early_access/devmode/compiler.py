...
from relationalai.early_access.metamodel import ir, compiler as c, visitor as v, factory as f, builtins, types, rewrite as rw, typer
...
class ModelToSQL:
    ...
    def _generate_statements(self, model: ir.Model) -> list[sql.Node]:
        ...
        for relation in model.relations:
            if not builtins.is_builtin(relation) and relation not in builtins.builtin_overloads:
