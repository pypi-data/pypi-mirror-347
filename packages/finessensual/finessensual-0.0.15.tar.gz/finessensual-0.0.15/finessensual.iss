...
;Source: "INSTALL.rtf"; DestDir: "{app}"; Flags: ignoreversion
...
var 
  Path: String;
begin
  Path := collectShellOutput( 'python3 -m site --user-base' );
  Result := GetExeOnPath('finessensual.exe', Path );
end;
