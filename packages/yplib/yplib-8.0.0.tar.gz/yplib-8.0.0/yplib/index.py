...
def to_print_file_thread(*args, file_path=None, file_name_use_path_with_date=False, file_name=None, file_name_prefix=None, file_name_suffix=None, mode='a', interval=None):
    """
    ...
    # 是否使用 to_print_file 功能, 默认为 False, 只有在 mode 非 'a' 的时候, 才会使用 to_print_file 功能
    __THREAD_LOCAL_INDEX_DATA._use_fun_flag = mode != 'a'
    # 存储函数引用
    __THREAD_LOCAL_INDEX_DATA._use_fun = to_print_file_thread
...
def to_print_date_file(*args, file_path=None, file_name_use_path_with_date=False, file_name=None, file_name_prefix=None, file_name_suffix=None, mode='a', interval=None):
    """
    将 文本输出到 date_file 中
    例如
    """
    ...
    __THREAD_LOCAL_INDEX_DATA._use_fun_flag = mode != 'a'
    # 存储函数引用
    __THREAD_LOCAL_INDEX_DATA._use_fun = to_print_date_file
...
def to_print_txt(*args, file_path=None, file_name_use_path_with_date=False, file_name=None, file_name_prefix=None, file_name_suffix=None, mode='a', interval=None):
    ...
    __THREAD_LOCAL_INDEX_DATA._use_fun_flag = mode != 'a'
    # 存储函数引用
    __THREAD_LOCAL_INDEX_DATA._use_fun = to_print_txt
...
def to_log_file(*args, file_path=None, file_name_use_path_with_date=False, file_name=None, file_name_prefix=None, file_name_suffix=None, time_prefix=True, mode='a', interval=None):
    ...
    __THREAD_LOCAL_INDEX_DATA._use_fun_flag = mode != 'a'
    # 存储函数引用
    __THREAD_LOCAL_INDEX_DATA._use_fun = to_log_file
...
def to_log_txt(*args, file_path=None, file_name_use_path_with_date=False, file_name=None, file_name_prefix=None, file_name_suffix=None, time_prefix=True, mode='a', interval=None):
    ...
    __THREAD_LOCAL_INDEX_DATA._use_fun_flag = mode != 'a'
    # 存储函数引用
    __THREAD_LOCAL_INDEX_DATA._use_fun = to_log_txt
