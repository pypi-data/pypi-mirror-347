...
def to_html(html_list: Union[list, str],
            name: str = None) -> None:
...
def to_text_html(text_list: list,
                 title: str = None,
                 return_file: bool = True) -> Union[str, None]:
    """
    text_list = [{
        name: '王小虎',
...
def insert_data_to_chart(html_data: str,
                         ...
                         series: Any = None,
                         smooth: int = 0,
                         x_min: Union[int, float, None] = None,
                         x_max: Union[int, float, None] = None,
                         return_file: bool = True) -> Union[list, None]:
    """
    将 html 中的占位符 替换成数据
    并且 导出 生成后的 html 文件
    """
...
def to_chart_table(x_list: Union[list, None] = None,
                   y_list: list = None,
                   name: str = None,
                   name_raw: bool = False):
    """
...
def to_chart_table_text(x_list: Union[list, None] = None,
                        y_list: Union[list, None] = None,
                        text_list: Union[list, None] = None,
                        name: str = None,
                        name_raw: bool = False):
    """
...
def to_chart_gantt(x_list: list = None,
    ...
    if x_list is None:
        x_list = []
    x_p_list: list[dict[str, Union[list, dict[str, Any]]]] = x_list
    # x_p_list = x_list
    y_p_list = y_list
