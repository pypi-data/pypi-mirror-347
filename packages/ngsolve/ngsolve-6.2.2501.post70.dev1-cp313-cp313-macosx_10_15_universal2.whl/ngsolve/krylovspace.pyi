...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('innerproduct', 'iterations', 'norm', 'restart')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('iterations', 'sol', 'atol', 'residuals', 'plotrates', 'fig', 'pre', 'ax', '_final_residual', 'ress', 'callback', 'maxiter', 'mat', 'display', 'printrates', 'its', 'callback_sol', 'clear_output', 'tol', 'plt')
