...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', 'time', 'dt', 'gfu_old', '_lin_solver_args', 'bfmstar', 'c')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', 'time', 'dt', 'gfu_old', 'gfv_old', '_lin_solver_args', 'bfmstar', 'c', 'gfa_old')
