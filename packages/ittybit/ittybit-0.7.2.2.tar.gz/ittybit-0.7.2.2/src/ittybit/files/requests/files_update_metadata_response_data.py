...
from ..types.files_update_metadata_response_data_kind import FilesUpdateMetadataResponseDataKind


class FilesUpdateMetadataResponseDataParams(typing_extensions.TypedDict):
    id: str
    """
    ...
    kind: FilesUpdateMetadataResponseDataKind
    """
