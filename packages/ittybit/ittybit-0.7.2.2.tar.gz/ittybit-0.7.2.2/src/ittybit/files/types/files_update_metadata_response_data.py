...
from .files_update_metadata_response_data_kind import FilesUpdateMetadataResponseDataKind


class FilesUpdateMetadataResponseData(UncheckedBaseModel):
    ...
    kind: FilesUpdateMetadataResponseDataKind = pydantic.Field()
    """
