...
from .task_workflow_item_kind import TaskWorkflowItemKind
from .task_workflow_item_status import TaskWorkflowItemStatus


class TaskWorkflowItem(UncheckedBaseModel):
    ...
    kind: TaskWorkflowItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TaskWorkflowItemStatus = pydantic.Field()
    """
