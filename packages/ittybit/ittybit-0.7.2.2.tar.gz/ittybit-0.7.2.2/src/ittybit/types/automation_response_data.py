...
class AutomationResponseData(UncheckedBaseModel):
    ...
    trigger: AutomationResponseDataTrigger = pydantic.Field()
    """
    The event and conditions that trigger this automation.
    """

    workflow: typing.List[AutomationResponseDataWorkflowItem] = pydantic.Field()
    """
    ...
    status: AutomationResponseDataStatus = pydantic.Field()
    """
