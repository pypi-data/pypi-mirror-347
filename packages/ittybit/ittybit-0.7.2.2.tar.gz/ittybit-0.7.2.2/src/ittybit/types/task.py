...
from .task_next_item import TaskNextItem
from .task_results import TaskResults
from .task_status import TaskStatus
from .task_workflow_item import TaskWorkflowItem
...
class Task(UncheckedBaseModel):
    ...
    workflow: typing.Optional[typing.List[TaskWorkflowItem]] = pydantic.Field(default=None)
    """
    Array of nested task objects representing the steps within this workflow task.
    """

    next: typing.Optional[typing.List[TaskNextItem]] = pydantic.Field(default=None)
    """
