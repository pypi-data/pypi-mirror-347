...
from .task_next_item_kind import TaskNextItemKind
from .task_next_item_status import TaskNextItemStatus


class TaskNextItem(UncheckedBaseModel):
    ...
    kind: TaskNextItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TaskNextItemStatus = pydantic.Field()
    """
