...
from .task_list_response_data_item_next_item import TaskListResponseDataItemNextItem
...
from .task_list_response_data_item_workflow_item import TaskListResponseDataItemWorkflowItem
...
class TaskListResponseDataItem(UncheckedBaseModel):
    ...
    kind: TaskListResponseDataItemKind = pydantic.Field()
    """
    ...
    status: TaskListResponseDataItemStatus = pydantic.Field()
    """
    ...
    workflow: typing.Optional[typing.List[TaskListResponseDataItemWorkflowItem]] = pydantic.Field(default=None)
    """
    Array of nested task objects representing the steps within this workflow task.
    """

    next: typing.Optional[typing.List[TaskListResponseDataItemNextItem]] = pydantic.Field(default=None)
    """
