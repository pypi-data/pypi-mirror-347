...
from .media_list_response_data_item_kind import MediaListResponseDataItemKind
from .media_list_response_data_item_sources_item import MediaListResponseDataItemSourcesItem
from .media_list_response_data_item_status import MediaListResponseDataItemStatus


class MediaListResponseDataItem(UncheckedBaseModel):
    ...
    kind: MediaListResponseDataItemKind = pydantic.Field()
    """
    ...
    sources: typing.List[MediaListResponseDataItemSourcesItem] = pydantic.Field()
    """
    ...
    status: MediaListResponseDataItemStatus = pydantic.Field()
    """
    Processing status.
    """
