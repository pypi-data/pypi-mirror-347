...
from ..types.media_list_response_data_item_sources_item_kind import MediaListResponseDataItemSourcesItemKind
from ..types.media_list_response_data_item_sources_item_orientation import (
    MediaListResponseDataItemSourcesItemOrientation,
)


class MediaListResponseDataItemSourcesItemParams(typing_extensions.TypedDict):
    """
    ...
    kind: MediaListResponseDataItemSourcesItemKind
    """
    ...
    orientation: typing_extensions.NotRequired[MediaListResponseDataItemSourcesItemOrientation]
    """
    Visual orientation.
    """
