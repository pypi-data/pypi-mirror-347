...
from ..types.automations_create_response_data_workflow_item_kind import AutomationsCreateResponseDataWorkflowItemKind


class AutomationsCreateResponseDataWorkflowItemParams(typing_extensions.TypedDict):
    kind: AutomationsCreateResponseDataWorkflowItemKind
    """
