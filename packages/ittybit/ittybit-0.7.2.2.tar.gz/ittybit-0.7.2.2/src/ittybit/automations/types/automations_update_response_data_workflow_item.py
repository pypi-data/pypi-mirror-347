...
from .automations_update_response_data_workflow_item_kind import AutomationsUpdateResponseDataWorkflowItemKind


class AutomationsUpdateResponseDataWorkflowItem(UncheckedBaseModel):
    kind: AutomationsUpdateResponseDataWorkflowItemKind = pydantic.Field()
    """
