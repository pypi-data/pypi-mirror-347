...
class AutomationsCreateResponseData(UncheckedBaseModel):
    ...
    trigger: AutomationsCreateResponseDataTrigger = pydantic.Field()
    """
    The event and conditions that trigger this automation.
    """

    workflow: typing.List[AutomationsCreateResponseDataWorkflowItem] = pydantic.Field()
    """
    ...
    status: AutomationsCreateResponseDataStatus = pydantic.Field()
    """
