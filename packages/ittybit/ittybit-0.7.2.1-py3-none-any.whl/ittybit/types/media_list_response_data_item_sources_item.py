...
from .media_list_response_data_item_sources_item_kind import MediaListResponseDataItemSourcesItemKind
from .media_list_response_data_item_sources_item_orientation import MediaListResponseDataItemSourcesItemOrientation


class MediaListResponseDataItemSourcesItem(UncheckedBaseModel):
    """
    ...
    kind: MediaListResponseDataItemSourcesItemKind = pydantic.Field()
    """
    ...
    orientation: typing.Optional[MediaListResponseDataItemSourcesItemOrientation] = pydantic.Field(default=None)
    """
    Visual orientation.
    """
