...
from .media_response_data_kind import MediaResponseDataKind
from .media_response_data_sources_item import MediaResponseDataSourcesItem
from .media_response_data_status import MediaResponseDataStatus


class MediaResponseData(UncheckedBaseModel):
    ...
    kind: MediaResponseDataKind = pydantic.Field()
    """
    ...
    sources: typing.List[MediaResponseDataSourcesItem] = pydantic.Field()
    """
    ...
    status: MediaResponseDataStatus = pydantic.Field()
    """
    Processing status.
    """
