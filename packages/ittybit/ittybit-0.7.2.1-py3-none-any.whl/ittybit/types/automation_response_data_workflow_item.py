...
from .automation_response_data_workflow_item_kind import AutomationResponseDataWorkflowItemKind


class AutomationResponseDataWorkflowItem(UncheckedBaseModel):
    kind: AutomationResponseDataWorkflowItemKind = pydantic.Field()
    """
