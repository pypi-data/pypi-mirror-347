...
from .media_response_data_sources_item_kind import MediaResponseDataSourcesItemKind
from .media_response_data_sources_item_orientation import MediaResponseDataSourcesItemOrientation


class MediaResponseDataSourcesItem(UncheckedBaseModel):
    """
    ...
    kind: MediaResponseDataSourcesItemKind = pydantic.Field()
    """
    ...
    orientation: typing.Optional[MediaResponseDataSourcesItemOrientation] = pydantic.Field(default=None)
    """
    Visual orientation.
    """
