...
from .media_get_response_data_sources_item_kind import MediaGetResponseDataSourcesItemKind
from .media_get_response_data_sources_item_orientation import MediaGetResponseDataSourcesItemOrientation


class MediaGetResponseDataSourcesItem(UncheckedBaseModel):
    """
    ...
    kind: MediaGetResponseDataSourcesItemKind = pydantic.Field()
    """
    ...
    orientation: typing.Optional[MediaGetResponseDataSourcesItemOrientation] = pydantic.Field(default=None)
    """
    Visual orientation.
    """
