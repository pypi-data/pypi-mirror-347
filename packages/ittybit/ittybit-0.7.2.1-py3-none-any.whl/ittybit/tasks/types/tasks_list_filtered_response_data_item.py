...
from .tasks_list_filtered_response_data_item_kind import TasksListFilteredResponseDataItemKind
from .tasks_list_filtered_response_data_item_next_item import TasksListFilteredResponseDataItemNextItem
from .tasks_list_filtered_response_data_item_results import TasksListFilteredResponseDataItemResults
from .tasks_list_filtered_response_data_item_status import TasksListFilteredResponseDataItemStatus
from .tasks_list_filtered_response_data_item_workflow_item import TasksListFilteredResponseDataItemWorkflowItem


class TasksListFilteredResponseDataItem(UncheckedBaseModel):
    ...
    kind: TasksListFilteredResponseDataItemKind = pydantic.Field()
    """
    ...
    status: TasksListFilteredResponseDataItemStatus = pydantic.Field()
    """
    ...
    workflow: typing.Optional[typing.List[TasksListFilteredResponseDataItemWorkflowItem]] = pydantic.Field(default=None)
    """
    Array of nested task objects representing the steps within this workflow task.
    """

    next: typing.Optional[typing.List[TasksListFilteredResponseDataItemNextItem]] = pydantic.Field(default=None)
    """
    Array representing subsequent tasks (e.g., in an automation). Structure may vary.
    """

    results: typing.Optional[TasksListFilteredResponseDataItemResults] = None
