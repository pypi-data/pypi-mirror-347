...
from .tasks_get_response_data_kind import TasksGetResponseDataKind
from .tasks_get_response_data_next_item import TasksGetResponseDataNextItem
from .tasks_get_response_data_results import TasksGetResponseDataResults
from .tasks_get_response_data_status import TasksGetResponseDataStatus
from .tasks_get_response_data_workflow_item import TasksGetResponseDataWorkflowItem


class TasksGetResponseData(UncheckedBaseModel):
    ...
    kind: TasksGetResponseDataKind = pydantic.Field()
    """
    ...
    status: TasksGetResponseDataStatus = pydantic.Field()
    """
    ...
    workflow: typing.Optional[typing.List[TasksGetResponseDataWorkflowItem]] = pydantic.Field(default=None)
    """
    Array of nested task objects representing the steps within this workflow task.
    """

    next: typing.Optional[typing.List[TasksGetResponseDataNextItem]] = pydantic.Field(default=None)
    """
    Array representing subsequent tasks (e.g., in an automation). Structure may vary.
    """

    results: typing.Optional[TasksGetResponseDataResults] = None
