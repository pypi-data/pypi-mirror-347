...
from .tasks_get_response_data_workflow_item_kind import TasksGetResponseDataWorkflowItemKind
from .tasks_get_response_data_workflow_item_status import TasksGetResponseDataWorkflowItemStatus


class TasksGetResponseDataWorkflowItem(UncheckedBaseModel):
    ...
    kind: TasksGetResponseDataWorkflowItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TasksGetResponseDataWorkflowItemStatus = pydantic.Field()
    """
