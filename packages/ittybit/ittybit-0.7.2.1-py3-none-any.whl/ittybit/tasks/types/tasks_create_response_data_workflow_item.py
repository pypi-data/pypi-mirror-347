...
from .tasks_create_response_data_workflow_item_kind import TasksCreateResponseDataWorkflowItemKind
from .tasks_create_response_data_workflow_item_status import TasksCreateResponseDataWorkflowItemStatus


class TasksCreateResponseDataWorkflowItem(UncheckedBaseModel):
    ...
    kind: TasksCreateResponseDataWorkflowItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TasksCreateResponseDataWorkflowItemStatus = pydantic.Field()
    """
