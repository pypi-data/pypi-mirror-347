...
from ..types.automation_response_data_workflow_item_kind import AutomationResponseDataWorkflowItemKind


class AutomationResponseDataWorkflowItemParams(typing_extensions.TypedDict):
    kind: AutomationResponseDataWorkflowItemKind
    """
