...
from ..types.task_response_data_workflow_item_kind import TaskResponseDataWorkflowItemKind
from ..types.task_response_data_workflow_item_status import TaskResponseDataWorkflowItemStatus


class TaskResponseDataWorkflowItemParams(typing_extensions.TypedDict):
    id: str
    """
    ...
    kind: TaskResponseDataWorkflowItemKind
    """
    The type of operation the task performs.
    """

    status: TaskResponseDataWorkflowItemStatus
    """
