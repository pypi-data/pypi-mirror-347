...
from ..types.task_response_data_next_item_kind import TaskResponseDataNextItemKind
from ..types.task_response_data_next_item_status import TaskResponseDataNextItemStatus


class TaskResponseDataNextItemParams(typing_extensions.TypedDict):
    id: str
    """
    ...
    kind: TaskResponseDataNextItemKind
    """
    The type of operation the task performs.
    """

    status: TaskResponseDataNextItemStatus
    """
