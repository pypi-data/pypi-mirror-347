...
from ..types.media_sources_item_kind import MediaSourcesItemKind
from ..types.media_sources_item_orientation import MediaSourcesItemOrientation


class MediaSourcesItemParams(typing_extensions.TypedDict):
    """
    ...
    orientation: typing_extensions.NotRequired[MediaSourcesItemOrientation]
    """
    Visual orientation.
    """
