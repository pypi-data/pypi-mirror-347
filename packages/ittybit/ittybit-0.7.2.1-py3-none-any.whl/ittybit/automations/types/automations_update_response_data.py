...
class AutomationsUpdateResponseData(UncheckedBaseModel):
    ...
    trigger: AutomationsUpdateResponseDataTrigger = pydantic.Field()
    """
    The event and conditions that trigger this automation.
    """

    workflow: typing.List[AutomationsUpdateResponseDataWorkflowItem] = pydantic.Field()
    """
    ...
    status: AutomationsUpdateResponseDataStatus = pydantic.Field()
    """
