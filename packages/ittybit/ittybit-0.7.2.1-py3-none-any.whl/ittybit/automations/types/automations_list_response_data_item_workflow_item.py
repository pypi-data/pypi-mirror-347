...
from .automations_list_response_data_item_workflow_item_kind import AutomationsListResponseDataItemWorkflowItemKind


class AutomationsListResponseDataItemWorkflowItem(UncheckedBaseModel):
    kind: AutomationsListResponseDataItemWorkflowItemKind = pydantic.Field()
    """
