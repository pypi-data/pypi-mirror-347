...
from .automations_get_response_data_workflow_item_kind import AutomationsGetResponseDataWorkflowItemKind


class AutomationsGetResponseDataWorkflowItem(UncheckedBaseModel):
    kind: AutomationsGetResponseDataWorkflowItemKind = pydantic.Field()
    """
