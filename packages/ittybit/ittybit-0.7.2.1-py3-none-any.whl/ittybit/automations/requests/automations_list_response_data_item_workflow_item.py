...
from ..types.automations_list_response_data_item_workflow_item_kind import (
    AutomationsListResponseDataItemWorkflowItemKind,
)


class AutomationsListResponseDataItemWorkflowItemParams(typing_extensions.TypedDict):
    kind: AutomationsListResponseDataItemWorkflowItemKind
    """
