...
from .files_get_response_data_kind import FilesGetResponseDataKind


class FilesGetResponseData(UncheckedBaseModel):
    ...
    kind: FilesGetResponseDataKind = pydantic.Field()
    """
