...
from ..types.files_get_response_data_kind import FilesGetResponseDataKind


class FilesGetResponseDataParams(typing_extensions.TypedDict):
    id: str
    """
