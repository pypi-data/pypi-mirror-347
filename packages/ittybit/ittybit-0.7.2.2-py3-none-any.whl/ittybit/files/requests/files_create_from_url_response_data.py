...
from ..types.files_create_from_url_response_data_kind import FilesCreateFromUrlResponseDataKind


class FilesCreateFromUrlResponseDataParams(typing_extensions.TypedDict):
    id: str
    """
    ...
    kind: FilesCreateFromUrlResponseDataKind
    """
