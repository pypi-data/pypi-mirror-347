...
from .tasks_list_filtered_response_data_item_next_item_kind import TasksListFilteredResponseDataItemNextItemKind
from .tasks_list_filtered_response_data_item_next_item_status import TasksListFilteredResponseDataItemNextItemStatus


class TasksListFilteredResponseDataItemNextItem(UncheckedBaseModel):
    ...
    kind: TasksListFilteredResponseDataItemNextItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TasksListFilteredResponseDataItemNextItemStatus = pydantic.Field()
    """
