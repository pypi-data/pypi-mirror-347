...
from ..types.tasks_get_response_data_next_item_kind import TasksGetResponseDataNextItemKind
from ..types.tasks_get_response_data_next_item_status import TasksGetResponseDataNextItemStatus


class TasksGetResponseDataNextItemParams(typing_extensions.TypedDict):
    id: str
    """
    ...
    kind: TasksGetResponseDataNextItemKind
    """
    The type of operation the task performs.
    """

    status: TasksGetResponseDataNextItemStatus
    """
