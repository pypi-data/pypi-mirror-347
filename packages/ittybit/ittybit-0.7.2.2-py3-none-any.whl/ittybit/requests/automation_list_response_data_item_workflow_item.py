...
from ..types.automation_list_response_data_item_workflow_item_kind import AutomationListResponseDataItemWorkflowItemKind


class AutomationListResponseDataItemWorkflowItemParams(typing_extensions.TypedDict):
    kind: AutomationListResponseDataItemWorkflowItemKind
    """
