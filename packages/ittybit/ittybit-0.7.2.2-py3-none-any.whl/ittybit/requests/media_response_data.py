...
from ..types.media_response_data_status import MediaResponseDataStatus
from .media_response_data_sources_item import MediaResponseDataSourcesItemParams
...
class MediaResponseDataParams(typing_extensions.TypedDict):
    ...
    sources: typing.Sequence[MediaResponseDataSourcesItemParams]
    """
    ...
    status: MediaResponseDataStatus
    """
    Processing status.
    """
