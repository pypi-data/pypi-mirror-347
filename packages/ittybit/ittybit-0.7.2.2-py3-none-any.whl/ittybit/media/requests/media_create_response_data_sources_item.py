...
from ..types.media_create_response_data_sources_item_kind import MediaCreateResponseDataSourcesItemKind
from ..types.media_create_response_data_sources_item_orientation import MediaCreateResponseDataSourcesItemOrientation


class MediaCreateResponseDataSourcesItemParams(typing_extensions.TypedDict):
    """
    ...
    kind: MediaCreateResponseDataSourcesItemKind
    """
    ...
    orientation: typing_extensions.NotRequired[MediaCreateResponseDataSourcesItemOrientation]
    """
    Visual orientation.
    """
