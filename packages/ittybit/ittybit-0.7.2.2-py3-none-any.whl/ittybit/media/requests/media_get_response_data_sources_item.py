...
from ..types.media_get_response_data_sources_item_kind import MediaGetResponseDataSourcesItemKind
from ..types.media_get_response_data_sources_item_orientation import MediaGetResponseDataSourcesItemOrientation


class MediaGetResponseDataSourcesItemParams(typing_extensions.TypedDict):
    """
    ...
    kind: MediaGetResponseDataSourcesItemKind
    """
    ...
    orientation: typing_extensions.NotRequired[MediaGetResponseDataSourcesItemOrientation]
    """
    Visual orientation.
    """
