...
from ..types.media_create_response_data_kind import MediaCreateResponseDataKind
from ..types.media_create_response_data_status import MediaCreateResponseDataStatus
from .media_create_response_data_sources_item import MediaCreateResponseDataSourcesItemParams


class MediaCreateResponseDataParams(typing_extensions.TypedDict):
    id: str
    """
    ...
    kind: MediaCreateResponseDataKind
    """
    ...
    sources: typing.Sequence[MediaCreateResponseDataSourcesItemParams]
    """
    ...
    status: MediaCreateResponseDataStatus
    """
    Processing status.
    """
