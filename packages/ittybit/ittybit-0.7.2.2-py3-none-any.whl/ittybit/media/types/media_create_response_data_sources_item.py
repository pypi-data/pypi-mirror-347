...
from .media_create_response_data_sources_item_kind import MediaCreateResponseDataSourcesItemKind
from .media_create_response_data_sources_item_orientation import MediaCreateResponseDataSourcesItemOrientation


class MediaCreateResponseDataSourcesItem(UncheckedBaseModel):
    """
    ...
    kind: MediaCreateResponseDataSourcesItemKind = pydantic.Field()
    """
    ...
    orientation: typing.Optional[MediaCreateResponseDataSourcesItemOrientation] = pydantic.Field(default=None)
    """
    Visual orientation.
    """
