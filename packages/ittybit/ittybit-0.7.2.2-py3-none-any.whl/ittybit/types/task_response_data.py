...
from .task_response_data_next_item import TaskResponseDataNextItem
...
from .task_response_data_workflow_item import TaskResponseDataWorkflowItem
...
class TaskResponseData(UncheckedBaseModel):
    ...
    kind: TaskResponseDataKind = pydantic.Field()
    """
    ...
    status: TaskResponseDataStatus = pydantic.Field()
    """
    ...
    workflow: typing.Optional[typing.List[TaskResponseDataWorkflowItem]] = pydantic.Field(default=None)
    """
    Array of nested task objects representing the steps within this workflow task.
    """

    next: typing.Optional[typing.List[TaskResponseDataNextItem]] = pydantic.Field(default=None)
    """
