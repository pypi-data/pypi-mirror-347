...
from .task_response_data_next_item_kind import TaskResponseDataNextItemKind
from .task_response_data_next_item_status import TaskResponseDataNextItemStatus


class TaskResponseDataNextItem(UncheckedBaseModel):
    ...
    kind: TaskResponseDataNextItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TaskResponseDataNextItemStatus = pydantic.Field()
    """
