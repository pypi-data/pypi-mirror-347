...
from .task_list_response_data_item_workflow_item_kind import TaskListResponseDataItemWorkflowItemKind
from .task_list_response_data_item_workflow_item_status import TaskListResponseDataItemWorkflowItemStatus


class TaskListResponseDataItemWorkflowItem(UncheckedBaseModel):
    ...
    kind: TaskListResponseDataItemWorkflowItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TaskListResponseDataItemWorkflowItemStatus = pydantic.Field()
    """
