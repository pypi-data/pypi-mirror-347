...
from .task_response_data_workflow_item_kind import TaskResponseDataWorkflowItemKind
from .task_response_data_workflow_item_status import TaskResponseDataWorkflowItemStatus


class TaskResponseDataWorkflowItem(UncheckedBaseModel):
    ...
    kind: TaskResponseDataWorkflowItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TaskResponseDataWorkflowItemStatus = pydantic.Field()
    """
