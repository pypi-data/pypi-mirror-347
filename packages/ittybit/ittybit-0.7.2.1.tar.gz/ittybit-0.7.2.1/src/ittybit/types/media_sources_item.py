...
from .media_sources_item_kind import MediaSourcesItemKind
from .media_sources_item_orientation import MediaSourcesItemOrientation


class MediaSourcesItem(UncheckedBaseModel):
    """
    ...
    kind: MediaSourcesItemKind = pydantic.Field()
    """
    ...
    orientation: typing.Optional[MediaSourcesItemOrientation] = pydantic.Field(default=None)
    """
    Visual orientation.
    """
