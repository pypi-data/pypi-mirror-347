...
from .automation_list_response_data_item_workflow_item_kind import AutomationListResponseDataItemWorkflowItemKind


class AutomationListResponseDataItemWorkflowItem(UncheckedBaseModel):
    kind: AutomationListResponseDataItemWorkflowItemKind = pydantic.Field()
    """
