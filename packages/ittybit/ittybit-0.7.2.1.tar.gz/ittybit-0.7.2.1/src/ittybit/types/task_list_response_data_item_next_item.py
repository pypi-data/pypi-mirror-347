...
from .task_list_response_data_item_next_item_kind import TaskListResponseDataItemNextItemKind
from .task_list_response_data_item_next_item_status import TaskListResponseDataItemNextItemStatus


class TaskListResponseDataItemNextItem(UncheckedBaseModel):
    ...
    kind: TaskListResponseDataItemNextItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TaskListResponseDataItemNextItemStatus = pydantic.Field()
    """
