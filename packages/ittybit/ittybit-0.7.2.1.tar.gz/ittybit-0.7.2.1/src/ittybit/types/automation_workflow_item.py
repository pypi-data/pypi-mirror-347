...
from .automation_workflow_item_kind import AutomationWorkflowItemKind


class AutomationWorkflowItem(UncheckedBaseModel):
    kind: AutomationWorkflowItemKind = pydantic.Field()
    """
