...
from .files_create_from_url_response_data_kind import FilesCreateFromUrlResponseDataKind


class FilesCreateFromUrlResponseData(UncheckedBaseModel):
    ...
    kind: FilesCreateFromUrlResponseDataKind = pydantic.Field()
    """
