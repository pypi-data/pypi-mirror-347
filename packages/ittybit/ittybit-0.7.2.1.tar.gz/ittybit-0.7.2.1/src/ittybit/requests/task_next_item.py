...
from ..types.task_next_item_kind import TaskNextItemKind
from ..types.task_next_item_status import TaskNextItemStatus


class TaskNextItemParams(typing_extensions.TypedDict):
    id: str
    """
    ...
    kind: TaskNextItemKind
    """
    The type of operation the task performs.
    """

    status: TaskNextItemStatus
    """
