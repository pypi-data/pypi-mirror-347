...
from ..types.media_list_response_data_item_status import MediaListResponseDataItemStatus
from .media_list_response_data_item_sources_item import MediaListResponseDataItemSourcesItemParams
...
class MediaListResponseDataItemParams(typing_extensions.TypedDict):
    ...
    kind: MediaListResponseDataItemKind
    """
    ...
    sources: typing.Sequence[MediaListResponseDataItemSourcesItemParams]
    """
    ...
    status: MediaListResponseDataItemStatus
    """
    Processing status.
    """
