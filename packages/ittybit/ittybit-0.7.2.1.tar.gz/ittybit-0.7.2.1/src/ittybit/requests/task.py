...
from .task_next_item import TaskNextItemParams
from .task_results import TaskResultsParams
from .task_workflow_item import TaskWorkflowItemParams
...
class TaskParams(typing_extensions.TypedDict):
    ...
    workflow: typing_extensions.NotRequired[typing.Sequence[TaskWorkflowItemParams]]
    """
    Array of nested task objects representing the steps within this workflow task.
    """

    next: typing_extensions.NotRequired[typing.Sequence[TaskNextItemParams]]
    """
