...
from .automations_create_response_data_workflow_item_kind import AutomationsCreateResponseDataWorkflowItemKind


class AutomationsCreateResponseDataWorkflowItem(UncheckedBaseModel):
    kind: AutomationsCreateResponseDataWorkflowItemKind = pydantic.Field()
    """
