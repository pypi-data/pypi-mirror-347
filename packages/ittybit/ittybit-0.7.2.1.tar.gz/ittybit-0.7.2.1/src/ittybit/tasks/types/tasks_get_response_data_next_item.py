...
from .tasks_get_response_data_next_item_kind import TasksGetResponseDataNextItemKind
from .tasks_get_response_data_next_item_status import TasksGetResponseDataNextItemStatus


class TasksGetResponseDataNextItem(UncheckedBaseModel):
    ...
    kind: TasksGetResponseDataNextItemKind = pydantic.Field()
    """
    The type of operation the task performs.
    """

    status: TasksGetResponseDataNextItemStatus = pydantic.Field()
    """
