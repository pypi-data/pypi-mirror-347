...
from .tasks_create_response_data_next_item import TasksCreateResponseDataNextItem
...
from .tasks_create_response_data_workflow_item import TasksCreateResponseDataWorkflowItem
...
class TasksCreateResponseData(UncheckedBaseModel):
    ...
    kind: TasksCreateResponseDataKind = pydantic.Field()
    """
    ...
    status: TasksCreateResponseDataStatus = pydantic.Field()
    """
    ...
    workflow: typing.Optional[typing.List[TasksCreateResponseDataWorkflowItem]] = pydantic.Field(default=None)
    """
    Array of nested task objects representing the steps within this workflow task.
    """

    next: typing.Optional[typing.List[TasksCreateResponseDataNextItem]] = pydantic.Field(default=None)
    """
