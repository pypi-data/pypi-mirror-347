...
from .media_get_response_data_kind import MediaGetResponseDataKind
from .media_get_response_data_sources_item import MediaGetResponseDataSourcesItem
from .media_get_response_data_status import MediaGetResponseDataStatus


class MediaGetResponseData(UncheckedBaseModel):
    ...
    kind: MediaGetResponseDataKind = pydantic.Field()
    """
    ...
    sources: typing.List[MediaGetResponseDataSourcesItem] = pydantic.Field()
    """
    ...
    status: MediaGetResponseDataStatus = pydantic.Field()
    """
    Processing status.
    """
