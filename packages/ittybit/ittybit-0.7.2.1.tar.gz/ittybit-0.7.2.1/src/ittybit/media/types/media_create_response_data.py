...
from .media_create_response_data_kind import MediaCreateResponseDataKind
from .media_create_response_data_sources_item import MediaCreateResponseDataSourcesItem
from .media_create_response_data_status import MediaCreateResponseDataStatus


class MediaCreateResponseData(UncheckedBaseModel):
    ...
    kind: MediaCreateResponseDataKind = pydantic.Field()
    """
    ...
    sources: typing.List[MediaCreateResponseDataSourcesItem] = pydantic.Field()
    """
    ...
    status: MediaCreateResponseDataStatus = pydantic.Field()
    """
    Processing status.
    """
