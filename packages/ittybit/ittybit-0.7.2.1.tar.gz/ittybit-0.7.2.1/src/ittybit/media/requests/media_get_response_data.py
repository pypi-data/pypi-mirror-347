...
from ..types.media_get_response_data_status import MediaGetResponseDataStatus
from .media_get_response_data_sources_item import MediaGetResponseDataSourcesItemParams
...
class MediaGetResponseDataParams(typing_extensions.TypedDict):
    ...
    sources: typing.Sequence[MediaGetResponseDataSourcesItemParams]
    """
    ...
    status: MediaGetResponseDataStatus
    """
    Processing status.
    """
