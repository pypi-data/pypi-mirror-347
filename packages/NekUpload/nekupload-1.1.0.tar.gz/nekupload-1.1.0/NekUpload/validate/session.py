        ...
        try:
            ...
            if IS_FORCING_DEFINED:
                warn_with_logging(f"Due to presence of FORCING, which currently has unkown rules, "
                                ...
                                f"check output file.")
                return True,["Due to presence of FORCING, unable to ascertain whether output shape is consistent with input check."]

            if IS_REFINEMENT_DEFINED:
                warn_with_logging((f"You have refinements in this file. Skipping output shape check as this "
                                "has not yet been implemented. "))
                return True,["Due to presence of REFINEMENTS, unable to ascertain whether output shape is consistent with input check."]
