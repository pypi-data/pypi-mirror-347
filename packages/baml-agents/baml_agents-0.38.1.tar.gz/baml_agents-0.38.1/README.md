...
[![PyPI Version](https://img.shields.io/badge/v0.38.1-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/baml-agents)
...
```bash
pip install "baml-agents>=0.38.1,<0.39.0"
```
