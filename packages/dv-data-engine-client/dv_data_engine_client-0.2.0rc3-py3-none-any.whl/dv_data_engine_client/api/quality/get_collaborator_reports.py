...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[GetCollaboratorReportsResponse400, GetCollaboratorReportsResponse404, list[Union["Finished", "Pending"]]]
]:
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            ...
            def _parse_response_200_item(data: object) -> Union["Finished", "Pending"]:
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    componentsschemas_quality_report_summary_type_0 = Pending.from_dict(data)
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_quality_report_summary_type_1 = Finished.from_dict(data)
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[GetCollaboratorReportsResponse400, GetCollaboratorReportsResponse404, list[Union['Finished', 'Pending']]]]
    """
