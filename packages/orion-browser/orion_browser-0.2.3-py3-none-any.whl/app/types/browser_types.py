...
from browser_use.controller.views import ClickElementAction, GoToUrlAction, InputTextAction, OpenTabAction, ScrollAction, SearchBaiduAction, SendKeysAction, SwitchTabAction, ClickByPositionAction
...
class BrowserAction(ActionModel):
    ...
    search_baidu: SearchBaiduAction | None = None
    go_to_url: GoToUrlAction | None = None
    click_element: ClickElementAction | None = None
    click_by_position: ClickByPositionAction | None = None
