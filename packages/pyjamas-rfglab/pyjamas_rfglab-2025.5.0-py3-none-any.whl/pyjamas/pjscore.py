...
class PyJAMAS(QtCore.QObject):
    ...
    def setupUI(self):
        ...
        self.addMenuItem(self.menuIO, 'Import mask as polylines ...', None, self.io.cbImportMasks)
        ...
        self.addMenuItem(self.menuOptions, 'Toggle highlighting objects under cursor', None,
        ...
        self.addMenuItem(self.menuClassifiers, 'Change neural net step size ...', None,
    ...
    def initData(self) -> bool:
        ...
        self.highlight_on_hover: bool = True  # whether to highlight the object under the cursor
