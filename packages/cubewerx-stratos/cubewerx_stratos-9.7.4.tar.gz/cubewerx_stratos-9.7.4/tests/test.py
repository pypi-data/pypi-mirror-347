#  $Id: test.py 79043 2025-05-05 19:50:09Z pomakis $
...
from cubewerx.stratos.Stratos import *
...
firstName  = stratos.credentials.get("firstName", "user")
print("Hello %s!" % firstName)

print("full version string: %s" % stratos.getVersionFull())
print("license expiration date: %s" % stratos.getLicenseExpirationDate())
...
##############################################################################
# Test adding and removing of layers.
##############################################################################
