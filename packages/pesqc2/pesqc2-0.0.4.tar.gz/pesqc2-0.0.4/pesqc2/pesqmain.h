...
float WB_InIIR_Hsos_8k[LINIIR] = { 0.251188 * 2.6657628f, 0.251188 * -5.3315255f, 0.251188 * 2.6657628f,  -1.8890331f,  0.89487434f }; // Corrigendum 2 coefficients
long WB_InIIR_Nsos_16k = 1L;
//float WB_InIIR_Hsos_16k[LINIIR] = {
//    2.740826f,  -5.4816519f,  2.740826f,  -1.9444777f,  0.94597794f };
float WB_InIIR_Hsos_16k[LINIIR] = { 0.251188 * 2.740826f, 0.251188 * -5.4816519f,  0.251188 * 2.740826f,  -1.9444777f,  0.94597794f }; // Corrigendum 2 coefficients
