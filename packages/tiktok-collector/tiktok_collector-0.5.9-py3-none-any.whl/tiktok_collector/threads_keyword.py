...
class ThreadsKeywordCollector:
    ...
    def __init__(self, api_key, country_code="VN", max_post_by_keyword=100, max_keyword_post_retry=3):
        """
        ...
        try:
            ...
            for i in content_list:
                try:
                    ...
                    user_id = i["node"]["thread"]["thread_items"][0]["post"]["user"]["id"]
                    username = i["node"]["thread"]["thread_items"][0]["post"]["user"]["username"]
                    ...
                    caption = i["node"]["thread"]["thread_items"][0]["post"]["caption"]["text"]
                    num_like = i["node"]["thread"]["thread_items"][0]["post"]["like_count"]
                    reply_count = i["node"]["thread"]["thread_items"][0]["post"]["text_post_app_info"]["direct_reply_count"]
                    repost_count = i["node"]["thread"]["thread_items"][0]["post"]["text_post_app_info"]["repost_count"]
                    taken_at = i["node"]["thread"]["thread_items"][0]["post"]["taken_at"]
