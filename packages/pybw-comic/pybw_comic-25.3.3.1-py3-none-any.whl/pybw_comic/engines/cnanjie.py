...
def get_dic_xpath():
    dic_xpath = {
                 ...
                 'catelogue-booktopic': '//*[@id="intro_l"]/div[2]/p[5]/a', 
                 'catelogue-bookstate': '//*[@id="intro_l"]/div[2]/p[1]/span', 
                 'catelogue-bookname': '/html/body/div[5]/div[1]/div/div/strong', 
...
class Catelogue():
    '''
    '''
    def __init__(self, url='https://www.cnanjie.com/manhua/cheyezhige/', headless=False):
        '''
        彻夜之歌: https://www.cnanjie.com/manhua/cheyezhige/
        '''
        self.url = url
...
class OneChapter():
    '''
    '''
    def __init__(self, url='https://www.cnanjie.com/manhua/cheyezhige/1762787.html', headless=False):
        self.url = url
        self._headless = headless
        ...
        self.image_url = self.images = self.get_image_url(self.driver)
    ...
    def get_image_url(self, driver):
        ...
        if not finds:
            raise Exception('\nLoad webpage fail, or do not find elements\n')
        images_url = [i.get_property(dic_xpath['onechapter-image-Property_url']) for i in finds]
...
class Book():
    ...
    '''
    def __init__(self, 
                 url='https://www.cnanjie.com/manhua/cheyezhige/', 
                 dire='', 
                 headless=False):
        self.url = url
        self._headless = headless
        
        self.website_label = 'cnanjie'
    ...
    def download(self, start_label=''):
        ...
        for chap_index, chapter in enumerate(self.chapters):
            ...
            # for i, image in enumerate(images):
                ...
                # wget.download(url_d, file_path + ImageDownloader._detect_filetype(url_d))
...
if __name__ == '__main__':
    ...
    urls = [
            'https://www.cnanjie.com/manhua/cheyezhige/', 
           ]
