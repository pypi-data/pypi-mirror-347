# -*- coding: utf-8 -*-
"""
author: Bowei Pu at 2022.09.21
version: 2023.06.20
function: Comic spider for https://manhua.dmzj.com/
"""
...
def init_driver_old(headless=False, if_return=False):
    global driver
...
def get_dic_xpath():
    dic_xpath = {
                 'catelogue-booktopic': '/html/body/div[5]/div[3]/div/div[1]/div[2]/div/div[4]/table/tbody/tr[7]/td', 
                 'catelogue-bookstate': '/html/body/div[5]/div[3]/div/div[1]/div[2]/div/div[4]/table/tbody/tr[5]/td/a', 
                 'catelogue-bookname': '/html/body/div[5]/div[2]/div[1]/div[1]/div[2]/span[1]/a/h1',
...
class OneChapter():
    def __init__(self, url='', url_referer=''):
        url_test = 'https://manhua.dmzj.com/engagekiss/127107.shtml'
        self.url = url if url else url_test
        
        self.req = requests.get(self.url, headers=HEADERS)
        if self.req.status_code != 200:
            raise Exception('requests status_code donot equal 200')
