...
class EnvironmentSearchResult(_message.Message):
    __slots__ = ["id", "is_custom_environment", "last_updated", "name"]
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., last_updated: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., is_custom_environment: bool = ...) -> None: ...
