...
class Partitioning(ABC):
    ...
    def partition_expression(self, table: pypika.queries.Selectable) -> pypika.terms.Term:
        raise NotImplementedError
...
class JoinKeyHashPartitioning(Partitioning):
    ...
    def partition_expression(self, table: pypika.queries.Selectable) -> pypika.terms.Term:
        ...
        return pypika.terms.Function(
            BUCKET_TRANSFORM_FUN, table.field(self._join_keys[0]), pypika.terms.LiteralValue(str(self._buckets))
        )
            ...
            pypika.terms.Function(
                ...
                pypika.terms.Function(
                    ...
                    pypika.terms.LiteralValue(
                        ...
                        f"(x, i) -> if(x > {table.field(self._join_keys[0]).get_sql()}, i - 1, NULL)"
                    ),
                ),
            ),
