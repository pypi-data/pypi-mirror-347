...
from pinaxai.api.schemas.user import TeamSchema
from pinaxai.api.schemas.workspace import WorkspaceSchema
from pinaxai.infra.base import InfraBase
...
class WorkspaceConfig(BaseModel):
    """The WorkspaceConfig holds the configuration for an Pinaxai workspace."""
    ...
    def workspace_settings(self) -> Optional[WorkspaceSettings]:
        ...
        try:
            from pinaxai.utils.py_io import get_python_objects_from_module
