...
class WorkspaceSettings(BaseSettings):
    ...
    # default env for pinaxai ws commands
    default_env: Optional[str] = "dev"
    # default infra for pinaxai ws commands
    default_infra: Optional[str] = None

    # Image Settings
    # Repository for images
    image_repo: str = "pinaxlabs"
    ...
    # ag cli settings
    # Set to True if Pinaxai should continue creating
    # resources after a resource creation has failed
    continue_on_create_failure: bool = False
    # Set to True if Pinaxai should continue deleting
    ...
    # Set to True if Pinaxai should continue patching
