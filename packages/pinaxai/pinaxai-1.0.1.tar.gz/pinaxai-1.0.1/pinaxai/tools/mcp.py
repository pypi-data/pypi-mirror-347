...
from pinaxai.utils.mcp import get_entrypoint_for_tool
...
class MCPTools(Toolkit):
    """
    A toolkit for integrating Model Context Protocol (MCP) servers with Pinaxai agents.
...
class MultiMCPTools(Toolkit):
    """
    A toolkit for integrating multiple Model Context Protocol (MCP) servers with Pinaxai agents.
    This allows agents to access tools, resources, and prompts exposed by MCP servers.
