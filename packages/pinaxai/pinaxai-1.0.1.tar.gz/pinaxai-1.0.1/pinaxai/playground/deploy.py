...
from pinaxai.api.playground import deploy_playground_archive
...
def deploy_archive(name: str, tar_path: Path) -> None:
    """Deploying the tar archive to pinaxai-cloud.
...
def deploy_playground_app(
    ...
    """Deploy a playground application to pinaxai-cloud.

    This function:
    1. Creates a tar archive of the root directory.
    2. Uploades the archive to pinaxai-cloud.
    ...
    pinaxai_cli_settings.gate_alpha_feature()
