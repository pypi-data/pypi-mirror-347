...
class InfraResource(InfraBase):
    ...
    def get_input_file_path(self) -> Optional[Path]:
        ...
        if workspace_dir is None:
            from pinaxai.workspace.helpers import get_workspace_dir_from_env
    ...
    def save_output_file(self) -> bool:
        ...
        if output_file_path is not None:
            try:
                from pinaxai.utils.yaml_io import write_yaml_file
    ...
    def read_resource_from_file(self) -> Optional[Dict[str, Any]]:
        ...
        if output_file_path is not None:
            try:
                from pinaxai.utils.yaml_io import read_yaml_file
