...
def factoranalysis(factorname = 'bplf_regression', freq = 'm', dbo = None, factor0= None ,  indexcode = '000906.SH'):

    indexstockpool = indexmemberseries(indexcode=[indexcode], dbo = dbo)
