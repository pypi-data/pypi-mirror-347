...
class Debugger:
    ...
    def add_breakpoint(self, module=None, function_name=None):
    ...
    def handle_breakpoint(self, frame):
        ...
        while True:
            try:
                ...
                if command == 'run' or command == 'r':
                    ...
                    break
                if command == 'breakpoint-module' or command == 'bm':
                ...
                if command == 'breakpoint-function' or command == 'bf':
