...
class DbPriceList:
    def __init__(self, ativo, codigo_filial, codigo_lista_preco, data_final, data_inicial, descricao_lista_preco, prioridade, tipo_escopo, cliente_erp, calcula_ipi='S', **kwargs):
