...
class InvoiceMplace:
    def __init__(self, pedido_oking_id: str, numero_nf: str, serie_nf: str, chave_nf: str, valor_nf: float, data_emissao_nf: str,
                 link_danfe: str, link_xml: str, xml_nf: str, last_invoice: bool = True):
