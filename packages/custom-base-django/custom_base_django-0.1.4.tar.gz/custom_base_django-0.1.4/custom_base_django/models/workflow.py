...
from custom_base_django.models. base import BaseModelWitDateNotFiscalDelete, BaseModelContentType, BaseStructure
from custom_base_django.models. choices import Choices
