...
class AssistantMessageBlock:
    type: Literal["llm","content", "search",
                  ...
                  'image','tool_call','text/event-stream',"video","audio","select"]
...
@dataclass
class AgentSelectBlock:
    description: str
    params: Optional[list[AgentSelectItemBlock]] = None
    select_type: Literal["single", "multiple", "time"] = "single"
