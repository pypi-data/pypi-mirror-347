...
class GetPermissionPermissionsLinksTypedDict(TypedDict):
    documentation: NotRequired[GetPermissionPermissionsDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class GetPermissionPermissionsLinks(BaseModel):
    documentation: Optional[GetPermissionPermissionsDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetPermissionPermissionsResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[GetPermissionPermissionsLinks], pydantic.Field(alias="_links")
    ] = None
...
class GetPermissionPermissionsResponseBody(Exception):
    ...
    def __init__(self, data: GetPermissionPermissionsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetPermissionPermissionsResponseBodyData)
