...
class GetClientClientsLinksTypedDict(TypedDict):
    documentation: NotRequired[GetClientClientsDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class GetClientClientsLinks(BaseModel):
    documentation: Optional[GetClientClientsDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetClientClientsResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[GetClientClientsLinks], pydantic.Field(alias="_links")
    ] = None
