...
class GetTerminalTerminalsResponseBody(Exception):
    ...
    data: GetTerminalTerminalsResponseBodyData

    def __init__(self, data: GetTerminalTerminalsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetTerminalTerminalsResponseBodyData)
...
class GetTerminalLinksTypedDict(TypedDict):
    ...
    self_: NotRequired[GetTerminalSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    documentation: NotRequired[GetTerminalDocumentationTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetTerminalLinks(BaseModel):
    ...
    self_: Annotated[Optional[GetTerminalSelf], pydantic.Field(alias="self")] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    documentation: Optional[GetTerminalDocumentation] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""


class GetTerminalResponseBodyTypedDict(TypedDict):
...
class GetTerminalResponseBody(BaseModel):
    r"""The terminal object."""
