...
class RequestApplePayPaymentSessionLinksTypedDict(TypedDict):
    documentation: NotRequired[RequestApplePayPaymentSessionDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class RequestApplePayPaymentSessionLinks(BaseModel):
    documentation: Optional[RequestApplePayPaymentSessionDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class RequestApplePayPaymentSessionResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[RequestApplePayPaymentSessionLinks], pydantic.Field(alias="_links")
    ] = None
