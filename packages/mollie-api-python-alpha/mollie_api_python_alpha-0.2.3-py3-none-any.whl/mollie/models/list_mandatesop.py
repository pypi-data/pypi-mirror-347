...
class ListMandatesMandatesResponseLinksTypedDict(TypedDict):
    documentation: NotRequired[ListMandatesMandatesResponseDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class ListMandatesMandatesResponseLinks(BaseModel):
    documentation: Optional[ListMandatesMandatesResponseDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class ListMandatesMandatesResponseResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[ListMandatesMandatesResponseLinks], pydantic.Field(alias="_links")
    ] = None
...
class ListMandatesMandatesLinksTypedDict(TypedDict):
    documentation: NotRequired[ListMandatesMandatesDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class ListMandatesMandatesLinks(BaseModel):
    documentation: Optional[ListMandatesMandatesDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class ListMandatesMandatesResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[ListMandatesMandatesLinks], pydantic.Field(alias="_links")
    ] = None
