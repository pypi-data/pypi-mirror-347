...
class CreateCustomerPaymentLinksTypedDict(TypedDict):
    ...
    self_: NotRequired[CreateCustomerPaymentSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: NotRequired[CreateCustomerPaymentPaymentTypedDict]
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class CreateCustomerPaymentLinks(BaseModel):
    ...
    self_: Annotated[
        Optional[CreateCustomerPaymentSelf], pydantic.Field(alias="self")
    ] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    payment: Optional[CreateCustomerPaymentPayment] = None
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""


class CreateCustomerPaymentRoutingTypedDict(TypedDict):
    amount: NotRequired[CreateCustomerPaymentCustomersRequestRequestBodyAmountTypedDict]
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    destination: NotRequired[CreateCustomerPaymentDestinationTypedDict]
    r"""The destination of this portion of the payment."""
    ...
    """
    links: NotRequired[Nullable[CreateCustomerPaymentLinksTypedDict]]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""


class CreateCustomerPaymentRouting(BaseModel):
    amount: Optional[CreateCustomerPaymentCustomersRequestRequestBodyAmount] = None
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""

    destination: Optional[CreateCustomerPaymentDestination] = None
    r"""The destination of this portion of the payment."""
    ...
    links: Annotated[
        OptionalNullable[CreateCustomerPaymentLinks], pydantic.Field(alias="_links")
    ] = UNSET
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class CreateCustomerPaymentCustomersResponse503Links(BaseModel):
    documentation: Optional[CreateCustomerPaymentCustomersResponseDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class CreateCustomerPaymentCustomersResponseResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[CreateCustomerPaymentCustomersResponse503Links],
...
class CreateCustomerPaymentCustomersResponse422LinksTypedDict(TypedDict):
    documentation: NotRequired[CreateCustomerPaymentCustomersDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class CreateCustomerPaymentCustomersResponse422Links(BaseModel):
    documentation: Optional[CreateCustomerPaymentCustomersDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class CreateCustomerPaymentCustomersResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[CreateCustomerPaymentCustomersResponse422Links],
        pydantic.Field(alias="_links"),
    ] = None
...
class CreateCustomerPaymentCustomersResponseLinksTypedDict(TypedDict):
    ...
    self_: NotRequired[CreateCustomerPaymentCustomersResponseSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: NotRequired[CreateCustomerPaymentCustomersPaymentTypedDict]
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class CreateCustomerPaymentCustomersResponseLinks(BaseModel):
    ...
    self_: Annotated[
        Optional[CreateCustomerPaymentCustomersResponseSelf],
        pydantic.Field(alias="self"),
    ] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    payment: Optional[CreateCustomerPaymentCustomersPayment] = None
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class CreateCustomerPaymentCustomersRoutingTypedDict(TypedDict):
    ...
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    destination: NotRequired[CreateCustomerPaymentCustomersDestinationTypedDict]
    r"""The destination of this portion of the payment."""
    release_date: NotRequired[Nullable[str]]
    r"""Optionally, schedule this portion of the payment to be transferred to its destination on a later date. The date must be given in `YYYY-MM-DD` format.
    ...
    If no date is given, the funds become available to the connected merchant as soon as the payment succeeds.
    """
    links: NotRequired[Nullable[CreateCustomerPaymentCustomersResponseLinksTypedDict]]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class CreateCustomerPaymentCustomersRouting(BaseModel):
    ...
    destination: Optional[CreateCustomerPaymentCustomersDestination] = None
    r"""The destination of this portion of the payment."""
    ...
    links: Annotated[
        OptionalNullable[CreateCustomerPaymentCustomersResponseLinks],
        pydantic.Field(alias="_links"),
    ] = UNSET
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class CreateCustomerPaymentCustomersLinksTypedDict(TypedDict):
    ...
    self_: NotRequired[CreateCustomerPaymentCustomersSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    checkout: NotRequired[Nullable[CreateCustomerPaymentCheckoutTypedDict]]
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""
    mobile_app_checkout: NotRequired[
        Nullable[CreateCustomerPaymentMobileAppCheckoutTypedDict]
    ]
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
    change_payment_state: NotRequired[
        Nullable[CreateCustomerPaymentChangePaymentStateTypedDict]
    ]
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different payment states.
    ...
    Secondly, for paid test mode payments. The payment state screen will then allow you to create a refund or chargeback for the test payment.
    """
    dashboard: NotRequired[CreateCustomerPaymentDashboardTypedDict]
    r"""Direct link to the payment in the Mollie Dashboard."""
    refunds: NotRequired[Nullable[CreateCustomerPaymentRefundsTypedDict]]
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
    ...
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
    settlement: NotRequired[Nullable[CreateCustomerPaymentSettlementTypedDict]]
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""
    customer: NotRequired[Nullable[CreateCustomerPaymentCustomerTypedDict]]
    r"""The API resource URL of the [customer](get-customer)."""
    mandate: NotRequired[Nullable[CreateCustomerPaymentMandateTypedDict]]
    r"""The API resource URL of the [mandate](get-mandate)."""
    subscription: NotRequired[Nullable[CreateCustomerPaymentSubscriptionTypedDict]]
    r"""The API resource URL of the [subscription](get-subscription)."""
    order: NotRequired[Nullable[CreateCustomerPaymentOrderTypedDict]]
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""
    terminal: NotRequired[Nullable[CreateCustomerPaymentTerminalTypedDict]]
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""
...
class CreateCustomerPaymentCustomersLinks(BaseModel):
    ...
    self_: Annotated[
        Optional[CreateCustomerPaymentCustomersSelf], pydantic.Field(alias="self")
    ] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    checkout: OptionalNullable[CreateCustomerPaymentCheckout] = UNSET
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""

    mobile_app_checkout: Annotated[
        OptionalNullable[CreateCustomerPaymentMobileAppCheckout],
        pydantic.Field(alias="mobileAppCheckout"),
    ] = UNSET
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""

    change_payment_state: Annotated[
        OptionalNullable[CreateCustomerPaymentChangePaymentState],
    ...
    dashboard: Optional[CreateCustomerPaymentDashboard] = None
    r"""Direct link to the payment in the Mollie Dashboard."""

    refunds: OptionalNullable[CreateCustomerPaymentRefunds] = UNSET
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
    ...
    settlement: OptionalNullable[CreateCustomerPaymentSettlement] = UNSET
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""

    customer: OptionalNullable[CreateCustomerPaymentCustomer] = UNSET
    r"""The API resource URL of the [customer](get-customer)."""

    mandate: OptionalNullable[CreateCustomerPaymentMandate] = UNSET
    r"""The API resource URL of the [mandate](get-mandate)."""

    subscription: OptionalNullable[CreateCustomerPaymentSubscription] = UNSET
    r"""The API resource URL of the [subscription](get-subscription)."""

    order: OptionalNullable[CreateCustomerPaymentOrder] = UNSET
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""

    terminal: OptionalNullable[CreateCustomerPaymentTerminal] = UNSET
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""
...
class CreateCustomerPaymentResponseBodyTypedDict(TypedDict):
    ...
    The maximum length of the description field differs per payment method, with the absolute maximum being 255 characters. The API will not reject strings longer than the maximum length but it will truncate them to fit.
    """
    amount: NotRequired[CreateCustomerPaymentCustomersResponseAmountTypedDict]
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
    ...
    If a tip was added for a Point-of-Sale payment, the amount will be updated to reflect the initial amount plus the tip amount.
    """
    amount_refunded: NotRequired[Nullable[CreateCustomerPaymentAmountRefundedTypedDict]]
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""
    amount_remaining: NotRequired[
        Nullable[CreateCustomerPaymentAmountRemainingTypedDict]
    ]
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
    amount_captured: NotRequired[Nullable[CreateCustomerPaymentAmountCapturedTypedDict]]
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
    amount_charged_back: NotRequired[
        Nullable[CreateCustomerPaymentAmountChargedBackTypedDict]
    ]
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""
    settlement_amount: NotRequired[
        Nullable[CreateCustomerPaymentSettlementAmountTypedDict]
    ]
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
    ...
    links: NotRequired[CreateCustomerPaymentCustomersLinksTypedDict]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class CreateCustomerPaymentResponseBody(BaseModel):
    ...
    amount: Optional[CreateCustomerPaymentCustomersResponseAmount] = None
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
    ...
    amount_refunded: Annotated[
        OptionalNullable[CreateCustomerPaymentAmountRefunded],
        pydantic.Field(alias="amountRefunded"),
    ] = UNSET
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""

    amount_remaining: Annotated[
        OptionalNullable[CreateCustomerPaymentAmountRemaining],
        pydantic.Field(alias="amountRemaining"),
    ] = UNSET
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""

    amount_captured: Annotated[
        OptionalNullable[CreateCustomerPaymentAmountCaptured],
        pydantic.Field(alias="amountCaptured"),
    ] = UNSET
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""

    amount_charged_back: Annotated[
        OptionalNullable[CreateCustomerPaymentAmountChargedBack],
        pydantic.Field(alias="amountChargedBack"),
    ] = UNSET
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""

    settlement_amount: Annotated[
        OptionalNullable[CreateCustomerPaymentSettlementAmount],
    ...
    links: Annotated[
        Optional[CreateCustomerPaymentCustomersLinks], pydantic.Field(alias="_links")
    ] = None
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
