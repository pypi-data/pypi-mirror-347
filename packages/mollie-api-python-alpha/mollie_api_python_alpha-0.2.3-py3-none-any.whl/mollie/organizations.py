...
class Organizations(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "404", "application/hal+json"):
            response_data = utils.unmarshal_json(
                http_res.text, models.GetOrganizationOrganizationsResponseBodyData
            )
            raise models.GetOrganizationOrganizationsResponseBody(data=response_data)
    ...
    def get_partner(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/hal+json"):
            return utils.unmarshal_json(
                http_res.text, models.GetPartnerStatusResponseBody
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
