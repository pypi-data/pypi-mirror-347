...
class GetSubscriptionSubscriptionsLinksTypedDict(TypedDict):
    documentation: NotRequired[GetSubscriptionSubscriptionsDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class GetSubscriptionSubscriptionsLinks(BaseModel):
    documentation: Optional[GetSubscriptionSubscriptionsDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetSubscriptionSubscriptionsResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[GetSubscriptionSubscriptionsLinks], pydantic.Field(alias="_links")
    ] = None
