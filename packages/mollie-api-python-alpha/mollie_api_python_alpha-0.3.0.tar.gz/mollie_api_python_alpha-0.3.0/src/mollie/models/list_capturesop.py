...
class ListCapturesQueryParamInclude(str, Enum):
...
class ListCapturesRequestTypedDict(TypedDict):
    ...
    include: NotRequired[ListCapturesQueryParamInclude]
    r"""This endpoint allows you to include additional information via the `include` query string parameter."""
...
class ListCapturesRequest(BaseModel):
    ...
    include: Annotated[
        Optional[ListCapturesQueryParamInclude],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""This endpoint allows you to include additional information via the `include` query string parameter."""
...
class ListCapturesCapturesResponseLinksTypedDict(TypedDict):
    documentation: NotRequired[ListCapturesCapturesResponseDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class ListCapturesCapturesResponseLinks(BaseModel):
    documentation: Optional[ListCapturesCapturesResponseDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class ListCapturesCapturesResponseResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[ListCapturesCapturesResponseLinks], pydantic.Field(alias="_links")
    ] = None
...
class ListCapturesCapturesLinksTypedDict(TypedDict):
    documentation: NotRequired[ListCapturesCapturesDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class ListCapturesCapturesLinks(BaseModel):
    documentation: Optional[ListCapturesCapturesDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class ListCapturesCapturesResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[ListCapturesCapturesLinks], pydantic.Field(alias="_links")
    ] = None
...
class ListCapturesCapturesResponse200LinksTypedDict(TypedDict):
    ...
    self_: NotRequired[ListCapturesCapturesSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: NotRequired[ListCapturesPaymentTypedDict]
    r"""The API resource URL of the [payment](get-payment) that this capture belongs to."""
    ...
    r"""The API resource URL of the [shipment](get-shipment) this capture is associated with. Not present if it isn't associated with a shipment."""
    documentation: NotRequired[ListCapturesCapturesResponse200DocumentationTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListCapturesCapturesResponse200Links(BaseModel):
    ...
    self_: Annotated[
        Optional[ListCapturesCapturesSelf], pydantic.Field(alias="self")
    ] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    payment: Optional[ListCapturesPayment] = None
    r"""The API resource URL of the [payment](get-payment) that this capture belongs to."""
    ...
    documentation: Optional[ListCapturesCapturesResponse200Documentation] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListCapturesCapturesTypedDict(TypedDict):
    ...
    amount: NotRequired[Nullable[ListCapturesAmountTypedDict]]
    r"""The amount captured. If no amount is provided, the full authorized amount is captured."""
    ...
    links: NotRequired[ListCapturesCapturesResponse200LinksTypedDict]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListCapturesCaptures(BaseModel):
    ...
    amount: OptionalNullable[ListCapturesAmount] = UNSET
    r"""The amount captured. If no amount is provided, the full authorized amount is captured."""
    ...
    links: Annotated[
        Optional[ListCapturesCapturesResponse200Links], pydantic.Field(alias="_links")
    ] = None
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
