...
class CancelSubscriptionSubscriptionsDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class CancelSubscriptionSubscriptionsLinksTypedDict(TypedDict):
    documentation: NotRequired[CancelSubscriptionSubscriptionsDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class CancelSubscriptionSubscriptionsLinks(BaseModel):
    documentation: Optional[CancelSubscriptionSubscriptionsDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""


class CancelSubscriptionSubscriptionsResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[CancelSubscriptionSubscriptionsLinks], pydantic.Field(alias="_links")
    ] = None
...
class CancelSubscriptionSubscriptionsResponseBody(Exception):
    ...
    def __init__(self, data: CancelSubscriptionSubscriptionsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, CancelSubscriptionSubscriptionsResponseBodyData
        )
...
class CancelSubscriptionSubscriptionsAmountTypedDict(TypedDict):
...
class CancelSubscriptionSubscriptionsAmount(BaseModel):
    r"""In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field."""
...
class CancelSubscriptionApplicationFeeTypedDict(TypedDict):
    ...
    amount: NotRequired[CancelSubscriptionSubscriptionsAmountTypedDict]
    r"""In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field."""
...
class CancelSubscriptionApplicationFee(BaseModel):
    ...
    amount: Optional[CancelSubscriptionSubscriptionsAmount] = None
    r"""In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field."""

    description: Optional[str] = None


class CancelSubscriptionMetadata2TypedDict(TypedDict):
    pass


class CancelSubscriptionMetadata2(BaseModel):
    pass


CancelSubscriptionMetadataTypedDict = TypeAliasType(
    "CancelSubscriptionMetadataTypedDict",
    Union[CancelSubscriptionMetadata2TypedDict, str, List[str]],
)
...
CancelSubscriptionMetadata = TypeAliasType(
    "CancelSubscriptionMetadata", Union[CancelSubscriptionMetadata2, str, List[str]]
)
r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
...
class CancelSubscriptionLinksTypedDict(TypedDict):
    ...
    self_: NotRequired[CancelSubscriptionSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    customer: NotRequired[Nullable[CancelSubscriptionCustomerTypedDict]]
    r"""The API resource URL of the [customer](get-customer) this subscription was created for."""
    mandate: NotRequired[Nullable[CancelSubscriptionMandateTypedDict]]
    r"""The API resource URL of the [mandate](get-mandate) this subscription was created for."""
    profile: NotRequired[Nullable[CancelSubscriptionProfileTypedDict]]
    r"""The API resource URL of the [profile](get-profile) this subscription was created for."""
    payments: NotRequired[Nullable[CancelSubscriptionPaymentsTypedDict]]
    r"""The API resource URL of the [payments](list-payments) created for this subscription. Omitted if no such payments exist (yet)."""
    documentation: NotRequired[CancelSubscriptionDocumentationTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class CancelSubscriptionLinks(BaseModel):
    ...
    self_: Annotated[Optional[CancelSubscriptionSelf], pydantic.Field(alias="self")] = (
        None
    )
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    customer: OptionalNullable[CancelSubscriptionCustomer] = UNSET
    r"""The API resource URL of the [customer](get-customer) this subscription was created for."""

    mandate: OptionalNullable[CancelSubscriptionMandate] = UNSET
    r"""The API resource URL of the [mandate](get-mandate) this subscription was created for."""

    profile: OptionalNullable[CancelSubscriptionProfile] = UNSET
    r"""The API resource URL of the [profile](get-profile) this subscription was created for."""

    payments: OptionalNullable[CancelSubscriptionPayments] = UNSET
    r"""The API resource URL of the [payments](list-payments) created for this subscription. Omitted if no such payments exist (yet)."""

    documentation: Optional[CancelSubscriptionDocumentation] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class CancelSubscriptionResponseBodyTypedDict(TypedDict):
    r"""The updated subscription object with status `canceled`. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation."""
    ...
    """
    amount: NotRequired[CancelSubscriptionAmountTypedDict]
    r"""The amount for each individual payment that is charged with this subscription. For example, for a monthly subscription of €10, the subscription amount should be set to €10."""
    ...
    **Please note:** the description needs to be unique for the Customer in case it has multiple active subscriptions.
    ...
    Refer to the `applicationFee` parameter on the [Get payment endpoint](get-payment) documentation for more information.
    """
    metadata: NotRequired[Nullable[CancelSubscriptionMetadataTypedDict]]
    r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
...
class CancelSubscriptionResponseBody(BaseModel):
    r"""The updated subscription object with status `canceled`. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation."""
    ...
    amount: Optional[CancelSubscriptionAmount] = None
    r"""The amount for each individual payment that is charged with this subscription. For example, for a monthly subscription of €10, the subscription amount should be set to €10."""
    ...
    **Please note:** the description needs to be unique for the Customer in case it has multiple active subscriptions.
    ...
    metadata: OptionalNullable[CancelSubscriptionMetadata] = UNSET
    r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
