...
class ListAllSubscriptionsSubscriptionsResponse200LinksTypedDict(TypedDict):
    ...
    self_: NotRequired[ListAllSubscriptionsSubscriptionsResponseSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: NotRequired[ListAllSubscriptionsPaymentTypedDict]
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class ListAllSubscriptionsSubscriptionsResponse200Links(BaseModel):
    ...
    self_: Annotated[
        Optional[ListAllSubscriptionsSubscriptionsResponseSelf],
        pydantic.Field(alias="self"),
    ] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    payment: Optional[ListAllSubscriptionsPayment] = None
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class ListAllSubscriptionsRoutingTypedDict(TypedDict):
    ...
    """
    amount: NotRequired[ListAllSubscriptionsSubscriptionsResponseAmountTypedDict]
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    destination: NotRequired[ListAllSubscriptionsDestinationTypedDict]
    r"""The destination of this portion of the payment."""
    ...
    """
    links: NotRequired[
        Nullable[ListAllSubscriptionsSubscriptionsResponse200LinksTypedDict]
    ]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListAllSubscriptionsRouting(BaseModel):
    ...
    amount: Optional[ListAllSubscriptionsSubscriptionsResponseAmount] = None
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""

    destination: Optional[ListAllSubscriptionsDestination] = None
    r"""The destination of this portion of the payment."""
    ...
    links: Annotated[
        OptionalNullable[ListAllSubscriptionsSubscriptionsResponse200Links],
...
class ListAllSubscriptionsSubscriptionsResponseLinksTypedDict(TypedDict):
    ...
    self_: NotRequired[ListAllSubscriptionsSubscriptionsSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    checkout: NotRequired[Nullable[ListAllSubscriptionsCheckoutTypedDict]]
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""
    mobile_app_checkout: NotRequired[
        Nullable[ListAllSubscriptionsMobileAppCheckoutTypedDict]
    ]
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
    change_payment_state: NotRequired[
        Nullable[ListAllSubscriptionsChangePaymentStateTypedDict]
    ]
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different payment states.
    ...
    Secondly, for paid test mode payments. The payment state screen will then allow you to create a refund or chargeback for the test payment.
    """
    dashboard: NotRequired[ListAllSubscriptionsDashboardTypedDict]
    r"""Direct link to the payment in the Mollie Dashboard."""
    refunds: NotRequired[Nullable[ListAllSubscriptionsRefundsTypedDict]]
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
    ...
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
    settlement: NotRequired[Nullable[ListAllSubscriptionsSettlementTypedDict]]
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""
    customer: NotRequired[Nullable[ListAllSubscriptionsCustomerTypedDict]]
    r"""The API resource URL of the [customer](get-customer)."""
    mandate: NotRequired[Nullable[ListAllSubscriptionsMandateTypedDict]]
    r"""The API resource URL of the [mandate](get-mandate)."""
    subscription: NotRequired[Nullable[ListAllSubscriptionsSubscriptionTypedDict]]
    r"""The API resource URL of the [subscription](get-subscription)."""
    order: NotRequired[Nullable[ListAllSubscriptionsOrderTypedDict]]
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""
    terminal: NotRequired[Nullable[ListAllSubscriptionsTerminalTypedDict]]
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""
...
class ListAllSubscriptionsSubscriptionsResponseLinks(BaseModel):
    ...
    self_: Annotated[
        Optional[ListAllSubscriptionsSubscriptionsSelf], pydantic.Field(alias="self")
    ] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    checkout: OptionalNullable[ListAllSubscriptionsCheckout] = UNSET
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""

    mobile_app_checkout: Annotated[
        OptionalNullable[ListAllSubscriptionsMobileAppCheckout],
        pydantic.Field(alias="mobileAppCheckout"),
    ] = UNSET
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""

    change_payment_state: Annotated[
        OptionalNullable[ListAllSubscriptionsChangePaymentState],
    ...
    dashboard: Optional[ListAllSubscriptionsDashboard] = None
    r"""Direct link to the payment in the Mollie Dashboard."""

    refunds: OptionalNullable[ListAllSubscriptionsRefunds] = UNSET
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
    ...
    settlement: OptionalNullable[ListAllSubscriptionsSettlement] = UNSET
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""

    customer: OptionalNullable[ListAllSubscriptionsCustomer] = UNSET
    r"""The API resource URL of the [customer](get-customer)."""

    mandate: OptionalNullable[ListAllSubscriptionsMandate] = UNSET
    r"""The API resource URL of the [mandate](get-mandate)."""

    subscription: OptionalNullable[ListAllSubscriptionsSubscription] = UNSET
    r"""The API resource URL of the [subscription](get-subscription)."""

    order: OptionalNullable[ListAllSubscriptionsOrder] = UNSET
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""

    terminal: OptionalNullable[ListAllSubscriptionsTerminal] = UNSET
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""
...
class ListAllSubscriptionsPaymentsTypedDict(TypedDict):
    ...
    """
    amount: NotRequired[ListAllSubscriptionsAmountTypedDict]
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
    ...
    If a tip was added for a Point-of-Sale payment, the amount will be updated to reflect the initial amount plus the tip amount.
    """
    amount_refunded: NotRequired[Nullable[ListAllSubscriptionsAmountRefundedTypedDict]]
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""
    amount_remaining: NotRequired[
        Nullable[ListAllSubscriptionsAmountRemainingTypedDict]
    ]
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
    amount_captured: NotRequired[Nullable[ListAllSubscriptionsAmountCapturedTypedDict]]
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
    amount_charged_back: NotRequired[
        Nullable[ListAllSubscriptionsAmountChargedBackTypedDict]
    ]
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""
    settlement_amount: NotRequired[
        Nullable[ListAllSubscriptionsSettlementAmountTypedDict]
    ]
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
    ...
    links: NotRequired[ListAllSubscriptionsSubscriptionsResponseLinksTypedDict]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListAllSubscriptionsPayments(BaseModel):
    ...
    amount: Optional[ListAllSubscriptionsAmount] = None
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
    ...
    amount_refunded: Annotated[
        OptionalNullable[ListAllSubscriptionsAmountRefunded],
        pydantic.Field(alias="amountRefunded"),
    ] = UNSET
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""

    amount_remaining: Annotated[
        OptionalNullable[ListAllSubscriptionsAmountRemaining],
        pydantic.Field(alias="amountRemaining"),
    ] = UNSET
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""

    amount_captured: Annotated[
        OptionalNullable[ListAllSubscriptionsAmountCaptured],
        pydantic.Field(alias="amountCaptured"),
    ] = UNSET
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""

    amount_charged_back: Annotated[
        OptionalNullable[ListAllSubscriptionsAmountChargedBack],
        pydantic.Field(alias="amountChargedBack"),
    ] = UNSET
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""

    settlement_amount: Annotated[
        OptionalNullable[ListAllSubscriptionsSettlementAmount],
