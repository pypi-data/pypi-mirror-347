...
class GetMandateMandatesDocumentationTypedDict(TypedDict):
...
class GetMandateMandatesDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetMandateMandatesLinksTypedDict(TypedDict):
    documentation: NotRequired[GetMandateMandatesDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class GetMandateMandatesLinks(BaseModel):
    documentation: Optional[GetMandateMandatesDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""


class GetMandateMandatesResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[GetMandateMandatesLinks], pydantic.Field(alias="_links")
    ] = None


class GetMandateMandatesResponseBody(Exception):
    r"""An error response object."""

    data: GetMandateMandatesResponseBodyData

    def __init__(self, data: GetMandateMandatesResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetMandateMandatesResponseBodyData)
...
class GetMandateResponseBodyTypedDict(TypedDict):
    ...
    """
    details: NotRequired[GetMandateDetailsTypedDict]
    ...
    links: NotRequired[GetMandateLinksTypedDict]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""


class GetMandateResponseBody(BaseModel):
    r"""The mandate object."""
    ...
    details: Optional[GetMandateDetails] = None
    ...
    links: Annotated[Optional[GetMandateLinks], pydantic.Field(alias="_links")] = None
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
