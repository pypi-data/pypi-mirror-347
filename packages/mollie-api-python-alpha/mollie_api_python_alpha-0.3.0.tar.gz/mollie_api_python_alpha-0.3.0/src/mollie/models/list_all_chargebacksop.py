...
class ListAllChargebacksChargebacksResponse200LinksTypedDict(TypedDict):
    ...
    self_: NotRequired[ListAllChargebacksChargebacksSelfTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: NotRequired[ListAllChargebacksPaymentTypedDict]
    r"""The API resource URL of the [payment](get-payment) that this chargeback belongs to."""
...
class ListAllChargebacksChargebacksResponse200Links(BaseModel):
    ...
    self_: Annotated[
        Optional[ListAllChargebacksChargebacksSelf], pydantic.Field(alias="self")
    ] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    payment: Optional[ListAllChargebacksPayment] = None
    r"""The API resource URL of the [payment](get-payment) that this chargeback belongs to."""

    settlement: OptionalNullable[ListAllChargebacksSettlement] = UNSET
    r"""The API resource URL of the [settlement](get-settlement) this chargeback has been settled with. Not present if not yet settled."""

    documentation: Optional[ListAllChargebacksChargebacksResponse200Documentation] = (
        None
    )
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListAllChargebacksChargebacksTypedDict(TypedDict):
    ...
    amount: NotRequired[ListAllChargebacksAmountTypedDict]
    r"""The amount charged back by the customer."""
    ...
    links: NotRequired[ListAllChargebacksChargebacksResponse200LinksTypedDict]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListAllChargebacksChargebacks(BaseModel):
    ...
    amount: Optional[ListAllChargebacksAmount] = None
    r"""The amount charged back by the customer."""
    ...
    links: Annotated[
        Optional[ListAllChargebacksChargebacksResponse200Links],
        pydantic.Field(alias="_links"),
    ] = None
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
