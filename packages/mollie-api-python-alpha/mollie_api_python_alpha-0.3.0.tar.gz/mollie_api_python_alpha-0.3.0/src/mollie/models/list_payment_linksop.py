...
class ListPaymentLinksPaymentLinksLinksTypedDict(TypedDict):
    documentation: NotRequired[ListPaymentLinksPaymentLinksDocumentationTypedDict]
    r"""The URL to the generic Mollie API error handling guide."""


class ListPaymentLinksPaymentLinksLinks(BaseModel):
    documentation: Optional[ListPaymentLinksPaymentLinksDocumentation] = None
    r"""The URL to the generic Mollie API error handling guide."""
...
class ListPaymentLinksPaymentLinksResponseBodyData(BaseModel):
    ...
    links: Annotated[
        Optional[ListPaymentLinksPaymentLinksLinks], pydantic.Field(alias="_links")
    ] = None
