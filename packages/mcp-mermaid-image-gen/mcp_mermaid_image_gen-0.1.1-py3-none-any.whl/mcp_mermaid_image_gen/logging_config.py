"""Logging configuration for MCP Mermaid Image Gen MCP server"""
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the MCP Mermaid Image Gen MCP server"""
    ...
    project_logger = logging.getLogger("mcp_mermaid_image_gen")
    ...
    log_file = log_path / "mcp_mermaid_image_gen.log"
...
logger = logging.getLogger("mcp_mermaid_image_gen")
