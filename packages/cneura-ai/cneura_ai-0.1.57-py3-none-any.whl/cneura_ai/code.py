...
class CodeGenerator:
    ...
    def identify_secrets(self, code: str, testcases: str)-> str:
        ...
        Focus only on secrets accessed using the pattern `Config.<VARIABLE_NAME>`. Ignore any other variables or patterns.
        Analyze both the provided code and test cases. In your output, list only the secrets names used with `Config.` (e.g., if you see `Config.API_KEY`, output only `API_KEY`).
        ...
        Remember - Don't include odinary variales or constants.
        """
