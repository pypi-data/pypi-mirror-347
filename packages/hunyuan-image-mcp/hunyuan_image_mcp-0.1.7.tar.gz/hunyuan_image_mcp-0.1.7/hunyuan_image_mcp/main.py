...
@mcp.tool(
    ...
    Args:
        imageUrl: 需要修改的图片url地址，如不提供则生成新图片
        prompt: 用于生成或修改图片的详细提示词，建议提供具体描述

    Returns:
        dict: 包含生成的图片url地址的字典
    """
)
async def hunyuanText2Image(
    imageUrl: str = Field(default="", description="需要修改的图片url地址，如不提供则生成新图片"), 
    prompt: str = Field(description="用于生成或修改图片的详细提示词，建议提供具体描述")
) -> dict:
    # """
