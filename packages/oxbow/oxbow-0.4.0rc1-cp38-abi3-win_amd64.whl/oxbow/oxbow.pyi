...
class PyBamScanner:
    def __init__(self, obj: object, compressed: bool | None = True) -> None: ...
    def chrom_names(self) -> List[str]: ...
    def chrom_sizes(self) -> List[Tuple[str, int]]: ...
    def field_names(self) -> List[str]: ...
    def tag_defs(self, scan_rows: int | None = None) -> List[Tuple[str, str]]: ...
    def schema(
        self,
...
class PyBBIZoomScanner:
    def __init__(self, reader: object, bbi_type: object, zoom_level: int) -> None: ...
    def field_names(self) -> List[str]: ...
...
class PyBcfScanner:
    ...
    def info_field_names(self) -> List[str]: ...
    def genotype_field_defs(self) -> List[Tuple[str, str, str]]: ...
    def genotype_field_names(self) -> List[str]: ...
...
class PyBigBedScanner:
    def __init__(
        self, obj: object, schema: Literal["autosql", "bedgraph"] | str | None = None
    ) -> None: ...
    def chrom_names(self) -> List[str]: ...
    def chrom_sizes(self) -> List[Tuple[str, int]]: ...
    def field_names(self) -> List[str]: ...
...
class PyFastqScanner:
    def __init__(self, obj: object, compressed: bool | None = False) -> None: ...
    def field_names(self) -> List[str]: ...
    def schema(self, fields: List[str] | None = None) -> object: ...
    def scan(
        self,
...
class PyGffScanner:
    def __init__(self, obj: object, compressed: bool | None = False) -> None: ...
    def field_names(self) -> List[str]: ...
    def attribute_defs(self, scan_rows: int | None = None) -> List[Tuple[str, str]]: ...
    def schema(
        self,
        fields: List[str] | None = None,
