...
from pyvenDF.templates.views import welcome_view  # Import the welcome view directly
...
def start_server(host='127.0.0.1', port=8080):
    ...
    router = Router()
    router.add_route("/", welcome_view)  # Default route to display the welcome page
            ...
            try:
                ...
                if sock_conn in ready_to_read:
                    ...
                    if os.path.isfile(file_path):
                        ...
                        if handler:
                            body = handler(**params).encode()  # Call the view handler
                            response = b"HTTP/1.1 200 OK\r\n"
