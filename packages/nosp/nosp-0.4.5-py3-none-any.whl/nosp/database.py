...
class Mysql(object):
    ...
    @staticmethod
    def simple(config: MysqlConfig, pool_num=4, db: str = None, monitor=None, max_pool: int = None, ) -> 'Mysql':
        """
        创建Mysql
    ...
    def insert_data(self, item: dict, table_name: str, replace: bool = False) -> int:
        ...
        if item:
            ...
            filtered_item = {
                ...
                k in insert_columns.keys() and not (v is None and insert_columns[k] in ('bigint', 'int', 'decimal'))
            }
