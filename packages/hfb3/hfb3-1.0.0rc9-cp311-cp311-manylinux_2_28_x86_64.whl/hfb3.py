...
class Action(Generic):
    ...
    def calcWSHFB(self):
        return _hfb3.Action_calcWSHFB(self)
    ...
    def calcBasis(self):
        return _hfb3.Action_calcBasis(self)
    ...
    blockingTries = property(_hfb3.Action_blockingTries_get, _hfb3.Action_blockingTries_set)
...
class Geometry(Generic):
    ...
    def calcChargeRMS(self, Z, N):
        return _hfb3.Geometry_calcChargeRMS(self, Z, N)

    @staticmethod
    def getDensityMultipoleExpansion(*args):
        return _hfb3.Geometry_getDensityMultipoleExpansion(*args)

    def getBetaFromQ20(self, parts, A, vq20):
        return _hfb3.Geometry_getBetaFromQ20(self, parts, A, vq20)
...
class Solver(Generic):
    ...
    converged = property(_hfb3.Solver_converged_get, _hfb3.Solver_converged_set)
...
class SolverHFBGradient(Solver):
    ...
    cvgTargetSwitchToBroyden = property(_hfb3.SolverHFBGradient_cvgTargetSwitchToBroyden_get, _hfb3.SolverHFBGradient_cvgTargetSwitchToBroyden_set)
...
class SolverBasis(Solver):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    FAIL = _hfb3.SolverBasis_FAIL
    ITERMAX = _hfb3.SolverBasis_ITERMAX
    DETMAX = _hfb3.SolverBasis_DETMAX
    CONV = _hfb3.SolverBasis_CONV
    FAILEDINIT = _hfb3.SolverBasis_FAILEDINIT
    ...
    @staticmethod
    def calcSingleHFB(arg1, arg2, quiet=False, _plotDensities=False):
        return _hfb3.SolverBasis_calcSingleHFB(arg1, arg2, quiet, _plotDensities)
...
class SolverWS(Solver):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ITERMAX = _hfb3.SolverWS_ITERMAX
    CONV = _hfb3.SolverWS_CONV
    ENDEVAL = _hfb3.SolverWS_ENDEVAL
