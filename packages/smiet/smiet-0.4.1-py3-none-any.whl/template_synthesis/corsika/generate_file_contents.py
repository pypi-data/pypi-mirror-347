...
def generate_inp_file(sim_nr, sim_zenith, sim_azimuth, sim_energy,
    ...
    contents = [
        ...
        f'PRMPAR  {CORSIKA_PARTICLE_CODES[primary]}\n',
        # Set fixed energy
...
def generate_list_file(sim_zenith, sim_azimuth, slices_gram,
    ...
    along the shower axis. This result in the antennas from the same "circle" to have different
    ...
    for slice_ind in range(len(slices_gram) - 1):
        ...
        for idx, ant in enumerate(ant_position):
