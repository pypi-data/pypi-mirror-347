...
class Atmosphere(metaclass=ModelMeta):
    """
    ...
    def get_geometric_distance_grammage(
        self: Self, grammage: jax.typing.ArrayLike, zenith: jax.typing.ArrayLike
    ) -> jax.Array:
        """
    ...
    def __get_density_from_height(self : Self, height : jax.typing.ArrayLike) -> jax.Array:
        """
    ...
    def get_atmosphere(self: Self, height: jax.typing.ArrayLike) -> jax.Array:
        """
    ...
    def get_vertical_height(self: Self, at: jax.typing.ArrayLike) -> jax.Array:
        """
        Get vertical height from atmosphere, i.e., mass overburden for different layer.

        Parameters
        ----------
        at : jax,typing.ArrayLike
    ...
    def get_xmax_from_distance(
        self: Self, distance: jax.typing.ArrayLike, zenith: jax.typing.ArrayLike
    ) -> jax.Array:
        """
        Calculate the cherenkov angle from the atmospheric depth and zenith angle.
