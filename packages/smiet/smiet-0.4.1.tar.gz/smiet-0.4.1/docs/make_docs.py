...
logger = logging.getLogger("template_synthesis.make_docs")


if __name__ == '__main__':
    argparser = argparse.ArgumentParser(
        prog="template_synthesis.docs.make_docs",
        description=(
    ...
    module_path = '../template_synthesis/'
    subprocess.run(
        [
    ...
    subprocess.check_output([
        'rm',
        os.path.join(output_folder, 'template_synthesis.numpy.rst'),
        os.path.join(output_folder, 'template_synthesis.jax.rst'),
        os.path.join(output_folder, 'template_synthesis.rst')
    ])
