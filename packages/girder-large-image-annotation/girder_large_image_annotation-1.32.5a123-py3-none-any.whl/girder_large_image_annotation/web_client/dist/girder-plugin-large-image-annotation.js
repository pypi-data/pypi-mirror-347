...
(function(a) {
  (function(e) {
    ...
    function h(r) {
      ...
      return typeof r == "string" && (r = at(r)), typeof r == "object" && (N(r.r) && N(r.g) && N(r.b) ? (l = F(r.r, r.g, r.b), j = !0, S = String(r.r).substr(-1) === "%" ? "prgb" : "rgb") : N(r.h) && N(r.s) && N(r.v) ? (_ = se(r.s), f = se(r.v), l = L(r.h, _, f), j = !0, S = "hsv") : N(r.h) && N(r.s) && N(r.l) && (_ = se(r.s), p = se(r.l), l = b(r.h, _, p), j = !0, S = "hsl"), r.hasOwnProperty("a") && (s = r.a)), s = B(s), {
        ok: j,
        format: r.format || S,
        r: c(255, g(l.r, 0)),
        g: c(255, g(l.g, 0)),
    ...
    u.mix = function(r, l, s) {
      ...
      switch (p = !1, f = rt(s), f.level + f.size) {
        case "AAsmall":
        case "AAAlarge":
          p = _ >= 4.5;
          break;
