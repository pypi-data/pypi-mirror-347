...
from sb_final.utils.deploy import getFeatureFromTemplate, read_yaml
from sb_final.utils.django_utils import ManageDjangoSettings, get_project_settings, updateMiddleware
from sb_final.utils.feature_dependencies import arrangeChunks, getCodeBlockNameAndType
from sb_final.utils.installDependencies import install_dependencies
from sb_final.utils.venv_utils import get_activated_venv
...
def convertFromTemplateToFeature(project_path,template_path,template_name):
    ...
    app_name,template_root = getFeatureFromTemplate(template_path,project_path,template_name,main_django_dir)
