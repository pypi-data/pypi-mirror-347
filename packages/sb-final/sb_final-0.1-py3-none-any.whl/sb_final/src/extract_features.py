...
from sb_final.utils.django_utils import ManageDjangoSettings
from sb_final.utils.feature_dependencies import arrangeChunks
from sb_final.utils.extract import clear_folder, extract_feature_code_and_dependencies, getTemplateFileNames, getURLForFeature
...
def create_temp_from_feature(project_path,project_name,feature_name,feature_file_path,template_django_apps):
    ...
    data = {
        ...
        "feature_file_path" : feature_file_path.replace(project_path,"")[1:],
    ...
    print(f"Template `{output_zip}` Created")
