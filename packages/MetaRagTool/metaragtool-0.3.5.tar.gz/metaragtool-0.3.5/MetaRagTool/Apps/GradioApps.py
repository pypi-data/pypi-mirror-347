...
def load_models_and_data(encoder_name,reranker_name=None):
    ...
    from MetaRagTool.Encoders.MyReranker import CrossEncoderReranker
...
def load_app(encoder_model_name='sentence-transformers/LaBSE', reranker_model_name='Alibaba-NLP/gte-multilingual-reranker-base'):
    Constants.lang = 'fa'
