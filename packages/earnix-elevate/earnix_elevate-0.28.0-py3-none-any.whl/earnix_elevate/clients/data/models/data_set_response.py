...
class DataSetResponse(BaseModel):
    ...
    nodes: Optional[List[DataSetNodeResponse]] = None
    edges: Optional[List[DataSetEdgeResponse]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "nodes": [
                    DataSetNodeResponse.from_dict(_item) for _item in obj["nodes"]
                ]
                if obj.get("nodes") is not None
                else None,
                "edges": [
                    DataSetEdgeResponse.from_dict(_item) for _item in obj["edges"]
                ]
