...
class ExportS3PartJobStatusResponse(BaseModel):
    ...
    result: Optional[List[ExportPartResultPair]] = None
    __properties: ClassVar[List[str]] = ["status", "error", "result"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "error": obj.get("error"),
                "result": [
                    ExportPartResultPair.from_dict(_item) for _item in obj["result"]
                ]
