...
class DataVersionMetadata(BaseModel):
    """
    DataVersionMetadata
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["schema", "numRows", "sizeInBytes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataVersionMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataVersionMetadata from a dict"""
        if obj is None:
            return None
