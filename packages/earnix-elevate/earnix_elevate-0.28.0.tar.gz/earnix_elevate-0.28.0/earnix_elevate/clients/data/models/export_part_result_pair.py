...
class ExportPartResultPair(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExportPartResultPair from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExportPartResultPair from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"ETag": obj.get("ETag"), "PartNumber": obj.get("PartNumber")}
        )
        return _obj
