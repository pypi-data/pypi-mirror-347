...
from mater._utils import input_completion, read_json
...
class Mater(_MaterProcessNonPhysical):
    ...
    def parameter_from_json(
        ...
        """Returns the parameters of the mater compiler by loading data from the json files orders in a data directory, as defined by the `mater-data-providing` package.
        ...
        :type scenario: str
        :return: The variable Class that aggregate all the parameters needed to run a mater simulation
        :rtype: Parameter
        ...
        .. code-block:: python
            ...
            params = model.parameter_from_json(
                "run0", 1900, 2100, "YS", "BAU Scenario"
            )
            # whatever parameter processing here
        ...
        inputs_dict = read_json("input_data", scenario)
