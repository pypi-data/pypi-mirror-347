...
def filter(p):
    ...
    p.add_argument("--threads", "-T", "-j", metavar="INT", type=int, default=1,
    ...
    p.add_argument("--threshold", metavar="INT", default=0.25, type=float,
    ...
    gmode.add_argument("--keep-host", action="store_true",
        help="output both the filtered FASTQ file and a file with the removed host reads")
