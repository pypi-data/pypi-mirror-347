...
from dataclass_parser.async_parser.core.fields.complex import UnionFieldParser
...
class ASchemaGenerator:
    ...
    @classmethod
    async def _get_parser_cls(cls, type_hint: type[Any], module: str) -> SimpleFieldParser:
    ...
    @classmethod
    async def _get_ellipsis_parser(cls, type_hint: type[Any]) -> SimpleFieldParser:
    ...
    @classmethod
    async def generate_schema(cls, entity: type[AEntityBase]) -> dict[str, SimpleFieldParser]:
