...
Link: https://github.com/apache/commons-validator/blob/master/src/main/java/org/apache/commons/validator/routines/LongValidator.java
...
class LongValidator(AbstractNumberValidator):
    ...
    Attributes:
        LONG_MIN (int): The minimum value of a long (-2^63).
        LONG_MAX (int): The maximum value of a long (2^63 - 1).
    """

    _VALIDATOR = None
    LONG_MIN:  Final[int] = -2**63
    LONG_MAX:  Final[int] = 2**63 - 1
    ...
    def _process_parsed_value(self, value: str, formatter):
        ...
        try:
            ...
            if self.is_in_range(val, self.LONG_MIN, self.LONG_MAX):
                return val
        except ValueError:
            return None
