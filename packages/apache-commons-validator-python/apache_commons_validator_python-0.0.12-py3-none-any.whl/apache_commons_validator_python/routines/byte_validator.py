...
Link: https://github.com/apache/commons-validator/blob/master/src/main/java/org/apache/commons/validator/routines/ByteValidator.java
...
class ByteValidator(AbstractNumberValidator):
    ...
    Attributes:
        BYTE_MIN (int): The value of the maximum allowed byte (-128).
        BYTE_MAX (int): The value of the minimum allowed byte (127).
    """
