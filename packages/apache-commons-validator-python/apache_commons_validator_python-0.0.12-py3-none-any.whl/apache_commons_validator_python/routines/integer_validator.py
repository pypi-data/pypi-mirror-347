...
Link: https://github.com/apache/commons-validator/blob/master/src/main/java/org/apache/commons/validator/routines/IntegerValidator.java
...
class IntegerValidator(AbstractNumberValidator):
    ...
    Attributes:
        INT_MIN (int): The minimum value of an int (-2^31).
        INT_MAX (int): The maximum value of an int (2^31 - 1).
    """
