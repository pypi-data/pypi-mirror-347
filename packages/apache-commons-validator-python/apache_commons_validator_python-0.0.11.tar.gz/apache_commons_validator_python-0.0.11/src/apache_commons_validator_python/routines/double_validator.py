...
Link: https://github.com/apache/commons-validator/blob/master/src/main/java/org/apache/commons/validator/routines/DoubleValidator.java
...
class DoubleValidator(AbstractNumberValidator):
    ...
    def get_instance(cls):
        ...
        if cls._VALIDATOR is None:
            cls._VALIDATOR = DoubleValidator()
