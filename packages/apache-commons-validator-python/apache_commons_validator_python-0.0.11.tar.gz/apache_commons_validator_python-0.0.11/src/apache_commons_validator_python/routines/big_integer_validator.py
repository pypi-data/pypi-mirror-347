...
Link: https://github.com/apache/commons-validator/blob/master/src/main/java/org/apache/commons/validator/routines/BigIntegerValidator.java
...
class BigIntegerValidator(AbstractNumberValidator):
    ...
    def get_instance(cls):
        ...
        if cls._VALIDATOR is None:
            cls._VALIDATOR = BigIntegerValidator()
