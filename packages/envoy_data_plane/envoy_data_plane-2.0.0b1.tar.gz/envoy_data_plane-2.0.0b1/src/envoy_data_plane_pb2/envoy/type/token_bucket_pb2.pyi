...
class TokenBucket(_message.Message):
    ...
    def __init__(self, max_tokens: _Optional[int] = ..., tokens_per_fill: _Optional[_Union[_wrappers_pb2.UInt32Value, _Mapping]] = ..., fill_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
