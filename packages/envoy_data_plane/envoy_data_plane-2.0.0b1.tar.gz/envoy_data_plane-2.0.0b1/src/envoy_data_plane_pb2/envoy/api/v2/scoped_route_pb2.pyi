...
class ScopedRouteConfiguration(_message.Message):
    __slots__ = ("name", "route_configuration_name", "key")
    ...
    def __init__(self, name: _Optional[str] = ..., route_configuration_name: _Optional[str] = ..., key: _Optional[_Union[ScopedRouteConfiguration.Key, _Mapping]] = ...) -> None: ...
