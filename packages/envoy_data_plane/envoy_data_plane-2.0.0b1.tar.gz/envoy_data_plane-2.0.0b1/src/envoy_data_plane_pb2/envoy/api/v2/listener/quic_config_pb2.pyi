...
class QuicProtocolOptions(_message.Message):
    ...
    def __init__(self, max_concurrent_streams: _Optional[_Union[_wrappers_pb2.UInt32Value, _Mapping]] = ..., idle_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., crypto_handshake_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
