...
class RedisClusterConfig(_message.Message):
    ...
    def __init__(self, cluster_refresh_rate: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., cluster_refresh_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., redirect_refresh_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., redirect_refresh_threshold: _Optional[_Union[_wrappers_pb2.UInt32Value, _Mapping]] = ..., failure_refresh_threshold: _Optional[int] = ..., host_degraded_refresh_threshold: _Optional[int] = ...) -> None: ...
