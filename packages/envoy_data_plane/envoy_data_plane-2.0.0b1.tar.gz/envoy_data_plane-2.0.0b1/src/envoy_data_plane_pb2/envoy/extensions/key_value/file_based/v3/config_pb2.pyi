...
class FileBasedKeyValueStoreConfig(_message.Message):
    ...
    def __init__(self, filename: _Optional[str] = ..., flush_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., max_entries: _Optional[_Union[_wrappers_pb2.UInt32Value, _Mapping]] = ...) -> None: ...
