...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOCALRATELIMIT'].fields_by_name['max_dynamic_descriptors']._loaded_options = None
  _globals['_LOCALRATELIMIT'].fields_by_name['max_dynamic_descriptors']._serialized_options = b'\372B\004*\002(\001'
