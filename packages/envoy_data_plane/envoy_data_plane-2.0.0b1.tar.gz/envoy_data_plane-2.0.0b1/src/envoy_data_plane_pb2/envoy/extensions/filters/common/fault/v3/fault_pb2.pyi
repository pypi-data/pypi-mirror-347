...
class FaultDelay(_message.Message):
    __slots__ = ("fixed_delay", "header_delay", "percentage")
    ...
    def __init__(self, fixed_delay: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., header_delay: _Optional[_Union[FaultDelay.HeaderDelay, _Mapping]] = ..., percentage: _Optional[_Union[_percent_pb2.FractionalPercent, _Mapping]] = ...) -> None: ...
