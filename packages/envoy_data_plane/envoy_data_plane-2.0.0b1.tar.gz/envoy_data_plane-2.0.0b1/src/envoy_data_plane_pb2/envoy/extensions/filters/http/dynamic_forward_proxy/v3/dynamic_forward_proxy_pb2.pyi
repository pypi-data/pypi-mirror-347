...
class FilterConfig(_message.Message):
    __slots__ = ("dns_cache_config", "sub_cluster_config", "save_upstream_address")
    ...
    def __init__(self, dns_cache_config: _Optional[_Union[_dns_cache_pb2.DnsCacheConfig, _Mapping]] = ..., sub_cluster_config: _Optional[_Union[SubClusterConfig, _Mapping]] = ..., save_upstream_address: bool = ...) -> None: ...
...
class SubClusterConfig(_message.Message):
    ...
    def __init__(self, cluster_init_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
