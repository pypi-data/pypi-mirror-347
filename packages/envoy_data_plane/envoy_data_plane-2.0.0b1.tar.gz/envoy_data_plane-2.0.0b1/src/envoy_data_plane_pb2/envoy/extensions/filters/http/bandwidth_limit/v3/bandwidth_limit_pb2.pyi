...
class BandwidthLimit(_message.Message):
    ...
    def __init__(self, stat_prefix: _Optional[str] = ..., enable_mode: _Optional[_Union[BandwidthLimit.EnableMode, str]] = ..., limit_kbps: _Optional[_Union[_wrappers_pb2.UInt64Value, _Mapping]] = ..., fill_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., runtime_enabled: _Optional[_Union[_base_pb2.RuntimeFeatureFlag, _Mapping]] = ..., enable_response_trailers: bool = ..., response_trailer_prefix: _Optional[str] = ...) -> None: ...
