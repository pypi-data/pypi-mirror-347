...
class FluentdConfig(_message.Message):
    ...
    def __init__(self, cluster: _Optional[str] = ..., tag: _Optional[str] = ..., stat_prefix: _Optional[str] = ..., buffer_flush_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., buffer_size_bytes: _Optional[_Union[_wrappers_pb2.UInt32Value, _Mapping]] = ..., retry_policy: _Optional[_Union[_base_pb2.RetryPolicy, _Mapping]] = ...) -> None: ...
