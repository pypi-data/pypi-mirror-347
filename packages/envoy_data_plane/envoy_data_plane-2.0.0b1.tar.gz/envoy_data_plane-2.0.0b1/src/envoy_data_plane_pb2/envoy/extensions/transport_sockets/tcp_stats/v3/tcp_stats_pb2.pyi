...
class Config(_message.Message):
    ...
    def __init__(self, transport_socket: _Optional[_Union[_base_pb2.TransportSocket, _Mapping]] = ..., update_period: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
