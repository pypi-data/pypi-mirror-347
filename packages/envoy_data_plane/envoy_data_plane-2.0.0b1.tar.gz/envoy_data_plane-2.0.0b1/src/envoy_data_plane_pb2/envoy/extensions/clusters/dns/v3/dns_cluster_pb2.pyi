...
class DnsCluster(_message.Message):
    ...
    def __init__(self, dns_refresh_rate: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., dns_failure_refresh_rate: _Optional[_Union[DnsCluster.RefreshRate, _Mapping]] = ..., respect_dns_ttl: bool = ..., dns_jitter: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., typed_dns_resolver_config: _Optional[_Union[_extension_pb2.TypedExtensionConfig, _Mapping]] = ..., dns_lookup_family: _Optional[_Union[_dns_pb2.DnsLookupFamily, str]] = ..., all_addresses_in_single_endpoint: bool = ...) -> None: ...
