...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ENDPOINT_HEALTHCHECKCONFIG'].fields_by_name['port_value']._loaded_options = None
  _globals['_ENDPOINT_HEALTHCHECKCONFIG'].fields_by_name['port_value']._serialized_options = b'\372B\006*\004\030\377\377\003'
  _globals['_ENDPOINT_HEALTHCHECKCONFIG']._loaded_options = None
  _globals['_ENDPOINT_HEALTHCHECKCONFIG']._serialized_options = b'\232\305\210\0362\n0envoy.api.v2.endpoint.Endpoint.HealthCheckConfig'
  _globals['_ENDPOINT']._loaded_options = None
  _globals['_ENDPOINT']._serialized_options = b'\232\305\210\036 \n\036envoy.api.v2.endpoint.Endpoint'
  _globals['_LBENDPOINT'].fields_by_name['load_balancing_weight']._loaded_options = None
  _globals['_LBENDPOINT'].fields_by_name['load_balancing_weight']._serialized_options = b'\372B\004*\002(\001'
  _globals['_LBENDPOINT']._loaded_options = None
  _globals['_LBENDPOINT']._serialized_options = b'\232\305\210\036\"\n envoy.api.v2.endpoint.LbEndpoint'
  _globals['_LOCALITYLBENDPOINTS'].fields_by_name['load_balancer_endpoints']._loaded_options = None
  _globals['_LOCALITYLBENDPOINTS'].fields_by_name['load_balancer_endpoints']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_LOCALITYLBENDPOINTS'].fields_by_name['load_balancing_weight']._loaded_options = None
  _globals['_LOCALITYLBENDPOINTS'].fields_by_name['load_balancing_weight']._serialized_options = b'\372B\004*\002(\001'
  _globals['_LOCALITYLBENDPOINTS'].fields_by_name['priority']._loaded_options = None
  _globals['_LOCALITYLBENDPOINTS'].fields_by_name['priority']._serialized_options = b'\372B\005*\003\030\200\001'
  _globals['_LOCALITYLBENDPOINTS']._loaded_options = None
  _globals['_LOCALITYLBENDPOINTS']._serialized_options = b'\232\305\210\036+\n)envoy.api.v2.endpoint.LocalityLbEndpoints'
  _globals['_ENDPOINT']._serialized_start=429
  _globals['_ENDPOINT']._serialized_end=993
  _globals['_ENDPOINT_HEALTHCHECKCONFIG']._serialized_start=675
  _globals['_ENDPOINT_HEALTHCHECKCONFIG']._serialized_end=885
  _globals['_ENDPOINT_ADDITIONALADDRESS']._serialized_start=887
  _globals['_ENDPOINT_ADDITIONALADDRESS']._serialized_end=954
  _globals['_LBENDPOINT']._serialized_start=996
  _globals['_LBENDPOINT']._serialized_end=1328
  _globals['_LBENDPOINTCOLLECTION']._serialized_start=1330
  _globals['_LBENDPOINTCOLLECTION']._serialized_end=1399
  _globals['_LEDSCLUSTERLOCALITYCONFIG']._serialized_start=1401
  _globals['_LEDSCLUSTERLOCALITYCONFIG']._serialized_end=1515
  _globals['_LOCALITYLBENDPOINTS']._serialized_start=1518
  _globals['_LOCALITYLBENDPOINTS']._serialized_end=2190
  _globals['_LOCALITYLBENDPOINTS_LBENDPOINTLIST']._serialized_start=2051
  _globals['_LOCALITYLBENDPOINTS_LBENDPOINTLIST']._serialized_end=2127
