...
class OverloadManager(_message.Message):
    ...
    def __init__(self, refresh_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., resource_monitors: _Optional[_Iterable[_Union[ResourceMonitor, _Mapping]]] = ..., actions: _Optional[_Iterable[_Union[OverloadAction, _Mapping]]] = ...) -> None: ...
