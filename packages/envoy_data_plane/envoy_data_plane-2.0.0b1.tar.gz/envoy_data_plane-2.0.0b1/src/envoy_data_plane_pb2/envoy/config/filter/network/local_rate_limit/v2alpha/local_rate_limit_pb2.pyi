...
from envoy.type import token_bucket_pb2 as _token_bucket_pb2
...
class LocalRateLimit(_message.Message):
    __slots__ = ("stat_prefix", "token_bucket", "runtime_enabled")
    ...
    def __init__(self, stat_prefix: _Optional[str] = ..., token_bucket: _Optional[_Union[_token_bucket_pb2.TokenBucket, _Mapping]] = ..., runtime_enabled: _Optional[_Union[_base_pb2.RuntimeFeatureFlag, _Mapping]] = ...) -> None: ...
