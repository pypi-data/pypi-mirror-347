...
class FaultDelay(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[FaultDelay.FaultDelayType, str]] = ..., fixed_delay: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., header_delay: _Optional[_Union[FaultDelay.HeaderDelay, _Mapping]] = ..., percentage: _Optional[_Union[_percent_pb2.FractionalPercent, _Mapping]] = ...) -> None: ...
