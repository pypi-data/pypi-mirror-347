...
class Squash(_message.Message):
    ...
    def __init__(self, cluster: _Optional[str] = ..., attachment_template: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., request_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., attachment_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., attachment_poll_period: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
