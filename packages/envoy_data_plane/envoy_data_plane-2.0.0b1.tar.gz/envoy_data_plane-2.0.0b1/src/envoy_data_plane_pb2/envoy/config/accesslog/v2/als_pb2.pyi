...
class CommonGrpcAccessLogConfig(_message.Message):
    ...
    def __init__(self, log_name: _Optional[str] = ..., grpc_service: _Optional[_Union[_grpc_service_pb2.GrpcService, _Mapping]] = ..., buffer_flush_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., buffer_size_bytes: _Optional[_Union[_wrappers_pb2.UInt32Value, _Mapping]] = ..., filter_state_objects_to_log: _Optional[_Iterable[str]] = ...) -> None: ...
