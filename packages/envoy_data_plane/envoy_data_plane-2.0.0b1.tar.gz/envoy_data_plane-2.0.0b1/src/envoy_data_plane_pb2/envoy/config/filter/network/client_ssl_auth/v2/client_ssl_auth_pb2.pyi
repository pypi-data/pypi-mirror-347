...
class ClientSSLAuth(_message.Message):
    ...
    def __init__(self, auth_api_cluster: _Optional[str] = ..., stat_prefix: _Optional[str] = ..., refresh_delay: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., ip_white_list: _Optional[_Iterable[_Union[_address_pb2.CidrRange, _Mapping]]] = ...) -> None: ...
