...
class CertificateDetails(_message.Message):
    ...
    class OcspDetails(_message.Message):
        ...
        def __init__(self, valid_from: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., expiration: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
    ...
    def __init__(self, path: _Optional[str] = ..., serial_number: _Optional[str] = ..., subject_alt_names: _Optional[_Iterable[_Union[SubjectAlternateName, _Mapping]]] = ..., days_until_expiration: _Optional[int] = ..., valid_from: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., expiration_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., ocsp_details: _Optional[_Union[CertificateDetails.OcspDetails, _Mapping]] = ...) -> None: ...
