...
class LocalityEndpointsHealth(_message.Message):
    __slots__ = ("locality", "endpoints_health")
    ...
    def __init__(self, locality: _Optional[_Union[_base_pb2.Locality, _Mapping]] = ..., endpoints_health: _Optional[_Iterable[_Union[EndpointHealth, _Mapping]]] = ...) -> None: ...

class ClusterEndpointsHealth(_message.Message):
    __slots__ = ("cluster_name", "locality_endpoints_health")
    CLUSTER_NAME_FIELD_NUMBER: _ClassVar[int]
    LOCALITY_ENDPOINTS_HEALTH_FIELD_NUMBER: _ClassVar[int]
    cluster_name: str
    locality_endpoints_health: _containers.RepeatedCompositeFieldContainer[LocalityEndpointsHealth]
    def __init__(self, cluster_name: _Optional[str] = ..., locality_endpoints_health: _Optional[_Iterable[_Union[LocalityEndpointsHealth, _Mapping]]] = ...) -> None: ...

class EndpointHealthResponse(_message.Message):
    __slots__ = ("endpoints_health", "cluster_endpoints_health")
    ENDPOINTS_HEALTH_FIELD_NUMBER: _ClassVar[int]
    CLUSTER_ENDPOINTS_HEALTH_FIELD_NUMBER: _ClassVar[int]
    endpoints_health: _containers.RepeatedCompositeFieldContainer[EndpointHealth]
    cluster_endpoints_health: _containers.RepeatedCompositeFieldContainer[ClusterEndpointsHealth]
    def __init__(self, endpoints_health: _Optional[_Iterable[_Union[EndpointHealth, _Mapping]]] = ..., cluster_endpoints_health: _Optional[_Iterable[_Union[ClusterEndpointsHealth, _Mapping]]] = ...) -> None: ...
...
class ClusterHealthCheck(_message.Message):
    __slots__ = ("cluster_name", "health_checks", "locality_endpoints", "transport_socket_matches", "upstream_bind_config")
    CLUSTER_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    transport_socket_matches: _containers.RepeatedCompositeFieldContainer[_cluster_pb2.Cluster.TransportSocketMatch]
    upstream_bind_config: _address_pb2.BindConfig
    def __init__(self, cluster_name: _Optional[str] = ..., health_checks: _Optional[_Iterable[_Union[_health_check_pb2.HealthCheck, _Mapping]]] = ..., locality_endpoints: _Optional[_Iterable[_Union[LocalityEndpoints, _Mapping]]] = ..., transport_socket_matches: _Optional[_Iterable[_Union[_cluster_pb2.Cluster.TransportSocketMatch, _Mapping]]] = ..., upstream_bind_config: _Optional[_Union[_address_pb2.BindConfig, _Mapping]] = ...) -> None: ...
...
class HealthCheckSpecifier(_message.Message):
    ...
    def __init__(self, cluster_health_checks: _Optional[_Iterable[_Union[ClusterHealthCheck, _Mapping]]] = ..., interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...

class HdsDummy(_message.Message):
    __slots__ = ()
