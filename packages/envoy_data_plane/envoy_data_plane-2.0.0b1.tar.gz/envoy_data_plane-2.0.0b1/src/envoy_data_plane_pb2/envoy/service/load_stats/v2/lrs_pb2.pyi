...
from envoy.api.v2.endpoint import load_report_pb2 as _load_report_pb2
...
class LoadStatsResponse(_message.Message):
    ...
    def __init__(self, clusters: _Optional[_Iterable[str]] = ..., send_all_clusters: bool = ..., load_reporting_interval: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., report_endpoint_granularity: bool = ...) -> None: ...
