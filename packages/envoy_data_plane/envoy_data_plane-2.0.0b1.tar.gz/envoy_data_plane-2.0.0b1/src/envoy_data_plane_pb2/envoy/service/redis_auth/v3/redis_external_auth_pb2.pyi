...
class RedisProxyExternalAuthResponse(_message.Message):
    ...
    message: str
    def __init__(self, status: _Optional[_Union[_status_pb2.Status, _Mapping]] = ..., expiration: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., message: _Optional[str] = ...) -> None: ...
