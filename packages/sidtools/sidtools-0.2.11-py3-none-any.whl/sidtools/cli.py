...
def s_gpumd_main():
    ...
    parser.add_argument("--min", type=int, default=1, help="Minimum trajectory folder index to run sbatch.")
    parser.add_argument("--max", type=int, default=None, help="Maximum trajectory folder index to run sbatch.")

    args = parser.parse_args()

    s_gpumd.run_gpumd_simulations(args.base, args.db, args.input, args.min, args.max)
