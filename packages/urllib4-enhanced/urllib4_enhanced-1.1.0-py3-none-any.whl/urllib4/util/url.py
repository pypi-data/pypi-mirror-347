...
# urllib4 infers URLs without a scheme (None) to be http.
...
class Url(
    ...
    def url(self) -> str:
        ...
        .. code-block:: python
            ...
            U = urllib4.util.parse_url("https://google.com/mail/")

            print(U.url)
            # "https://google.com/mail/"

            print( urllib4.util.Url("https", "username:password",
...
def parse_url(url: str) -> Url:
    ...
    .. code-block:: python
        ...
        print( urllib4.util.parse_url('http://google.com/mail/'))
        # Url(scheme='http', host='google.com', port=None, path='/mail/', ...)

        print( urllib4.util.parse_url('google.com:80'))
        # Url(scheme=None, host='google.com', port=80, path=None, ...)

        print( urllib4.util.parse_url('/foo?bar'))
