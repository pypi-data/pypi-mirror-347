...
class SynthonSpace(Boost.Python.instance):
    ...
    def GetSynthonFingerprintType(self) -> str:
        """
            ...
            C++ signature :
                std::string GetSynthonFingerprintType(RDKit::SynthonSpaceSearch::SynthonSpace {lvalue})
        """
    ...
    def ReadDBFile(self, inFile: str, numThreads: int = 1) -> None:
        """
            ...
            C++ signature :
                void ReadDBFile(RDKit::SynthonSpaceSearch::SynthonSpace {lvalue},std::string [,int=1])
        """
...
def ConvertTextToDBFile(inFilename: str, outFilename: str, fpGen: typing.Any = None) -> None:
    """
        ...
        C++ signature :
            void ConvertTextToDBFile(std::string,std::string [,boost::python::api::object=None])
    """
def FormattedIntegerString(value: int) -> str:
    """
        ...
        C++ signature :
            std::string FormattedIntegerString(long)
    """
