...
class ChemicalReaction(Boost.Python.instance):
    ...
    def GetBoolProp(self, key: str) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetBoolProp(RDKit::ChemicalReaction const*,std::string)
        """
    def GetDoubleProp(self, key: str) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetDoubleProp(RDKit::ChemicalReaction const*,std::string)
        """
    def GetIntProp(self, key: str) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetIntProp(RDKit::ChemicalReaction const*,std::string)
        """
    ...
    def GetProp(self, key: str) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetProp(RDKit::ChemicalReaction const*,std::string)
        """
    ...
    def GetUnsignedProp(self, key: str) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetUnsignedProp(RDKit::ChemicalReaction const*,std::string)
        """
...
def CreateDifferenceFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> UIntSparseIntVect:
    """
        ...
        C++ signature :
            RDKit::SparseIntVect<unsigned int>* CreateDifferenceFingerprintForReaction(RDKit::ChemicalReaction [,RDKit::ReactionFingerprintParams=<rdkit.Chem.rdChemReactions.ReactionFingerprintParams object at 0x7eff24d90040>])
    """
def CreateStructuralFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            ExplicitBitVect* CreateStructuralFingerprintForReaction(RDKit::ChemicalReaction [,RDKit::ReactionFingerprintParams=<rdkit.Chem.rdChemReactions.ReactionFingerprintParams object at 0x7eff24d900c0>])
    """
...
def SanitizeRxn(rxn: ChemicalReaction, sanitizeOps: int = 4294967295, params: AdjustQueryParameters = ..., catchErrors: bool = False) -> SanitizeFlags:
    """
        ...
        C++ signature :
            RDKit::RxnOps::SanitizeRxnFlags SanitizeRxn(RDKit::ChemicalReaction {lvalue} [,unsigned long=4294967295 [,RDKit::MolOps::AdjustQueryParameters=<rdkit.Chem.rdmolops.AdjustQueryParameters object at 0x7eff24d27880> [,bool=False]]])
    """
