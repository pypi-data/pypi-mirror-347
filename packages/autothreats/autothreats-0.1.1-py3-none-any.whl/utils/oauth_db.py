...
async def find_or_create_oauth_user(
    provider: str, provider_user_id: str, user_data: Dict[str, Any]
) -> Dict[str, Any]:
    """
    ...
    existing_user = next(
        (u for u in oauth_users.values() if u.get("oauth_id") == oauth_id), None
    )
...
async def store_oauth_token(
    user_id: int, provider: str, token_data: Dict[str, Any]
) -> str:
    """
    Store OAuth token
