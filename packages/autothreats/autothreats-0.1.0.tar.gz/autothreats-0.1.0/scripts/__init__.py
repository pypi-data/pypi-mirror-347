...
from .simplified_analyze_large_codebase import \
    main as run_analyze_large_codebase
...
try:
    ...
    async def run_threat_modeling_cli(*args, **kwargs):
        import logging
        logging.warning("threat_modeling_cli is not available in the simplified version")
        return 0
