...
class ExtensionManager:
        ...
        if agent_factories:
            try:
                ...
                agents = register_all_agents(
                    workspace=self.workspace, agent_factories=agent_factories
                )
    ...
    def load_and_register_extensions(
        self, extension_dirs: List[str]
...
def load_extensions(
    workspace: SharedWorkspace, extension_dirs: List[str]
) -> ExtensionManager:
    """
