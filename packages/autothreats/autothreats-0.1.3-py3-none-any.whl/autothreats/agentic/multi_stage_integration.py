...
class MultiStageAgentIntegration:
    ...
    async def _handle_threat_detection_start(
    ...
    async def _handle_pipeline_complete(
        ...
        self.logger.info(
            f"Published THREAT_DETECTION_COMPLETE message for job {job_id}"
        )
    ...
    async def _handle_pipeline_failed(
        self, message: Message
    ) -> Optional[Dict[str, Any]]:
        """
...
def register_multi_stage_integration(
    workspace: SharedWorkspace,
) -> MultiStageAgentIntegration:
    """
