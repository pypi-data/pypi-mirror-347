...
class SimplifiedExplainableSecurity:
    ...
    async def explain_vulnerabilities(self, vulnerabilities: List[Dict[str, Any]], job_id: str) -> List[Dict[str, Any]]:
        """
        ...
        """
        self.logger.info(f"Explaining {len(vulnerabilities)} vulnerabilities for job {job_id}")
    ...
    async def _explain_vulnerability(self, vulnerability: Dict[str, Any], job_id: str) -> Dict[str, Any]:
        """
...
"""
                ...
                try:
                    ...
                    if json_match:
                        ...
                        explained_vuln["exploitation_vector"] = "See detailed explanation"
...
"""
    ...
    async def generate_executive_summary(self, vulnerabilities: List[Dict[str, Any]], job_id: str) -> str:
        """
...
"""
                ...
                return self._generate_standard_summary(vulnerabilities, severity_counts, top_types)
        else:
            # Use standard summary if LLM service is not available
            summary = self._generate_standard_summary(vulnerabilities, severity_counts, top_types)
    ...
    def _generate_standard_summary(self, vulnerabilities: List[Dict[str, Any]], severity_counts: Dict[str, int], top_types: List[Tuple[str, int]]) -> str:
        """
