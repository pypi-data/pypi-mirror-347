...
class StorageSharing(object):
    ...
    def __init__(self, id=None, entity_id=None, root_sharing_id=None, user_id=None, group_id=None, restriction_role_id=None, type=None, created_time=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def group_id(self):
        """Gets the group_id of this StorageSharing.  # noqa: E501

        If non-empty, an ID of a group to which the access is granted. Cannot be set at the same time as user.  # noqa: E501

        :return: The group_id of this StorageSharing.  # noqa: E501
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this StorageSharing.

        If non-empty, an ID of a group to which the access is granted. Cannot be set at the same time as user.  # noqa: E501

        :param group_id: The group_id of this StorageSharing.  # noqa: E501
        :type group_id: str
        """
