...
class StorageDeployment(object):
    ...
    def __init__(self, id=None, created_time=None, last_modified_time=None, project_id=None, deployment_environment_id=None, experiment_id=None, type=None, secondary_scorer=None, metadata=None, deployer_data_version=None, deployer_data=None, owner_id=None, local_vars_configuration=None):  # noqa: E501
