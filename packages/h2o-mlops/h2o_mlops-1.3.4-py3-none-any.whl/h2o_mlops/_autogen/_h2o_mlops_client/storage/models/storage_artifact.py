...
class StorageArtifact(object):
    ...
    def __init__(self, id=None, entity_id=None, type=None, state=None, size=None, md5_digest=None, created_time=None, uploaded_time=None, mime_type=None, last_modified_time=None, local_vars_configuration=None):  # noqa: E501
