...
class V1Job(object):
    ...
    def __init__(self, name=None, display_name=None, source=None, sink=None, instance_spec=None, batch_parameters=None, model_request_parameters=None, state=None, creator=None, create_time=None, start_time=None, end_time=None, local_vars_configuration=None):  # noqa: E501
