...
class DeployPagingResponse(object):
    ...
    def __init__(self, next_page_token=None, local_vars_configuration=None):  # noqa: E501
        """DeployPagingResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def next_page_token(self):
        """Gets the next_page_token of this DeployPagingResponse.  # noqa: E501
        ...
        :return: The next_page_token of this DeployPagingResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def next_page_token(self, next_page_token):
        """Sets the next_page_token of this DeployPagingResponse.

        An opaque token to be sent together with the next listing request to continue with the next record under any given filter and sorting. This token should not be interpreted by the client and its structure may change without any prior notice.  # noqa: E501

        :param next_page_token: The next_page_token of this DeployPagingResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployPagingResponse):
            return False
