...
import _h2o_mlops_client.deployer.models
from _h2o_mlops_client.deployer import rest
from _h2o_mlops_client.deployer.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(_h2o_mlops_client.deployer.models, klass)
