...
class ApiExportMetricResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """ApiExportMetricResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ApiExportMetricResponse.  # noqa: E501


        :return: The data of this ApiExportMetricResponse.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ApiExportMetricResponse.


        :param data: The data of this ApiExportMetricResponse.  # noqa: E501
        :type data: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiExportMetricResponse):
            return False
