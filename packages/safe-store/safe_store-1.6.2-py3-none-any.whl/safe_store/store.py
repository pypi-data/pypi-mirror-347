         ...
         with self._instance_lock:
              ...
              try:
                   ...
                   for row in cursor.fetchall():
                        metadata_dict = None;
                        if row[4]: try: metadata_dict = json.loads(row[4]) except json.JSONDecodeError: pass
    ...
    def list_vectorization_methods(self) -> List[Dict[str, Any]]:
         ...
         with self._instance_lock:
              ...
              try:
                   ...
                   for row in cursor.fetchall():
                        params_dict = None;
                        if row[5]: try: params_dict = json.loads(row[5]) except json.JSONDecodeError: pass
