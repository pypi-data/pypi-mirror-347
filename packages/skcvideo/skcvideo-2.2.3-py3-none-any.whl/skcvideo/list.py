...
from skcvideo.reader import WHITE, put_text
...
class ImageGenerator:
    def __init__(self, images_dir):
        ...
        self.keydict = {"k": self.next, "j": self.previous, "q": self.exit}
        ...
        cv2.namedWindow("SKC video reader")
    ...
    def refresh(self):
        ...
        put_text(self.big_image, f"i: {self.i}", (20, 30), WHITE)
