...
install_requires = [
    # Ultralytics (YOLO)
    'ultralytics==8.3.28; python_version <= "3.11"',
    'ultralytics; python_version > "3.11"',

    # OpenCV
    'opencv-python==4.10.0.84; python_version <= "3.11"',
    'opencv-python; python_version > "3.11"',
    ...
    # TorchAudio
    'torchaudio==2.1; python_version <= "3.11"',
