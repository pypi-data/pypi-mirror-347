...
class PublicOrderbookGet200Response(BaseModel):
    """
    PublicOrderbookGet200Response
    """ # noqa: E501
    bids: List[Annotated[List[StrictStr], Field(min_length=2, max_length=2)]]
    asks: List[Annotated[List[StrictStr], Field(min_length=2, max_length=2)]]
