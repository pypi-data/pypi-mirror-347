...
class PublicFundsTransparencyGet200ResponseFundsValueValue(BaseModel):
    """
    PublicFundsTransparencyGet200ResponseFundsValueValue
    """ # noqa: E501
    total: Union[StrictFloat, StrictInt]
    in_cold: Union[StrictFloat, StrictInt]
    free: Union[StrictFloat, StrictInt]
    locked: Union[StrictFloat, StrictInt]
    address_count: Union[StrictFloat, StrictInt]
    addresses: List[StrictStr]
    __properties: ClassVar[List[str]] = ["total", "in_cold", "free", "locked", "address_count", "addresses"]
