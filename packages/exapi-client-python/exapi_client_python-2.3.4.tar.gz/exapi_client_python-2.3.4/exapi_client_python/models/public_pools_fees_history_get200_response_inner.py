...
class PublicPoolsFeesHistoryGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["timestamp", "fees"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fees": PublicPoolsGet200ResponseInnerEarned24h.from_dict(obj["fees"]) if obj.get("fees") is not None else None
        })
        return _obj
