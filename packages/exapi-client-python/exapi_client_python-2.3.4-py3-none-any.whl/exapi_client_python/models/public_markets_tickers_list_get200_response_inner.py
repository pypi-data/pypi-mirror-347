...
class PublicMarketsTickersListGet200ResponseInner(BaseModel):
    """
    PublicMarketsTickersListGet200ResponseInner
    """ # noqa: E501
    symbol: StrictStr
    last_price: StrictStr
    price_change_percent: StrictStr
    base_volume: StrictStr
    __properties: ClassVar[List[str]] = ["symbol", "last_price", "price_change_percent", "base_volume"]
