...
from kadmin.attribute import __author__
from kadmin.attribute import __author_email__
from kadmin.attribute import __description__
...
setup(
    ...
    packages=find_packages(include=["kadmin*"], exclude=["kadmin.unittest"]),  # noqa:E501
