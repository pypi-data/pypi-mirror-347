...
def make_static_plot(field_a: cp.Field, field_b: cp.Field,
                     output_file: Optional[str] = None, layers: Optional[List[str]] = None,
    ...
    **kwargs
    ...
    unit_a = field_a[0].metadata['units'] if unit_a is None else unit_a
    unit_b = field_b[0].metadata['units'] if unit_b is None else unit_b
