...
We recommend starting with one of these examples and modifying the parameters to customize the figure according to your needs.
...
.. warning::
    ...
    You are restricted to the predefined set of parameters accepted by each visualization function (see :ref:`visualization` for reference).
