...
class ChatUtils:
    ...
    def send_message_to_chat(chat_id: str, message: str):
        ...
        payload = {
            "body": {
                ...
                "content": message + "</br></br><p style=\"color: grey;\"> - Sent from PM Studio</p>"
    ...
    def send_to_myself(message: str):
        ...
        return ChatUtils.send_message_to_chat("self", message)
    ...
    def send_to_group_chat(topic: str, message: str):
        ...
        return ChatUtils.send_message_to_chat(chat_id, message)
