...
FILTER_COLUMNS = \
{
    ...
    "tenant_type": {
        "description": "Classification of the tenant environment",
        "mapping": {
            "All": "Desktop - All",
            "Client": "Desktop – Client",
            "PWA": "Desktop – PWA",
            "PWA_WithInfo": "Desktop – PWA_WithInfo",
            "WebView": "Desktop – WebView"
        },
        "default_value": "Desktop – Client"
    },
    "os_category": {
...
SQL_TEMPLATES = [
    {
        "name": "mac_upscaled_DAU_by_region",
        "description": "Retrieve daily active users filtered by a14 region",
        "required_filters": ["start_date", "end_date"],
        "optional_filters": ["tenant_type_value", "os_value", "channel_value", "region_value"],
        "template": """
SELECT CASE
           WHEN (a14RegionId == 1
...
""",
    ...
    {
        "name": "mac_upscaled_dau",
        "description": "get upscaled DAU count for specific tenant type, OS category, and channel",
        "required_filters": ["start_date", "end_date"],
        "optional_filters": ["tenant_type_value", "os_value", "channel_value", "rolling_window"],
        "template": """
