...
class HometaxScraper:
    ...
    def login_with_cert_by_webdriver(self, cert_paths: List[str], prikey_password):
        driver = HometaxDriver()
        driver.login_with_cert(cert_paths, prikey_password)
        self.login_with_cookies(driver.driver.get_cookies())
