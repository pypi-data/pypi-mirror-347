import{r as t,j as o,aV as z,l as c,P as w,R as P,E as b,cN as k,ey as S,ez as F,eA as L,bV as C,eB as l,o as E,eC as R}from"./vendor-BvFaCsmL.js";import{e as I,w as j,D as A,K as T,M as _}from"./vendor-arizeai-DJ2Xx4kZ.js";import{L as D,r as O,g as G,h as N,F as M,i as V,P as q,j as B,M as m,k as K,D as U,l as W,E as J,n as Y,o as $,p as H,q as Q,s as p,t as X,v as Z,w as oo,x as lo,y as ao,z as ro,B as co,C as go,G as eo,H as bo,I as u,J as f,K as y,N as no,O as io,Q as so,U as to,V as mo,W as po,X as uo,Y as fo,Z as yo,_ as vo,$ as ho,a0 as xo,a1 as zo,a2 as wo,a3 as Po,a4 as ko,a5 as So,a6 as Fo,a7 as Lo,a8 as Co,a9 as Eo,aa as Ro,ab as Io,ac as jo,ad as Ao,ae as To,af as _o,ag as Do,ah as Oo,ai as Go,aj as No,ak as Mo,al as Vo,am as qo,an as Bo,ao as Ko,ap as Uo,aq as Wo}from"./pages-DiZbDjAl.js";import{z as Jo,em as Yo,bY as $o,R as Ho,en as Qo,eo as Xo}from"./components-fznwgFMD.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-CC0itEC8.js";import"./vendor-shiki-CnRwDBHX.js";import"./vendor-recharts-ZOUPDkCE.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(r){if(r.ep)return;r.ep=!0;const g=i(r);fetch(r.href,g)}})();const v="arize-phoenix-feature-flags",d={__RESET__:!1};function Zo(){const a=localStorage.getItem(v);if(!a)return d;try{const e=JSON.parse(a);return Object.assign({},d,e)}catch{return d}}const h=t.createContext(null);function ol(){const a=P.useContext(h);if(a===null)throw new Error("useFeatureFlags must be used within a FeatureFlagsProvider");return a}function ll(a){const[e,i]=t.useState(Zo()),s=r=>{localStorage.setItem(v,JSON.stringify(r)),i(r)};return o(h.Provider,{value:{featureFlags:e,setFeatureFlags:s},children:o(al,{children:a.children})})}function al(a){const{children:e}=a,{featureFlags:i,setFeatureFlags:s}=ol(),[r,g]=t.useState(!1);return z("ctrl+shift+f",()=>g(!0)),c(w,{children:[e,o(A,{type:"modal",isDismissable:!0,onDismiss:()=>g(!1),children:r&&o(I,{title:"Feature Flags",children:o(Jo,{height:"size-1000",padding:"size-100",children:Object.keys(i).map(n=>o(j,{isSelected:i[n],onChange:x=>s({...i,[n]:x}),children:n},n))})})})]})}const rl=b`
  :root {
