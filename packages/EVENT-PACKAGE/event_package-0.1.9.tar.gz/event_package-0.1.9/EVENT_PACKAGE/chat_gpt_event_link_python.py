...
#         print(c)
    ...
    winter = winterr
    all_varient.append(float(winterr))

    spring = springg
    all_varient.append(float(springg))

    summer = summerr
    all_varient.append(float(summerr))

    fall = falll
    all_varient.append(float(falll))
...
winterr, springg, summerr, falll = thresholds['winter'], thresholds['spring'], thresholds['summer'], thresholds['fall']

if analysis_type == 'Daily':
    daily_events(file_path, heading, water_table, water_temp, winterr, springg, summerr, falll, seasonal_method)
elif analysis_type == 'Hourly':
    hourly_events(file_path, heading, water_table, water_temp, winterr, springg, summerr, falll, seasonal_method)