# -*- coding: utf-8 -*-
"""TLKT_20250514_00.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1BOaMDZKv8CpTMIIgzRA34qtNShRVe2FC
...
# ────────────────────────────────────────────────────────────────
import os, sys, io, shutil, threading, subprocess, time
...
class ToolKit():
    ...
    def create_virtualenv(self, venv_path: Path, python_executable: str = "/usr/bin/python3"):
        ...
        logger.info(f"🔧 Creating virtualenv at: {venv_path_str} (python: {python_executable})")
        buf = io.StringIO()
        try:
            # stdout, stderr をバッファにリダイレクト
