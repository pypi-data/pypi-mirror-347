...
class ToolKit():
    ...
    def create_virtualenv(self, venv_path: Path, python_executable: str = "/usr/bin/python3"):
        ...
        self.logger.info(f"🔧 Creating virtualenv at: {venv_path_str} (python: {python_executable})")
        # virtualenv の呼び出し
        try:
            virtualenv.cli_run([
            ...
            self.logger.info("✅ virtualenv created successfully")
        except Exception as e:
