...
class TripletexPosting(TripletexCrud[Posting]):
    ...
    def list(self, parent_id: Optional[str] = None, params: Optional[JSONDict] = None) -> PostingResponse:
        ...
        # The base class already handles returning the correct response model type
        # when _api_response_model is set. We just need to ensure the type hint matches.
        return cast(PostingResponse, response)
