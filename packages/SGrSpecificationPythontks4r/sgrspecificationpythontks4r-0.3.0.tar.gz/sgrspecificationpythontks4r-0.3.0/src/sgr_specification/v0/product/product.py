...
from sgr_specification.v0.product.contact_interface import ContactInterface
from sgr_specification.v0.product.generic_interface import GenericInterface
from sgr_specification.v0.product.messaging_interface import MessagingInterface
from sgr_specification.v0.product.modbus_interface import ModbusInterface
from sgr_specification.v0.product.rest_api_interface import RestApiInterface
...
class DeviceInformation:
    ...
    test_state: Optional[TestState] = field(
        default=None,
        metadata={
            "name": "testState",
            "type": "Element",
...
class InterfaceList:
    ...
    messaging_interface: Optional[MessagingInterface] = field(
        default=None,
        metadata={
