...
class StagingConfigurationFullDto(object):
    ...
    def __init__(self, query=None, id_entity=None, schema_name=None, table_name=None, table_field_definition=None, id_pipeline=None, id=None, entity_name=None, last_load_date=None):  # noqa: E501
