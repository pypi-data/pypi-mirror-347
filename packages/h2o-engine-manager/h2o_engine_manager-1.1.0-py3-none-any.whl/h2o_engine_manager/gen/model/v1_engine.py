...
class V1Engine(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            profile (str): The resource name of the DAIEngineProfile or H2OEngineProfile that is used by this Engine. Format is `daiEngineProfiles/*`, `h2oEngineProfiles/*` or `notebookEngineProfiles/*`.. [optional]  # noqa: E501
