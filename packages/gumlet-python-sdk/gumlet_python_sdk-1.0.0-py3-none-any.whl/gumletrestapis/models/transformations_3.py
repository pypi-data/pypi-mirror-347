...
class Transformations3(object):

    """Implementation of the 'Transformations3' model.
    ...
    Attributes:
        ...
        keep_original (bool): The model property of type bool.
        per_title_encoding (bool): The model property of type bool.
        process_low_resolution_input (bool): The model property of type bool.
    ...
    def __init__(self,
        ...
        """Constructor for the Transformations3 class"""
    ...
    def from_dictionary(cls,
        ...
        keep_original = dictionary.get("keep_original") if dictionary.get("keep_original") else True
        per_title_encoding = dictionary.get("per_title_encoding") if dictionary.get("per_title_encoding") else True
        process_low_resolution_input = dictionary.get("process_low_resolution_input") if dictionary.get("process_low_resolution_input") else True
