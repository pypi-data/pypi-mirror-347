...
class GenerateSubtitles2(object):

    """Implementation of the 'GenerateSubtitles2' model.

    Attributes:
        audio_language (str): The model property of type str.
        subtitle_languages (List[str]): The model property of type List[str].
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateSubtitles2 class"""
