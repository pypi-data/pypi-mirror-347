...
from gumletrestapis.models.aws import Aws
from gumletrestapis.models.channel_settings import ChannelSettings
from gumletrestapis.models.embed_details import EmbedDetails
from gumletrestapis.models.player_config import PlayerConfig
from gumletrestapis.models.video_protection import VideoProtection


class VideoSourcesResponse2(object):

    """Implementation of the 'Video Sources Response2' model.
    ...
    Attributes:
        ...
        video_protection (VideoProtection): The model property of type
            VideoProtection.
        ...
        aws (Aws): The model property of type Aws.
        embed_details (EmbedDetails): The model property of type EmbedDetails.
        folders (List[str]): The model property of type List[str].
        channel_settings (ChannelSettings): The model property of type
            ChannelSettings.
    ...
    def __init__(self,
        ...
        """Constructor for the VideoSourcesResponse2 class"""
    ...
    def from_dictionary(cls,
        ...
        video_protection = VideoProtection.from_dictionary(dictionary.get('video_protection')) if 'video_protection' in dictionary.keys() else APIHelper.SKIP
        ...
        aws = Aws.from_dictionary(dictionary.get('aws')) if 'aws' in dictionary.keys() else APIHelper.SKIP
        embed_details = EmbedDetails.from_dictionary(dictionary.get('embed_details')) if 'embed_details' in dictionary.keys() else APIHelper.SKIP
        folders = dictionary.get("folders") if dictionary.get("folders") else APIHelper.SKIP
        channel_settings = ChannelSettings.from_dictionary(dictionary.get('channel_settings')) if 'channel_settings' in dictionary.keys() else APIHelper.SKIP
