...
class PlayerConfig2(object):

    """Implementation of the 'PlayerConfig2' model.

    Configure player settings for this playlist, it overrides the setting set
    on collection.
    ...
    def __init__(self,
                 preload=APIHelper.SKIP,
                 autoplay=APIHelper.SKIP,
                 disable_seek=APIHelper.SKIP,
                 disable_player_controls=APIHelper.SKIP,
                 powered_by_gumlet_overlay=APIHelper.SKIP,
                 allow_drm_protected_videos=APIHelper.SKIP,
                 loop=APIHelper.SKIP,
                 player_color=APIHelper.SKIP,
                 include_seo=APIHelper.SKIP,
                 subtitle_enabled=APIHelper.SKIP,
                 pixel_tags=APIHelper.SKIP,
                 logo_width=APIHelper.SKIP,
                 logo_height=APIHelper.SKIP,
                 dynamic_watermark=APIHelper.SKIP,
                 watermark_font_size=APIHelper.SKIP,
                 watermark_font_color=APIHelper.SKIP,
                 watermark_bg_color=APIHelper.SKIP,
                 watermark_interval=APIHelper.SKIP):
        """Constructor for the PlayerConfig2 class"""

        # Initialize members of the class
        if preload is not APIHelper.SKIP:
            self.preload = preload 
        if autoplay is not APIHelper.SKIP:
            self.autoplay = autoplay 
        if disable_seek is not APIHelper.SKIP:
            self.disable_seek = disable_seek 
        if disable_player_controls is not APIHelper.SKIP:
            self.disable_player_controls = disable_player_controls 
        if powered_by_gumlet_overlay is not APIHelper.SKIP:
            self.powered_by_gumlet_overlay = powered_by_gumlet_overlay 
        if allow_drm_protected_videos is not APIHelper.SKIP:
            self.allow_drm_protected_videos = allow_drm_protected_videos 
        if loop is not APIHelper.SKIP:
            self.loop = loop 
        if player_color is not APIHelper.SKIP:
            self.player_color = player_color 
        if include_seo is not APIHelper.SKIP:
            self.include_seo = include_seo 
        if subtitle_enabled is not APIHelper.SKIP:
            self.subtitle_enabled = subtitle_enabled 
        if pixel_tags is not APIHelper.SKIP:
            self.pixel_tags = pixel_tags 
        if logo_width is not APIHelper.SKIP:
            self.logo_width = logo_width 
        if logo_height is not APIHelper.SKIP:
            self.logo_height = logo_height 
        if dynamic_watermark is not APIHelper.SKIP:
            self.dynamic_watermark = dynamic_watermark 
        if watermark_font_size is not APIHelper.SKIP:
        ...
        if watermark_interval is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        preload = dictionary.get("preload") if "preload" in dictionary.keys() else APIHelper.SKIP
        autoplay = dictionary.get("autoplay") if "autoplay" in dictionary.keys() else APIHelper.SKIP
        disable_seek = dictionary.get("disable_seek") if "disable_seek" in dictionary.keys() else APIHelper.SKIP
        disable_player_controls = dictionary.get("disable_player_controls") if "disable_player_controls" in dictionary.keys() else APIHelper.SKIP
        powered_by_gumlet_overlay = dictionary.get("powered_by_gumlet_overlay") if "powered_by_gumlet_overlay" in dictionary.keys() else APIHelper.SKIP
        allow_drm_protected_videos = dictionary.get("allow_drm_protected_videos") if "allow_drm_protected_videos" in dictionary.keys() else APIHelper.SKIP
        loop = dictionary.get("loop") if "loop" in dictionary.keys() else APIHelper.SKIP
        player_color = dictionary.get("player_color") if dictionary.get("player_color") else APIHelper.SKIP
        include_seo = dictionary.get("include_seo") if "include_seo" in dictionary.keys() else APIHelper.SKIP
        subtitle_enabled = dictionary.get("subtitle_enabled") if "subtitle_enabled" in dictionary.keys() else APIHelper.SKIP
        pixel_tags = dictionary.get("pixel_tags") if dictionary.get("pixel_tags") else APIHelper.SKIP
        logo_width = dictionary.get("logo_width") if dictionary.get("logo_width") else APIHelper.SKIP
        logo_height = dictionary.get("logo_height") if dictionary.get("logo_height") else APIHelper.SKIP
        dynamic_watermark = dictionary.get("dynamic_watermark") if "dynamic_watermark" in dictionary.keys() else APIHelper.SKIP
        watermark_font_size = dictionary.get("watermark_font_size") if dictionary.get("watermark_font_size") else APIHelper.SKIP
        ...
        watermark_interval = dictionary.get("watermark_interval") if dictionary.get("watermark_interval") else APIHelper.SKIP
