...
class VideoProfilesRequest(object):

    """Implementation of the 'Video Profiles Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VideoProfilesRequest class"""
    ...
    def from_dictionary(cls,
        ...
        name = dictionary.get("name") if dictionary.get("name") else 'Gumlet-Profile-1'
