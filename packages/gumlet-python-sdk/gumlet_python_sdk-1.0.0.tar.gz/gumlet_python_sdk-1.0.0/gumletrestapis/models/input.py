...
from gumletrestapis.models.call_to_action_1 import CallToAction1
from gumletrestapis.models.metadata import Metadata
from gumletrestapis.models.transformations import Transformations
...
class Input(object):
    ...
    Attributes:
        transformations (Transformations): The model property of type
            Transformations.
        ...
        call_to_actions (List[CallToAction1]): The model property of type
            List[CallToAction1].
    ...
    def from_dictionary(cls,
        ...
        transformations = Transformations.from_dictionary(dictionary.get('transformations')) if 'transformations' in dictionary.keys() else APIHelper.SKIP
        ...
        if dictionary.get('call_to_actions') is not None:
            call_to_actions = [CallToAction1.from_dictionary(x) for x in dictionary.get('call_to_actions')]
        else:
            call_to_actions = APIHelper.SKIP
