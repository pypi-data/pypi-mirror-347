...
from gumletrestapis.models.webfolder_1 import Webfolder1


class ImageSourcesRequest1(object):

    """Implementation of the 'Image Sources Request1' model.

    Attributes:
        mtype (Type3Enum): The model property of type Type3Enum.
        webfolder (Webfolder1): This is a required field if source type is
            webfolder.
    ...
    def __init__(self,
        ...
        """Constructor for the ImageSourcesRequest1 class"""
    ...
    def from_dictionary(cls,
        ...
        webfolder = Webfolder1.from_dictionary(dictionary.get('webfolder')) if 'webfolder' in dictionary.keys() else APIHelper.SKIP
