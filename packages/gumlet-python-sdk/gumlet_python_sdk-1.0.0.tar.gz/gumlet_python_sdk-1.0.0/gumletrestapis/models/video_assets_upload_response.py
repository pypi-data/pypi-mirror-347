...
from gumletrestapis.models.input_1 import Input1
from gumletrestapis.models.output import Output


class VideoAssetsUploadResponse(object):

    """Implementation of the 'Video Assets Upload Response' model.
    ...
    Attributes:
        ...
        input (Input1): The model property of type Input1.
        output (Output): The model property of type Output.
        upload_url (str): The model property of type str.
    ...
    def __init__(self,
        ...
        """Constructor for the VideoAssetsUploadResponse class"""
    ...
    def from_dictionary(cls,
        ...
        input = Input1.from_dictionary(dictionary.get('input')) if 'input' in dictionary.keys() else APIHelper.SKIP
        output = Output.from_dictionary(dictionary.get('output')) if 'output' in dictionary.keys() else APIHelper.SKIP
        upload_url = dictionary.get("upload_url") if dictionary.get("upload_url") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'upload_url={(self.upload_url if hasattr(self, "upload_url") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'upload_url={(self.upload_url if hasattr(self, "upload_url") else None)!s}, '
