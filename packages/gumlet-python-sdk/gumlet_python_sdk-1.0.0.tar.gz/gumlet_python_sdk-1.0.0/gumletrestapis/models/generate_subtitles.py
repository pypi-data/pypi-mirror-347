...
class GenerateSubtitles(object):

    """Implementation of the 'GenerateSubtitles' model.

    Gumlet allows to generate subtitles from the audio stream (use <a
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateSubtitles class"""
