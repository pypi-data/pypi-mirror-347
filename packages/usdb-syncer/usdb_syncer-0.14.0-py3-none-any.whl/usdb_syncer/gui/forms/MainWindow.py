...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon23 = QIcon()
        icon23.addFile(u":/icons/drive-download.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.button_download.setIcon(icon23)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/icons/control-pause.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.button_pause.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u":/icons/drawer.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menu_custom_data.setIcon(icon25)
        self.menu_open_song_in = QMenu(self.menu_songs)
        self.menu_open_song_in.setObjectName(u"menu_open_song_in")
        icon26 = QIcon()
        icon26.addFile(u":/icons/music--arrow.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menu_open_song_in.setIcon(icon26)
        ...
        icon27 = QIcon()
        icon27.addFile(u":/icons/error.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_errors.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u":/icons/warning.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_warnings.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/icons/info.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_infos.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/icons/bug.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_debugs.setIcon(icon30)
...
#endif // QT_CONFIG(tooltip)
        self.action_preview.setText(QCoreApplication.translate("MainWindow", u"Preview Song", None))
