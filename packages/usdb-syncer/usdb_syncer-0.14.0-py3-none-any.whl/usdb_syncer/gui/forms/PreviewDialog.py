...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.button_to_start = QToolButton(Dialog)
        ...
        self.button_backward = QToolButton(Dialog)
        ...
        self.button_pause = QToolButton(Dialog)
        ...
        self.button_forward = QToolButton(Dialog)
        ...
        self.button_to_end = QToolButton(Dialog)
        ...
        self.label_ticks_volume = QLabel(Dialog)
        ...
        self.label_voice = QLabel(Dialog)
        ...
        self.slider_source = QSlider(Dialog)
        ...
        self.label_source_volume = QLabel(Dialog)
        ...
        self.label_pitch_volume = QLabel(Dialog)
        ...
        self.slider_ticks = QSlider(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.button_to_start.setText(QCoreApplication.translate("Dialog", u"...", None))
        self.button_backward.setText(QCoreApplication.translate("Dialog", u"...", None))
        self.button_pause.setText(QCoreApplication.translate("Dialog", u"...", None))
        self.button_forward.setText(QCoreApplication.translate("Dialog", u"...", None))
        self.button_to_end.setText(QCoreApplication.translate("Dialog", u"...", None))
        self.label_time.setText(QCoreApplication.translate("Dialog", u"00:00 / 02:30", None))
        self.label_bpm.setText(QCoreApplication.translate("Dialog", u"#BPM: ", None))
        self.label_gap.setText(QCoreApplication.translate("Dialog", u"#GAP: ", None))
        self.label_start.setText(QCoreApplication.translate("Dialog", u"#START:", None))
        self.label_end.setText(QCoreApplication.translate("Dialog", u"#END:", None))
        self.label_ticks_volume.setText(QCoreApplication.translate("Dialog", u"100", None))
        self.label_voice.setText(QCoreApplication.translate("Dialog", u"Voice:", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"Source:", None))
        self.label_source_volume.setText(QCoreApplication.translate("Dialog", u"100", None))
        self.label_3.setText(QCoreApplication.translate("Dialog", u"Pitch:", None))
        self.label_pitch_volume.setText(QCoreApplication.translate("Dialog", u"0", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Ticks:", None))
    # retranslateUi
