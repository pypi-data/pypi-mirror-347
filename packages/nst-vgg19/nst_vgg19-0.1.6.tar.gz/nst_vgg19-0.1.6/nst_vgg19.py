...
class NST_VGG19_AdaIN:
    def __init__(self, style_image_numpy, alpha=0.5):
        ...
        decoder_path = os.path.join(model_dir, 'AdaIN_VGG19/decoder.tar')
        if not os.path.exists(model_dir) or not not os.path.exists(realesrgan_path) or not os.path.exists(decom_path) or not os.path.exists(relight_path):
