...
asset(path="mantine_provider.js", shared=True)
...
class MantineDescriptionProps:
    description: Var[Component | str]
    description_props: Var[dict]

class BaseMantineErrorMessage(MantineCoreBase):
    @overload
    @classmethod
    def create(  # type: ignore
        cls,
        *children,
        ...
        on_unmount: Optional[EventType[()]] = None,
        **props,
    ) -> "BaseMantineErrorMessage":
        """Create the Reflex Enterprise component."""
        ...

class BaseMantineLabel(MantineCoreBase):
    @overload
    @classmethod
    def create(  # type: ignore
        cls,
