...
> [!TIP]
> The following feature requires `rai_interfaces` to be installed. This package is available at [rai_interfaces](https://github.com/RobotecAI/rai/tree/development/src/rai_interfaces). Soon, it will be also available through apt.
>
> ```bash
