...
# base_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "chart")
...
def get_perf_report(title=None):
    ...
    for k in range(1, 2):
        ...
        # plt.show()
        chart_path = os.path.join(current_path, "chart")
        if not os.path.exists(chart_path):
            os.makedirs(chart_path)
        fig.savefig(os.path.join(chart_path, "chart.png"), dpi=300)
