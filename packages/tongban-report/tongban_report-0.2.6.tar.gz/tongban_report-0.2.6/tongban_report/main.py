...
def main():
    ...
    parser.add_argument("-u", "--upload", help="上传测试报告")
    ...
    if args.func:
        ...
        func_report(docx=args.func, xlsx=args.data, sheet=sheet, project_num=2)
    if args.safe:
        print("安全模板:", args.safe)
        safe_report(docx=args.safe, xlsx=args.data, sheet=sheet, project_num=2)
