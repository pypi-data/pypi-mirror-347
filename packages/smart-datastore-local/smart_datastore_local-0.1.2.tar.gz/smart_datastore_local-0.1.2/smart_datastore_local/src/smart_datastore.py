...
#  parameter
def generic_method(self, schema_name: str = None, table_name: str = None,
                   data_dict: dict = None,
    ...
    print("generic_method", flush=True)
    ...
    try:
        ...
        print("result_mysql="+result_mysql, flash=True)
        pass
    ...
    if is_redis_table(table_name=table_name,
        ...
        print("Suppose to call generic_crud_redis.insert", flash=True)
        try:
...
class SmartDatastore (GenericCrudAbstract):
    def __init__(self, default_schema_name: str = None,
        ...
        self.generic_crud_redis = GenericCrudMysql(
            ...
            default_column_name=default_column_name,
            is_test_data=is_test_data)
        crud_method_dict = {"mysql": self.generic_crud_mysql,
                            "redis": self.generic_crud_redis}

    def insert(self, *, schema_name: str = None, table_name: str = None,
               data_dict: dict = None,
               ignore_duplicate: bool = False, commit_changes: bool = True
               ) -> int:
        print("SmartDatastore: insert (Not generic_method())", flush=True)
        result_redis = None
        # TODO Run in parallel
        # self.generic_crud_mysql.insert
        try:
...
for method_name in GenericCrudAbstract.__abstractmethods__:
    ...
    setattr(SmartDatastore, method_name, generic_method)
