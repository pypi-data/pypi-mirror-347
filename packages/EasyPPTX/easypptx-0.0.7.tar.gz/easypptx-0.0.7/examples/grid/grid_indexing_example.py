...
for i in range(9):
    grid3[i].add_text(
        ...
        align="center",
        vertical="middle",
        bg_color=["lightgray", "lightblue", "lightgreen", 
                  "pink", "yellow", "lightcyan",
                  "orange", "lavender", "lightsalmon"][i]
    )

# Create a fourth slide with a 3x3 grid for negative indexing
slide4, grid4 = pres.add_grid_slide(
    rows=3,
    cols=3,
    title="Negative Flat Indexing Demo",
    title_align="center"
)
