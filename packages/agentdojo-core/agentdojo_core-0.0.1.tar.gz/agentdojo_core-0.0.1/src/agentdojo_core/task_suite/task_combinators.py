...
from agentdojo_core.base_tasks import BaseUserTask, TaskDifficulty
from agentdojo_core.functions_runtime import FunctionCall, TaskEnvironment

if TYPE_CHECKING:
    from agentdojo_core.task_suite import TaskSuite
