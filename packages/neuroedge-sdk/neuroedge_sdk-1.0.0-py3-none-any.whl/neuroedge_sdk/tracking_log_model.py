...
class ModelTrackingLogger:
    ...
    def __enter__(self):
        ...
        if not uri:
            logging.error("Environment variable 'MLFLOW_TRACKING_URI' is not set.")
    ...
    def log_training_parameters(self, train_path, epochs, imgsz):
        try:
    ...
    def log_training_metrics_and_artifacts(self, project_name, model_path, results):
        try:
            results_csv = os.path.join(project_name, model_path, "results.csv")
