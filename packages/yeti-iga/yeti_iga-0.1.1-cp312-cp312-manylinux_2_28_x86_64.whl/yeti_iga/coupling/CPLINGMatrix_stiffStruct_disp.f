...
c     --> cas des structures raidies
      ...
      subroutine build_CplgMatrix(CMatrix, TABinterfaceDef,NBINT,
...
!     ----------------
      ...
      dimension CMatrix(nb_dof_free,nb_cp_l*MCRD)
...
c     ---------------
     ...
     &     k1,kk1,ddl1,k2,kk2,ddl2,num_l,numCP, count
...
C     ------------------------------------------------------------------
      ...
      end subroutine build_CplgMatrix
