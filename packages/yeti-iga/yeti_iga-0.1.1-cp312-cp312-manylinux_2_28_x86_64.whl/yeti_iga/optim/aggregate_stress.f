...
!! with Yeti. If not, see <https://www.gnu.org/licenses/>
      ...
      subroutine pnormStress(stressPN,
...
C     Output variables :
c     ----------------
      Double precision, intent(out) :: stressPN
      dimension stressPN(6)
...
C     ------------------------------------------------------------------
     ...
     &              stress)
      ...
      stressPN(:) = stressPN(:)**(one/dble(Pnorm))


C     ------------------------------------------------------------------
      
      end subroutine pnormStress
...
C     Output variables :
c     ----------------
      Double precision, intent(out) :: vonmisesPN
...
c     ---------------
      ...
      ! strain/stress
      Integer          :: ntens
      Double precision :: stress,stressVM
      dimension stress(6)
...
C     ------------------------------------------------------------------
     ...
     &           + 6.d0*(stress(4)**2 + stress(5)**2 + stress(6)**2)
            ...
            vonmisesPN = vonmisesPN + abs(stressVM)**dble(Pnorm)
      ...
      vonmisesPN = vonmisesPN**(one/dble(Pnorm))
      
C     ------------------------------------------------------------------
      
      end subroutine pnormVM
