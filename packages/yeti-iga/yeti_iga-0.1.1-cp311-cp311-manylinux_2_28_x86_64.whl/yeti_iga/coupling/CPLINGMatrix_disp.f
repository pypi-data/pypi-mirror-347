...
C     ******************************************************************
      ...
      Subroutine build_CplgMatrix(CMatrx, ind_dof_free,nb_dof_free,
...
c     ----------------
      ...
      dimension CMatrx(nb_dof_free,nb_cp_l*MCRD)
...
c     ---------------
     ...
     &     R(MAXVAL(NNODE)),dRdxi(MAXVAL(NNODE),3)
      ...
      ! for assembly
      Integer :: num_l,numCP,ddl1,ddl2,k1,k2,kk2, sctr,sctr_l,tab
