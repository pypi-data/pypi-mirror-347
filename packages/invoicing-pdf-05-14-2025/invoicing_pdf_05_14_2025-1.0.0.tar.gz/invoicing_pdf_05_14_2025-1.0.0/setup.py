...
setup(
  name = 'invoicing-pdf-05-14-2025',         #* Your package will have this name
  ...
  author = 'Venky Narra',                   # Your name
  author_email = 'venkateshnarra368@gmail.com',  # Your email
  url = 'https://github.com/venkynarra/Python-Package-app20.git',              # Homepage of your library (e.g. github or your website)
