...
def preprocess_and_predict(
    ...
    if creds["type"] == "snowflake":
        ...
        entity_column_index = input_df.columns.index(trainer.entity_column.upper())
        _ = types.pop(entity_column_index)
        features = [
            col for col in input_df.columns if col != trainer.entity_column.upper()
        ]
