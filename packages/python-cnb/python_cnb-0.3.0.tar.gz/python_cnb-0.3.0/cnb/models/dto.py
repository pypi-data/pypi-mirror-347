...
class Budget(CNBBaseModel):
	...
	charge_type_ci_policy: Optional[int] = Field(alias="charge_type_ci_policy", default=None)
	charge_type_ci_price: Optional[int] = Field(alias="charge_type_ci_price", default=None)
	charge_type_dev: Optional[int] = Field(alias="charge_type_dev", default=None)
	charge_type_dev_policy: Optional[int] = Field(alias="charge_type_dev_policy", default=None)
	charge_type_dev_price: Optional[int] = Field(alias="charge_type_dev_price", default=None)
	charge_type_git: Optional[int] = Field(alias="charge_type_git", default=None)
	charge_type_git_policy: Optional[int] = Field(alias="charge_type_git_policy", default=None)
	charge_type_git_price: Optional[int] = Field(alias="charge_type_git_price", default=None)
	charge_type_object: Optional[int] = Field(alias="charge_type_object", default=None)
	charge_type_object_policy: Optional[int] = Field(alias="charge_type_object_policy", default=None)
	charge_type_object_price: Optional[int] = Field(alias="charge_type_object_price", default=None)
	name: Optional[str] = Field(alias="name", default=None)
	status: Optional['constant.BudgetSts'] = Field(alias="status", default=None)
	uin: Optional[str] = Field(alias="uin", default=None)
	pass
class BudgetPrice(CNBBaseModel):
	charge_type_ci_price: Optional[int] = Field(alias="charge_type_ci_price", default=None)
	charge_type_dev_price: Optional[int] = Field(alias="charge_type_dev_price", default=None)
	charge_type_git_price: Optional[int] = Field(alias="charge_type_git_price", default=None)
	charge_type_object_price: Optional[int] = Field(alias="charge_type_object_price", default=None)
...
class ManifestMetadata(CNBBaseModel):
	...
	pass
class MavenPackageDetail(CNBBaseModel):
	address: Optional[str] = Field(alias="address", default=None)
	desc: Optional[str] = Field(alias="desc", default=None)
	last_pusher: Optional['LastPusher'] = Field(alias="last_pusher", default=None)
	package: Optional[str] = Field(alias="package", default=None)
	...
	slug: Optional[str] = Field(alias="slug", default=None)
	tag_total: Optional[int] = Field(alias="tag_total", default=None)
	tags: Optional[list['MavenTag']] = Field(alias="tags", default=None)
	pass
class MavenTag(CNBBaseModel):
	desc: Optional[str] = Field(alias="desc", default=None)
	digest: Optional[str] = Field(alias="digest", default=None)
	last_pusher: Optional['LastPusher'] = Field(alias="last_pusher", default=None)
	name: Optional[str] = Field(alias="name", default=None)
	...
	status: Optional[str] = Field(alias="status", default=None)
	pass
class MavenTagDetail(CNBBaseModel):
	address: Optional[str] = Field(alias="address", default=None)
	desc: Optional[str] = Field(alias="desc", default=None)
...
class MissionPatch(CNBBaseModel):
	...
	pass
class MissionWithPath(CNBBaseModel):
	created_at: Optional[str] = Field(alias="created_at", default=None)
	description: Optional[str] = Field(alias="description", default=None)
	freeze: Optional[bool] = Field(alias="freeze", default=None)
	id: Optional[int] = Field(alias="id", default=None)
...
class Missions4User(CNBBaseModel):
	...
	visibility_level: Optional['constant.Visibility'] = Field(alias="visibility_level", default=None)
	pass
class NpmPackageDetail(CNBBaseModel):
	address: Optional[str] = Field(alias="address", default=None)
	desc: Optional[str] = Field(alias="desc", default=None)
	last_pusher: Optional['LastPusher'] = Field(alias="last_pusher", default=None)
	package: Optional[str] = Field(alias="package", default=None)
	...
	slug: Optional[str] = Field(alias="slug", default=None)
	tag_total: Optional[int] = Field(alias="tag_total", default=None)
	tags: Optional[list['NpmTag']] = Field(alias="tags", default=None)
	pass
class NpmTag(CNBBaseModel):
	desc: Optional[str] = Field(alias="desc", default=None)
	digest: Optional[str] = Field(alias="digest", default=None)
	last_pusher: Optional['LastPusher'] = Field(alias="last_pusher", default=None)
	name: Optional[str] = Field(alias="name", default=None)
	...
	status: Optional[str] = Field(alias="status", default=None)
	pass
class NpmTagDetail(CNBBaseModel):
	address: Optional[str] = Field(alias="address", default=None)
	...
	tags: Optional[list['NpmTag']] = Field(alias="tags", default=None)
	pass
class OhpmPackageDetail(CNBBaseModel):
	address: Optional[str] = Field(alias="address", default=None)
	desc: Optional[str] = Field(alias="desc", default=None)
	last_pusher: Optional['LastPusher'] = Field(alias="last_pusher", default=None)
	package: Optional[str] = Field(alias="package", default=None)
	...
	slug: Optional[str] = Field(alias="slug", default=None)
	tag_total: Optional[int] = Field(alias="tag_total", default=None)
	tags: Optional[list['OhpmTag']] = Field(alias="tags", default=None)
	pass
class OhpmTag(CNBBaseModel):
	desc: Optional[str] = Field(alias="desc", default=None)
	digest: Optional[str] = Field(alias="digest", default=None)
	last_pusher: Optional['LastPusher'] = Field(alias="last_pusher", default=None)
	name: Optional[str] = Field(alias="name", default=None)
	...
	status: Optional[str] = Field(alias="status", default=None)
	pass
class OhpmTagDetail(CNBBaseModel):
	address: Optional[str] = Field(alias="address", default=None)
	dependencies: Optional[list['Dependency']] = Field(alias="dependencies", default=None)
	desc: Optional[str] = Field(alias="desc", default=None)
	files: Optional[list['File']] = Field(alias="files", default=None)
...
class PackageDetail(CNBBaseModel):
	...
	maven: Optional['MavenPackageDetail'] = Field(alias="maven", default=None)
	npm: Optional['NpmPackageDetail'] = Field(alias="npm", default=None)
	ohpm: Optional['OhpmPackageDetail'] = Field(alias="ohpm", default=None)
	pass
...
class Registry4User(CNBBaseModel):
	...
	visibility_level: Optional['constant.Visibility'] = Field(alias="visibility_level", default=None)
	pass
class RegistryCleanDetail(CNBBaseModel):
...
class RegistryPatch(CNBBaseModel):
	description: Optional[str] = Field(alias="description", default=None)
	pass
class RegistryPolicy(CNBBaseModel):
	clean_policy_detail: Optional['RegistryCleanDetail'] = Field(alias="clean_policy_detail", default=None)
...
class Tag(CNBBaseModel):
	...
	maven: Optional[list['MavenTag']] = Field(alias="maven", default=None)
	npm: Optional[list['NpmTag']] = Field(alias="npm", default=None)
	ohpm: Optional[list['OhpmTag']] = Field(alias="ohpm", default=None)
	package: Optional[str] = Field(alias="package", default=None)
	pass
class TagDetail(CNBBaseModel):
	...
	maven: Optional['MavenTagDetail'] = Field(alias="maven", default=None)
	npm: Optional['NpmTagDetail'] = Field(alias="npm", default=None)
	ohpm: Optional['OhpmTagDetail'] = Field(alias="ohpm", default=None)
	pass
