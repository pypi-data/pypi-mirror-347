...
from mangokit.exceptions import MangoKitError, ERROR_MSG_0042, ERROR_MSG_0045, ERROR_MSG_0034, ERROR_MSG_0040
...
class NewAndroid:
    ...
    def new_android(self):
        if self.and_equipment is None:
            raise MangoKitError(*ERROR_MSG_0042)
        try:
            ...
            raise MangoKitError(*ERROR_MSG_0040, value=(self.and_equipment,))
        except RuntimeError:
            raise MangoKitError(*ERROR_MSG_0045, value=(self.and_equipment,))
