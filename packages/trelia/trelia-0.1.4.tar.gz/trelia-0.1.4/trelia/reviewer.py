...
class CodeReviewer:
    ...
    def grade_code(self, task_description: str, resource_code: str, resource_role: str) -> dict:
        ...
        prompt = (
            ...
            "The rating should be based on the coding standards expected for the role. "
            "Give 5/5 only if the code is complete, correct, and fully solves the task, following the best practices for the role. "
