...
from    jsonpath_ng.ext import parse                # a python tool for parsing json data
...
class DataCiteRepository:
    ...
    def __init__(self,
        ...
        if 'rep_id' in kwargs.keys():
            ...
            self.name               = kwargs['rep_id']                    # set the name of the repository
...
#            self.URL                += '&page[size]=1'                                  # just get one record
    ...
    def getNumberOfRecords(self):
        ...
        if self.numberOfRecords is None:                            # retrieve one record to get metadata
            ...
            URL += '&page[size]=1'                                  # just get one record

            response = requests.get(URL)                            # retrieve one record
    ...
    def get_metadataPaging(self,
        ...
        if self.numberOfRecords > recordLimit:                              # if the number of records is greater than the record limit 
            ...
            print('Making random selection of {recordLimit} records from {self.numberOfRecords} records')
        else:
...
def makeSquishedTable(df, numberOfSets=2):
    '''
        This function takes a dataframe and returns a dataframe with the data squished into a table with multiple columns.
    '''
...
spiral_d = [
        ...
        'items': [
            ...
            {'concept': 'Resource Publisher',
             'paths': [
                 ...
                 {'container': 'data[*].attributes', 'attribute': 'publisher'}
             ]
             },
            {'concept': 'Resource Title',
    ...
    {
        'title': 'Findable Identifiers',
        'code': 'FAIR_Findable_Support',
        'dialect':  'DataCite',
        'description': 'Documentation concepts that provide extra information, i.e. identifiers and references, about discovery concepts. The average for this spiral for 387 University reporitories during January 2024 is 19%.',
        'items': [
    ...
    {
        'title': 'AIR Connections',
        'code': 'FAIR_AIR_Essential',
        'dialect':  'DataCite',
        'description': 'Documentation concepts for datasets interoperability and connections for resource documentation, understanding, and trust. This spiral includes one mandatory concept (Resource URL) so the minimum score is 6%. The average for this spiral for 387 University reporitories during January 2024 is 12%.',
        'items': [
            #
    ...
    {
        'title': 'AIR Contacts',
        'code': 'FAIR_AIR_Support',
        'dialect':  'DataCite',
        'description': 'Documentation concepts for contacts that can answer questions not addressed in the metadata or other documentation. The average for this spiral for 387 University reporitories during January 2024 is 4%.',
        'items': [
            #
