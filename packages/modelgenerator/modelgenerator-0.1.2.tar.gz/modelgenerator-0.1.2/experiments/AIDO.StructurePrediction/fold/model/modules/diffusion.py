...
from fold.model.modules.embedders import FourierEmbedding, RelativePositionEncoding
from fold.model.modules.primitives import LinearNoBias, Transition
from fold.model.modules.transformer import (
    AtomAttentionDecoder,
    AtomAttentionEncoder,
    DiffusionTransformer,
)
from fold.model.utils import expand_at_dim
from fold.openfold_local.model.primitives import LayerNorm
from fold.openfold_local.utils.checkpointing import get_checkpoint_fn
...
class DiffusionConditioning(nn.Module):
    ...
    def __init__(
        ...
        logger.info(f"Diffusion Module has {self.sigma_data}")
