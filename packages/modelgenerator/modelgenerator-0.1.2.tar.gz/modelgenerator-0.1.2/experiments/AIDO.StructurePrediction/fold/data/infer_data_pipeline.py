...
from fold.data.json_to_feature import SampleDictToFeatures
from fold.data.msa_featurizer import InferenceMSAFeaturizer
from fold.data.utils import data_type_transform, make_dummy_feature
from fold.utils.distributed import DIST_WRAPPER
from fold.utils.torch_utils import dict_to_tensor
...
class InferenceDataset(Dataset):
    ...
    def process_one(
        ...
        t1 = time.time()
        # Msa features
        entity_to_asym_id = get_label_entity_id_to_asym_id_int(atom_array)
        msa_features = (
            InferenceMSAFeaturizer.make_msa_feature(
                ...
                msa_pool=os.path.dirname(self.input_json_path),
