...
atom_types_af3 = ['N', 'CA', 'C', 'CB', 'O', 'CG', 'CG1', 'CG2', 'OG', 'OG1', 'SG', 'CD', 'CD1', 'CD2', 'ND1', 'ND2', 'OD1', 
'OD2', 'SD', 'CE', 'CE1', 'CE2', 'CE3', 'NE', 'NE1', 'NE2', 'OE1', 'OE2', 'CH2', 'NH1', 'NH2', 'OH', 'CZ', 'CZ2', 'CZ3', 'NZ', 'OXT', 
"C1'", 'C2', "C2'", "C3'", 'C4', "C4'", 'C5', "C5'", 'C6', 'C7', 'C8', 'N1', 'N2', 'N3', 'N4', 'N6', 'N7', 'N9', 
'O2', "O2'", "O3'", 'O4', "O4'", "O5'", 'O6', 'OP1', 'OP2', 'OP3', 'P'] # 66

ATOM_TO_ID_GLOBAL = OrderedDict([(n, i) for i, n in enumerate(atom_types_af3)])


RES_ATOMS_DICT_reverse = {k: {vv: kk for kk,vv in v.items()}  for k, v in RES_ATOMS_DICT.items()}

# # {vv: kk for kk,vv in v.items()}
# print(RES_ATOMS_DICT_reverse)