...
def from_unrolled(UTG: StaticGraph) -> TemporalGraph:
    """
    Returns :class:`~networkx_temporal.classes.TemporalGraph` from unrolled temporal graph.

    Note that the UTG must be a valid unrolled temporal graph, i.e., it must contain
