...
class BottomInnerExternalSide1NodeSmoother(NodeSmoother):
    """
    Class for smooth a node with an inner corner and external profile at side 1 add the bottom of the prism.
    """
