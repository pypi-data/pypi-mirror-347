...
class BottomInnerExternalSide2NodeSmoother(NodeSmoother):
    """
    Class for smooth a node with an inner corner and external profile at side 2 add the bottom of the prism.
    """
