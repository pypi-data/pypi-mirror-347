...
class TopOuterExternalSide2NodeSmoother(NodeSmoother):
    """
    Class for smooth a node with an inner outer and external profile at side 2 add the top of the prism.
    """
