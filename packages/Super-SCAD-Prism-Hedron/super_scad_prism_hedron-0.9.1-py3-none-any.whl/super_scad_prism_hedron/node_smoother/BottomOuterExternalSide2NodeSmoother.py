...
class BottomOuterExternalSide2NodeSmoother(NodeSmoother):
    """
    Class for smooth a node with an outer corner and external profile at side 2 add the bottom of the prism.
    """
