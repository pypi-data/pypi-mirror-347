...
class BottomOuterExternalSide1NodeSmoother(NodeSmoother):
    """
    Class for smooth a node with an outer corner and external profile at side 1 add the bottom of the prism.
    """
