...
class NinaAPI:
    ...
    async def application_info(self):
        try:
            ...
            _LOGGER.info("N.I.N.A. not available.")
            return ApplicationData(data={"Connected": False})
        except KeyError as ke:
            _LOGGER.info("Application not connected.")
            return ApplicationData(data={"Connected": False})
    ...
    async def camera_info(self):
        try:
            ...
            _LOGGER.info("Camera not connected.")
    ...
    async def filterwheel_info(self):
        try:
            ...
            _LOGGER.info("FilterWheel not connected.")
    ...
    async def focuser_info(self):
        try:
            ...
            _LOGGER.info("Focuser not connected.")
    ...
    async def guider_info(self):
        try:
            ...
            _LOGGER.info("Guider not connected.")
    ...
    async def image_latest(self):
        try:
            _LOGGER.info("Retrieve index of last capture")
        ...
        if image_index_latest > self._image_index_latest:
            ...
            try:
                ...
                _LOGGER.info("Timeout retrieving capture. Try increasing the timeout.")
                return None
        else:
    ...
    async def mount_info(self):
        try:
            ...
            _LOGGER.info("Mount not connected.")
    ...
    async def switch_info(self):
        try:
            ...
            _LOGGER.info("Switch not connected.")
    ...
    async def nina_info(
        ...
        _LOGGER.info("Connecting to N.I.N.A.")
        ...
        try:
            ...
            # traceback.print_exc()
            _LOGGER.info("N.I.N.A. not connected.")
            return NinaDevicesData(data={"Connected": False})
