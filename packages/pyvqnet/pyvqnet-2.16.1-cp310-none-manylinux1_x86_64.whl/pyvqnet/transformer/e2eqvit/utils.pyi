...
def scaled_dot_product_attention_pyimpl(query: QTensor, key: QTensor, value: QTensor, attn_mask: Incomplete | None = None, dropout_p: float = 0.0, scale: Incomplete | None = None, is_causal: bool = False): ...
