from ...backends import check_not_default_backend as check_not_default_backend
from ...device import DEV_CPU as DEV_CPU
from ...dtype import C_DTYPE as C_DTYPE, D_DTYPE as D_DTYPE, F_DTYPE as F_DTYPE, HC_DTYPE as HC_DTYPE, Z_DTYPE as Z_DTYPE, complex_dtype_to_float_dtype as complex_dtype_to_float_dtype, float_dtype_to_complex_dtype as float_dtype_to_complex_dtype, kcomplex128 as kcomplex128, kcomplex32 as kcomplex32, kfloat16 as kfloat16, kfloat32 as kfloat32, may_be_c_dtype as may_be_c_dtype, may_be_hc_dtype as may_be_hc_dtype, may_be_z_dtype as may_be_z_dtype, vqnet_complex_dtypes as vqnet_complex_dtypes, vqnet_float_dtypes as vqnet_float_dtypes
...
from .qcircuit_utils import quantum_gate_op_tn as quantum_gate_op_tn
...
def qft(qmachine, wires, mat: Incomplete | None = None, use_dagger: bool = False) -> None:
    ...
    qft function
    """
def unitary(q_machine: QMachine, wires: _generic_wires_type, mat: QTensor, use_dagger: bool = False):
    """
...
def cy(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    cy gate function.
    ...
    """
def i(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    i gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def pauliz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def hadamard(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j 0.       +0.j]]]]]
    """
def x(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    x gate function.
    ...
    Example::
        ...
        print(qm.states)
    """
def paulix(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def rx(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j       0.       +0.j      ]]]]]
    """
def s(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    s gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def ry(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j 0.       +0.j]]]]]
    """
def rz_eigvals(theta: QTensor | None = None): ...
def rz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    rotate y gate function.
    ...
    Example::
        ...
        #     [0.       +0.j       0.       +0.j      ]]]]]
    """
def cry(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def crz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def multi_control_rz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False): ...
def crx(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    controlled-rotate x gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def rxx(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def ryy(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def rzz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def rzx(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def pauliy(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    """
def ring_cnot(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False): ...
def cnot(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    cnot gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def roll(t: QTensor, shifts: int, axis: int):
    """
    temp roll impl for states
    """
def x1(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    x1 function.
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def y1(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    y1 gate function.
    ...
    Example::
        ...
        #     [0.       +0.j 0.       +0.j]]]]]
    """
def z1(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    z1 gate function.
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def t(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    t gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]       
    """
def swap(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    swap gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def p(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    p gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def u1(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    u1 gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]
    """
def u2(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    u2 gate function.
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def u3(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    u3 gate function.
    ...
    Example::
        ...
        #     [0.       +0.j        0.       +0.j       ]]]]]
    """
def rot(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    rot gate function.
    ...
    """
def cr(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    cr gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def cz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.+0.j,0.+0.j]]]]]
    """
def cswap(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    """
def toffoli(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def iswap(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    iswap gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def isingxx(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j       0.       +0.j      ]]]]]
    """
def isingyy(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j       0.       +0.j      ]]]]]
    """
def isingzz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j       0.       +0.j      ]]]]]
    """
def isingxy(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
...
def phaseshift(q_machine, wires, params: Incomplete | None = None, use_dagger: bool = False) -> None:
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def multirz(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.       +0.j       0.       +0.j      ]]]]]
    """
def sdg(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    sdg gate function.
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def tdg(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False):
    """
    tdg gate function.
...
def controlledphaseshift(q_machine, wires, params: Incomplete | None = None, use_dagger: bool = False) -> None:
    ...
    Example::
        ...
        #     [0.2193956+0.1198564j 0.2193956+0.1198564j]]]]]
    """
def single_excitation(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.+0.j 0.+0.j]]]]]
    """
def double_excitation(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None, use_dagger: bool = False):
    """
    ...
    Example::
        ...
        #     [0.2406063-0.0678867j 0.2406063-0.0678867j]]]]]
    """
def multicontrolledx(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False, control_values: list[int] | None = None):
    """
...
def basic_state_projector(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False): ...
...
def quantum_gate_op(name: str, mat: Callable | QTensor, q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False, hyper_parameters: dict = {}): ...
...
class VQC_QuantumEmbedding(QModule):
    ...
    dtype: Incomplete
    vqc: Incomplete
    def __init__(self, num_repetitions_input: int, depth_input: int, num_unitary_layers: int, num_repetitions: int, initial: QTensor | None = None, dtype: int | None = None, name: str = '') -> None: ...
...
def vqc_crot_circuit(para: QTensor, control_wire: int, rot_wire: int, q_machine: QMachine):
    '''
...
def vqc_fermionic_single_excitation(weight: QTensor, wires: list[int] | tuple[int, ...], q_machine: QMachine):
...
def vqc_fermionic_double_excitation(weight: QTensor, wires1: list[int] | tuple[int, ...], wires2: list[int] | tuple[int, ...], q_machine: QMachine):
    '''Circuit to exponentiate the tensor product of Pauli matrices representing the
...
def vqc_basis_embedding(basis_state: QTensor, q_machine: QMachine, wires: Incomplete | None = None):
    """
...
def vqc_quantumpooling_circuit(ignored_wires: _generic_wires_type, sinks_wires: _generic_wires_type, params: QTensor, q_machine: QMachine):
    """
...
def givens_decomposition(unitary: QTensor):
    ...
    """
def vqc_controlled_hadamard_wrapper(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False): ...
...
def vqc_ccz_wrapper(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False): ...
...
def CRot_wrapper(q_machine: QMachine, wires: _generic_wires_type, params: QTensor | None = None, use_dagger: bool = False): ...
