...
def get_u_parameter(m: Tensor) -> tuple[float, float, float]:
    ...
    """
def u_gate(theta: int = 0, phi: float = 0, lbd: float = 0) -> Gate:
    """
    ...
    :rtype: Gate
    """
def r_gate(theta: int = 0, alpha: float = 0, phi: float = 0) -> Gate:
    """
...
def exponential_gate_unity(unitary: Tensor, theta: float, half: bool = False, name: str = 'none') -> Gate:
    """
