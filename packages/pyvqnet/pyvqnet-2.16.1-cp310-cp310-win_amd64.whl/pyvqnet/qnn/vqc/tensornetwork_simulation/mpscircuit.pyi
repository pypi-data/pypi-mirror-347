...
class MPSCircuit(AbstractCircuit):
    ...
    split: Incomplete
    def __init__(self, nqubits: int, center_position: int | None = None, tensors: Sequence[Tensor] | None = None, wavefunction: QuVector | Tensor | None = None, split: dict[str, Any] | None = None) -> None:
        """
    ...
    def reduce_tensor_dimension(cls, tensor_left: Tensor, tensor_right: Tensor, center_left: bool = True, split: dict[str, Any] | None = None) -> tuple[Tensor, Tensor]:
        ...
        """
    def reduce_dimension(self, index_left: int, center_left: bool = True, split: dict[str, Any] | None = None) -> None:
        """
        Reduce the bond dimension between two adjacent sites by SVD
        """
    def apply_MPO(self, tensors: Sequence[Tensor], index_left: int, center_left: bool = True, split: dict[str, Any] | None = None) -> None:
        """
