...
class LSTM(Module):
    ...
    def forward(self, x: QTensor, init_states: tuple[QTensor, QTensor] | list[QTensor] | None = None) -> tuple[QTensor, tuple[QTensor, QTensor]]:
        """
...
class Dynamic_LSTM(LSTM):
    ...
    def forward(self, x: PackedSequence, init_states: None | tuple[QTensor, QTensor] | list[QTensor] = None) -> tuple[PackedSequence, tuple[QTensor, QTensor]]:
        """
