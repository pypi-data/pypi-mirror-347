...
class DynamicFilterSchema(BaseModel):
    ...
    """ # noqa: E501
    var_and: Optional[List[DynamicFilterSchemaAndInner]] = Field(default=None, description="Logical operator grouping filters or nested logical groups", alias="and")
    var_or: Optional[List[DynamicFilterSchemaAndInner]] = Field(default=None, description="Logical operator grouping filters or nested logical groups", alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [DynamicFilterSchemaAndInner.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None,
            "or": [DynamicFilterSchemaAndInner.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
        return _obj

from cloudbeds_pms.models.dynamic_filter_schema_and_inner import DynamicFilterSchemaAndInner
# TODO: Rewrite to not use raise_errors
DynamicFilterSchema.model_rebuild(raise_errors=False)
