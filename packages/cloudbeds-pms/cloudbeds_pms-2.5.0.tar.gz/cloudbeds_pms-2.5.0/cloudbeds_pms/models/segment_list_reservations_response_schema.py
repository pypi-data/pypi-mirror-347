...
class SegmentListReservationsResponseSchema(BaseModel):
    """
    ...
    reservation_ids: Optional[List[StrictStr]] = Field(default=None, alias="reservationIds")
    __properties: ClassVar[List[str]] = ["id", "limit", "offset", "reservationIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reservation_ids (nullable) is None
        # and model_fields_set contains the field
        if self.reservation_ids is None and "reservation_ids" in self.model_fields_set:
            _dict['reservationIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservationIds": obj.get("reservationIds")
        })
        return _obj
