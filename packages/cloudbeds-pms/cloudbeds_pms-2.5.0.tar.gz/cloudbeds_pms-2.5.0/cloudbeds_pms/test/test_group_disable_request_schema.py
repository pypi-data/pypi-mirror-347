...
class TestGroupDisableRequestSchema(unittest.TestCase):
    """GroupDisableRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDisableRequestSchema:
        """Test GroupDisableRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDisableRequestSchema`
        """
        model = GroupDisableRequestSchema()
        if include_optional:
            return GroupDisableRequestSchema(
                id = '1-b'
            )
        else:
            return GroupDisableRequestSchema(
    ...
    def testGroupDisableRequestSchema(self):
        """Test GroupDisableRequestSchema"""
