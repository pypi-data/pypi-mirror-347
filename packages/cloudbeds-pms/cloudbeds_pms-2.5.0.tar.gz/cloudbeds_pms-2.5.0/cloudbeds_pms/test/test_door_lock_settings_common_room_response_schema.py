...
class TestDoorLockSettingsCommonRoomResponseSchema(unittest.TestCase):
    """DoorLockSettingsCommonRoomResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsCommonRoomResponseSchema:
        """Test DoorLockSettingsCommonRoomResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsCommonRoomResponseSchema`
        """
        model = DoorLockSettingsCommonRoomResponseSchema()
        if include_optional:
            return DoorLockSettingsCommonRoomResponseSchema(
                id = '',
                name = '',
                doors = [
                    ''
    ...
    def testDoorLockSettingsCommonRoomResponseSchema(self):
        """Test DoorLockSettingsCommonRoomResponseSchema"""
