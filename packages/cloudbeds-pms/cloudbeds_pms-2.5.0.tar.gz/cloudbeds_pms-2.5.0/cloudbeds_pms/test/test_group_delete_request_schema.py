...
class TestGroupDeleteRequestSchema(unittest.TestCase):
    """GroupDeleteRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDeleteRequestSchema:
        """Test GroupDeleteRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDeleteRequestSchema`
        """
        model = GroupDeleteRequestSchema()
        if include_optional:
            return GroupDeleteRequestSchema(
                id = '1-b'
            )
        else:
            return GroupDeleteRequestSchema(
    ...
    def testGroupDeleteRequestSchema(self):
        """Test GroupDeleteRequestSchema"""
