...
class TestImportTaskListResponseSchema(unittest.TestCase):
    """ImportTaskListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTaskListResponseSchema:
        """Test ImportTaskListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTaskListResponseSchema`
        """
        model = ImportTaskListResponseSchema()
        if include_optional:
            return ImportTaskListResponseSchema(
                offset = 56,
                limit = 56,
                total = 56,
                data = [
                    cloudbeds_pms.models.import_task_get_response_schema.ImportTaskGetResponseSchema(
                        id = '', 
                        name = '', 
                        source = '', 
    ...
    def testImportTaskListResponseSchema(self):
        """Test ImportTaskListResponseSchema"""
