...
class TestImportTaskRecordGetResponseSchema(unittest.TestCase):
    """ImportTaskRecordGetResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTaskRecordGetResponseSchema:
        """Test ImportTaskRecordGetResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTaskRecordGetResponseSchema`
        """
        model = ImportTaskRecordGetResponseSchema()
        if include_optional:
            return ImportTaskRecordGetResponseSchema(
                id = '',
                import_id = '',
                uuid = '',
                created_at = '',
    ...
    def testImportTaskRecordGetResponseSchema(self):
        """Test ImportTaskRecordGetResponseSchema"""
