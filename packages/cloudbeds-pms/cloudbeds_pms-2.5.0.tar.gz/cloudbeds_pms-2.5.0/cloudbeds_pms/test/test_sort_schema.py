...
class TestSortSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SortSchema:
        """Test SortSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortSchema`
        """
        model = SortSchema()
        if include_optional:
            return SortSchema(
                fields = [
                    cloudbeds_pms.models.sort_field_schema.SortFieldSchema(
                        field = 'checkin_date', 
                        direction = 'asc', )
                    ]
            )
