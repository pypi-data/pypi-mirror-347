...
class TestImportFailedToCreateImportTaskSchema(unittest.TestCase):
    """ImportFailedToCreateImportTaskSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportFailedToCreateImportTaskSchema:
        """Test ImportFailedToCreateImportTaskSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportFailedToCreateImportTaskSchema`
        """
        model = ImportFailedToCreateImportTaskSchema()
        if include_optional:
            return ImportFailedToCreateImportTaskSchema(
                message = ''
            )
        else:
            return ImportFailedToCreateImportTaskSchema(
    ...
    def testImportFailedToCreateImportTaskSchema(self):
        """Test ImportFailedToCreateImportTaskSchema"""
