...
class TestGroupSingleRequestSchema(unittest.TestCase):
    """GroupSingleRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupSingleRequestSchema:
        """Test GroupSingleRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupSingleRequestSchema`
        """
        model = GroupSingleRequestSchema()
        if include_optional:
            return GroupSingleRequestSchema(
                id = '1-b'
            )
        else:
            return GroupSingleRequestSchema(
    ...
    def testGroupSingleRequestSchema(self):
        """Test GroupSingleRequestSchema"""
