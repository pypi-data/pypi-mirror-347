...
class TestDoorLockSettingsCommonRoomRequestSchema(unittest.TestCase):
    """DoorLockSettingsCommonRoomRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsCommonRoomRequestSchema:
        """Test DoorLockSettingsCommonRoomRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsCommonRoomRequestSchema`
        """
        model = DoorLockSettingsCommonRoomRequestSchema()
        if include_optional:
            return DoorLockSettingsCommonRoomRequestSchema(
                id = '',
                name = '',
                doors = [
                    ''
    ...
    def testDoorLockSettingsCommonRoomRequestSchema(self):
        """Test DoorLockSettingsCommonRoomRequestSchema"""
