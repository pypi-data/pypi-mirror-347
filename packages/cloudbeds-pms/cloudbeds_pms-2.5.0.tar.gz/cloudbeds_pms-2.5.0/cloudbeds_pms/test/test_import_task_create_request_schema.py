...
class TestImportTaskCreateRequestSchema(unittest.TestCase):
    """ImportTaskCreateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTaskCreateRequestSchema:
        """Test ImportTaskCreateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTaskCreateRequestSchema`
        """
        model = ImportTaskCreateRequestSchema()
        if include_optional:
            return ImportTaskCreateRequestSchema(
                type = 'addon',
                priority = 'standard'
            )
        else:
    ...
    def testImportTaskCreateRequestSchema(self):
        """Test ImportTaskCreateRequestSchema"""
