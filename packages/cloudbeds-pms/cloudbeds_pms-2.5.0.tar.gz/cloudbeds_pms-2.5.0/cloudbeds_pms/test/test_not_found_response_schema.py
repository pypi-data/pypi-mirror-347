...
class TestNotFoundResponseSchema(unittest.TestCase):
    """NotFoundResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotFoundResponseSchema:
        """Test NotFoundResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotFoundResponseSchema`
        """
        model = NotFoundResponseSchema()
        if include_optional:
            return NotFoundResponseSchema(
                message = ''
            )
        else:
            return NotFoundResponseSchema(
    ...
    def testNotFoundResponseSchema(self):
        """Test NotFoundResponseSchema"""
