...
class TestImportFailedToProcessCsvResponseSchema(unittest.TestCase):
    """ImportFailedToProcessCsvResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportFailedToProcessCsvResponseSchema:
        """Test ImportFailedToProcessCsvResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportFailedToProcessCsvResponseSchema`
        """
        model = ImportFailedToProcessCsvResponseSchema()
        if include_optional:
            return ImportFailedToProcessCsvResponseSchema(
                message = ''
            )
        else:
            return ImportFailedToProcessCsvResponseSchema(
    ...
    def testImportFailedToProcessCsvResponseSchema(self):
        """Test ImportFailedToProcessCsvResponseSchema"""
