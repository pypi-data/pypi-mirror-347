...
class TestBodyDynamicFilterSchema(unittest.TestCase):
    """BodyDynamicFilterSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BodyDynamicFilterSchema:
        """Test BodyDynamicFilterSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BodyDynamicFilterSchema`
        """
        model = BodyDynamicFilterSchema()
        if include_optional:
            return BodyDynamicFilterSchema(
                filters = None
            )
        else:
            return BodyDynamicFilterSchema(
    ...
    def testBodyDynamicFilterSchema(self):
        """Test BodyDynamicFilterSchema"""
