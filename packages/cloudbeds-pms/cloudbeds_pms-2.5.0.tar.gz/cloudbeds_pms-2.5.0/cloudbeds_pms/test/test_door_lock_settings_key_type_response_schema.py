...
class TestDoorLockSettingsKeyTypeResponseSchema(unittest.TestCase):
    """DoorLockSettingsKeyTypeResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsKeyTypeResponseSchema:
        """Test DoorLockSettingsKeyTypeResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsKeyTypeResponseSchema`
        """
        model = DoorLockSettingsKeyTypeResponseSchema()
        if include_optional:
            return DoorLockSettingsKeyTypeResponseSchema(
                id = '',
                name = ''
            )
        else:
    ...
    def testDoorLockSettingsKeyTypeResponseSchema(self):
        """Test DoorLockSettingsKeyTypeResponseSchema"""
