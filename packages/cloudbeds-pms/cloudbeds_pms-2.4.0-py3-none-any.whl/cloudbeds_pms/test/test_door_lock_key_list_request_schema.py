...
class TestDoorLockKeyListRequestSchema(unittest.TestCase):
    """DoorLockKeyListRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockKeyListRequestSchema:
        """Test DoorLockKeyListRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockKeyListRequestSchema`
        """
        model = DoorLockKeyListRequestSchema()
        if include_optional:
            return DoorLockKeyListRequestSchema(
                reservation_id = '',
                sub_reservation_id = ''
            )
        else:
    ...
    def testDoorLockKeyListRequestSchema(self):
        """Test DoorLockKeyListRequestSchema"""
