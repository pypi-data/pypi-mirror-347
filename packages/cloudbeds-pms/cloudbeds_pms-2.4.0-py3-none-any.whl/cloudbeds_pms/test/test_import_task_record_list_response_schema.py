...
class TestImportTaskRecordListResponseSchema(unittest.TestCase):
    """ImportTaskRecordListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTaskRecordListResponseSchema:
        """Test ImportTaskRecordListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTaskRecordListResponseSchema`
        """
        model = ImportTaskRecordListResponseSchema()
        if include_optional:
            return ImportTaskRecordListResponseSchema(
                offset = 56,
                limit = 56,
                total = 56,
                data = [
                    cloudbeds_pms.models.import_task_record_get_response_schema.ImportTaskRecordGetResponseSchema(
                        id = '', 
                        import_id = '', 
                        uuid = '', 
                        created_at = '', 
    ...
    def testImportTaskRecordListResponseSchema(self):
        """Test ImportTaskRecordListResponseSchema"""
