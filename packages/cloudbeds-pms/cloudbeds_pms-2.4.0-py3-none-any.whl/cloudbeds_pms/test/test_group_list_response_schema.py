...
class TestGroupListResponseSchema(unittest.TestCase):
    """GroupListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupListResponseSchema:
        """Test GroupListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupListResponseSchema`
        """
        model = GroupListResponseSchema()
        if include_optional:
            return GroupListResponseSchema(
                limit = 56,
                offset = 56,
                data = [
                    cloudbeds_pms.models.group_response_schema.GroupResponseSchema(
                        id = '', 
                        name = '', 
                        code = '', 
                        description = '', 
    ...
    def testGroupListResponseSchema(self):
        """Test GroupListResponseSchema"""
