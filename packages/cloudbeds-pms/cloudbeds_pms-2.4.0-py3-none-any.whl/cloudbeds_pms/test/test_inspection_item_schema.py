...
class TestInspectionItemSchema(unittest.TestCase):
    """InspectionItemSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InspectionItemSchema:
        """Test InspectionItemSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InspectionItemSchema`
        """
        model = InspectionItemSchema()
        if include_optional:
            return InspectionItemSchema(
                updated_date = '',
                room_type_id = '',
                room_id = '',
                room_condition = '',
    ...
    def testInspectionItemSchema(self):
        """Test InspectionItemSchema"""
