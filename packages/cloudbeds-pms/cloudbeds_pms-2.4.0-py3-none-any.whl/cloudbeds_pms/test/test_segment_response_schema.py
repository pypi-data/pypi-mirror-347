...
class TestSegmentResponseSchema(unittest.TestCase):
    """SegmentResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentResponseSchema:
        """Test SegmentResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentResponseSchema`
        """
        model = SegmentResponseSchema()
        if include_optional:
            return SegmentResponseSchema(
                id = '',
                group_id = '',
                name = '',
                code = '',
    ...
    def testSegmentResponseSchema(self):
        """Test SegmentResponseSchema"""
