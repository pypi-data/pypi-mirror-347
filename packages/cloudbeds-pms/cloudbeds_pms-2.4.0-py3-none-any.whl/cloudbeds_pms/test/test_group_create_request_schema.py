...
class TestGroupCreateRequestSchema(unittest.TestCase):
    """GroupCreateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupCreateRequestSchema:
        """Test GroupCreateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupCreateRequestSchema`
        """
        model = GroupCreateRequestSchema()
        if include_optional:
    ...
    def testGroupCreateRequestSchema(self):
        """Test GroupCreateRequestSchema"""
