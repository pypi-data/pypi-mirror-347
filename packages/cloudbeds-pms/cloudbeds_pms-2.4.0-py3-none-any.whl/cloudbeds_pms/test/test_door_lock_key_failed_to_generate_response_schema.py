...
class TestDoorLockKeyFailedToGenerateResponseSchema(unittest.TestCase):
    """DoorLockKeyFailedToGenerateResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockKeyFailedToGenerateResponseSchema:
        """Test DoorLockKeyFailedToGenerateResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockKeyFailedToGenerateResponseSchema`
        """
        model = DoorLockKeyFailedToGenerateResponseSchema()
        if include_optional:
            return DoorLockKeyFailedToGenerateResponseSchema(
                message = ''
            )
        else:
            return DoorLockKeyFailedToGenerateResponseSchema(
    ...
    def testDoorLockKeyFailedToGenerateResponseSchema(self):
        """Test DoorLockKeyFailedToGenerateResponseSchema"""
