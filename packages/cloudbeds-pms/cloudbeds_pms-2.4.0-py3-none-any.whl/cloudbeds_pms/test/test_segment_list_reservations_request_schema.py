...
class TestSegmentListReservationsRequestSchema(unittest.TestCase):
    """SegmentListReservationsRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentListReservationsRequestSchema:
        """Test SegmentListReservationsRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentListReservationsRequestSchema`
        """
        model = SegmentListReservationsRequestSchema()
        if include_optional:
            return SegmentListReservationsRequestSchema(
                limit = 1,
                offset = 1,
                id = '1-b',
                active = True
    ...
    def testSegmentListReservationsRequestSchema(self):
        """Test SegmentListReservationsRequestSchema"""
