...
class TestGroupUpdateRequestSchema(unittest.TestCase):
    """GroupUpdateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupUpdateRequestSchema:
        """Test GroupUpdateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupUpdateRequestSchema`
        """
        model = GroupUpdateRequestSchema()
        if include_optional:
            return GroupUpdateRequestSchema(
                id = '1-b',
                name = 'Abc',
                code = '1000',
    ...
    def testGroupUpdateRequestSchema(self):
        """Test GroupUpdateRequestSchema"""
