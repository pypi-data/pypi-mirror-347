...
class TestDoorLockKeyUpdateRequestSchema(unittest.TestCase):
    """DoorLockKeyUpdateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockKeyUpdateRequestSchema:
        """Test DoorLockKeyUpdateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockKeyUpdateRequestSchema`
        """
        model = DoorLockKeyUpdateRequestSchema()
        if include_optional:
    ...
    def testDoorLockKeyUpdateRequestSchema(self):
        """Test DoorLockKeyUpdateRequestSchema"""
