...
class TestSegmentDisableRequestSchema(unittest.TestCase):
    """SegmentDisableRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentDisableRequestSchema:
        """Test SegmentDisableRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentDisableRequestSchema`
        """
        model = SegmentDisableRequestSchema()
        if include_optional:
            return SegmentDisableRequestSchema(
                id = '1-b'
            )
        else:
            return SegmentDisableRequestSchema(
    ...
    def testSegmentDisableRequestSchema(self):
        """Test SegmentDisableRequestSchema"""
