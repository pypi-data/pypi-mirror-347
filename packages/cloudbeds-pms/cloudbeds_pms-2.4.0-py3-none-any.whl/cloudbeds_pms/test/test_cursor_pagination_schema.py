...
class TestCursorPaginationSchema(unittest.TestCase):
    """CursorPaginationSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CursorPaginationSchema:
        """Test CursorPaginationSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CursorPaginationSchema`
        """
        model = CursorPaginationSchema()
        if include_optional:
    ...
    def testCursorPaginationSchema(self):
        """Test CursorPaginationSchema"""
