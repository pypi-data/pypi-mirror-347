...
class TestForbiddenResponseSchema(unittest.TestCase):
    """ForbiddenResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForbiddenResponseSchema:
        """Test ForbiddenResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForbiddenResponseSchema`
        """
        model = ForbiddenResponseSchema()
        if include_optional:
            return ForbiddenResponseSchema(
                message = ''
            )
        else:
            return ForbiddenResponseSchema(
    ...
    def testForbiddenResponseSchema(self):
        """Test ForbiddenResponseSchema"""
