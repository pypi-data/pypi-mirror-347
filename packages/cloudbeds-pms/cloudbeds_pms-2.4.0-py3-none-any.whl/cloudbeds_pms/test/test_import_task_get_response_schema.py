...
class TestImportTaskGetResponseSchema(unittest.TestCase):
    """ImportTaskGetResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTaskGetResponseSchema:
        """Test ImportTaskGetResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTaskGetResponseSchema`
        """
        model = ImportTaskGetResponseSchema()
        if include_optional:
    ...
    def testImportTaskGetResponseSchema(self):
        """Test ImportTaskGetResponseSchema"""
