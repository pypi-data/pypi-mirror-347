...
class ImportTaskGetRecordListRequestSchema(BaseModel):
    """
    ...
    errors_only: Optional[StrictBool] = Field(default=False, description="Get erroneous records if set to true.", alias="errorsOnly")
    __properties: ClassVar[List[str]] = ["limit", "offset", "errorsOnly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errorsOnly": obj.get("errorsOnly") if obj.get("errorsOnly") is not None else False
        })
        return _obj
