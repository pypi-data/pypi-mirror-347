...
class DoorLockKeyListResponseSchema(BaseModel):
    """
    DoorLockKeyListResponseSchema
    """ # noqa: E501
    data: Optional[List[List[DoorLockKeyResponseSchema]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [
                    [DoorLockKeyResponseSchema.from_dict(_inner_item) for _inner_item in _item]
