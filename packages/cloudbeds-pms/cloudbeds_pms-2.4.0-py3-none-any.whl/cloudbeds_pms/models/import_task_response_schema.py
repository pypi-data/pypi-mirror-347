...
class ImportTaskResponseSchema(BaseModel):
    """
    ImportTaskResponseSchema
    """ # noqa: E501
    id: StrictStr
    upload_url: StrictStr = Field(description="A temporary URL, valid for 10 minutes, used to upload the import file.", alias="uploadUrl")
