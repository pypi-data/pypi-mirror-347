...
class CursorPaginationSchema(BaseModel):
    ...
    """ # noqa: E501
    limit: Optional[StrictInt] = Field(default=5, description="The limit for the number of items to return (max 1000)")
    page_token: Optional[StrictStr] = Field(default=None, description="Token to retrieve the next page of results. It is returned in the response of the previous page.", alias="pageToken")
    __properties: ClassVar[List[str]] = ["limit", "pageToken"]
