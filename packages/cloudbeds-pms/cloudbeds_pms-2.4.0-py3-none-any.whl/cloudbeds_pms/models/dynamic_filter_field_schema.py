...
class DynamicFilterFieldSchema(BaseModel):
    """
    Represents a single filter condition
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="The field to apply the filter on", alias="field")
    operator: Optional[FilterOperatorEnumSchema] = None
    value: Optional[DynamicFilterFieldSchemaValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": DynamicFilterFieldSchemaValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
