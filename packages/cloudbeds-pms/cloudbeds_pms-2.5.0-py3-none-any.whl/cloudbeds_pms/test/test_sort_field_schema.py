...
class TestSortFieldSchema(unittest.TestCase):
    """SortFieldSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortFieldSchema:
        """Test SortFieldSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortFieldSchema`
        """
        model = SortFieldSchema()
        if include_optional:
            return SortFieldSchema(
