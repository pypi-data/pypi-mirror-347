...
class TestIntegrationEventListResponseSchema(unittest.TestCase):
    """IntegrationEventListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationEventListResponseSchema:
        """Test IntegrationEventListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationEventListResponseSchema`
        """
        model = IntegrationEventListResponseSchema()
        if include_optional:
            return IntegrationEventListResponseSchema(
                data = [
                    cloudbeds_pms.models.integration_event_response_schema.IntegrationEventResponseSchema(
                        id = '123456', 
                        property_id = '123456', 
                        object_id = '123456', 
    ...
    def testIntegrationEventListResponseSchema(self):
        """Test IntegrationEventListResponseSchema"""
