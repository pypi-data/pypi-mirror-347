...
class TestDoorLockSettingsCreateRequestSchema(unittest.TestCase):
    """DoorLockSettingsCreateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsCreateRequestSchema:
        """Test DoorLockSettingsCreateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsCreateRequestSchema`
        """
        model = DoorLockSettingsCreateRequestSchema()
        if include_optional:
            return DoorLockSettingsCreateRequestSchema(
                encoders = [
                    cloudbeds_pms.models.door_lock_settings_encoder_request_schema.DoorLockSettingsEncoderRequestSchema(
                        id = '', 
                        name = '', )
                    ],
                key_types = [
                    cloudbeds_pms.models.door_lock_settings_key_type_request_schema.DoorLockSettingsKeyTypeRequestSchema(
                        id = '', 
                        name = '', )
                    ],
                common_rooms = [
                    cloudbeds_pms.models.door_lock_settings_common_room_request_schema.DoorLockSettingsCommonRoomRequestSchema(
                        id = '', 
                        name = '', 
                        doors = [
                            ''
    ...
    def testDoorLockSettingsCreateRequestSchema(self):
        """Test DoorLockSettingsCreateRequestSchema"""
