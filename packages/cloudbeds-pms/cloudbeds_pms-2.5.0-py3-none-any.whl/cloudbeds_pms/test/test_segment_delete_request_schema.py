...
class TestSegmentDeleteRequestSchema(unittest.TestCase):
    """SegmentDeleteRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentDeleteRequestSchema:
        """Test SegmentDeleteRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentDeleteRequestSchema`
        """
        model = SegmentDeleteRequestSchema()
        if include_optional:
            return SegmentDeleteRequestSchema(
                id = '1-b'
            )
        else:
            return SegmentDeleteRequestSchema(
    ...
    def testSegmentDeleteRequestSchema(self):
        """Test SegmentDeleteRequestSchema"""
