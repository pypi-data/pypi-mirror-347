...
class TestDoorLockSettingsEncoderRequestSchema(unittest.TestCase):
    """DoorLockSettingsEncoderRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsEncoderRequestSchema:
        """Test DoorLockSettingsEncoderRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsEncoderRequestSchema`
        """
        model = DoorLockSettingsEncoderRequestSchema()
        if include_optional:
            return DoorLockSettingsEncoderRequestSchema(
                id = '',
                name = ''
            )
        else:
    ...
    def testDoorLockSettingsEncoderRequestSchema(self):
        """Test DoorLockSettingsEncoderRequestSchema"""
