...
class TestImportReprocessTaskResponse(unittest.TestCase):
    """ImportReprocessTaskResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportReprocessTaskResponse:
        """Test ImportReprocessTaskResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportReprocessTaskResponse`
        """
        model = ImportReprocessTaskResponse()
        if include_optional:
            return ImportReprocessTaskResponse(
                message = ''
            )
        else:
            return ImportReprocessTaskResponse(
    ...
    def testImportReprocessTaskResponse(self):
        """Test ImportReprocessTaskResponse"""
