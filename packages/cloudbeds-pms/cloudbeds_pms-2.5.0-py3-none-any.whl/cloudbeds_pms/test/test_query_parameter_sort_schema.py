...
class TestQueryParameterSortSchema(unittest.TestCase):
    """QueryParameterSortSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryParameterSortSchema:
        """Test QueryParameterSortSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryParameterSortSchema`
        """
        model = QueryParameterSortSchema()
        if include_optional:
            return QueryParameterSortSchema(
                sort = [
        {
            "field": "checkin_date",
            "direction": "desc"
    ...
    def testQueryParameterSortSchema(self):
        """Test QueryParameterSortSchema"""
