...
class TestSegmentListReservationsResponseSchema(unittest.TestCase):
    """SegmentListReservationsResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentListReservationsResponseSchema:
        """Test SegmentListReservationsResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentListReservationsResponseSchema`
        """
        model = SegmentListReservationsResponseSchema()
        if include_optional:
            return SegmentListReservationsResponseSchema(
                id = '',
                limit = 56,
                offset = 56,
                reservation_ids = [
    ...
    def testSegmentListReservationsResponseSchema(self):
        """Test SegmentListReservationsResponseSchema"""
