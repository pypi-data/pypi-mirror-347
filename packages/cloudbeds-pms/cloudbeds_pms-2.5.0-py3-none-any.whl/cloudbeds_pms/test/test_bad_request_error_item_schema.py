...
class TestBadRequestErrorItemSchema(unittest.TestCase):
    """BadRequestErrorItemSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadRequestErrorItemSchema:
        """Test BadRequestErrorItemSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadRequestErrorItemSchema`
        """
        model = BadRequestErrorItemSchema()
        if include_optional:
            return BadRequestErrorItemSchema(
                var_field = '',
                message = ''
            )
        else:
    ...
    def testBadRequestErrorItemSchema(self):
        """Test BadRequestErrorItemSchema"""
