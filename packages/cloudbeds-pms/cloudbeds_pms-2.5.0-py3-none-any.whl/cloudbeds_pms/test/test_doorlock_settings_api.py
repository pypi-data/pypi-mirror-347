...
class TestDoorlockSettingsApi(unittest.TestCase):
    """DoorlockSettingsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DoorlockSettingsApi()

    def tearDown(self) -> None:
        pass

    def test_door_lock_settings_controller_delete(self) -> None:
        """Test case for door_lock_settings_controller_delete

        Delete doorlock settings for property for specific application client.
        """
        pass

    def test_door_lock_settings_controller_single(self) -> None:
        """Test case for door_lock_settings_controller_single

        Get doorlock settings for property for specific application client.
        """
        pass

    def test_door_lock_settings_controller_upsert(self) -> None:
        """Test case for door_lock_settings_controller_upsert
