...
class TestBadRequestResponseSchema(unittest.TestCase):
    """BadRequestResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadRequestResponseSchema:
        """Test BadRequestResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadRequestResponseSchema`
        """
    ...
    def testBadRequestResponseSchema(self):
        """Test BadRequestResponseSchema"""
