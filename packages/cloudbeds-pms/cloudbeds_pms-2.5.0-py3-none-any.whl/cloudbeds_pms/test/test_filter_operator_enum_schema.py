...
class TestFilterOperatorEnumSchema(unittest.TestCase):
    """FilterOperatorEnumSchema unit test stubs"""
    ...
    def testFilterOperatorEnumSchema(self):
        """Test FilterOperatorEnumSchema"""
        # inst = FilterOperatorEnumSchema()
