...
class TestDirectionEnumSchema(unittest.TestCase):
    """DirectionEnumSchema unit test stubs"""
    ...
    def testDirectionEnumSchema(self):
        """Test DirectionEnumSchema"""
        # inst = DirectionEnumSchema()
