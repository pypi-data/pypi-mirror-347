...
class TestSegmentCreateRequestSchema(unittest.TestCase):
    """SegmentCreateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentCreateRequestSchema:
        """Test SegmentCreateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentCreateRequestSchema`
        """
        model = SegmentCreateRequestSchema()
        if include_optional:
            return SegmentCreateRequestSchema(
                group_id = '1-b',
                name = 'Abc',
                code = '1000',
    ...
    def testSegmentCreateRequestSchema(self):
        """Test SegmentCreateRequestSchema"""
