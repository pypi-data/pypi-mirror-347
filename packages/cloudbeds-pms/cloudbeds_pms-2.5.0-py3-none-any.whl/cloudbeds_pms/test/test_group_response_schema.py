...
class TestGroupResponseSchema(unittest.TestCase):
    """GroupResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupResponseSchema:
        """Test GroupResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupResponseSchema`
        """
        model = GroupResponseSchema()
        if include_optional:
    ...
    def testGroupResponseSchema(self):
        """Test GroupResponseSchema"""
