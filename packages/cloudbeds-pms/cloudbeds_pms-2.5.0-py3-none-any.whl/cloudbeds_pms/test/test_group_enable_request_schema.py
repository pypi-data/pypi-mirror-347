...
class TestGroupEnableRequestSchema(unittest.TestCase):
    """GroupEnableRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupEnableRequestSchema:
        """Test GroupEnableRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupEnableRequestSchema`
        """
        model = GroupEnableRequestSchema()
        if include_optional:
            return GroupEnableRequestSchema(
                id = '1-b'
            )
        else:
            return GroupEnableRequestSchema(
    ...
    def testGroupEnableRequestSchema(self):
        """Test GroupEnableRequestSchema"""
