...
class TestDoorLockSettingsResponseSchema(unittest.TestCase):
    """DoorLockSettingsResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsResponseSchema:
        """Test DoorLockSettingsResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsResponseSchema`
        """
        model = DoorLockSettingsResponseSchema()
        if include_optional:
            return DoorLockSettingsResponseSchema(
                key_types = [
                    cloudbeds_pms.models.door_lock_settings_key_type_response_schema.DoorLockSettingsKeyTypeResponseSchema(
                        id = '', 
                        name = '', )
                    ],
                encoders = [
                    cloudbeds_pms.models.door_lock_settings_encoder_response_schema.DoorLockSettingsEncoderResponseSchema(
                        id = '', 
                        name = '', )
                    ],
                common_rooms = [
                    cloudbeds_pms.models.door_lock_settings_common_room_response_schema.DoorLockSettingsCommonRoomResponseSchema(
                        id = '', 
                        name = '', 
                        doors = [
                            ''
    ...
    def testDoorLockSettingsResponseSchema(self):
        """Test DoorLockSettingsResponseSchema"""
