...
class SegmentListReservationsRequestSchema(BaseModel):
    """
    ...
    active: Optional[StrictBool] = Field(default=None, description="List only active reservations.")
    __properties: ClassVar[List[str]] = ["limit", "offset", "id", "active"]
