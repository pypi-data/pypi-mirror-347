...
class InspectionListResponseSchema(BaseModel):
    """
    InspectionListResponseSchema
    """ # noqa: E501
    limit: StrictInt = Field(description="The limit for the number of items to return")
    offset: StrictInt = Field(description="The offset for the current page of results")
    data: List[InspectionItemSchema] = Field(description="The list of data objects")
    __properties: ClassVar[List[str]] = ["limit", "offset", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [InspectionItemSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
