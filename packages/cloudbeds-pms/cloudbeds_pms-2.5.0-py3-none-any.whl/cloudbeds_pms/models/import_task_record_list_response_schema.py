...
class ImportTaskRecordListResponseSchema(BaseModel):
    """
    ...
    limit: StrictInt
    total: StrictInt
    data: List[ImportTaskRecordGetResponseSchema] = Field(description="List of import task records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "total": obj.get("total"),
            "data": [ImportTaskRecordGetResponseSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
