...
DYNAMICFILTERFIELDSCHEMAVALUE_ONE_OF_SCHEMAS = ["List[date]", "List[datetime]", "List[int]", "List[str]", "bool", "date", "datetime", "int", "str"]

class DynamicFilterFieldSchemaValue(BaseModel):
    """
    ...
    # data type: date
    oneof_schema_3_validator: Optional[date] = None
    # data type: int
    oneof_schema_4_validator: Optional[StrictInt] = None
    # data type: bool
    oneof_schema_5_validator: Optional[StrictBool] = None
    # data type: List[str]
    oneof_schema_6_validator: Optional[List[StrictStr]] = None
    # data type: List[int]
    oneof_schema_7_validator: Optional[List[StrictInt]] = None
    # data type: List[date]
    oneof_schema_8_validator: Optional[List[date]] = None
    # data type: List[datetime]
    oneof_schema_9_validator: Optional[List[datetime]] = None
    actual_instance: Optional[Union[List[date], List[datetime], List[int], List[str], bool, date, datetime, int, str]] = None
    one_of_schemas: Set[str] = { "List[date]", "List[datetime]", "List[int]", "List[str]", "bool", "date", "datetime", "int", "str" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        instance = DynamicFilterFieldSchemaValue.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in DynamicFilterFieldSchemaValue with oneOf schemas: List[date], List[datetime], List[int], List[str], bool, date, datetime, int, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in DynamicFilterFieldSchemaValue with oneOf schemas: List[date], List[datetime], List[int], List[str], bool, date, datetime, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into List[date]
        try:
            # validation
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into DynamicFilterFieldSchemaValue with oneOf schemas: List[date], List[datetime], List[int], List[str], bool, date, datetime, int, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DynamicFilterFieldSchemaValue with oneOf schemas: List[date], List[datetime], List[int], List[str], bool, date, datetime, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[date], List[datetime], List[int], List[str], bool, date, datetime, int, str]]:
