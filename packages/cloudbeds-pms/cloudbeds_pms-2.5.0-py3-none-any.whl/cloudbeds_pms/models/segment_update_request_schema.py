...
class SegmentUpdateRequestSchema(BaseModel):
    """
    ...
    code: Annotated[str, Field(strict=True, max_length=16)] = Field(description="Segment code.")
    description: StrictStr = Field(description="Segment description.")
    is_enabled: StrictBool = Field(description="Is Segment enabled?.", alias="isEnabled")
    rate_plan_ids: List[StrictStr] = Field(description="List of Rate Plan IDs.", alias="ratePlanIds")
    __properties: ClassVar[List[str]] = ["id", "groupId", "name", "code", "description", "isEnabled", "ratePlanIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlanIds": obj.get("ratePlanIds")
        })
        return _obj
