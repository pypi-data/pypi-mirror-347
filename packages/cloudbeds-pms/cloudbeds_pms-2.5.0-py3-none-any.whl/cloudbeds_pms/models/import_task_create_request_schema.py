...
class ImportTaskCreateRequestSchema(BaseModel):
    """
    ImportTaskCreateRequestSchema
    """ # noqa: E501
    type: StrictStr = Field(description="Import task type.")
    priority: Optional[StrictStr] = Field(default=None, description="Import task priority.")
    __properties: ClassVar[List[str]] = ["type", "priority"]
