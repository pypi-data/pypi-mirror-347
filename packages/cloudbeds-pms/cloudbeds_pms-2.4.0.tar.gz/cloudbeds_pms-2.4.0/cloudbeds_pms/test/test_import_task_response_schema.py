...
class TestImportTaskResponseSchema(unittest.TestCase):
    """ImportTaskResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTaskResponseSchema:
        """Test ImportTaskResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTaskResponseSchema`
        """
        model = ImportTaskResponseSchema()
        if include_optional:
            return ImportTaskResponseSchema(
                id = '',
                upload_url = ''
            )
        else:
    ...
    def testImportTaskResponseSchema(self):
        """Test ImportTaskResponseSchema"""
