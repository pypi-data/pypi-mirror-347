...
class TestImportTaskGetRecordListRequestSchema(unittest.TestCase):
    """ImportTaskGetRecordListRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportTaskGetRecordListRequestSchema:
        """Test ImportTaskGetRecordListRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportTaskGetRecordListRequestSchema`
        """
        model = ImportTaskGetRecordListRequestSchema()
        if include_optional:
            return ImportTaskGetRecordListRequestSchema(
                limit = 1,
                offset = 1,
                errors_only = True
            )
    ...
    def testImportTaskGetRecordListRequestSchema(self):
        """Test ImportTaskGetRecordListRequestSchema"""
