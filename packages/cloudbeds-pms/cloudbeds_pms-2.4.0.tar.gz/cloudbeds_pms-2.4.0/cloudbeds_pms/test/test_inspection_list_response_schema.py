...
class TestInspectionListResponseSchema(unittest.TestCase):
    """InspectionListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InspectionListResponseSchema:
        """Test InspectionListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InspectionListResponseSchema`
        """
        model = InspectionListResponseSchema()
        if include_optional:
            return InspectionListResponseSchema(
                limit = 56,
                offset = 56,
                data = [
                    cloudbeds_pms.models.inspection_item_schema.InspectionItemSchema(
                        updated_date = '', 
                        room_type_id = '', 
                        room_id = '', 
                        room_condition = '', 
    ...
    def testInspectionListResponseSchema(self):
        """Test InspectionListResponseSchema"""
