...
class TestDoorLockSettingsKeyTypeRequestSchema(unittest.TestCase):
    """DoorLockSettingsKeyTypeRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsKeyTypeRequestSchema:
        """Test DoorLockSettingsKeyTypeRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsKeyTypeRequestSchema`
        """
        model = DoorLockSettingsKeyTypeRequestSchema()
        if include_optional:
            return DoorLockSettingsKeyTypeRequestSchema(
                id = '',
                name = ''
            )
        else:
    ...
    def testDoorLockSettingsKeyTypeRequestSchema(self):
        """Test DoorLockSettingsKeyTypeRequestSchema"""
