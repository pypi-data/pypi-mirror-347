...
class TestDoorLockSettingsEncoderResponseSchema(unittest.TestCase):
    """DoorLockSettingsEncoderResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoorLockSettingsEncoderResponseSchema:
        """Test DoorLockSettingsEncoderResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoorLockSettingsEncoderResponseSchema`
        """
        model = DoorLockSettingsEncoderResponseSchema()
        if include_optional:
            return DoorLockSettingsEncoderResponseSchema(
                id = '',
                name = ''
            )
        else:
    ...
    def testDoorLockSettingsEncoderResponseSchema(self):
        """Test DoorLockSettingsEncoderResponseSchema"""
