...
class TestSegmentUpdateRequestSchema(unittest.TestCase):
    """SegmentUpdateRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentUpdateRequestSchema:
        """Test SegmentUpdateRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentUpdateRequestSchema`
        """
        model = SegmentUpdateRequestSchema()
        if include_optional:
            return SegmentUpdateRequestSchema(
                id = '1-b',
                group_id = '1-b',
                name = 'Abc',
                code = '1000',
    ...
    def testSegmentUpdateRequestSchema(self):
        """Test SegmentUpdateRequestSchema"""
