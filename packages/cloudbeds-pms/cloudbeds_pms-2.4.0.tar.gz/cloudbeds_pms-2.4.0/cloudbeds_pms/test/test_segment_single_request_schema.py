...
class TestSegmentSingleRequestSchema(unittest.TestCase):
    """SegmentSingleRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentSingleRequestSchema:
        """Test SegmentSingleRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentSingleRequestSchema`
        """
        model = SegmentSingleRequestSchema()
        if include_optional:
            return SegmentSingleRequestSchema(
                id = '1-b'
            )
        else:
            return SegmentSingleRequestSchema(
    ...
    def testSegmentSingleRequestSchema(self):
        """Test SegmentSingleRequestSchema"""
