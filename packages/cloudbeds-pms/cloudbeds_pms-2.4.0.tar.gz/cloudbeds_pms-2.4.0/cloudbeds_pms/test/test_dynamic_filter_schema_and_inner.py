...
class TestDynamicFilterSchemaAndInner(unittest.TestCase):
    """DynamicFilterSchemaAndInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicFilterSchemaAndInner:
        """Test DynamicFilterSchemaAndInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicFilterSchemaAndInner`
        """
        model = DynamicFilterSchemaAndInner()
        if include_optional:
            return DynamicFilterSchemaAndInner(
                var_field = 'checkin_date',
    ...
    def testDynamicFilterSchemaAndInner(self):
        """Test DynamicFilterSchemaAndInner"""
