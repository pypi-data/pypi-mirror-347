...
class TestInternalServerErrorResponseSchema(unittest.TestCase):
    """InternalServerErrorResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalServerErrorResponseSchema:
        """Test InternalServerErrorResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalServerErrorResponseSchema`
        """
        model = InternalServerErrorResponseSchema()
        if include_optional:
            return InternalServerErrorResponseSchema(
                message = ''
            )
        else:
            return InternalServerErrorResponseSchema(
    ...
    def testInternalServerErrorResponseSchema(self):
        """Test InternalServerErrorResponseSchema"""
