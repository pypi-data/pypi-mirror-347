...
class TestSegmentListResponseSchema(unittest.TestCase):
    """SegmentListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentListResponseSchema:
        """Test SegmentListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentListResponseSchema`
        """
        model = SegmentListResponseSchema()
        if include_optional:
            return SegmentListResponseSchema(
                limit = 56,
                offset = 56,
                data = [
                    cloudbeds_pms.models.segment_response_schema.SegmentResponseSchema(
                        id = '', 
                        group_id = '', 
                        name = '', 
                        code = '', 
    ...
    def testSegmentListResponseSchema(self):
        """Test SegmentListResponseSchema"""
