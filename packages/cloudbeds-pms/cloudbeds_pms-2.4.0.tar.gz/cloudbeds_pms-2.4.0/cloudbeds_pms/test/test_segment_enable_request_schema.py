...
class TestSegmentEnableRequestSchema(unittest.TestCase):
    """SegmentEnableRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SegmentEnableRequestSchema:
        """Test SegmentEnableRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentEnableRequestSchema`
        """
        model = SegmentEnableRequestSchema()
        if include_optional:
            return SegmentEnableRequestSchema(
                id = '1-b'
            )
        else:
            return SegmentEnableRequestSchema(
    ...
    def testSegmentEnableRequestSchema(self):
        """Test SegmentEnableRequestSchema"""
