...
class TestImportFailedToPreProcessResponseSchema(unittest.TestCase):
    """ImportFailedToPreProcessResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportFailedToPreProcessResponseSchema:
        """Test ImportFailedToPreProcessResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportFailedToPreProcessResponseSchema`
        """
        model = ImportFailedToPreProcessResponseSchema()
        if include_optional:
            return ImportFailedToPreProcessResponseSchema(
                message = ''
            )
        else:
            return ImportFailedToPreProcessResponseSchema(
    ...
    def testImportFailedToPreProcessResponseSchema(self):
        """Test ImportFailedToPreProcessResponseSchema"""
