...
class TestLimitOffsetPaginationSchema(unittest.TestCase):
    """LimitOffsetPaginationSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LimitOffsetPaginationSchema:
        """Test LimitOffsetPaginationSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LimitOffsetPaginationSchema`
        """
        model = LimitOffsetPaginationSchema()
        if include_optional:
    ...
    def testLimitOffsetPaginationSchema(self):
        """Test LimitOffsetPaginationSchema"""
