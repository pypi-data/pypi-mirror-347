...
class DoorLockSettingsCommonRoomRequestSchema(BaseModel):
    """
    DoorLockSettingsCommonRoomRequestSchema
    """ # noqa: E501
    id: StrictStr = Field(description="Common room ID.")
    name: StrictStr = Field(description="Common room name.")
    doors: List[StrictStr] = Field(description="Common room doors.")
    __properties: ClassVar[List[str]] = ["id", "name", "doors"]
