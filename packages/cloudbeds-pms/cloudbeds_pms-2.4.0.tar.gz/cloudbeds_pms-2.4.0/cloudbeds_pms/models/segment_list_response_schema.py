...
class SegmentListResponseSchema(BaseModel):
    """
    SegmentListResponseSchema
    """ # noqa: E501
    limit: Optional[StrictInt] = None
    offset: Optional[StrictInt] = None
    data: Optional[List[SegmentResponseSchema]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [SegmentResponseSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
