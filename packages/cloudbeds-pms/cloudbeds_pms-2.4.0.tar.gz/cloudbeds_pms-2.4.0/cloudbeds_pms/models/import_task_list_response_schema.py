...
class ImportTaskListResponseSchema(BaseModel):
    """
    ...
    limit: StrictInt
    total: StrictInt
    data: List[ImportTaskGetResponseSchema] = Field(description="Logical operator grouping filters or nested logical groups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "total": obj.get("total"),
            "data": [ImportTaskGetResponseSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
