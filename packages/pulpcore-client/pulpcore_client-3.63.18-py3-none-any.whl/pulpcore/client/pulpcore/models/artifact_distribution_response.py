...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, hidden=False, pulp_href=None, base_path=None, name=None, base_url=None, pulp_last_updated=None, pulp_created=None, no_content_change_since=None, pulp_labels=None, prn=None, local_vars_configuration=None):  # noqa: E501
