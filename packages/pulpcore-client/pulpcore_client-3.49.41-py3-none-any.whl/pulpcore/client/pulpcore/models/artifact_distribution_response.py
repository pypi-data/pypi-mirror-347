...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, hidden=False, name=None, pulp_labels=None, pulp_last_updated=None, pulp_created=None, base_path=None, base_url=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
