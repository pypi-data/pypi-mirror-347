...
class QuaProgramAnyScalarExpression(betterproto.Message):
    ...
    function: "QuaProgramFunctionExpression" = betterproto.message_field(
        7, group="expression_oneof"
    )
    broadcast: "QuaProgramBroadcastExpression" = betterproto.message_field(
        8, group="expression_oneof"
    )
...
@dataclass(eq=False, repr=False)
class QuaProgramFunctionExpression(betterproto.Message):
    and_: "QuaProgramFunctionExpressionAndFunction" = betterproto.message_field(
        1, group="function_oneof"
    )
    or_: "QuaProgramFunctionExpressionOrFunction" = betterproto.message_field(
        2, group="function_oneof"
    )
    xor: "QuaProgramFunctionExpressionXorFunction" = betterproto.message_field(
        3, group="function_oneof"
    )
    loc: str = betterproto.string_field(100)


@dataclass(eq=False, repr=False)
class QuaProgramFunctionExpressionScalarOrVectorArgument(betterproto.Message):
    scalar: "QuaProgramAnyScalarExpression" = betterproto.message_field(
        1, group="argument_oneof"
    )
    array: "QuaProgramArrayVarRefExpression" = betterproto.message_field(
...
@dataclass(eq=False, repr=False)
class QuaProgramFunctionExpressionAndFunction(betterproto.Message):
    values: List[
...
@dataclass(eq=False, repr=False)
class QuaProgramFunctionExpressionOrFunction(betterproto.Message):
    values: List[
        "QuaProgramFunctionExpressionScalarOrVectorArgument"
    ] = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class QuaProgramFunctionExpressionXorFunction(betterproto.Message):
    values: List[
        "QuaProgramFunctionExpressionScalarOrVectorArgument"
    ] = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class QuaProgramBroadcastExpression(betterproto.Message):
    value: "QuaProgramAnyScalarExpression" = betterproto.message_field(1)
    loc: str = betterproto.string_field(100)
