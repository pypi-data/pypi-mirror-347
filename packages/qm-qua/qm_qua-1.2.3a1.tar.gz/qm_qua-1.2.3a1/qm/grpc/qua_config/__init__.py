...
@dataclass(eq=False, repr=False)
class QuaConfigExponentialParameters(betterproto.Message):
    amplitude: float = betterproto.double_field(1)
    time_constant: float = betterproto.double_field(2)


@dataclass(eq=False, repr=False)
class QuaConfigIirFilter(betterproto.Message):
    exponential: List["QuaConfigExponentialParameters"] = betterproto.message_field(1)
    high_pass: Optional[float] = betterproto.double_field(2, optional=True)
...
class QuaConfigAnalogOutputPortFilter(betterproto.Message):
    ...
    """
    oneof cannot be used because it does not support repeated fields
     IIR filtering approach prior to QOP 3.3
    """

    iir: "QuaConfigIirFilter" = betterproto.message_field(3)
    """IIR filtering approach since QOP 3.3"""
