...
class TokenizeBlock(tf.keras.layers.Layer):
    def __init__(
        ...
        **kwargs
        ...
        self._divide = mlable.layers.shaping.Divide(axis=sequence_axis, factor=token_dim, insert=False, right=True, name='reshaping') # (B, S * G, E) => (B, S, G * E)
...
class DetokenizeBlock(tf.keras.layers.Layer):
    def __init__(
        ...
        **kwargs
        ...
        self._divide = mlable.layers.shaping.Divide(axis=feature_axis, insert=False, right=False, factor=token_dim, name='reshaping') # (B, S, G * E) => (B, S * G, E)
        self._normalize = tf.keras.layers.LayerNormalization(axis=feature_axis, epsilon=epsilon, center=False, scale=False, name='normalization') # normalize each token unit independently
