    ...
    def compare(
        ...
        results: Dict[str, Any] = {
            ...
            "comparison_params": {
                ...
                "delimiter1_used": delimiter1,
                "delimiter2_used": delimiter2,
                "encoding": encoding,
                "decimal_places": decimal_places,
                "max_examples": max_examples,
                "check_structure_only": check_structure_only,  # Added new param
            },
        ...
        if check_structure_only:
            ...
            if not header_comp_result["are_structurally_equivalent"]:
                ...
                # results["are_equivalent"] is already False from header check
            else:
