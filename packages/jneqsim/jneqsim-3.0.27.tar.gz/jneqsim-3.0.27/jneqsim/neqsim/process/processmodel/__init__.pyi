...
class ProcessSystem(jneqsim.neqsim.process.SimulationBaseClass):
    ...
    _addUnit_4__T = typing.TypeVar('_addUnit_4__T', bound=jneqsim.neqsim.process.equipment.ProcessEquipmentInterface)  # <T>
    @typing.overload
    ...
    @typing.overload
    def addUnit(self, string: typing.Union[java.lang.String, str], equipmentEnum: jneqsim.neqsim.process.equipment.EquipmentEnum) -> _addUnit_2__T: ...
    @typing.overload
    ...
    @typing.overload
    def addUnit(self, equipmentEnum: jneqsim.neqsim.process.equipment.EquipmentEnum) -> _addUnit_4__T: ...
    @typing.overload
