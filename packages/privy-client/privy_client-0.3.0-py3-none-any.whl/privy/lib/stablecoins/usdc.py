...
from ...types.fiat import OnrampCreateResponse, onramp_create_params, offramp_create_params
from ...types.wallet_rpc_params import EthSendTransactionParams, EthSendTransactionParamsTransaction
...
def withdraw_usdc_to_bank(
    ...
    rpc_response = send_usdc(
        ...
        amount_in_usdc=float(amount_in_usdc),
        chain_id=chain_id,
    )
