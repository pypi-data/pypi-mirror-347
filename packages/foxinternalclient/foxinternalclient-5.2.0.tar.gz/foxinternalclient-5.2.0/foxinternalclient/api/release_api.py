...
class ReleaseApi:
    ...
    @validate_call
    async def get_release_releases_get_get(
        self,
        ...
        _param = self._get_release_releases_get_get_serialize(
    ...
    @validate_call
    async def get_release_releases_get_get_with_http_info(
        self,
        release_id: Annotated[Optional[Any], Field(description="Release ID")] = None,
        id: Annotated[Optional[Any], Field(description="Release ID (deprecated)")] = None,
        build_id: Annotated[Optional[StrictStr], Field(description="Build ID, `ro.build.fox_id` prop")] = None,
    ...
    @validate_call
    async def get_release_releases_get_get_without_preload_content(
        self,
        release_id: Annotated[Optional[Any], Field(description="Release ID")] = None,
        id: Annotated[Optional[Any], Field(description="Release ID (deprecated)")] = None,
        build_id: Annotated[Optional[StrictStr], Field(description="Build ID, `ro.build.fox_id` prop")] = None,
    ...
    def _get_release_releases_get_get_serialize(
        self,
        release_id,
        id,
        build_id,
    ...
    @validate_call
    async def get_release_short_releases_release_id_get(
        self,
        release_id: Any,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_release_short_releases_release_id_get_serialize(
            release_id=release_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_release_short_releases_release_id_get_with_http_info(
        self,
        release_id: Any,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_release_short_releases_release_id_get_without_preload_content(
        self,
        release_id: Any,
        _request_timeout: Union[
            None,
    ...
    def _get_release_short_releases_release_id_get_serialize(
        self,
        release_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def get_releases_releases_get(
        self,
        ...
        _param = self._get_releases_releases_get_serialize(
            id=id,
            id2=id2,
            build_id=build_id,
            device_id=device_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResponseGetReleasesReleasesGet",
            '404': None,
            '422': "HTTPValidationError",
        }
        response_data = await self.api_client.call_api(
    ...
    @validate_call
    async def get_releases_releases_get_with_http_info(
        self,
        id: Annotated[Optional[List[Any]], Field(description="Filter by Release IDs")] = None,
        id2: Annotated[Optional[List[Any]], Field(description="Filter by Release IDs (deprecated)")] = None,
        build_id: Annotated[Optional[List[StrictStr]], Field(description="Filter by Build IDs")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseGetReleasesReleasesGet]:
        """Get Releases
    ...
    @validate_call
    async def get_releases_releases_get_without_preload_content(
        self,
        id: Annotated[Optional[List[Any]], Field(description="Filter by Release IDs")] = None,
        id2: Annotated[Optional[List[Any]], Field(description="Filter by Release IDs (deprecated)")] = None,
        build_id: Annotated[Optional[List[StrictStr]], Field(description="Filter by Build IDs")] = None,
    ...
    def _get_releases_releases_get_serialize(
        self,
        id,
        id2,
        build_id,
    ...
    @validate_call
    async def get_updates_updates_last_known_id_get(
        self,
        last_known_id: Any,
        ...
        _param = self._get_updates_updates_last_known_id_get_serialize(
    ...
    @validate_call
    async def get_updates_updates_last_known_id_get_with_http_info(
        self,
        last_known_id: Any,
        device_id: Annotated[Optional[List[Any]], Field(description="Filter by device ID")] = None,
        type: Annotated[Optional[List[ReleaseType]], Field(description="Filter by release type")] = None,
    ...
    @validate_call
    async def get_updates_updates_last_known_id_get_without_preload_content(
        self,
        last_known_id: Any,
        device_id: Annotated[Optional[List[Any]], Field(description="Filter by device ID")] = None,
        type: Annotated[Optional[List[ReleaseType]], Field(description="Filter by release type")] = None,
    ...
    def _get_updates_updates_last_known_id_get_serialize(
        self,
        last_known_id,
        device_id,
        type,
