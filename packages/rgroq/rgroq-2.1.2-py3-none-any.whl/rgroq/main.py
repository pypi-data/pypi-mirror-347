...
def main():
    ...
    parser.add_argument('-t', '--temperature', action='store', dest='temperature', 
                       help=f"specify temperature with -t flag: default: {config.llmTemperature}")
    parser.add_argument('-o', '--outputtokens', action='store', dest='outputtokens',
                       help=f"specify max output tokens with -o flag: default: {config.groqApi_max_tokens}")
    # Parse arguments
