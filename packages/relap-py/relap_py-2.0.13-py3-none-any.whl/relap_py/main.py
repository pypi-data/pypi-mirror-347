...
plt.ioff()
#▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
colors = ['k','b','r','g','tab:orange','tab:purple', 'tab:brown','tab:pink',
          'tab:olive','tab:cyan', 'tab:gray', 'tab:blue', 'firebrick', 'goldenrod',
          'turquoise', 'slateblue', 'purple', 'lightcoral', 'limegreen', 'steelblue',
          'moccasin', 'seagreen', 'mediumvioletred', 'dimgrey', 'peru', 'salmon',
          'gold', 'darkslategray', 'khaki', 'beige']
#▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
relap_labels = {
...
def plot_var(variable: str, variables_df: pd.DataFrame, cases_df: pd.DataFrame,
    ...
    if is_one_case:
        if is_multiindex:
            ...
            ax.plot(cases_df['time'], cases_df[tag], linewidth=0.75, color=colors[1])
    else :
        for j, cc in enumerate(case_folder) :
            ax.plot(cases_df.loc[cc]['time'], cases_df.loc[cc][tag], linewidth=0.75,
                    color=colors[j+1], label=cc)
...
def mypie(data: list, labels: list, title='',unit: str='%'):
    ...
    colors_pie = ['#FCD8F9', '#F8B1F1', '#F273E7', '#EE44DE', '#EB25D8', '#DA14C7',
         '#A40F96', '#7C0C72']
    
    fig, ax = plt.subplots(figsize=(10, 5), subplot_kw=dict(aspect="equal"))
    perc = [str(round(e / s * 100., 1)) + '%' for s in (sum(data),) for e in data]
    wedges, texts = ax.pie(data, colors=colors_pie, wedgeprops=dict(width=0.5), startangle=-40)
...
def interactive_plot(data: pd.DataFrame, name: str='interactive_plot',
    ...
    if dataExp is not None :
        common_cols = data.columns.intersection(dataExp.columns)
        dataExp = dataExp[common_cols]
    ...
    cases = all_data.keys()
    colors_plot = dict(zip(cases, colors[:len(cases)]))
    ...
    colors_json = json.dumps(colors_plot)
