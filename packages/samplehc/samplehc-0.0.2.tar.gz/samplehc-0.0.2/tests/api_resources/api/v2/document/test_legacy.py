...
class TestLegacy:
    ...
    def test_method_extract(self, client: SampleHealthcare) -> None:
        legacy = client.api.v2.document.legacy.extract(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    def test_raw_response_extract(self, client: SampleHealthcare) -> None:
        response = client.api.v2.document.legacy.with_raw_response.extract(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    def test_streaming_response_extract(self, client: SampleHealthcare) -> None:
        with client.api.v2.document.legacy.with_streaming_response.extract(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    def test_method_reason(self, client: SampleHealthcare) -> None:
        legacy = client.api.v2.document.legacy.reason(
            documents=[
                {
                    "id": "id",
                    "file_name": "fileName",
    ...
    def test_raw_response_reason(self, client: SampleHealthcare) -> None:
        response = client.api.v2.document.legacy.with_raw_response.reason(
            documents=[
                {
                    "id": "id",
                    "file_name": "fileName",
    ...
    def test_streaming_response_reason(self, client: SampleHealthcare) -> None:
        with client.api.v2.document.legacy.with_streaming_response.reason(
            documents=[
                {
                    "id": "id",
                    "file_name": "fileName",
...
class TestAsyncLegacy:
    ...
    async def test_method_extract(self, async_client: AsyncSampleHealthcare) -> None:
        legacy = await async_client.api.v2.document.legacy.extract(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    async def test_raw_response_extract(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.document.legacy.with_raw_response.extract(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    async def test_streaming_response_extract(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.document.legacy.with_streaming_response.extract(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    async def test_method_reason(self, async_client: AsyncSampleHealthcare) -> None:
        legacy = await async_client.api.v2.document.legacy.reason(
            documents=[
                {
                    "id": "id",
                    "file_name": "fileName",
    ...
    async def test_raw_response_reason(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.document.legacy.with_raw_response.reason(
            documents=[
                {
                    "id": "id",
                    "file_name": "fileName",
    ...
    async def test_streaming_response_reason(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.document.legacy.with_streaming_response.reason(
            documents=[
                {
                    "id": "id",
                    "file_name": "fileName",
