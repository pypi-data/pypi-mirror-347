...
class V2ResourceWithRawResponse:
    ...
    def claim(self) -> ClaimResourceWithRawResponse:
        return ClaimResourceWithRawResponse(self._v2.claim)
...
class AsyncV2ResourceWithRawResponse:
    ...
    def claim(self) -> AsyncClaimResourceWithRawResponse:
        return AsyncClaimResourceWithRawResponse(self._v2.claim)
...
class V2ResourceWithStreamingResponse:
    ...
    def claim(self) -> ClaimResourceWithStreamingResponse:
        return ClaimResourceWithStreamingResponse(self._v2.claim)
...
class AsyncV2ResourceWithStreamingResponse:
    ...
    def claim(self) -> AsyncClaimResourceWithStreamingResponse:
        return AsyncClaimResourceWithStreamingResponse(self._v2.claim)
