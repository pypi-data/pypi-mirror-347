...
from .....types.api.v2.document import legacy_reason_params, legacy_extract_params
from .....types.api.v2.document.legacy_extract_response import LegacyExtractResponse
...
class LegacyResource(SyncAPIResource):
    ...
    def extract(
        ...
        *,
        ...
        """
        return self._post(
            "/api/v2/document/legacy/extract",
