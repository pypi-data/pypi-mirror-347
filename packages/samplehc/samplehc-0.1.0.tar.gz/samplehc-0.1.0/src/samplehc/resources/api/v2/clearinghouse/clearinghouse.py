...
from .....types.api.v2 import (
    ...
    clearinghouse_submit_coordination_of_benefits_params,
)
from .....types.api.v2.clearinghouse_list_payers_response import ClearinghouseListPayersResponse
from .....types.api.v2.clearinghouse_check_eligibility_response import ClearinghouseCheckEligibilityResponse
    ...
    def list_payers(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=ClearinghouseListPayersResponse,
        )

    def submit_coordination_of_benefits(
        self,
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                clearinghouse_submit_coordination_of_benefits_params.ClearinghouseSubmitCoordinationOfBenefitsParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncClearinghouseResource(AsyncAPIResource):
    ...
    async def submit_coordination_of_benefits(
        self,
        *,
        dependent_date_of_birth: str,
        dependent_first_name: str,
...
class ClearinghouseResourceWithRawResponse:
    def __init__(self, clearinghouse: ClearinghouseResource) -> None:
        ...
        self.list_payers = to_raw_response_wrapper(
            clearinghouse.list_payers,
        )
        self.submit_coordination_of_benefits = to_raw_response_wrapper(
            clearinghouse.submit_coordination_of_benefits,
        )
...
class AsyncClearinghouseResourceWithRawResponse:
    def __init__(self, clearinghouse: AsyncClearinghouseResource) -> None:
        ...
        self.submit_coordination_of_benefits = async_to_raw_response_wrapper(
            clearinghouse.submit_coordination_of_benefits,
        )
...
class ClearinghouseResourceWithStreamingResponse:
    def __init__(self, clearinghouse: ClearinghouseResource) -> None:
        ...
        self.submit_coordination_of_benefits = to_streamed_response_wrapper(
            clearinghouse.submit_coordination_of_benefits,
        )
...
class AsyncClearinghouseResourceWithStreamingResponse:
    def __init__(self, clearinghouse: AsyncClearinghouseResource) -> None:
        ...
        self.submit_coordination_of_benefits = async_to_streamed_response_wrapper(
            clearinghouse.submit_coordination_of_benefits,
        )
