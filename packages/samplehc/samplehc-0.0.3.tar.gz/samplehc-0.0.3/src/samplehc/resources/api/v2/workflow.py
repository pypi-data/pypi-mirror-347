...
from ....types.api.v2 import workflow_start_params
from ....types.api.v2.workflow_start_response import WorkflowStartResponse
...
class WorkflowResource(SyncAPIResource):
    ...
    def deploy(
        ...
        *,
        ...
        return self._post(
            f"/api/v2/workflow/{workflow_id}/deploy",
    ...
    def start(
        ...
        *,
        ...
        return self._post(
            f"/api/v2/workflow/{workflow_slug}/start",
