...
from samplehc.types.api.v2 import ClaimSubmitResponse
...
class TestClaim:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_coordinate_benefits(self, client: SampleHealthcare) -> None:
        claim = client.api.v2.claim.coordinate_benefits(
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_coordinate_benefits(self, client: SampleHealthcare) -> None:
        response = client.api.v2.claim.with_raw_response.coordinate_benefits(
            dependent_date_of_birth="dependentDateOfBirth",
            dependent_first_name="dependentFirstName",
            dependent_last_name="dependentLastName",
            encounter_date_of_service="encounterDateOfService",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_coordinate_benefits(self, client: SampleHealthcare) -> None:
        with client.api.v2.claim.with_streaming_response.coordinate_benefits(
            dependent_date_of_birth="dependentDateOfBirth",
            dependent_first_name="dependentFirstName",
            dependent_last_name="dependentLastName",
            encounter_date_of_service="encounterDateOfService",
    ...
    def test_method_submit(self, client: SampleHealthcare) -> None:
        claim = client.api.v2.claim.submit(
            input={
                "claim_information": {
    ...
    def test_raw_response_submit(self, client: SampleHealthcare) -> None:
        response = client.api.v2.claim.with_raw_response.submit(
            input={
                "claim_information": {
                    "benefits_assignment_certification_indicator": "benefitsAssignmentCertificationIndicator",
                    "claim_charge_amount": "claimChargeAmount",
    ...
    def test_streaming_response_submit(self, client: SampleHealthcare) -> None:
        with client.api.v2.claim.with_streaming_response.submit(
            input={
                "claim_information": {
                    "benefits_assignment_certification_indicator": "benefitsAssignmentCertificationIndicator",
                    "claim_charge_amount": "claimChargeAmount",
...
class TestAsyncClaim:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_coordinate_benefits(self, async_client: AsyncSampleHealthcare) -> None:
        claim = await async_client.api.v2.claim.coordinate_benefits(
            dependent_date_of_birth="dependentDateOfBirth",
            dependent_first_name="dependentFirstName",
            dependent_last_name="dependentLastName",
            encounter_date_of_service="encounterDateOfService",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_coordinate_benefits(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.claim.with_raw_response.coordinate_benefits(
            dependent_date_of_birth="dependentDateOfBirth",
            dependent_first_name="dependentFirstName",
            dependent_last_name="dependentLastName",
            encounter_date_of_service="encounterDateOfService",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_coordinate_benefits(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.claim.with_streaming_response.coordinate_benefits(
            dependent_date_of_birth="dependentDateOfBirth",
            dependent_first_name="dependentFirstName",
            dependent_last_name="dependentLastName",
            encounter_date_of_service="encounterDateOfService",
    ...
    async def test_method_submit(self, async_client: AsyncSampleHealthcare) -> None:
        claim = await async_client.api.v2.claim.submit(
            input={
                "claim_information": {
                    "benefits_assignment_certification_indicator": "benefitsAssignmentCertificationIndicator",
                    "claim_charge_amount": "claimChargeAmount",
    ...
    async def test_raw_response_submit(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.claim.with_raw_response.submit(
            input={
                "claim_information": {
                    "benefits_assignment_certification_indicator": "benefitsAssignmentCertificationIndicator",
                    "claim_charge_amount": "claimChargeAmount",
    ...
    async def test_streaming_response_submit(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.claim.with_streaming_response.submit(
            input={
                "claim_information": {
                    "benefits_assignment_certification_indicator": "benefitsAssignmentCertificationIndicator",
                    "claim_charge_amount": "claimChargeAmount",
