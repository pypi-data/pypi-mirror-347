...
class PromptManager:
    ...
    def create_prompt(self,
        ...
        max_tokens = self.model_mgr.selected_max_tokens -num_tokens_from_string(str({"model": self.model_mgr.selected_model_name, "messages": [{"role": self.role or "user", "content":self.prompt }]}))
