...
class AlmanacApi:
    ...
    def get_domain_details_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DomainDetails]]:
        """Get Domain Details
    ...
    def _get_domain_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/almanac/search/domain_details/{domain_name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_domains_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/almanac/search/domains/{address}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def register_agents_batch_v1_almanac_agents_batch_post(
        self,
    ...
    @validate_call
    def register_agents_batch_v1_almanac_agents_batch_post_with_http_info(
        self,
        agent_registration_attestation_batch: AgentRegistrationAttestationBatch,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def register_agents_batch_v1_almanac_agents_batch_post_without_preload_content(
        self,
        agent_registration_attestation_batch: AgentRegistrationAttestationBatch,
        _request_timeout: Union[
            None,
    ...
    def search_agents(
        ...
        :param agent_search: (required)
        :type agent_search: AgentSearch
        :param page_num:
        :type page_num: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def _search_agents_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/almanac/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
