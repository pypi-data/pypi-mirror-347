...
class gTracks():
    ...
    def __init__(self, label: str = ''):
        ...
        self.step_length_m = gQuant('step_length_m',float)
        ...
        self.quantities = (self.uid,self.parent_uid,self.pdgid,
                           ...
                           self.Etot_GeV,self.step_length_m,
                           self.process_name)
    ...
    def set_data(self, new_uid: int, new_parent_uid: int, new_pdgid: int, \
                 new_pos_m: G4ThreeVector, new_t_ns: float, new_Etot_GeV: float, \
                 new_step_length_m: int, new_process_name: bytes = None) -> None:
        ...
        self.step_length_m.value = new_step_length_m
