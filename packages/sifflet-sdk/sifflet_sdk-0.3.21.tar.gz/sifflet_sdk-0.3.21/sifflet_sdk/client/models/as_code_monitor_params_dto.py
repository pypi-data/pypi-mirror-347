...
class AsCodeMonitorParamsDto(BaseModel):
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('Metrics', 'Freshness', 'RowDuplicates', 'FieldUniqueness', 'SchemaChange', 'Sql', 'NoCode', 'InterlinkedMetrics', 'Distribution', 'CustomMetrics', 'FieldFormat', 'FieldInList', 'MetadataFreshness', 'ReferentialIntegrity', 'Volume', 'ValueRange', 'FieldDuplicates', 'FieldNulls', 'StaticFieldProfiling', 'DynamicFieldProfiling', 'StaticMetrics', 'DynamicMetrics', 'Completeness', 'StaticCompleteness', 'Duplicates')"
            )
        return value
