...
class PublicGetSourceV2Dto(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('ATHENA', 'BIGQUERY', 'REDSHIFT', 'SNOWFLAKE', 'DATABRICKS', 'MSSQL', 'MYSQL', 'POSTGRESQL', 'ORACLE', 'SYNAPSE', 'LOOKER', 'TABLEAU', 'QUICKSIGHT', 'MICROSTRATEGY', 'QLIK', 'AIRFLOW', 'DBT', 'DBT_CLOUD', 'FIVETRAN', 'POWER_BI', 'DECLARATIVE')"
            )
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[PublicGetSnowflakeSourceV2Dto]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[PublicGetSnowflakeSourceV2Dto]]:
