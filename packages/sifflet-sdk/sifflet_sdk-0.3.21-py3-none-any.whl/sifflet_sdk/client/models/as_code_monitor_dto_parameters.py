...
class AsCodeMonitorDtoParameters(BaseModel):
    ...
    oneof_schema_2_validator: Optional[AsCodeCustomMetricsMonitorParamsDtoV1] = None
    # data type: AsCodeCustomMetricsMonitorParamsDtoV2
    oneof_schema_3_validator: Optional[AsCodeCustomMetricsMonitorParamsDtoV2] = None
    # data type: AsCodeDistributionMonitorParamsDto
    oneof_schema_4_validator: Optional[AsCodeDistributionMonitorParamsDto] = None
    # data type: AsCodeDuplicatesMonitorParamsDto
    oneof_schema_5_validator: Optional[AsCodeDuplicatesMonitorParamsDto] = None
    # data type: AsCodeDynamicFieldProfilingMonitorParamsDto
    oneof_schema_6_validator: Optional[AsCodeDynamicFieldProfilingMonitorParamsDto] = None
    # data type: AsCodeDynamicMetricMonitorParamsDto
    oneof_schema_7_validator: Optional[AsCodeDynamicMetricMonitorParamsDto] = None
    # data type: AsCodeFieldDuplicatesMonitorParamsDto
    oneof_schema_8_validator: Optional[AsCodeFieldDuplicatesMonitorParamsDto] = None
    # data type: AsCodeFieldFormatMonitorParamsDtoV1
    oneof_schema_9_validator: Optional[AsCodeFieldFormatMonitorParamsDtoV1] = None
    # data type: AsCodeFieldFormatMonitorParamsDtoV2
    oneof_schema_10_validator: Optional[AsCodeFieldFormatMonitorParamsDtoV2] = None
    # data type: AsCodeFieldInListConstraintMonitorParamsDtoV1
    oneof_schema_11_validator: Optional[AsCodeFieldInListConstraintMonitorParamsDtoV1] = None
    # data type: AsCodeFieldInListConstraintMonitorParamsDtoV2
    oneof_schema_12_validator: Optional[AsCodeFieldInListConstraintMonitorParamsDtoV2] = None
    # data type: AsCodeFieldNullsMonitorParamsDto
    oneof_schema_13_validator: Optional[AsCodeFieldNullsMonitorParamsDto] = None
    # data type: AsCodeFieldUniquenessMonitorParamsDto
    oneof_schema_14_validator: Optional[AsCodeFieldUniquenessMonitorParamsDto] = None
    # data type: AsCodeFreshnessMonitorParamsDtoV1
    oneof_schema_15_validator: Optional[AsCodeFreshnessMonitorParamsDtoV1] = None
    # data type: AsCodeFreshnessMonitorParamsDtoV2
    oneof_schema_16_validator: Optional[AsCodeFreshnessMonitorParamsDtoV2] = None
    # data type: AsCodeMetadataFreshnessMonitorParamsDtoV1
    oneof_schema_17_validator: Optional[AsCodeMetadataFreshnessMonitorParamsDtoV1] = None
    # data type: AsCodeMetadataFreshnessMonitorParamsDtoV2
    oneof_schema_18_validator: Optional[AsCodeMetadataFreshnessMonitorParamsDtoV2] = None
    # data type: AsCodeMetricsMonitorParamsDto
    oneof_schema_19_validator: Optional[AsCodeMetricsMonitorParamsDto] = None
    # data type: AsCodeReferentialIntegrityMonitorParamsDtoV1
    oneof_schema_20_validator: Optional[AsCodeReferentialIntegrityMonitorParamsDtoV1] = None
    # data type: AsCodeReferentialIntegrityMonitorParamsDtoV2
    oneof_schema_21_validator: Optional[AsCodeReferentialIntegrityMonitorParamsDtoV2] = None
    # data type: AsCodeRowDuplicatesMonitorParamsDto
    oneof_schema_22_validator: Optional[AsCodeRowDuplicatesMonitorParamsDto] = None
    # data type: AsCodeSchemaChangeMonitorParamsDto
    oneof_schema_23_validator: Optional[AsCodeSchemaChangeMonitorParamsDto] = None
    # data type: AsCodeSqlMonitorParamsDto
    oneof_schema_24_validator: Optional[AsCodeSqlMonitorParamsDto] = None
    # data type: AsCodeStaticCompletenessMonitorParamsDto
    oneof_schema_25_validator: Optional[AsCodeStaticCompletenessMonitorParamsDto] = None
    # data type: AsCodeStaticFieldProfilingMonitorParamsDto
    oneof_schema_26_validator: Optional[AsCodeStaticFieldProfilingMonitorParamsDto] = None
    # data type: AsCodeStaticMetricMonitorParamsDto
    oneof_schema_27_validator: Optional[AsCodeStaticMetricMonitorParamsDto] = None
    # data type: AsCodeValueRangeMonitorParamsDto
    oneof_schema_28_validator: Optional[AsCodeValueRangeMonitorParamsDto] = None
    # data type: AsCodeVolumeMonitorParamsDto
    oneof_schema_29_validator: Optional[AsCodeVolumeMonitorParamsDto] = None
