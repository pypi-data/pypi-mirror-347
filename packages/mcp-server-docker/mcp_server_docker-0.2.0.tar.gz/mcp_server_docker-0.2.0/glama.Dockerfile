...
RUN git clone https://github.com/ckreiling/mcp-server-docker . && git checkout 48c549a9f10a40b8911d28c507f63d19779027ed

RUN (uv sync --frozen --no-dev --no-editable)

# CMD ["mcp-proxy","uv","run","mcp-server-docker"]
CMD ["uv","run","mcp-server-docker"]
