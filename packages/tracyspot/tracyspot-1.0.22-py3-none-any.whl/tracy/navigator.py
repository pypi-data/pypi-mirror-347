...
class KymographNavigator(QMainWindow):
        ...
        try:
            ...
            if hc:
                ...
                hc.update_histogram(frame_img, center_hist,
                                    ...
                                    sigma=fs, intensity=intensity, background=background, peak=pk)
    ...
    def stoploop(self, prompt=True):
        ...
        image, center, crop_size, sigma, intensity, background, peak = self.histogramCanvas._last_histogram_params
        self.histogramCanvas._do_update_histogram(image, center, crop_size, sigma, intensity, background, peak)
    ...
    def _get_traj_colors(self, traj):
        ...
        if mode == "binary":
            ...
            main = "#FFC107" if flag else "#BF7CDA"
