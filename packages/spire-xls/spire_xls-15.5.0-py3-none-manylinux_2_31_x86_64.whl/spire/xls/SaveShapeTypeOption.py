...
class SaveShapeTypeOption (SpireObject) :
    ...
    @dispatch
    def __init__(self):
        GetDllLibXls().SaveShapeTypeOption_CreateSaveShapeTypeOption.restype = c_void_p
        intPtr = CallCFunction(GetDllLibXls().SaveShapeTypeOption_CreateSaveShapeTypeOption)

        super(SaveShapeTypeOption, self).__init__(intPtr)
    """
    <summary>
