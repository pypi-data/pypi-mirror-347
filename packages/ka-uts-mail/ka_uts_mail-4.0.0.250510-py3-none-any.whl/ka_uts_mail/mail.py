...
from ka_uts_mail.mailrcv import MailRcv
from ka_uts_mail.mailsnd import MailDoSnd
...
class Mail:
    ...
    def snd(kwargs: TyDic) -> None:
        ...
        _path: TyPath = Path.sh_path_by_tpl_and_pac(_in_path_aod_snd, kwargs)
    ...
    def rcv(kwargs: TyDic) -> None:
        ...
        _path: TyPath = Path.sh_path_by_tpl_and_pac(_in_path_aod_rcv, kwargs)
        LogEq.debug("_path", _path)
