...
conf = {
    bstack11111l_opy_ (u"ࠫࡦࡶࡰࡠࡣࡸࡸࡴࡳࡡࡵࡧࠪᙷ"): False,
    bstack11111l_opy_ (u"ࠬࡨࡳࡵࡣࡦ࡯ࡤࡹࡥࡴࡵ࡬ࡳࡳ࠭ᙸ"): True,
    bstack11111l_opy_ (u"࠭ࡳ࡬࡫ࡳࡣࡸ࡫ࡳࡴ࡫ࡲࡲࡤࡹࡴࡢࡶࡸࡷࠬᙹ"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11ll1lllll1_opy_ = conf
    @classmethod
    def bstack1l11l111_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll1llllll_opy_=None):
        return self._11ll1lllll1_opy_.get(property_name, bstack11ll1llllll_opy_)
    def bstack1111ll11_opy_(self, property_name, bstack11lll111111_opy_):
        self._11ll1lllll1_opy_[property_name] = bstack11lll111111_opy_
    def bstack1llll11l1l_opy_(self, val):
        self._11ll1lllll1_opy_[bstack11111l_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᙺ")] = bool(val)
    def bstack1111lll111_opy_(self):
        return self._11ll1lllll1_opy_.get(bstack11111l_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧᙻ"), False)