...
PACKAGE_NAME = "database-postgresql-local"
...
setuptools.setup(
    ...
    version='0.1.1',  # https://pypi.org/project/database-postgresql-local/
    author="Circles",
    ...
    # When another package/code imports from this package, the packages
    #  in install_requires will be installed automatically
    install_requires=[
        'python-sdk-remote',
        # TODO: in -remote package please use logger-remote instead.
        'logger-local',
        # TODO: In -remote package please delete this line.
        'psycopg2'
    ]
)
