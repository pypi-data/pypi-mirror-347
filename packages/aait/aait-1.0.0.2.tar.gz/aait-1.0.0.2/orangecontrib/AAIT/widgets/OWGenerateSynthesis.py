    ...
    def cascade_summary_on_summaries(self, chunks, model, embedder, chunk_size=25000, llm="gpt4all", safety_margin=1000):
        ...
        while len(chunks) > 1:
            ...
            for i, chunk in enumerate(chunks):
                ...
                self.label_progress_2.setText(f"Working on chunk {i+1}/{len(chunks)} - {remaining_length} tokens left")
            ...
            chunks, _ = chunking.chunk_tokens(partial_summaries, embedder.tokenizer, chunk_size=25000, chunk_overlap=200)
        return chunks[0]
