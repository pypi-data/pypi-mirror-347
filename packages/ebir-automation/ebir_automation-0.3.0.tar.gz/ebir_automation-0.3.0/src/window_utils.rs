...
const DEFAULT_APP_PATH: &str = r"C:\eBIRForms\BIRForms.exe";
const SNAP_KEY_DELAY: Duration = Duration::from_millis(500);

// eBIRForms application specific constants
const EBIRFORMS_PROCESS_NAME: &str = "mshta.exe";
const EBIRFORMS_CLASS_NAME: &str = "HTA";
#[allow(dead_code)]
const EBIRFORMS_WINDOW_TITLE_PARTIAL: &str = "eBIRForms";
