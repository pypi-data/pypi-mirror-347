...
class LandingPage:
    ...
    def __init__(self, page: Page) -> None:
        ...
        self.ARK_docs_link: Locator = page.get_by_role("link", name="Aria Research Kit")
        self.MPS_docs_link: Locator = page.get_by_role(
            "link", name="Machine Perception Services"
        )
        self.discord_link: Locator = page.get_by_role("link", name="Aria Discord")
