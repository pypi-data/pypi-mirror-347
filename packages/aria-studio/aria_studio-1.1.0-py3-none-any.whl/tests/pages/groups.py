...
class GroupsPage:
    ...
    def __init__(self, page: Page) -> None:
        ...
        self.delete_group_button: Locator = page.locator("button:nth-child(4)")
    ...
    def delete_group(self, group_name: str) -> None:
        ...
        self.page.route(
            "**/group/list",
            lambda route: route.fulfill(path="mock_data/group_data.json"),
        )
        self.page.get_by_text(group_name, exact=True).click()
        self.delete_group_button.click()
        self.delete_group_modal_button.click()
    ...
    def mock_new_group_list_api(self, group_name: str):
        ...
        Returns:
            None
        """
        with open("../tests/mock_data/group_data.json", "r") as f:
            data = json.load(f)
        data.append(
            {
                "name": group_name,
    ...
    def mock_add_files_to_group_api(self, group_name: str):
        ...
        with open("../tests/mock_data/rec_on_computer_files.json", "r") as f:
            data = json.load(f)
