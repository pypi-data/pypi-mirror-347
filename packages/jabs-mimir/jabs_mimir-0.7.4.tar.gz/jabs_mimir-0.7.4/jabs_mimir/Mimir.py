...
class Mimir:
    ...
    def __init__(self, app):
        ...
        self._allowThemeToggle = False #Bool for if darkmode is enabled
    ...
    def addLabeledEntry(self, parent, row, label, variable, state="normal", tooltip=None, validation=None, column=0, vertical=False, columnspan=1, options=None):
        """
