...
class MoHalfcheetah(Halfcheetah):
    """
    The multi-objective version of halfcheetah env.
    ...
    def __init__(self, **kwargs):
        """Initialize the multi-objective halfcheetah env.
    ...
    def step(self, state, action):
        ...
        For more information, please refer to `halfcheetah <https://github.com/google/brax/tree/main/brax/envs/half_cheetah.py>` env in brax.
        """
