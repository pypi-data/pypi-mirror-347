...
class SequenceOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, sequenceType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_461')) else
      _ods_ir.AttrBuilder.get('anonymous_461')(sequenceType, context=_ods_context))
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class TargetOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, target, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_504')) else
      _ods_ir.AttrBuilder.get('anonymous_504')(target, context=_ods_context))
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
