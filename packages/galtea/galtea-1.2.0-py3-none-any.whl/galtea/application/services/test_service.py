    ...
    def create(
        ...
        Args:
            ...
            variants (list[str], optional): Whether we should create variants in the synthetic data. Only makes sense for tests created by Galtea.
                ...
                To check the available variants, please refer to the documentation: https://docs.galtea.ai/sdk/api/test-service#param-variants.\n
        ...
        # Create a dictionary with all test fields including variants
