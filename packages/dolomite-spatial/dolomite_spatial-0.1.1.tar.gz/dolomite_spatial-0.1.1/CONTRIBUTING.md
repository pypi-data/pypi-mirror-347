...
Welcome to `dolomite-spatial` contributor's guide.
...
If you experience bugs or general issues with `dolomite-spatial`, please have a look
...
You can help improve `dolomite-spatial` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dolomite-spatial` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dolomite-spatial`'s files. While this mechanism can
...
```
conda create -n dolomite-spatial python=3 six virtualenv pytest pytest-cov
conda activate dolomite-spatial
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dolomite-spatial.git
   cd dolomite-spatial
   ```
...
5. Install [pre-commit]:
   ...
   `dolomite-spatial` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dolomite-spatial
[issue tracker]: https://github.com/<USERNAME>/dolomite-spatial/issues
