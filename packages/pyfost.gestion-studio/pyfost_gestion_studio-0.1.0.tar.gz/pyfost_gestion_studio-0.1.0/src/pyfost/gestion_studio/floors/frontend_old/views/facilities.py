...
async def create_ui():
    """Creates the UI for the Facilities view."""
    print("Creating Facilities UI")  # Debug print
    ...
    async def refresh_facilities():
        """Fetches facilities from API and updates the table."""
        nonlocal facilities
        try:
    ...
    with ui.column().classes("w-full"):
        with ui.row().classes("w-full items-center justify-between"):
            ...
            with ui.row():
                ...
                ui.button("Refresh", on_click=refresh_facilities, icon="refresh")
    ...
    with ui.dialog() as add_dialog, ui.card():
        ...
        async def handle_add():
            ...
            try:
                ...
                add_dialog.close()
                await refresh_facilities()  # Refresh table
            except Exception as e:
    ...
    ui.timer(0.1, refresh_facilities, once=True)
