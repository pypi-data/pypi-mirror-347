...
from core.llm.data_structure.pcap_analysis import pcap_analysis
...
PYDANTIC_OBJECT = pcap_analysis


@section
def agent_pcap(pcap_log: str) -> pcap_analysis:
    """
    通过LLM分析pcap日志
    :param pcap_log:
    :return:
    ...
    loguru.logger.debug(f"result: {res}")
    return res
