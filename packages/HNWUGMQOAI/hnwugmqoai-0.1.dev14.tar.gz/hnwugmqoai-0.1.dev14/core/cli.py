...
def pcap(
        ...
        INVOKE_THREADS: int = typer.Option(1, help="Number of threads for invoke"),
):
    """
    解析pcap文件，生成报告
    ...
    core.invoke.pcap.invoke(input_pcap_path=input_path, output_report_path=output_path, INVOKE_THREADS=INVOKE_THREADS)
