...
class Block(rx.Base):
    ...
    line_transforms: ClassVar[list[Callable[[str, dict], str]]] = []
    ...
    def from_line(
        ...
        Args:
            ...
            component_map: The component map to use for rendering.
            filename: The filename of the file containing the block.
    ...
    def get_lines(self, env: types.Env) -> list[str]:
