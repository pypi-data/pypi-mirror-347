...
TOS_ACCESS_KEY_ID = "tos.access-key-id"
TOS_SECRET_ACCESS_KEY = "tos.secret-access-key"
TOS_SESSION_TOKEN = "tos.session-token"
TOS_REGION = "tos.region"
TOS_MAX_RETRY_NUM = "tos.max-retry-num"
TOS_MAX_CONNECTIONS = "tos.max-connections"
TOS_CONNECT_TIMEOUT = "tos.connect-timeout"
TOS_SOCKET_TIMEOUT = "tos.socket-timeout"
TOS_HIGH_LATENCY_LOG_THRESHOLD = "tos.high-latency-log-threshold"
TOS_VERSION_AWARE = "tos.version-aware"
TOS_CREDENTIALS_PROVIDER = "tos.credentials-provider"
TOS_DEFAULT_BLOCK_SIZE = "tos.default-block-size"
TOS_DEFAULT_FILL_CACHE = "tos.default-fill-cache"
TOS_DEFAULT_CACHE_TYPE = "tos.default-cache-type"
TOS_MULTIPART_STAGING_DIRS = "tos.multipart-staging-dirs"
TOS_MULTIPART_SIZE = "tos.multipart-size"
TOS_MULTIPART_THREAD_POOL_SIZE = "tos.multipart-thread-pool-size"
TOS_MULTIPART_THRESHOLD = "tos.multipart-threshold"
TOS_ENABLE_CRC = "tos.enable-crc"
TOS_ENABLE_VERIFY_SSL = "tos.enable-verify-ssl"
TOS_DNS_CACHE_TIMEOUT = "tos.dns-cache-timeout"
TOS_PROXY_HOST = "tos.proxy-host"
TOS_PROXY_PORT = "tos.proxy-port"
TOS_PROXY_USERNAME = "tos.proxy-username"
TOS_PROXY_PASSWORD = "tos.proxy-password"
TOS_DISABLE_ENCODING_META = "tos.disable-encoding-meta"
TOS_EXPECT_100_CONTINUE_THRESHOLD = "tos.expect-100-continue-threshold"
