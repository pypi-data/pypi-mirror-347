...
def load_hive(name: str, conf: Properties) -> Catalog:
    try:
        ...
        if conf.get("las.enabled"):
            from pyiceberg.catalog.las import LasCatalog
            return LasCatalog(name, **conf)
...
class Catalog(ABC):
    ...
    def set_access_key_id(self, value: str) -> None:
        ...
        Args:
            value (str): The access key ID to set.
        """
    ...
    def set_secret_access_key(self, value: str) -> None:
        ...
        Args:
            value (str): The secret access key to set.
        """
    ...
    def set_identity_id(self, value: str) -> None:
        ...
        Args:
            value (str): The identity ID to set.
        """
    ...
    def set_identity_type(self, value: str) -> None:
        """
        Set the identity type.

        Args:
            value (str): The identity type to set.
        """
    ...
    def set_catalog_name(self, value: str) -> None:
        ...
        Args:
            value (str): The catalog name to set.
        """
