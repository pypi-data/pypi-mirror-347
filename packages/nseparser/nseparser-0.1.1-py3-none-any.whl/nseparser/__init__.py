...
def get_default_config_path():
    ...
    try:
        return files("nseparser").joinpath("config/config_sample.yaml")
...
eod_prices = LazyModule("nseparser.eod_prices")
company_info = LazyModule("nseparser.company_info")
