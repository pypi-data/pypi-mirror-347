...
#from topbar.docs.restApi.playlist import GetPlaylist, GetPlaylistDetails
...
urlpatterns = [
    ...
    # path('v1/playlist',                           GetPlaylist.as_view(),                   name='getPlaylist'),
    # path('v1/playlist/details',                   GetPlaylistDetails.as_view(),            name='getPlaylistDetails'),
