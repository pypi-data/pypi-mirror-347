    ...
    def set_cell_attachment_fact(self,
        ...
        if get_factid_attachment:
            ...
            try:
                ...
                if self._is_cp4d and self._cp4d_version < "5.1.0":
                    attachment_url = self._set_model_attachments_url(
                        asset_id=model_asset_id,container_id=model_container_id, container_type=model_container_type, name=base_filename, description=description, mimetype=mimetype, fact_id=fact_id, phase_type=phase_name)
                    ...
                    attachment_url = self._set_model_attachments_url_new(
                        asset_id=model_asset_id,container_id=model_container_id, container_type=model_container_type, name=file_name, description=description, mimetype=mimetype, fact_id=fact_id, phase_type=phase_name)
