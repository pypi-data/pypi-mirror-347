...
class AIDataClient:
    ...
    # Embeddings API
    def create_embeddings(self, texts: List[str], model: str = "text-embedding-3-small", normalize: bool = True, metadata: List[Dict] = None) -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            metadata: Optional metadata for each text (list of dicts of same length as texts)
    ...
    def search(self, 
        ...
        Args:
            query: Text to search for (required if embedding not provided)
            embedding: Vector to search with (required if query not provided)
    ...
    def detect_pii(self, 
                  ...
                  resolve_overlaps: bool = True) -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            mask_pii: Whether to apply masking
        ...
        return self._request("POST", "/api/v1/pii/detect", data)
    ...
    def anonymize_pii(self,
                      ...
                      resolve_overlaps: bool = True) -> Dict[str, Any]:
        """
        Advanced PII anonymization with consistent replacements.
        
        Args:
            text: Text to anonymize
            pii_types: Types of PII to detect and anonymize (default: all)
            replacement_map: Optional pre-defined replacements
            consistent_replacements: Use consistent replacements
            resolve_overlaps: Whether to resolve overlapping entities
            
        Returns:
            Anonymized text and details about replacements
        """
        data = {
            "text": text,
        ...
        if pii_types:
            data["pii_types"] = pii_types
        if replacement_map:
            data["replacement_map"] = replacement_map
            
        return self._request("POST", "/api/v1/pii/anonymize", data)
