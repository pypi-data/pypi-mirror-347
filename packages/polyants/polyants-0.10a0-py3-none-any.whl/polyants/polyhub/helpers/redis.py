...
from polyants.polyhub.constants import REDIS_PREFIX, DEFAULT_ID, REDIS_HOST, REDIS_PORT, REDIS_DB
...
def handle_event(cg, subscriptions):
    counter = 0
    while True:
        counter += 1
