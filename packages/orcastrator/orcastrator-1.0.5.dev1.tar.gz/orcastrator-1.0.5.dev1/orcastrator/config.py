...
SCHEMA = {
    ...
    "molecules": {
        ...
        "required": True,
        "schema": {
            "xyz_dir": {"type": "string", "required": True, "default": "molecules"},
            "default_charge": {"type": "integer", "required": True, "default": 0},
            "default_mult": {
                "type": "integer",
                "min": 1,
                "required": True,
...
def load_config(config_file: Path) -> dict:
    ...
    schema["molecules"]["schema"]["xyz_dir"]["coerce"] = "relativepath"
