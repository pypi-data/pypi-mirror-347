...
class ProtoType(Enum):
    ...
    AUTOMATON_OUTPUT = "automaton_output"
...
def deserialize_protobuf(protobuf: bytes, proto_type: ProtoType) -> Union[MissionRequest, MissionResponse, AgentUpdate, ObstaclesUpdate, ControllerFeedback, UnsafeSet, AutomatonOutput]:
...
def _deserialize_unsafe_set(protobuf: bytes) -> AutomatonOutput: 
    """Deserialize Automaton output"""
    msg = AutomatonOutput()
