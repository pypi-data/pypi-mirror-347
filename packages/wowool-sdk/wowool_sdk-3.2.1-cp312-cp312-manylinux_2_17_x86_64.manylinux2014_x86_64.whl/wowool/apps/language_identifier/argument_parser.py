...
class ArgumentParser(ArgumentParserBase):
    def __init__(self):
        """
        EyeOnText Wowool Language Identifier
        """
        ...
        self.add_argument("--sections" ,help="return the language sections in a multi language document.", default=False, action="store_true")
