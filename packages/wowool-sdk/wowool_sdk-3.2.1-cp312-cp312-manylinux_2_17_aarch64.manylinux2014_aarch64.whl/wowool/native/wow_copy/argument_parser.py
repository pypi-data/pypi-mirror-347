...
"""
        super(ArgumentParserBase, self).__init__(prog="wow.cp", description=ArgumentParser.__init__.__doc__, formatter_class = argparse.RawDescriptionHelpFormatter )
        self.add_argument("-f", "--file", help="folder or file", required = True)
        self.add_argument("--glob", help="glob the given pattern, default '**/*", default='**/*')
        ...
        self.add_argument("-i", "--provider_type", help="input provider type: ex. html, pdf, text", default="")
