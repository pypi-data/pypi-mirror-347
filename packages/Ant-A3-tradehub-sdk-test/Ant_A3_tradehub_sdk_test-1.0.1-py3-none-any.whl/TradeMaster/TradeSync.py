...
class TradeHub:
    ...
    def exitBracketOrder(self, orderNo, orderComplexity):
        """
        # Mandatory
        :param orderNo:
        :param orderComplexity:
        ...
        # Request Validate Part
        validate_exitBracketOrder(orderNo=orderNo,
                                   orderComplexity=orderComplexity)
    ...
    def positionSqrOff(self, product, quantity, exchange=None, instrumentId=None, symbol=None, instrument=None):
        """
        # Mandatory
        :param exchange:
        :param product:
        ...
        if instrument is not None:
            if not isinstance(instrument, Instrument):
                raise TypeError("Instrument must be of type Instrument")
            exchange = exchange or instrument.exchange
            instrumentId = exchange or instrument.token
        ...
        # Request Validate Part
        validate_positionSqrOff(exchange=exchange, product=product, quantity=quantity, instrumentId=instrumentId, symbol=symbol)
        ...
        # API call
        positionSqrOffResp = self._init_post(_endpoints_key="positionSqrOff", data=data)
        return positionSqrOffResp
