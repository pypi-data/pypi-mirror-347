...
```python
from filmlens import MovieClient, MovieConfig

# Configuration avec l’URL de votre API (Render ou locale)
config = MovieConfig(movie_base_url="https://movie-backend-8zzx.onrender.com")
...
- API Render : [https://movie-backend-8zzx.onrender.com](https://movie-backend-8zzx.onrender.com)
- PyPI : [https://pypi.org/project/filmlens](https://pypi.org/project/filmlens)