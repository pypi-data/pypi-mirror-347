...
from .....models.analytics.sources import WhatsAppDefaultSource, TopicDefaultSource, PureAd, Source, TemplateSource
...
class SourceFactory:
    ...
    @staticmethod
    def create_new_impure_ad(message: ChattyMessage, company_id: str, default_flow: str | None = None) -> PureAd:
        source_data = {
            "agent_email": "source_checker@letschatty.com",
