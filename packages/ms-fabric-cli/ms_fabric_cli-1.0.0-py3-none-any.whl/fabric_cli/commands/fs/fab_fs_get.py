...
def _validate_sensitivity_label_warning(args: Namespace, item: Item) -> bool:
    ...
    if args.force:
        utils_ui.print_warning("Item definition is retrieved without its sensitivity label")
        return True
    else:
        return utils_ui.prompt_confirm("Item definition is retrieved without its sensitivity label. Are you sure?")
