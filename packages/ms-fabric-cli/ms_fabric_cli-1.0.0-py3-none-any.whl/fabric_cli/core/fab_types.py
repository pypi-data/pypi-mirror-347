        ...
        match elem_type_str.lower():
            ...
            case x if x.startswith("."):
                ...
                raise FabricCLIError(
                    f"{elem_type_str} is not a valid Fabric Element",
                    fab_constant.WARNING_INVALID_ELEMENT_TYPE,
                )
            case _:
    ...
    def from_string(cls, ws_type_str):
        ...
        for item in cls:
            if item.value.lower() == ws_type_str.lower():
                return item
        raise FabricCLIError(
            f"{ws_type_str} is not a valid Fabric Workspace Type",
    ...
    def from_string(cls, vws_type_str):
        ...
        for item in cls:
            if item.value.lower() == vws_type_str.lower():
                return item
        raise FabricCLIError(
            f"{vws_type_str} is not a valid FabricVirtualWorkspaceType",
            fab_constant.WARNING_INVALID_WORKSPACE_TYPE,
        )
    ...
    def from_string(cls, item_type_str):
        ...
        for item in cls:
            if str(item).lower() == item_type_str.lower():
                return item
        raise FabricCLIError(
            f"{item_type_str} is not a valid FabricItemType",
    ...
    def from_string(cls, vws_type_str):
        ...
        for item in cls:
            if item.value.lower() == vws_type_str.lower():
                return item
        raise FabricCLIError(
            f"{vws_type_str} is not a valid FabricVirtualItemContainerType.",
            fab_constant.WARNING_INVALID_ITEM_TYPE,
        )
