...
Refer to the Terraform Registry for docs: [`data_databricks_database_instances`](https://registry.terraform.io/providers/databricks/databricks/1.79.1/docs/data-sources/database_instances).
'''
...
class DataDatabricksDatabaseInstances(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataDatabricksDatabaseInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.79.1/docs/data-sources/database_instances#import import section} in the documentation of this resource for the id to use
...
class DataDatabricksDatabaseInstancesDatabaseInstances:
    def __init__(
        ...
        *,
        ...
        admin_rolename: typing.Optional[builtins.str] = None,
        ...
        '''
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.79.1/docs/data-sources/database_instances#name DataDatabricksDatabaseInstances#name}.
        :param admin_password: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.79.1/docs/data-sources/database_instances#admin_password DataDatabricksDatabaseInstances#admin_password}.
        :param admin_rolename: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.79.1/docs/data-sources/database_instances#admin_rolename DataDatabricksDatabaseInstances#admin_rolename}.
        :param capacity: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.79.1/docs/data-sources/database_instances#capacity DataDatabricksDatabaseInstances#capacity}.
        :param stopped: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.79.1/docs/data-sources/database_instances#stopped DataDatabricksDatabaseInstances#stopped}.
        '''
        if __debug__:
            ...
            check_type(argname="argument admin_rolename", value=admin_rolename, expected_type=type_hints["admin_rolename"])
        ...
        if admin_rolename is not None:
            self._values["admin_rolename"] = admin_rolename
    ...
    @builtins.property
    def admin_rolename(self) -> typing.Optional[builtins.str]:
        ...
        result = self._values.get("admin_rolename")
        return typing.cast(typing.Optional[builtins.str], result)
...
class DataDatabricksDatabaseInstancesDatabaseInstancesOutputReference(
    ...
    @jsii.member(jsii_name="resetAdminRolename")
    def reset_admin_rolename(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetAdminRolename", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="adminRolenameInput")
    def admin_rolename_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "adminRolenameInput"))
    ...
    def admin_password(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3aa7f8be06915e9281f9810d4706915203387444bb53f4e0c470d988367d6ccd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "adminPassword", value) # pyright: ignore[reportArgumentType]

    @builtins.property
    @jsii.member(jsii_name="adminRolename")
    def admin_rolename(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "adminRolename"))

    @admin_rolename.setter
    def admin_rolename(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0a41bab12288fca93723a7eb654bdc44b276b29c53ee78a2fdd92ad3f86271cf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "adminRolename", value) # pyright: ignore[reportArgumentType]
...
def _typecheckingstub__3aa7f8be06915e9281f9810d4706915203387444bb53f4e0c470d988367d6ccd(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0a41bab12288fca93723a7eb654bdc44b276b29c53ee78a2fdd92ad3f86271cf(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
