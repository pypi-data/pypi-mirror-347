...
class RabbitMQClient:
    ...
    def process_message(self, message) -> EventHandler:
        # Logic xử lý thông báo, subclass cần override phương thức này
...
To exit press CTRL+C"""
    ...
    def close_all_connections(self, queue_name: str):
        try:
            # Duyệt qua tất cả các kết nối và đóng những kết nối liên quan đến queue_name
