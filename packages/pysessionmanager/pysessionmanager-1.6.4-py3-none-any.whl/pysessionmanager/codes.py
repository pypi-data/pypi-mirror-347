class SessionMessages:
    ...
    @staticmethod
    def sessions_as_json_added_message(file_path):
        return f"Sessions have been successfully added to JSON file: {file_path}", SessionMessages.SESSIONS_AS_JSON_ADDED
    @staticmethod
    def sessions_as_json_failed_message(file_path):
        return f"Failed to add sessions to JSON file: {file_path}", SessionMessages.SESSIONS_AS_JSON_FAILED
    @staticmethod
    def sessions_as_csv_added_message(file_path):
        return f"Sessions have been successfully added to CSV file: {file_path}", SessionMessages.SESSIONS_AS_CSV_ADDED
    @staticmethod
    def sessions_as_csv_failed_message(file_path):
        return f"Failed to add sessions to CSV file: {file_path}", SessionMessages.SESSIONS_AS_CSV_FAILED
    @staticmethod
    def sessions_as_sqlite_added_message(file_path):
        return f"Sessions have been successfully added to SQLite file: {file_path}", SessionMessages.SESSIONS_AS_SQLITE_ADDED
    @staticmethod
    def sessions_as_sqlite_failed_message(file_path):
        return f"Failed to add sessions to SQLite file: {file_path}", SessionMessages.SESSIONS_AS_SQLITE_FAILED
    @staticmethod
    def sessions_as_postgresql_added_message(file_path):
        return f"Sessions have been successfully added to PostgreSQL file: {file_path}", SessionMessages.SESSIONS_AS_POSTGRESQL_ADDED
    @staticmethod
    def sessions_as_postgresql_failed_message(file_path):
        return f"Failed to add sessions to PostgreSQL file: {file_path}", SessionMessages.SESSIONS_AS_POSTGRESQL_FAILED
    @staticmethod
    def session_as_json_loaded_message(file_path):
        return f"Session has been successfully loaded from JSON file: {file_path}", SessionMessages.SESSION_AS_JSON_LOADED
    @staticmethod
    def session_as_json_loaded_failed_message(file_path):
        return f"Failed to load session from JSON file: {file_path}", SessionMessages.SESSION_AS_JSON_LOADED_FAILED
    @staticmethod
    def session_as_csv_loaded_message(file_path):
        return f"Session has been successfully loaded from CSV file: {file_path}", SessionMessages.SESSION_AS_CSV_LOADED
    @staticmethod
    def session_as_csv_loaded_failed_message(file_path):
        return f"Failed to load session from CSV file: {file_path}", SessionMessages.SESSION_AS_CSV_LOADED_FAILED
    @staticmethod
    def session_as_sqlite_loaded_message(file_path):
        return f"Session has been successfully loaded from SQLite file: {file_path}", SessionMessages.SESSION_AS_SQLITE_LOADED
    @staticmethod
    def session_as_sqlite_loaded_failed_message(file_path):
        return f"Failed to load session from SQLite file: {file_path}", SessionMessages.SESSION_AS_SQLITE_LOADED_FAILED
    @staticmethod
    def session_as_postgresql_loaded_message(file_path):
        return f"Session has been successfully loaded from PostgreSQL file: {file_path}", SessionMessages.SESSION_AS_POSTGRESQL_LOADED
    @staticmethod
    def session_as_postgresql_loaded_failed_message(file_path):
        return f"Failed to load session from PostgreSQL file: {file_path}", SessionMessages.SESSION_AS_POSTGRESQL_LOADED_FAILED