...
class FrameworkAdapter(ABC):
    ...
    def handle_sync_stream(
        self,
        pillar: "Pillar",
        stream_result: Iterable[StreamChunk],
        extracted_input: ExtractedInput,  # Pass extracted input for context
        analyze_func: Callable[..., Any],  # pillar.analyze_sync or pillar.analyze_async
    ...
    def handle_async_stream(
        self,
        pillar: "Pillar",
        stream_result: AsyncIterable[StreamChunk],
        extracted_input: ExtractedInput,  # Pass extracted input for context
        analyze_func: Callable[..., Any],  # pillar.analyze_async
    ) -> AsyncGenerator[StreamChunk, None]:
        """
        Handles an asynchronous stream result by returning an async generator.
        The returned generator yields chunks and performs analysis upon completion.
        Uses context from extracted_input (model, tools, api_type).
        """
        pass
