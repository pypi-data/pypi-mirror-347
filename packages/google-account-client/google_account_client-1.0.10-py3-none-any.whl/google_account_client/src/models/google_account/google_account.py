...
class GoogleAccount(GoogleServiceCredentials, GoogleCalendar):
    ...
    """
    def __init__(self, name: str, user_token: any = None, credentials: Credentials = None, logger: any = None):
        """
        ...
        GoogleServiceCredentials.__init__(self, user_token, credentials, logger)
