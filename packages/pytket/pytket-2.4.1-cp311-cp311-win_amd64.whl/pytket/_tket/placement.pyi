...
class Placement:
    ...
    @staticmethod
    def place_with_map(circuit: pytket._tket.circuit.Circuit, qmap: Mapping[pytket._tket.unit_id.Qubit, pytket._tket.unit_id.Node]) -> bool:
        """
    ...
    @staticmethod
    def from_dict(arg: dict, /) -> Placement:
        """
...
class LinePlacement(Placement):
    ...
    def to_dict(self) -> object:
        """
        Return a JSON serializable dict representation of the LinePlacement.
...
class GraphPlacement(Placement):
    ...
    def to_dict(self) -> object:
        """
        Return a JSON serializable dict representation of the GraphPlacement.
...
class NoiseAwarePlacement(Placement):
    ...
    def __init__(self, arc: pytket._tket.architecture.Architecture, node_errors: Mapping[pytket._tket.unit_id.Node, float] = {}, link_errors: Mapping[tuple[pytket._tket.unit_id.Node, pytket._tket.unit_id.Node], float] = {}, readout_errors: Mapping[pytket._tket.unit_id.Node, float] = {}, maximum_matches: int = 1000, timeout: int = 1000, maximum_pattern_gates: int = 100, maximum_pattern_depth: int = 100) -> None:
        """
    ...
    def to_dict(self) -> object:
        """
        Return a JSON serializable dict representation of the NoiseAwarePlacement.

        :return: dict representing the NoiseAwarePlacement.
        """

def place_with_map(circuit: pytket._tket.circuit.Circuit, qmap: Mapping[pytket._tket.unit_id.Qubit, pytket._tket.unit_id.Node]) -> None:
    """
