...
class ZXGen:
    ...
    @overload
    @staticmethod
    def create(type: ZXType, param: Union[sympy.Expr, float], qtype: QuantumType = QuantumType.Quantum) -> ZXGen: ...
...
class ZXDiagram:
    ...
    @overload
    def add_vertex(self, type: ZXType, param: Union[sympy.Expr, float], qtype: QuantumType = QuantumType.Quantum) -> ZXVert:
        """
