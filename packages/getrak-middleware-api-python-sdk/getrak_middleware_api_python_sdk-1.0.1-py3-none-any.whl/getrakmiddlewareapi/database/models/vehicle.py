...
class Vehicle(CustomBaseDocument):
	...
	vel = IntField()
	velocidade = IntField()
	is_capture_records = BooleanField(default=False)
	tipo_transmissao = StringField()
	tensao_bateria = IntField()
	nivel_bateria_reserva = IntField()
	...
	def to_dict(self):
		json_string = {
			...
			"tipo": self.tipo,
			"vel": self.vel,
			"is_capture_records": self.is_capture_records,
			"velocidade": self.velocidade,
			"tipo_transmissao": self.tipo_transmissao,
