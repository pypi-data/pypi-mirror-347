...
def find_solution_brfs(search_context: SearchContext, start_state: State | None = None, brfs_event_handler: IBrFSEventHandler | None = None, goal_strategy: IGoalStrategy | None = None, pruning_strategy: IPruningStrategy | None = None, stop_if_goal: bool = True, max_num_states: int = 4294967295, max_time_in_ms: int = 4294967295) -> SearchResult: ...
...
def find_solution_gbfs(search_context: SearchContext, heuristic: IHeuristic, start_state: State | None = None, gbfs_event_handler: IGBFSEventHandler | None = None, goal_strategy: IGoalStrategy | None = None, pruning_strategy: IPruningStrategy | None = None) -> SearchResult: ...
