...
class Plan:
    def to_string(self, arg: pymimir.advanced.formalism.Problem, /) -> str: ...
...
def find_solution_brfs(search_context: SearchContext, start_state: Optional[State] = None, brfs_event_handler: Optional[IBrFSEventHandler] = None, goal_strategy: Optional[IGoalStrategy] = None, pruning_strategy: Optional[IPruningStrategy] = None, stop_if_goal: bool = True, max_num_states: int = 4294967295, max_time_in_ms: int = 4294967295) -> SearchResult: ...

class GBFSStatistics:
    def __init__(self) -> None: ...
...
class IGBFSEventHandler:
    ...
    def get_statistics(self) -> GBFSStatistics: ...

class DefaultGBFSEventHandler(IGBFSEventHandler):
    def __init__(self, problem: pymimir.advanced.formalism.Problem, quiet: bool = True) -> None: ...

class DebugGBFSEventHandler(IGBFSEventHandler):
    def __init__(self, problem: pymimir.advanced.formalism.Problem, quiet: bool = True) -> None: ...

def find_solution_gbfs(search_context: SearchContext, heuristic: IHeuristic, start_state: Optional[State] = None, gbfs_event_handler: Optional[IGBFSEventHandler] = None, goal_strategy: Optional[IGoalStrategy] = None, pruning_strategy: Optional[IPruningStrategy] = None) -> SearchResult: ...
