...
CRUD_MYSQL_TEST_LOGGER_OBJECT = CRUD_MYSQL_CODE_LOGGER_OBJECT.copy()
CRUD_MYSQL_TEST_LOGGER_OBJECT['component_category'] = LoggerComponentEnum.ComponentCategory.Unit_Test.value
