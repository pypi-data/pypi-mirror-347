...
class GenericCRUD(GenericCrudAbstract, metaclass=ABCMetaLogger,
    ...
    def __init__(self, *, default_schema_name: str,
                 ...
                 # For backward compatability we have added is_latest_version optional parameter. A better way will be to rename the name of the Class and create new Class in the original name
    ...
    def insert(self, *, schema_name: str = None, table_name: str = None, data_dict: dict = None,
        ...
        try:
            ...
            if ignore_duplicate:
                ...
                self.logger.warning(f"GenericCRUD.insert({schema_name}.{table_name}) using ignore_duplicate, is it needed? - Trying to insert a duplicate value",
                                    object={"data_dict": data_dict})
