"""
Module migrated from 'yta_general_utils' to enhance the 
base Enum class and to be able to operate easier.

I use a lot this custom Enum class along all my projects.
"""
