...
class FileWriteMode(Enum):
    """
    The mode we want to use to write a file.
    """

    WRITE = 'w'
    """
    The file content will be overwritten if there
    is a previous content.
    """
    APPEND = 'a'
    """
    The file content will be appended to the previous
    content if existing.
    """