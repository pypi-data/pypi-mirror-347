...
@mcp.tool(description="查询资源退还TOP")
def describe_user_activity_top_decrease(
    ...
    pool: Annotated[Optional[str], Field(description="资源池")] = None,
    region: Annotated[Optional[str], Field(description="地域")] = None,
    zone: Annotated[Optional[str], Field(description="可用区")] = None,
    start_time: Annotated[Optional[str], Field(description="起始时间")] = None,
    end_time: Annotated[Optional[str], Field(description="结束时间")] = None,
    main_zone: Annotated[Optional[bool], Field(description="是否主力园区")] = None,
    main_instance_family: Annotated[Optional[bool], Field(description="是否主力机型")] = None,
    customhouse: Annotated[Optional[str], Field(description="境内外")] = None,
...
@mcp.tool(description="查询资源增长TOP")
...
@mcp.tool(description="查询活跃资源TOP")
