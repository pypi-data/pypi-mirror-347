...
@mcp.tool(description="查询 VStation 任务列表")
def query_task_message(
    region: Annotated[str, Field(description="地域，如 ap-guangzhou")],
    task_id: Annotated[List[str], Field(description="任务ID列表")],
    instance_id: Annotated[List[str], Field(description="实例ID列表")] = [],
    uuid: Annotated[List[str], Field(description="任务UUID列表")] = [],
    request_id: Annotated[List[str], Field(description="请求ID列表")] = [],
...
@mcp.tool(description="查询母机/宿主机/Compute组件的任务列表")
