...
def query_quota(
    ...
    app_id: Annotated[Optional[List[str]], Field(description="用户AppID列表")] = None,
...
@mcp.tool(description="获取用户拥有的网格列表")
def get_user_owned_grid(
    app_id: Annotated[int, Field(description="APPID")],
...
@mcp.tool(description="获取用户拥有的实例列表")
