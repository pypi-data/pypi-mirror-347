...
@mcp.tool(description="查询VStation任务列表")
def query_task_message(
    region: Annotated[str, Field(description="地域，如 ap-guangzhou")],
    task_id: Annotated[Optional[List[str]], Field(description="任务ID列表")] = [],
    instance_id: Annotated[Optional[List[str]], Field(description="实例ID列表")] = [],
    uuid: Annotated[Optional[List[str]], Field(description="任务UUID列表")] = [],
    request_id: Annotated[Optional[List[str]], Field(description="请求ID列表")] = [],
...
@mcp.tool(description="查询 VStation 错误码")
...
@mcp.tool(description="根据VStation任务和母机IP查询Compute任务列表")
...
@mcp.tool(description="查询母机/宿主机/Compute组件的任务的执行日志")
