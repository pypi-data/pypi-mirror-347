...
def query_quota(
    ...
    app_id: Annotated[Optional[List[str]], Field(description="用户AppID列表", gt=0)] = None,
    pay_mode: Annotated[Optional[List[str]], Field(description="计费模式列表")] = None,
...
def query_instances(
    ...
    next_token: Annotated[str, Field(description="分页token")] = "",
    limit: Annotated[int, Field(description="每页数量")] = 20,
    app_ids: Annotated[Optional[List[int]], Field(description="AppID列表", gt=0)] = None,
    uins: Annotated[Optional[List[str]], Field(description="UIN列表")] = None,
    instance_types: Annotated[Optional[List[str]], Field(description="实例类型列表")] = None,
    instance_families: Annotated[Optional[List[str]], Field(description="实例族列表")] = None
) -> str:
...
@mcp.tool(description="获取用户预扣资源统计")
def get_user_owned_grid(
    app_id: Annotated[int, Field(description="APPID", gt=0)],
...
@mcp.tool(description="获取用户实例资源统计")
...
@mcp.tool(description="获取客户账号信息")
def get_customer_account_info(
    customer_ids: Annotated[List[str], Field(description="客户ID列表")]
) -> str:
    """获取客户账号信息
