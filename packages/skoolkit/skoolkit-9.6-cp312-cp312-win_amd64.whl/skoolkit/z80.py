...
AFTER_DDCB_TIMINGS = {
    ...
    0x7E: 20, # BIT 7,(IX+0)
    0x7F: 20, # BIT 7,(IX+0)
    0x80: 23, # RES 0,(IX+0),B
    0x81: 23, # RES 0,(IX+0),C
    0x82: 23, # RES 0,(IX+0),D
    0x83: 23, # RES 0,(IX+0),E
    0x84: 23, # RES 0,(IX+0),H
    0x85: 23, # RES 0,(IX+0),L
    0x86: 23, # RES 0,(IX+0)
    0x87: 23, # RES 0,(IX+0),A
    0x88: 23, # RES 1,(IX+0),B
    0x89: 23, # RES 1,(IX+0),C
    0x8A: 23, # RES 1,(IX+0),D
    0x8B: 23, # RES 1,(IX+0),E
    0x8C: 23, # RES 1,(IX+0),H
    0x8D: 23, # RES 1,(IX+0),L
    0x8E: 23, # RES 1,(IX+0)
    0x8F: 23, # RES 1,(IX+0),A
    0x90: 23, # RES 2,(IX+0),B
    0x91: 23, # RES 2,(IX+0),C
    0x92: 23, # RES 2,(IX+0),D
    0x93: 23, # RES 2,(IX+0),E
    0x94: 23, # RES 2,(IX+0),H
    0x95: 23, # RES 2,(IX+0),L
    0x96: 23, # RES 2,(IX+0)
    0x97: 23, # RES 2,(IX+0),A
    0x98: 23, # RES 3,(IX+0),B
    0x99: 23, # RES 3,(IX+0),C
    0x9A: 23, # RES 3,(IX+0),D
    0x9B: 23, # RES 3,(IX+0),E
    0x9C: 23, # RES 3,(IX+0),H
    0x9D: 23, # RES 3,(IX+0),L
    0x9E: 23, # RES 3,(IX+0)
    0x9F: 23, # RES 3,(IX+0),A
    0xA0: 23, # RES 4,(IX+0),B
    0xA1: 23, # RES 4,(IX+0),C
    0xA2: 23, # RES 4,(IX+0),D
    0xA3: 23, # RES 4,(IX+0),E
    0xA4: 23, # RES 4,(IX+0),H
    0xA5: 23, # RES 4,(IX+0),L
    0xA6: 23, # RES 4,(IX+0)
    0xA7: 23, # RES 4,(IX+0),A
    0xA8: 23, # RES 5,(IX+0),B
    0xA9: 23, # RES 5,(IX+0),C
    0xAA: 23, # RES 5,(IX+0),D
    0xAB: 23, # RES 5,(IX+0),E
    0xAC: 23, # RES 5,(IX+0),H
    0xAD: 23, # RES 5,(IX+0),L
    0xAE: 23, # RES 5,(IX+0)
    0xAF: 23, # RES 5,(IX+0),A
    0xB0: 23, # RES 6,(IX+0),B
    0xB1: 23, # RES 6,(IX+0),C
    0xB2: 23, # RES 6,(IX+0),D
    0xB3: 23, # RES 6,(IX+0),E
    0xB4: 23, # RES 6,(IX+0),H
    0xB5: 23, # RES 6,(IX+0),L
    0xB6: 23, # RES 6,(IX+0)
    0xB7: 23, # RES 6,(IX+0),A
    0xB8: 23, # RES 7,(IX+0),B
    0xB9: 23, # RES 7,(IX+0),C
    0xBA: 23, # RES 7,(IX+0),D
    0xBB: 23, # RES 7,(IX+0),E
    0xBC: 23, # RES 7,(IX+0),H
    0xBD: 23, # RES 7,(IX+0),L
    0xBE: 23, # RES 7,(IX+0)
    0xBF: 23, # RES 7,(IX+0),A
    0xC0: 23, # SET 0,(IX+0),B
    0xC1: 23, # SET 0,(IX+0),C
    0xC2: 23, # SET 0,(IX+0),D
    0xC3: 23, # SET 0,(IX+0),E
    0xC4: 23, # SET 0,(IX+0),H
    0xC5: 23, # SET 0,(IX+0),L
    0xC6: 23, # SET 0,(IX+0)
    0xC7: 23, # SET 0,(IX+0),A
    0xC8: 23, # SET 1,(IX+0),B
    0xC9: 23, # SET 1,(IX+0),C
    0xCA: 23, # SET 1,(IX+0),D
    0xCB: 23, # SET 1,(IX+0),E
    0xCC: 23, # SET 1,(IX+0),H
    0xCD: 23, # SET 1,(IX+0),L
    0xCE: 23, # SET 1,(IX+0)
    0xCF: 23, # SET 1,(IX+0),A
    0xD0: 23, # SET 2,(IX+0),B
    0xD1: 23, # SET 2,(IX+0),C
    0xD2: 23, # SET 2,(IX+0),D
    0xD3: 23, # SET 2,(IX+0),E
    0xD4: 23, # SET 2,(IX+0),H
    0xD5: 23, # SET 2,(IX+0),L
    0xD6: 23, # SET 2,(IX+0)
    0xD7: 23, # SET 2,(IX+0),A
    0xD8: 23, # SET 3,(IX+0),B
    0xD9: 23, # SET 3,(IX+0),C
    0xDA: 23, # SET 3,(IX+0),D
    0xDB: 23, # SET 3,(IX+0),E
    0xDC: 23, # SET 3,(IX+0),H
    0xDD: 23, # SET 3,(IX+0),L
    0xDE: 23, # SET 3,(IX+0)
    0xDF: 23, # SET 3,(IX+0),A
    0xE0: 23, # SET 4,(IX+0),B
    0xE1: 23, # SET 4,(IX+0),C
    0xE2: 23, # SET 4,(IX+0),D
    0xE3: 23, # SET 4,(IX+0),E
    0xE4: 23, # SET 4,(IX+0),H
    0xE5: 23, # SET 4,(IX+0),L
    0xE6: 23, # SET 4,(IX+0)
    0xE7: 23, # SET 4,(IX+0),A
    0xE8: 23, # SET 5,(IX+0),B
    0xE9: 23, # SET 5,(IX+0),C
    0xEA: 23, # SET 5,(IX+0),D
    0xEB: 23, # SET 5,(IX+0),E
    0xEC: 23, # SET 5,(IX+0),H
    0xED: 23, # SET 5,(IX+0),L
    0xEE: 23, # SET 5,(IX+0)
    0xEF: 23, # SET 5,(IX+0),A
    0xF0: 23, # SET 6,(IX+0),B
    0xF1: 23, # SET 6,(IX+0),C
    0xF2: 23, # SET 6,(IX+0),D
    0xF3: 23, # SET 6,(IX+0),E
    0xF4: 23, # SET 6,(IX+0),H
    0xF5: 23, # SET 6,(IX+0),L
    0xF6: 23, # SET 6,(IX+0)
    0xF7: 23, # SET 6,(IX+0),A
    0xF8: 23, # SET 7,(IX+0),B
    0xF9: 23, # SET 7,(IX+0),C
    0xFA: 23, # SET 7,(IX+0),D
    0xFB: 23, # SET 7,(IX+0),E
    0xFC: 23, # SET 7,(IX+0),H
    0xFD: 23, # SET 7,(IX+0),L
    0xFE: 23, # SET 7,(IX+0)
    0xFF: 23, # SET 7,(IX+0),A
}
...
class Assembler:
    ...
    def _bit_res_set(self, base_code, address, op1, op2, op3=None):
        bit_offset = base_code + 8 * self.parse_byte(op1, 8, non_neg=True)
        if op2.startswith('(I'):
            if op3:
                return (_index_code(op2), 203, self._parse_offset(op2), bit_offset + _reg_index(op3))
    ...
    def _rotate_and_shift(self, base_code, address, op1, op2=None):
        if op1.startswith('(I'):
            if op2:
                return (_index_code(op1), 203, self._parse_offset(op1), base_code + _reg_index(op2))
            return (_index_code(op1), 203, self._parse_offset(op1), base_code + 6)
        return (203, base_code + _reg_index(op1))
