...
def add_creat_updt_info(data: Dict[str, Any], updater_user_id: str) -> Dict[str, Any]:
    """
...
def create_or_merge_firestore_document_extended(
    ...
    Args:
        ...
        data: Data to save
        firestore_client: Firestore client
        merge: Whether to merge (True) or overwrite (False) the document
        add_metadata: Whether to add standard metadata
        creator_id: ID of creator for metadata
        force_metadata_update: Whether to force update metadata fields
    ...
    # Determine action based on merge parameter
    ...
    try:
        ...
        result.add_state(f"DOCUMENT_SET_COMPLETED")
        ...
        try:
            ...
            log_by_lvl(
                info_msg=f"Firestore SET document {document_id} in collection {collection} completed",
