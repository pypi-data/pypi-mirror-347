...
def get_fleet_variables(
    fleet: balena.types.models.TypeApplication | int | str,
    ...
    if isinstance(fleet, int):
        ...
        fleet_id = get_fleet(fleet)
        if fleet_id:
            service = get_service_id(fleet_id, "main")
...
def get_custom_set_vars_fleet(fleet_name: str) -> dict[str, dict[str, str | int]]:
    ...
    raw_env_vars = balena_sdk.models.device.env_var.get_all_by_application(ORGANIZATION_HANDLE + fleet_name)
