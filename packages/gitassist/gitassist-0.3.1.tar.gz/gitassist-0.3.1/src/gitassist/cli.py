...
def new_pr_command(base):
    ...
    description_prompt = (
        ...
        "Ensure that this response is in markdown format, make sure to use `` for the file names.\n"
        "The description should in paragraph format and only the content of the description, no titles.\n"
        "Let's make the content brief while capturing the nature of the PR. \n"
        f"Commit messages:\n{commit_messages}"
    )
