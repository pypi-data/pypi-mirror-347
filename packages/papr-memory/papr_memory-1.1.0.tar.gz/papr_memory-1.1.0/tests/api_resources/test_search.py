...
from papr_memory.types import SearchResponse
...
class TestSearch:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_perform(self, client: PaprMemory) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_perform_with_all_params(self, client: PaprMemory) -> None:
        search = client.search.perform(
            query="Find recurring customer complaints about API performance from the last month. Focus on issues where customers specifically mentioned timeout errors or slow response times in their conversations.",
            max_memories=1,
            max_nodes=1,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_perform(self, client: PaprMemory) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_perform(self, client: PaprMemory) -> None:
...
class TestAsyncSearch:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_perform(self, async_client: AsyncPaprMemory) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_perform_with_all_params(self, async_client: AsyncPaprMemory) -> None:
        search = await async_client.search.perform(
            query="Find recurring customer complaints about API performance from the last month. Focus on issues where customers specifically mentioned timeout errors or slow response times in their conversations.",
            max_memories=1,
            max_nodes=1,
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_perform(self, async_client: AsyncPaprMemory) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_perform(self, async_client: AsyncPaprMemory) -> None:
