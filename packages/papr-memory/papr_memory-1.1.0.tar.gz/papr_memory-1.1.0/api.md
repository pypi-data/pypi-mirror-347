...
- <code title="post /v1/search">client.search.<a href="./src/papr_memory/resources/search.py">perform</a>(\*\*<a href="src/papr_memory/types/search_perform_params.py">params</a>) -> <a href="./src/papr_memory/types/search_response.py">SearchResponse</a></code>
