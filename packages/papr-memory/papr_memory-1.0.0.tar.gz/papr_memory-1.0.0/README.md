...
[![PyPI version](https://img.shields.io/pypi/v/papr-memory.svg)](https://pypi.org/project/papr-memory/)
...
client = Papr(
    api_key=os.environ.get("PAPR_API_KEY"),  # This is the default and can be omitted
    bearer_token=os.environ.get("PAPR_BEARER_TOKEN"),  # This is the default and can be omitted
)
...
to add `PAPR_API_KEY="My API Key"` to your `.env` file
