...
from maleo_metadata.types.results.client.organization_role import MaleoMetadataOrganizationRoleClientResultsTypes
...
class MaleoMetadataOrganizationRoleClientService(ClientService):
    ...
    ) -> MaleoMetadataOrganizationRoleClientResultsTypes.GetMultiple:
    ...
    async def get_organization_role(
        ...
        controller_type:MaleoMetadataGeneralEnums.ClientControllerType = MaleoMetadataGeneralEnums.ClientControllerType.HTTP
    ) -> MaleoMetadataOrganizationRoleClientResultsTypes.GetSingle:
