...
from maleo_metadata.client.controllers.http.blood_type import MaleoMetadataBloodTypeHTTPController
from maleo_metadata.client.controllers.http.gender import MaleoMetadataGenderHTTPController
from maleo_metadata.client.controllers.http.organization_role import MaleoMetadataOrganizationRoleHTTPController
from maleo_metadata.client.controllers.http.organization_type import MaleoMetadataOrganizationTypeHTTPController
from maleo_metadata.client.controllers.http.service import MaleoMetadataServiceHTTPController
from maleo_metadata.client.controllers.http.system_role import MaleoMetadataSystemRoleHTTPController
from maleo_metadata.client.controllers.http.user_type import MaleoMetadataUserTypeHTTPController
...
class MaleoMetadataClientManager(MaleoClientManager):
    ...
    def _initialize_controllers(self):
        ...
        blood_type_http_controller = MaleoMetadataBloodTypeHTTPController(service_manager=self.service_manager, manager=self._controller_managers.http)
        blood_type_controllers = MaleoMetadataBloodTypeControllers(http=blood_type_http_controller)
        #* Gender controllers
        gender_http_controller = MaleoMetadataGenderHTTPController(service_manager=self.service_manager, manager=self._controller_managers.http)
        gender_controllers = MaleoMetadataGenderControllers(http=gender_http_controller)
        #* Organization role controllers
        organization_role_http_controller = MaleoMetadataOrganizationRoleHTTPController(service_manager=self.service_manager, manager=self._controller_managers.http)
        ...
        organization_type_http_controller = MaleoMetadataOrganizationTypeHTTPController(service_manager=self.service_manager, manager=self._controller_managers.http)
        organization_type_controllers = MaleoMetadataOrganizationTypeControllers(http=organization_type_http_controller)
        #* Service controllers
        service_http_controller = MaleoMetadataServiceHTTPController(service_manager=self.service_manager, manager=self._controller_managers.http)
        service_controllers = MaleoMetadataServiceControllers(http=service_http_controller)
        #* System role controllers
        system_role_http_controller = MaleoMetadataSystemRoleHTTPController(service_manager=self.service_manager, manager=self._controller_managers.http)
        system_role_controllers = MaleoMetadataSystemRoleControllers(http=system_role_http_controller)
        #* User type controllers
        user_type_http_controller = MaleoMetadataUserTypeHTTPController(service_manager=self.service_manager, manager=self._controller_managers.http)
