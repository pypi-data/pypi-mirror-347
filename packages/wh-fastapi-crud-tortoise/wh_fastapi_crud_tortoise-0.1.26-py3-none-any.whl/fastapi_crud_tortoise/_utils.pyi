...
def resp_success(data: Incomplete | None = None, total: int = None, current: int = None, size: int = None, code: str = '0000', msg: str = 'OK', http_code=..., headers={}): ...
def resp_fail(data: Incomplete | None = None, total: Incomplete | None = None, code: str = '5000', msg: str = 'Fail', http_code=..., headers={}): ...
