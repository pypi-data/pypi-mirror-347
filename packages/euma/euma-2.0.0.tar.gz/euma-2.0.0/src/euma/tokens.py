...
class Dimension:
	def __init__(self, value: int | float, unit: DimensionalUnit):
		self.value = value
		self.unit = unit
...
class Duration:
	def __init__(self, value: int | float, unit: TemporalUnit):
		self.value = value
		self.unit = unit
...
class Transition:
	def __init__(self, duration: Duration, delay: Duration, timing_function: CubicBezier):
...
class StrokeStyle:
	...
	def __init__(self, dash_array: list[Dimension] | None, line_cap: LineCap | None):
...
class GradientStop:
	def __init__(self, color: Color, position: float):
		self.color = color
...
class Border:
	def __init__(self, color: Color, width: Dimension, style: StrokeStyle):
		self.color = color
		self.width = width
		self.style = style
...
class StylisticSet:
	def __init__(self, identifier: StylisticSetId, value: bool):
		self.id = identifier
		self.value = value
...
class CharacterVariant:
	def __init__(self, identifier: CharacterVariantId, value: bool):
		self.id = identifier
		self.value = value
...
class FontFeature:
	def __init__(self, identifier: FontFeatureId, value: int):
...
class TextElementContainer:
	# a button element
	button = StateContainer()
	# a badge element
	badge = StateContainer()
	# a link element
	link = StateContainer()
	# a label element
	...
	paragraph = StateContainer()
	# a small text element
	small = StateContainer()
	...
	select = StateContainer()
	# a text input element
	inputs = StateContainer()
	# a legend element
	legend = StateContainer()
	# a quoted text element
	quote = StateContainer()
	# a notification element
	notification = StateContainer()
	...
	entry = StateContainer()
	# description for another element
	caption = StateContainer()
...
class TokenSpace:
	...
	margin = ElementContainer()
	# the top margin
	margin_top = ElementContainer()
	# the right margin
	margin_right = ElementContainer()
	# the bottom margin
	margin_bottom = ElementContainer()
	# the left margin
	margin_left = ElementContainer()
	# the top and bottom margin
	margin_block = ElementContainer()
	# even padding all around
	padding = ElementContainer()
	# the top padding
	padding_top = ElementContainer()
	# the right padding
	padding_right = ElementContainer()
	# the bottom padding
	padding_bottom = ElementContainer()
	# the left padding
	padding_left = ElementContainer()
	# the border/corner radius of all corners
	border_radius = ElementContainer()
	# the top left border/corner radius
	border_top_left_radius = ElementContainer()
	# the the top right border/corner radius
	border_top_right_radius = ElementContainer()
	# the the bottom right border/corner radius
	border_bottom_right_radius = ElementContainer()
	# the bottom left border/corner radius
	border_bottom_left_radius = ElementContainer()
	# predefined max widths
	max_width = ElementContainer()
	# predefined max heights
	max_height = ElementContainer()
	# the thickens of a border
	border_width = ElementContainer()
...
class TokenFx:
	...
	animation_duration = ElementContainer()
	# the duration of a transition
	transition_duration = ElementContainer()
	# animation easing functions
	animation_timing_function = ElementContainer()
	# transition easing functions
	transition_timing_function = ElementContainer()
	# the delay before the start of an animation
	animation_delay = ElementContainer()
	# the delay before the start of a transition
	transition_delay = ElementContainer()
	# box shadows
	box_shadow = ElementContainer()
