...
from testindex.core.exceptions import ConfigurationError
...
DEFAULT_CONFIG = {
    "neo4j_uri": None,  # Changed from 'bolt://localhost:7687' to None
    "neo4j_user": "neo4j",
    "neo4j_password": "password",
    "knowledge_graph_dir": ".aston",
    "pinecone": PineconeConfig().to_dict()
}
...
def load_config() -> Dict[str, Any]:
    ...
    config_file = os.environ.get('TESTINDEX_CONFIG', 'testindex.yaml')
