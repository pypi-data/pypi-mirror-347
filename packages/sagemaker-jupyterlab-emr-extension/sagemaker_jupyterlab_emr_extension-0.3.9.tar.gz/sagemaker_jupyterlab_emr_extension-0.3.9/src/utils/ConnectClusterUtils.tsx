...
import { isKerberosCluster } from './AuthTypeUtil';
...
const handleSpecialClusterConnect = (
  ...
  // cluster is either Kerberos or LDAP cluster
  const authMode = isKerberosCluster(cluster) ? AuthType.Kerberos : AuthType.Basic_Access;
