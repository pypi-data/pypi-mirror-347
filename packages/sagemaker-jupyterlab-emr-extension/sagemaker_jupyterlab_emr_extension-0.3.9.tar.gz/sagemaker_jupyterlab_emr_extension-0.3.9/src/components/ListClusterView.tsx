...
import { handleSpecialClusterConnect, openSelectAuthType } from '../utils/ConnectClusterUtils';
...
import { isKerberosCluster, isLdapCluster } from '../utils/AuthTypeUtil';
  ...
  const onConnect = async () => {
    try {
      ...
      if (clusterRow.clusterAccountId === emrConnectRoleData.CallerAccountId) {
        ...
        if (isKerberosCluster(clusterRow) || isLdapCluster(clusterRow)) {
