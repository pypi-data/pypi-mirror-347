...
class Database(object):
    ...
    def __init__(self, instance, schema, retry=None, do_fallback=True):
        """
        Inicialització de paràmetres i connexió a la base de dades.
        En cas d'error, intenta cada (retry) segons.
        """
        hacked_instance = instance + 'p' if "prod" in schema else instance
        ...
        if self.engine == 'my':
            ...
            if do_fallback and instance in DB_FALLBACKS and schema in DB_FALLBACKS[instance]:  # noqa
