...
class RunCreateStateful(BaseModel):
    ...
    stream_subgraphs: Optional[StrictBool] = Field(
        default=False, description="Whether to stream output from subgraphs."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "stream_subgraphs": obj.get("stream_subgraphs")
                if obj.get("stream_subgraphs") is not None
                else False,
