...
from ..Infrastructure.JwtService.auth_service import AuthServiceFWDI
...
class WebApplicationBuilder():
    ...
    def build(self)-> type[T]:
        ...
        AuthServiceFWDI.oauth2_scheme = OAuth2PasswordBearer(tokenUrl="token", scopes=self.__scopes,) if len(self.__scopes) > 0 else OAuth2PasswordBearer(tokenUrl="token")
