...
class TestResponseGetReleasesReleasesGet(unittest.TestCase):
    """ResponseGetReleasesReleasesGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseGetReleasesReleasesGet:
        """Test ResponseGetReleasesReleasesGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseGetReleasesReleasesGet`
        """
        model = ResponseGetReleasesReleasesGet()
        if include_optional:
            return ResponseGetReleasesReleasesGet(
                data = {
                    'key' : [
    ...
    def testResponseGetReleasesReleasesGet(self):
        """Test ResponseGetReleasesReleasesGet"""
