...
ProcessorCreateRequestConfig = typing.Union[
    ProcessorCreateRequestConfig_Classify, ProcessorCreateRequestConfig_Extract, ProcessorCreateRequestConfig_Splitter
]
