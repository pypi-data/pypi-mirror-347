...
from comps_extractor.utils.geo_encoder import get_coordinates
...
from property import Property, SoldProperty, ForSaleProperty, PropertyAddress
...
def generate_comps(for_sale_property: ForSaleProperty, radius: Optional[float] = 0.5,
    ...
    final_scraped_properties: List[SoldProperty] = \
        [prop for prop in scraped_properties
...
if __name__ == '__main__':
    # Only parameters that matters - address, bedrooms, sqft, lat/long
    generate_comps(for_sale_property=ForSaleProperty(
        address=PropertyAddress.from_full_address('223 Kittanning St, Pittsburgh, PA 1521'),
        beds=5,
        sqft=2072,
        lat=40.510627,
        long=-79.939150,
