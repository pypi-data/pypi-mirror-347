...
class FloPyEnv(gym.Env):
    ...
    def _setup_gym_spaces(self):
        ...
        print('DEBUG self.observation_space, self.action_space', self.observation_space, self.action_space)
    ...
    def fig_to_rgb_array(self, fig):
        ...
        return copy(frombuffer(data, dtype=uint8).reshape(height, width, 3))
