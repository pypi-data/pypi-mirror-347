...
Welcome to `dolomite-sfe` contributor's guide.
...
If you experience bugs or general issues with `dolomite-sfe`, please have a look
...
You can help improve `dolomite-sfe` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dolomite-sfe` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dolomite-sfe`'s files. While this mechanism can
...
```
conda create -n dolomite-sfe python=3 six virtualenv pytest pytest-cov
conda activate dolomite-sfe
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dolomite-sfe.git
   cd dolomite-sfe
   ```
...
5. Install [pre-commit]:
   ...
   `dolomite-sfe` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dolomite-sfe
[issue tracker]: https://github.com/<USERNAME>/dolomite-sfe/issues
