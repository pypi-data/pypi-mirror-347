...
class FleetAppsManagementRunbooksClient(object):
    ...
    def change_runbook_compartment(self, runbook_id, change_runbook_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.152.0/fleetappsmanagement/change_runbook_compartment.py.html>`__ to see an example of how to use change_runbook_compartment API.
        """
    ...
    def change_task_record_compartment(self, task_record_id, change_task_record_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.152.0/fleetappsmanagement/change_task_record_compartment.py.html>`__ to see an example of how to use change_task_record_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_runbook(self, create_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.152.0/fleetappsmanagement/create_runbook.py.html>`__ to see an example of how to use create_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_runbook_version(self, create_runbook_version_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.152.0/fleetappsmanagement/create_runbook_version.py.html>`__ to see an example of how to use create_runbook_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_task_record(self, create_task_record_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.152.0/fleetappsmanagement/create_task_record.py.html>`__ to see an example of how to use create_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_runbook(self, runbook_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.152.0/fleetappsmanagement/delete_runbook.py.html>`__ to see an example of how to use delete_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookId']
    ...
    def delete_runbook_version(self, runbook_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.152.0/fleetappsmanagement/delete_runbook_version.py.html>`__ to see an example of how to use delete_runbook_version API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
