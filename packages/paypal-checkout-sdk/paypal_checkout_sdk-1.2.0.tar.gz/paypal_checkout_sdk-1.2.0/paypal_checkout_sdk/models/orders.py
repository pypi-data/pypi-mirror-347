...
class PatchOperation(BaseModel):
    ...
    from_path: Optional[str] = Field(None, alias="from", description="A JSON Pointer path (RFC 6901) that references the location in the target document to move or copy the value from. Required for 'move' and 'copy' operations.")
    ...
    # Pydantic v2: Use model_config for alias handling
    model_config = {
        "populate_by_name": True # Allows using 'from' as field name in code, but serializes as 'from'
    }
